...
public class CreateEdgeNodeServiceRequest extends AbstractModel {
    ...
    */
    ...
    public CreateEdgeNodeServiceRequest() {
    }
     ...
     */
    public CreateEdgeNodeServiceRequest(CreateEdgeNodeServiceRequest source) {
        if (source.Zone != null) {
