...
public class DescribeRaspEventCWPRequest extends AbstractModel {
...
Source is case-sensitive for memory shell injection and vulnerability defense, rasp: vulnerability defense, memshell_inject: memory shell injection
    ...
    public DescribeRaspEventCWPRequest() {
    }
     ...
     */
    public DescribeRaspEventCWPRequest(DescribeRaspEventCWPRequest source) {
