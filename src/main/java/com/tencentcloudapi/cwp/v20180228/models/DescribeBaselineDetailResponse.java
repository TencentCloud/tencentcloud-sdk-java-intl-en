...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public DescribeBaselineDetailResponse(DescribeBaselineDetailResponse source) {
        if (source.BaselineDetail != null) {
            this.BaselineDetail = new BaselineDetail(source.BaselineDetail);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamObj(map, prefix + "BaselineDetail.", this.BaselineDetail);
