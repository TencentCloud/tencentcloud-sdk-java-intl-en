...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public DescribeRansomDefenseStrategyDetailResponse(DescribeRansomDefenseStrategyDetailResponse source) {
        if (source.Strategy != null) {
            this.Strategy = new RansomDefenseStrategyDetail(source.Strategy);
        }
