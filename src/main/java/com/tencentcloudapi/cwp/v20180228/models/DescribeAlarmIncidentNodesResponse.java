...
Note: This field may return null, indicating that no valid values can be obtained.
    */
    ...
    @Expose
    private IncidentVertexInfo [] IncidentNodes;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeAlarmIncidentNodesResponse() {
    }
     ...
     */
    public DescribeAlarmIncidentNodesResponse(DescribeAlarmIncidentNodesResponse source) {
        if (source.IncidentNodes != null) {
            this.IncidentNodes = new IncidentVertexInfo[source.IncidentNodes.length];
            for (int i = 0; i < source.IncidentNodes.length; i++) {
                this.IncidentNodes[i] = new IncidentVertexInfo(source.IncidentNodes[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "IncidentNodes.", this.IncidentNodes);
