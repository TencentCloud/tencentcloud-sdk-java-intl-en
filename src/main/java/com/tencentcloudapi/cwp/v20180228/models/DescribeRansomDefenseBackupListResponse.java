...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     * Set Backup list
Note: This field may return null, indicating that no valid values can be obtained.
     * @param List Backup list
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public void setList(RansomDefenseBackup [] List) {
        this.List = List;
    }
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public DescribeRansomDefenseBackupListResponse(DescribeRansomDefenseBackupListResponse source) {
        if (source.List != null) {
            this.List = new RansomDefenseBackup[source.List.length];
            for (int i = 0; i < source.List.length; i++) {
                this.List[i] = new RansomDefenseBackup(source.List[i]);
            }
        }
