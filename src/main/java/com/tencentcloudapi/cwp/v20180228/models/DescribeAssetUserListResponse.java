...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public DescribeAssetUserListResponse(DescribeAssetUserListResponse source) {
        if (source.Total != null) {
            this.Total = new Long(source.Total);
        }
        if (source.Users != null) {
            this.Users = new AssetUserBaseInfo[source.Users.length];
            for (int i = 0; i < source.Users.length; i++) {
                this.Users[i] = new AssetUserBaseInfo(source.Users[i]);
            }
        }
