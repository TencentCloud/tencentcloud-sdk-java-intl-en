...
public class ExportPatchEffectHostListRequest extends AbstractModel {
...
<li>Uuid : string type, optional, host uuid</li>
    ...
    public ExportPatchEffectHostListRequest() {
    }
     ...
     */
    public ExportPatchEffectHostListRequest(ExportPatchEffectHostListRequest source) {
        if (source.KbId != null) {
