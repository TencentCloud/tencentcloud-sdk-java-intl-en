...
public class DeletePrivilegeEventsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get ID array, with the maximum number being 100. 
     * @return Ids ID array, with the maximum number being 100.
     */
    public Long [] getIds() {
        return this.Ids;
    }
    ...
    /**
     * Set ID array, with the maximum number being 100.
     * @param Ids ID array, with the maximum number being 100.
     */
