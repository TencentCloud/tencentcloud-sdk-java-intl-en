...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public DescribeAssetWebAppPluginListResponse(DescribeAssetWebAppPluginListResponse source) {
        if (source.Plugins != null) {
            this.Plugins = new AssetWebAppPluginInfo[source.Plugins.length];
            for (int i = 0; i < source.Plugins.length; i++) {
                this.Plugins[i] = new AssetWebAppPluginInfo(source.Plugins[i]);
            }
        }
