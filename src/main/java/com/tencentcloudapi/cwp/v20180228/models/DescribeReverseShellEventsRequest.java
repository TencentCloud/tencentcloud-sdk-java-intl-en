...
public class DescribeReverseShellEventsRequest extends AbstractModel {
...
<li>Keywords - String - required: no - keyword (host's private IP address|process name)</li>
    ...
    /**
     * Get Sorting field. CreateTime: occurrence time. 
    ...
    /**
     * Set Sorting field. CreateTime: occurrence time.
     * @param By Sorting field. CreateTime: occurrence time.
     */
    public void setBy(String By) {
        this.By = By;
    }

    public DescribeReverseShellEventsRequest() {
    }
     ...
     */
    public DescribeReverseShellEventsRequest(DescribeReverseShellEventsRequest source) {
