...
public class DescribeIgnoreRuleEffectHostListResponse extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
    */
    ...
    @Expose
    private IgnoreRuleEffectHostInfo [] IgnoreRuleEffectHostList;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeIgnoreRuleEffectHostListResponse() {
    }
     ...
     */
    public DescribeIgnoreRuleEffectHostListResponse(DescribeIgnoreRuleEffectHostListResponse source) {
        if (source.IgnoreRuleEffectHostList != null) {
            this.IgnoreRuleEffectHostList = new IgnoreRuleEffectHostInfo[source.IgnoreRuleEffectHostList.length];
            for (int i = 0; i < source.IgnoreRuleEffectHostList.length; i++) {
                this.IgnoreRuleEffectHostList[i] = new IgnoreRuleEffectHostInfo(source.IgnoreRuleEffectHostList[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "IgnoreRuleEffectHostList.", this.IgnoreRuleEffectHostList);
