...
Note: This field may return null, indicating that no valid values can be obtained.
    */
    ...
    @Expose
    private VulLevelInfo [] VulLevelList;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeVulLevelCountResponse() {
    }
     ...
     */
    public DescribeVulLevelCountResponse(DescribeVulLevelCountResponse source) {
        if (source.VulLevelList != null) {
            this.VulLevelList = new VulLevelInfo[source.VulLevelList.length];
            for (int i = 0; i < source.VulLevelList.length; i++) {
                this.VulLevelList[i] = new VulLevelInfo(source.VulLevelList[i]);
            }
        }
