...
public class DescribeNetAttackWhiteListRequest extends AbstractModel {
...
<li>SrcIP- String - required: no - query by allowlisted IP</li>
    ...
    public DescribeNetAttackWhiteListRequest() {
    }
     ...
     */
    public DescribeNetAttackWhiteListRequest(DescribeNetAttackWhiteListRequest source) {
