...
public class DescribeCloudProtectServiceOrderListResponse extends AbstractModel {
    ...
    */
    @SerializedName("Data")
    @Expose
    private CloudProtectService [] Data;
    ...
    */
     ...
     * @return Data Cloud escort order list
     */
     ...
     * @param Data Cloud escort order list
     */
    ...
    public DescribeCloudProtectServiceOrderListResponse(DescribeCloudProtectServiceOrderListResponse source) {
        if (source.Data != null) {
            this.Data = new CloudProtectService[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new CloudProtectService(source.Data[i]);
            }
        }
