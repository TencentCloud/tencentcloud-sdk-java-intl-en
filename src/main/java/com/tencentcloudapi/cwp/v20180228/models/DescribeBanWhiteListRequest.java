...
public class DescribeBanWhiteListRequest extends AbstractModel {
...
<li>Keywords - String - required: no - query by keywords</li>
    ...
    public DescribeBanWhiteListRequest() {
    }
     ...
     */
    public DescribeBanWhiteListRequest(DescribeBanWhiteListRequest source) {
