...
public class DescribePrivilegeEventInfoResponse extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
    */
    ...
    @Expose
    private PrivilegeEventInfo PrivilegeEventInfo;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribePrivilegeEventInfoResponse() {
    }
     ...
     */
    public DescribePrivilegeEventInfoResponse(DescribePrivilegeEventInfoResponse source) {
        if (source.PrivilegeEventInfo != null) {
            this.PrivilegeEventInfo = new PrivilegeEventInfo(source.PrivilegeEventInfo);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamObj(map, prefix + "PrivilegeEventInfo.", this.PrivilegeEventInfo);
