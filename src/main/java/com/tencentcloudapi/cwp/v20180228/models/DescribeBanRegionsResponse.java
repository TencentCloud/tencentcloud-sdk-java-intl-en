...
public class DescribeBanRegionsResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeBanRegionsResponse() {
    }
     ...
     */
    public DescribeBanRegionsResponse(DescribeBanRegionsResponse source) {
        if (source.RegionSet != null) {
            this.RegionSet = new RegionSet[source.RegionSet.length];
            for (int i = 0; i < source.RegionSet.length; i++) {
                this.RegionSet[i] = new RegionSet(source.RegionSet[i]);
            }
        }
