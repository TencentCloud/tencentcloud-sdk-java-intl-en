...
public class DescribePrivilegeRulesRequest extends AbstractModel {
...
<li>Keywords - String - required: no - keyword (process name)</li>
    ...
    public DescribePrivilegeRulesRequest() {
    }
     ...
     */
    public DescribePrivilegeRulesRequest(DescribePrivilegeRulesRequest source) {
