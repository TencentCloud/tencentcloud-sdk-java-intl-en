...
public class DescribeBaselineItemDetectListRequest extends AbstractModel {
...
<li>EndTime - string - required: no - end time</li>
    ...
    */
    ...
    /**
     * Get <li>HostId - string - required: no - host ID</li>
<li>RuleId - int64 - required: no - rule ID</li>
<li>PolicyId - int64 - required: no - policy ID</li>
<li>ItemName - string - required: no - item name</li>
<li>DetectStatus - int - required: no - detection status</li>
...
<li>EndTime - string - required: no - end time</li>
    ...
    /**
     * Set <li>HostId - string - required: no - host ID</li>
<li>RuleId - int64 - required: no - rule ID</li>
<li>PolicyId - int64 - required: no - policy ID</li>
<li>ItemName - string - required: no - item name</li>
<li>DetectStatus - int - required: no - detection status</li>
...
<li>StartTime - string - required: no - start time</li>
<li>EndTime - string - required: no - end time</li>
     * @param Filters <li>HostId - string - required: no - host ID</li>
<li>RuleId - int64 - required: no - rule ID</li>
<li>PolicyId - int64 - required: no - policy ID</li>
<li>ItemName - string - required: no - item name</li>
<li>DetectStatus - int - required: no - detection status</li>
...
<li>EndTime - string - required: no - end time</li>
    ...
    /**
     * Get Sorting column: [HostCount|FirstTime|LastTime] 
    ...
    /**
     * Set Sorting column: [HostCount|FirstTime|LastTime]
     * @param By Sorting column: [HostCount|FirstTime|LastTime]
     */
    public void setBy(String By) {
        this.By = By;
    }

    public DescribeBaselineItemDetectListRequest() {
    }
     ...
     */
    public DescribeBaselineItemDetectListRequest(DescribeBaselineItemDetectListRequest source) {
