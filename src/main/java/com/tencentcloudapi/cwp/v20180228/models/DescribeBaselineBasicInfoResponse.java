...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    */
    ...
    /**
     * Get Baseline basic information list
Note: This field may return null, indicating that no valid values can be obtained. 
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Set Baseline basic information list
Note: This field may return null, indicating that no valid values can be obtained.
     * @param BaselineBasicInfoList Baseline basic information list
Note: This field may return null, indicating that no valid values can be obtained.
     */
     ...
     */
    public DescribeBaselineBasicInfoResponse(DescribeBaselineBasicInfoResponse source) {
        if (source.BaselineBasicInfoList != null) {
            this.BaselineBasicInfoList = new BaselineBasicInfo[source.BaselineBasicInfoList.length];
            for (int i = 0; i < source.BaselineBasicInfoList.length; i++) {
                this.BaselineBasicInfoList[i] = new BaselineBasicInfo(source.BaselineBasicInfoList[i]);
            }
        }
