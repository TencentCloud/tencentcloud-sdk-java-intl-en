...
Note: This field may return null, indicating that no valid values can be obtained.
    */
    ...
    @Expose
    private AssetWebLocationInfo WebLocation;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeAssetWebLocationInfoResponse() {
    }
     ...
     */
    public DescribeAssetWebLocationInfoResponse(DescribeAssetWebLocationInfoResponse source) {
        if (source.WebLocation != null) {
            this.WebLocation = new AssetWebLocationInfo(source.WebLocation);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamObj(map, prefix + "WebLocation.", this.WebLocation);
