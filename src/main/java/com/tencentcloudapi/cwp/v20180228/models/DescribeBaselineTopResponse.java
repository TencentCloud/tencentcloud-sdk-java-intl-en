...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public DescribeBaselineTopResponse(DescribeBaselineTopResponse source) {
        if (source.RuleTopList != null) {
            this.RuleTopList = new BaselineRuleTopInfo[source.RuleTopList.length];
            for (int i = 0; i < source.RuleTopList.length; i++) {
                this.RuleTopList[i] = new BaselineRuleTopInfo(source.RuleTopList[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "RuleTopList.", this.RuleTopList);
