...
public class ExportAssetInitServiceListRequest extends AbstractModel {
...
14: Log-in </li>
    ...
    public ExportAssetInitServiceListRequest() {
    }
     ...
     */
    public ExportAssetInitServiceListRequest(ExportAssetInitServiceListRequest source) {
        if (source.Uuid != null) {
