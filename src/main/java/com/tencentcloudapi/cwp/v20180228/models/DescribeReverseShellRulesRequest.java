...
public class DescribeReverseShellRulesRequest extends AbstractModel {
...
<li>Keywords - String - whether required: no - keyword (process name)</li>
    ...
    public DescribeReverseShellRulesRequest() {
    }
     ...
     */
    public DescribeReverseShellRulesRequest(DescribeReverseShellRulesRequest source) {
