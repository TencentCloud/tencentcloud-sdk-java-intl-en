...
public class CreateCloudProtectServiceOrderRecordRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Resource ID corresponding to cloud escort service 
    ...
    /**
     * Set Resource ID corresponding to cloud escort service
     * @param ResourceIds Resource ID corresponding to cloud escort service
     */
