...
public class DescribeAssetDiskListRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeAssetDiskListRequest() {
    }
     ...
     */
    public DescribeAssetDiskListRequest(DescribeAssetDiskListRequest source) {
