...
public class DescribeBaselineHostDetectListRequest extends AbstractModel {
...
<li>EndTime - string - required: no - end time</li>
    ...
    /**
     * Get Optional Order Column: [LastTime|ItemCount|PassedItemCount|NotPassedItemCount|FirstTime] 
    ...
    /**
     * Set Optional Order Column: [LastTime|ItemCount|PassedItemCount|NotPassedItemCount|FirstTime]
     * @param By Optional Order Column: [LastTime|ItemCount|PassedItemCount|NotPassedItemCount|FirstTime]
     */
    public void setBy(String By) {
        this.By = By;
    }

    public DescribeBaselineHostDetectListRequest() {
    }
     ...
     */
    public DescribeBaselineHostDetectListRequest(DescribeBaselineHostDetectListRequest source) {
