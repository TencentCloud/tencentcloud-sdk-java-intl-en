...
public class ExportRiskDnsEventListResponse extends AbstractModel {
    ...
    */
    ...
    public ExportRiskDnsEventListResponse() {
    }
     ...
     */
    public ExportRiskDnsEventListResponse(ExportRiskDnsEventListResponse source) {
