...
public class DescribePrivilegeRulesResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setList(PrivilegeRule [] List) {
        this.List = List;
    }
