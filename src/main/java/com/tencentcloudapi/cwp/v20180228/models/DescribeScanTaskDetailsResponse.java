...
public class DescribeScanTaskDetailsResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get whether all tasks are being stopped (true: yes) 
    ...
    /**
     * Set whether all tasks are being stopped (true: yes)
     * @param StoppingAll whether all tasks are being stopped (true: yes)
     */
    ...
    /**
     * Get Scan info when scanning kb separately 
    ...
    /**
     * Set Scan info when scanning kb separately
     * @param PatchInfo Scan info when scanning kb separately
     */
