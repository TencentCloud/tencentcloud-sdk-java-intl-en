...
public class DescribeEmergencyResponseListRequest extends AbstractModel {
...
<li>Uuids - String - whether required: no - filter by host ID</li>
    ...
    public DescribeEmergencyResponseListRequest() {
    }
     ...
     */
    public DescribeEmergencyResponseListRequest(DescribeEmergencyResponseListRequest source) {
