...
public class Filters extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Whether to use fuzzy match. It will be handled by the front-end and can be ignored. 
    ...
    /**
     * Set Whether to use fuzzy match. It will be handled by the front-end and can be ignored.
     * @param ExactMatch Whether to use fuzzy match. It will be handled by the front-end and can be ignored.
     */
