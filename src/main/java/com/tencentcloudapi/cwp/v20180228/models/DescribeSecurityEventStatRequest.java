...
public class DescribeSecurityEventStatRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get This API has no filtering criteria. 
     * @return Filters This API has no filtering criteria.
     */
    ...
    /**
     * Set This API has no filtering criteria.
     * @param Filters This API has no filtering criteria.
     */
