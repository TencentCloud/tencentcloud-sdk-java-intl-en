...
public class DescribeAssetPortCountRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Search criteria: Return the data of specified port numbers. 
    ...
    /**
     * Set Search criteria: Return the data of specified port numbers.
     * @param Port Search criteria: Return the data of specified port numbers.
     */
