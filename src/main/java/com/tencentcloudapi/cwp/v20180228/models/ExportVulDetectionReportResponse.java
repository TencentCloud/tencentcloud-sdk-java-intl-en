...
public class ExportVulDetectionReportResponse extends AbstractModel {
    ...
    */
     ...
     * @return DownloadUrl Download URL for exported file
     */
     ...
     * @param DownloadUrl Download URL for exported file
     */
     ...
     * @return TaskId ID of the task for exporting detection report (different from the vulnerability scan task ID in the input parameters)
     */
     ...
     * @param TaskId ID of the task for exporting detection report (different from the vulnerability scan task ID in the input parameters)
     */
