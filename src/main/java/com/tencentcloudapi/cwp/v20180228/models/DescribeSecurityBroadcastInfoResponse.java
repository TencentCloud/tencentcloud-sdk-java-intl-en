...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public DescribeSecurityBroadcastInfoResponse(DescribeSecurityBroadcastInfoResponse source) {
        if (source.BroadcastInfo != null) {
            this.BroadcastInfo = new BroadcastInfo(source.BroadcastInfo);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamObj(map, prefix + "BroadcastInfo.", this.BroadcastInfo);
