...
public class DescribeRaspRuleVulsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Filter criteria. Name=WhiteType is required. 0: indicates a list of vulnerabilities with custom scope. 1: indicates a list of all request ranges. 
    ...
    /**
     * Set Filter criteria. Name=WhiteType is required. 0: indicates a list of vulnerabilities with custom scope. 1: indicates a list of all request ranges.
     * @param Filters Filter criteria. Name=WhiteType is required. 0: indicates a list of vulnerabilities with custom scope. 1: indicates a list of all request ranges.
     */
