...
public class DescribeVulDefencePluginDetailResponse extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
    */
    @SerializedName("List")
    @Expose
    private VulDefencePluginDetail [] List;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeVulDefencePluginDetailResponse() {
    }
     ...
     */
    public DescribeVulDefencePluginDetailResponse(DescribeVulDefencePluginDetailResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.List != null) {
            this.List = new VulDefencePluginDetail[source.List.length];
            for (int i = 0; i < source.List.length; i++) {
                this.List[i] = new VulDefencePluginDetail(source.List[i]);
            }
        }
