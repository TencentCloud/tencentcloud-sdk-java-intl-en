...
public class DeleteNetAttackWhiteListRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteNetAttackWhiteListRequest() {
    }
     ...
     */
    public DeleteNetAttackWhiteListRequest(DeleteNetAttackWhiteListRequest source) {
        if (source.Ids != null) {
