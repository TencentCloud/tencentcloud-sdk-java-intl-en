...
public class ModifyFileTamperEventsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Status. 1: added to allowlist; 2: deleted; 3: ignored. 
    ...
    /**
     * Set Status. 1: added to allowlist; 2: deleted; 3: ignored.
     * @param Status Status. 1: added to allowlist; 2: deleted; 3: ignored.
     */
