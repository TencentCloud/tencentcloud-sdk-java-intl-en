...
public class DescribeReverseShellRulesAggregationResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeReverseShellRulesAggregationResponse() {
    }
     ...
     */
    public DescribeReverseShellRulesAggregationResponse(DescribeReverseShellRulesAggregationResponse source) {
        if (source.List != null) {
            this.List = new ReverseShellRuleAggregation[source.List.length];
            for (int i = 0; i < source.List.length; i++) {
                this.List[i] = new ReverseShellRuleAggregation(source.List[i]);
            }
        }
