...
public class ExportAssetPlanTaskListRequest extends AbstractModel {
...
<li>Status- int - required: no - default enabling status: 0 - unenabled; 1 - enabled</li>
    ...
    public ExportAssetPlanTaskListRequest() {
    }
     ...
     */
    public ExportAssetPlanTaskListRequest(ExportAssetPlanTaskListRequest source) {
        if (source.Uuid != null) {
