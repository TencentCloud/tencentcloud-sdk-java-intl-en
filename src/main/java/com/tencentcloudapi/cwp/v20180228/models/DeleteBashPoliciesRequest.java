...
public class DeleteBashPoliciesRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteBashPoliciesRequest() {
    }
     ...
     */
    public DeleteBashPoliciesRequest(DeleteBashPoliciesRequest source) {
        if (source.Ids != null) {
