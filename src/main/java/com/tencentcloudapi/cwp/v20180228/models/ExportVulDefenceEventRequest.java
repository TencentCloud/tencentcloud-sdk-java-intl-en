...
public class ExportVulDefenceEventRequest extends AbstractModel {
    ...
    */
    ...
    public ExportVulDefenceEventRequest() {
    }
     ...
     */
    public ExportVulDefenceEventRequest(ExportVulDefenceEventRequest source) {
