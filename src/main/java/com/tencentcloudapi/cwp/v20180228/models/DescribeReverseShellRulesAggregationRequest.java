...
<li>Keywords - String - required: no - keyword (process name)</li>
    ...
    public DescribeReverseShellRulesAggregationRequest() {
    }
     ...
     */
    public DescribeReverseShellRulesAggregationRequest(DescribeReverseShellRulesAggregationRequest source) {
