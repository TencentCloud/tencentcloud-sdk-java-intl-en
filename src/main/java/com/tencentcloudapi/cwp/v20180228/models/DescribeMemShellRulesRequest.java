...
public class DescribeMemShellRulesRequest extends AbstractModel {
...
<li>Keywords - String - required: no - keyword (process name)</li>
    ...
    public DescribeMemShellRulesRequest() {
    }
     ...
     */
    public DescribeMemShellRulesRequest(DescribeMemShellRulesRequest source) {
