...
public class DescribeVulListRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Filtering conditions. <li>Status - String - required: no - processing status.  0 - pending processing; 1 - allowlisted; 2 - deleted; 3 - fixed; 5 - detecting; 6 - fixing; 8 - fixing failed.</li><li>ModifyTime - String - required: no - last occurrence time.</li><li>Uuid- String - required: no - Query by host UUID.</li><li>VulName- String -</li><li>VulCategory- String - required: no - vulnerability category. 1: Web-CMS vulnerability; 2: application vulnerability; 4: Linux software vulnerability; 5: Windows system vulnerability.</li><li>IsSupportDefense - int- required: no - whether defense is supported. 0: not supported; 1: supported.</li><li>Labels- string- required: no - search by tag.</li><li>IsSupportAutoFix- string- required: no - whether automatic fixing is supported. 0: not supported; 1: supported.</li><li>CvssScore- string- required: no - lower limit of CVSS score.</li><li>AttackLevel- string- required: no - lower limit of attack level.</li> 
    ...
    /**
     * Set Filtering conditions. <li>Status - String - required: no - processing status.  0 - pending processing; 1 - allowlisted; 2 - deleted; 3 - fixed; 5 - detecting; 6 - fixing; 8 - fixing failed.</li><li>ModifyTime - String - required: no - last occurrence time.</li><li>Uuid- String - required: no - Query by host UUID.</li><li>VulName- String -</li><li>VulCategory- String - required: no - vulnerability category. 1: Web-CMS vulnerability; 2: application vulnerability; 4: Linux software vulnerability; 5: Windows system vulnerability.</li><li>IsSupportDefense - int- required: no - whether defense is supported. 0: not supported; 1: supported.</li><li>Labels- string- required: no - search by tag.</li><li>IsSupportAutoFix- string- required: no - whether automatic fixing is supported. 0: not supported; 1: supported.</li><li>CvssScore- string- required: no - lower limit of CVSS score.</li><li>AttackLevel- string- required: no - lower limit of attack level.</li>
     * @param Filters Filtering conditions. <li>Status - String - required: no - processing status.  0 - pending processing; 1 - allowlisted; 2 - deleted; 3 - fixed; 5 - detecting; 6 - fixing; 8 - fixing failed.</li><li>ModifyTime - String - required: no - last occurrence time.</li><li>Uuid- String - required: no - Query by host UUID.</li><li>VulName- String -</li><li>VulCategory- String - required: no - vulnerability category. 1: Web-CMS vulnerability; 2: application vulnerability; 4: Linux software vulnerability; 5: Windows system vulnerability.</li><li>IsSupportDefense - int- required: no - whether defense is supported. 0: not supported; 1: supported.</li><li>Labels- string- required: no - search by tag.</li><li>IsSupportAutoFix- string- required: no - whether automatic fixing is supported. 0: not supported; 1: supported.</li><li>CvssScore- string- required: no - lower limit of CVSS score.</li><li>AttackLevel- string- required: no - lower limit of attack level.</li>
     */
