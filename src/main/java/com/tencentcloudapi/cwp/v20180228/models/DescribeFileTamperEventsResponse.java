...
public class DescribeFileTamperEventsResponse extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeFileTamperEventsResponse() {
    }
     ...
     */
    public DescribeFileTamperEventsResponse(DescribeFileTamperEventsResponse source) {
        if (source.List != null) {
            this.List = new FileTamperEvent[source.List.length];
            for (int i = 0; i < source.List.length; i++) {
                this.List[i] = new FileTamperEvent(source.List[i]);
            }
        }
