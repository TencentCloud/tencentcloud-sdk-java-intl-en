...
public class DescribeStrategyExistResponse extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeStrategyExistResponse() {
    }
     ...
     */
    public DescribeStrategyExistResponse(DescribeStrategyExistResponse source) {
        if (source.IfExist != null) {
            this.IfExist = new Long(source.IfExist);
        }
