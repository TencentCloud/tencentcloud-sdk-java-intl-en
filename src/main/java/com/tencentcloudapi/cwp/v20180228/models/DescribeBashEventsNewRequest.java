...
public class DescribeBashEventsNewRequest extends AbstractModel {
...
<li>EndTime - String - required: no - end time</li>
    ...
    /**
     * Get Sorting method: sort by number of requests. asc: ascending; desc: descending. 
    ...
    /**
     * Set Sorting method: sort by number of requests. asc: ascending; desc: descending.
     * @param Order Sorting method: sort by number of requests. asc: ascending; desc: descending.
     */
    ...
    public DescribeBashEventsNewRequest() {
    }
     ...
     */
    public DescribeBashEventsNewRequest(DescribeBashEventsNewRequest source) {
