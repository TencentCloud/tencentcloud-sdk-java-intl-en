...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public DescribeBaselineDefaultStrategyListResponse(DescribeBaselineDefaultStrategyListResponse source) {
        if (source.StrategyList != null) {
            this.StrategyList = new DefaultStrategyInfo[source.StrategyList.length];
            for (int i = 0; i < source.StrategyList.length; i++) {
                this.StrategyList[i] = new DefaultStrategyInfo(source.StrategyList[i]);
            }
        }
