...
public class DescribeRaspEventTCSSRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Filter criteria: Keywords: ip or hostname, VulKeywords vulnerability name or CveId for fuzzy query; AttackTypeKeywords attack type for fuzzy query; Quuid, VulId, EventType, Status for precise match, CreateBeginTime, CreateEndTime time period query 
    ...
    /**
     * Set Filter criteria: Keywords: ip or hostname, VulKeywords vulnerability name or CveId for fuzzy query; AttackTypeKeywords attack type for fuzzy query; Quuid, VulId, EventType, Status for precise match, CreateBeginTime, CreateEndTime time period query
     * @param Filters Filter criteria: Keywords: ip or hostname, VulKeywords vulnerability name or CveId for fuzzy query; AttackTypeKeywords attack type for fuzzy query; Quuid, VulId, EventType, Status for precise match, CreateBeginTime, CreateEndTime time period query
     */
    ...
    public DescribeRaspEventTCSSRequest() {
    }
     ...
     */
    public DescribeRaspEventTCSSRequest(DescribeRaspEventTCSSRequest source) {
