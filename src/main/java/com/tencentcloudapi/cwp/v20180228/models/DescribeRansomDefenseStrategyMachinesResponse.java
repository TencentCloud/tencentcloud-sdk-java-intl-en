...
Note: This field may return null, indicating that no valid values can be obtained.
    */
    @SerializedName("List")
    @Expose
    private RansomDefenseStrategyMachineDetail [] List;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeRansomDefenseStrategyMachinesResponse() {
    }
     ...
     */
    public DescribeRansomDefenseStrategyMachinesResponse(DescribeRansomDefenseStrategyMachinesResponse source) {
        if (source.List != null) {
            this.List = new RansomDefenseStrategyMachineDetail[source.List.length];
            for (int i = 0; i < source.List.length; i++) {
                this.List[i] = new RansomDefenseStrategyMachineDetail(source.List[i]);
            }
        }
