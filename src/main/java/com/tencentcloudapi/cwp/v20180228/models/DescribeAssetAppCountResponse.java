...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public DescribeAssetAppCountResponse(DescribeAssetAppCountResponse source) {
        if (source.Apps != null) {
            this.Apps = new AssetKeyVal[source.Apps.length];
            for (int i = 0; i < source.Apps.length; i++) {
                this.Apps[i] = new AssetKeyVal(source.Apps[i]);
            }
        }
