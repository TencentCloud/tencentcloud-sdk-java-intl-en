...
public class DescribeRansomDefenseStrategyListResponse extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
    */
    @SerializedName("List")
    @Expose
    private RansomDefenseStrategy [] List;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeRansomDefenseStrategyListResponse() {
    }
     ...
     */
    public DescribeRansomDefenseStrategyListResponse(DescribeRansomDefenseStrategyListResponse source) {
        if (source.List != null) {
            this.List = new RansomDefenseStrategy[source.List.length];
            for (int i = 0; i < source.List.length; i++) {
                this.List[i] = new RansomDefenseStrategy(source.List[i]);
            }
        }
