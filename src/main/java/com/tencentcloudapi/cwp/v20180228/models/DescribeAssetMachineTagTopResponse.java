...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public DescribeAssetMachineTagTopResponse(DescribeAssetMachineTagTopResponse source) {
        if (source.Tags != null) {
            this.Tags = new AssetKeyVal[source.Tags.length];
            for (int i = 0; i < source.Tags.length; i++) {
                this.Tags[i] = new AssetKeyVal(source.Tags[i]);
            }
        }
