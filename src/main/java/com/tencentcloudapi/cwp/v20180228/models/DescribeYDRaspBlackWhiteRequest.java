...
public class DescribeYDRaspBlackWhiteRequest extends AbstractModel {
...
<li>Status - String - required: no - policy switch</li>
    ...
    /**
     * Get Sort field, which currently supports CreateTime and ModifyTime. The default value is ModifyTime. 
     * @return By Sort field, which currently supports CreateTime and ModifyTime. The default value is ModifyTime.
     */
    public String getBy() {
        return this.By;
    }
    ...
    /**
     * Set Sort field, which currently supports CreateTime and ModifyTime. The default value is ModifyTime.
     * @param By Sort field, which currently supports CreateTime and ModifyTime. The default value is ModifyTime.
     */
    ...
    public DescribeYDRaspBlackWhiteRequest() {
    }
     ...
     */
    public DescribeYDRaspBlackWhiteRequest(DescribeYDRaspBlackWhiteRequest source) {
