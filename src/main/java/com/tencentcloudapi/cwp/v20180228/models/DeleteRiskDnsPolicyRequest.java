...
public class DeleteRiskDnsPolicyRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Set Policy ID
     * @param PolicyIds Policy ID
     */
    public void setPolicyIds(Long [] PolicyIds) {
        this.PolicyIds = PolicyIds;
    }

    public DeleteRiskDnsPolicyRequest() {
    }
     ...
     */
    public DeleteRiskDnsPolicyRequest(DeleteRiskDnsPolicyRequest source) {
