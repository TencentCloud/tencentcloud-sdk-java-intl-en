...
public class EnableSRVConnectionUrlRequest extends AbstractModel {
    ...
    */
    ...
    public EnableSRVConnectionUrlRequest() {
    }
     ...
     */
    public EnableSRVConnectionUrlRequest(EnableSRVConnectionUrlRequest source) {
