...
public class ModifyBackupExpireTimeRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Expiration time</p><p>Parameter format: YYYY-MM-DD hh:mm:ss</p> 
    ...
    /**
     * Set <p>Expiration time</p><p>Parameter format: YYYY-MM-DD hh:mm:ss</p>
     * @param ExpireTime <p>Expiration time</p><p>Parameter format: YYYY-MM-DD hh:mm:ss</p>
     */
