...
public class DeleteDBBackupsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Instance id, cmgo-xxxx 
     * @return InstanceId Instance id, cmgo-xxxx
     */
    ...
    /**
     * Set Instance id, cmgo-xxxx
     * @param InstanceId Instance id, cmgo-xxxx
     */
    ...
    /**
     * Set File id list
     * @param BackupIds File id list
     */
    public void setBackupIds(Long [] BackupIds) {
        this.BackupIds = BackupIds;
    }

    public DeleteDBBackupsRequest() {
    }
     ...
     */
    public DeleteDBBackupsRequest(DeleteDBBackupsRequest source) {
