...
- false: disabled.
    */
    ...
    /**
     * Get Configures whether to enable SSL for access.
- true: enabled.
- false: disabled. 
...
- false: disabled.
    ...
    /**
     * Set Configures whether to enable SSL for access.
- true: enabled.
- false: disabled.
     * @param Enable Configures whether to enable SSL for access.
- true: enabled.
- false: disabled.
     */
