...
public class DescribeBackupRulesRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeBackupRulesRequest() {
    }
     ...
     */
    public DescribeBackupRulesRequest(DescribeBackupRulesRequest source) {
