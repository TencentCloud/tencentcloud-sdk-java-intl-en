...
public class DisableSRVConnectionUrlRequest extends AbstractModel {
    ...
    */
    ...
    public DisableSRVConnectionUrlRequest() {
    }
     ...
     */
    public DisableSRVConnectionUrlRequest(DisableSRVConnectionUrlRequest source) {
