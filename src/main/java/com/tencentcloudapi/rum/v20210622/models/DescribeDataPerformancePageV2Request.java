...
public class DescribeDataPerformancePageV2Request extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Indicates whether to return webvitals data. 
     * @return WebVitals Indicates whether to return webvitals data.
     */
    ...
    /**
     * Set Indicates whether to return webvitals data.
     * @param WebVitals Indicates whether to return webvitals data.
     */
    ...
    public DescribeDataPerformancePageV2Request() {
    }
     ...
     */
    public DescribeDataPerformancePageV2Request(DescribeDataPerformancePageV2Request source) {
        if (source.ID != null) {
