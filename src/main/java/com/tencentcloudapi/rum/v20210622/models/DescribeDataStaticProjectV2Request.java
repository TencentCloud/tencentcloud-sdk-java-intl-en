...
public class DescribeDataStaticProjectV2Request extends AbstractModel {
    ...
    */
    ...
    /**
     * Get allcount: performance view. day: 14-day data. condition: condition list. area: request speed distribution. nettype/version/platform/isp/region/device/browser/ext1/ext2/ext3/ret/status/from/url/env/: network platform view, version view, device view, ISP view, region view, browser view, ext1 view, and so on. 
    ...
    /**
     * Set allcount: performance view. day: 14-day data. condition: condition list. area: request speed distribution. nettype/version/platform/isp/region/device/browser/ext1/ext2/ext3/ret/status/from/url/env/: network platform view, version view, device view, ISP view, region view, browser view, ext1 view, and so on.
     * @param Type allcount: performance view. day: 14-day data. condition: condition list. area: request speed distribution. nettype/version/platform/isp/region/device/browser/ext1/ext2/ext3/ret/status/from/url/env/: network platform view, version view, device view, ISP view, region view, browser view, ext1 view, and so on.
     */
    ...
    public DescribeDataStaticProjectV2Request() {
    }
     ...
     */
    public DescribeDataStaticProjectV2Request(DescribeDataStaticProjectV2Request source) {
