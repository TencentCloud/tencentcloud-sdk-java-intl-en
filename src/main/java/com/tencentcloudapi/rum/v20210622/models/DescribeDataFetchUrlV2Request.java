...
public class DescribeDataFetchUrlV2Request extends AbstractModel {
    ...
    */
     ...
     * @return Status HTTP response code.
     */
    ...
    public DescribeDataFetchUrlV2Request() {
    }
     ...
     */
    public DescribeDataFetchUrlV2Request(DescribeDataFetchUrlV2Request source) {
