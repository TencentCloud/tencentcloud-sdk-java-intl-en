...
public class DescribeWhitelistsResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setWhitelistSet(Whitelist [] WhitelistSet) {
     ...
     */
    public DescribeWhitelistsResponse(DescribeWhitelistsResponse source) {
        if (source.WhitelistSet != null) {
            this.WhitelistSet = new Whitelist[source.WhitelistSet.length];
            for (int i = 0; i < source.WhitelistSet.length; i++) {
                this.WhitelistSet[i] = new Whitelist(source.WhitelistSet[i]);
            }
        }
