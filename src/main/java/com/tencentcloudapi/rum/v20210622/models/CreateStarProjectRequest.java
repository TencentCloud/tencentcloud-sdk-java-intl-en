...
public class CreateStarProjectRequest extends AbstractModel{
    ...
    */
    ...
    public CreateStarProjectRequest() {
    }
     ...
     */
    public CreateStarProjectRequest(CreateStarProjectRequest source) {
