...
public class DescribeDataSetUrlStatisticsV2Request extends AbstractModel {
    ...
    */
    ...
    /**
     * Get allcount: performance view. data: mini program. component: related to mini program. day: 14-day data. nettype: network or platform view. performance: top page performance view. version/platform/isp/region/device/browser/ext1/ext2/ext3/ret/status/from/url/env/: ISP view, region view, browser view, and so on. 
    ...
    /**
     * Set allcount: performance view. data: mini program. component: related to mini program. day: 14-day data. nettype: network or platform view. performance: top page performance view. version/platform/isp/region/device/browser/ext1/ext2/ext3/ret/status/from/url/env/: ISP view, region view, browser view, and so on.
    ...
    /**
     * Get Obtaining package. 
     * @return PackageType Obtaining package.
     */
    ...
    /**
     * Set Obtaining package.
     * @param PackageType Obtaining package.
     */
    ...
    public DescribeDataSetUrlStatisticsV2Request() {
    }
     ...
     */
    public DescribeDataSetUrlStatisticsV2Request(DescribeDataSetUrlStatisticsV2Request source) {
