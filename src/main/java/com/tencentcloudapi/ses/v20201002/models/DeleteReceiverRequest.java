...
public class DeleteReceiverRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Recipient group ID, which is returned when a recipient group is created. 
    ...
    /**
     * Set Recipient group ID, which is returned when a recipient group is created.
     ...
     */
    public DeleteReceiverRequest(DeleteReceiverRequest source) {
