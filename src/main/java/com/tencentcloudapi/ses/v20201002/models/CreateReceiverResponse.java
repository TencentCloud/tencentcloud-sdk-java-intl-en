...
public class CreateReceiverResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Recipient group ID, by which recipient email addresses are uploaded 
    ...
    /**
     * Set Recipient group ID, by which recipient email addresses are uploaded
     ...
     */
    public CreateReceiverResponse(CreateReceiverResponse source) {
