...
public class DescribeCfsRulesResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private PGroupRuleInfo [] RuleList;
    ...
    */
    ...
    /**
     * Get List of permission group rules 
     * @return RuleList List of permission group rules
     */
    public PGroupRuleInfo [] getRuleList() {
        return this.RuleList;
    }

    /**
     * Set List of permission group rules
     * @param RuleList List of permission group rules
     */
    public void setRuleList(PGroupRuleInfo [] RuleList) {
