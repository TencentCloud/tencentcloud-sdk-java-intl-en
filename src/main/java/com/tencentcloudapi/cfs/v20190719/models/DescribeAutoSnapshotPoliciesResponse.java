...
public class DescribeAutoSnapshotPoliciesResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Total number of snapshot policies 
    ...
    /**
     * Set Total number of snapshot policies
    ...
    /**
     * Get Snapshot policy information 
    ...
    /**
     * Set Snapshot policy information
     * @param AutoSnapshotPolicies Snapshot policy information
     */
    public void setAutoSnapshotPolicies(AutoSnapshotPolicyInfo [] AutoSnapshotPolicies) {
    ...
    public DescribeAutoSnapshotPoliciesResponse(DescribeAutoSnapshotPoliciesResponse source) {
        ...
        if (source.AutoSnapshotPolicies != null) {
            this.AutoSnapshotPolicies = new AutoSnapshotPolicyInfo[source.AutoSnapshotPolicies.length];
            for (int i = 0; i < source.AutoSnapshotPolicies.length; i++) {
                this.AutoSnapshotPolicies[i] = new AutoSnapshotPolicyInfo(source.AutoSnapshotPolicies[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamArrayObj(map, prefix + "AutoSnapshotPolicies.", this.AutoSnapshotPolicies);
