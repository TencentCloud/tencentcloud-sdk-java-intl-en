...
public class CreateCfsSnapshotResponse extends AbstractModel {
    ...
    */
    ...
    public CreateCfsSnapshotResponse() {
    }
     ...
     */
    public CreateCfsSnapshotResponse(CreateCfsSnapshotResponse source) {
