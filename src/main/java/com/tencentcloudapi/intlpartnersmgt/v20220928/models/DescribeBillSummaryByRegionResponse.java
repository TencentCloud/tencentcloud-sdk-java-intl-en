...
public class DescribeBillSummaryByRegionResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Get the region details of the customer bill data totaled by region through the api. 
     * @return SummaryOverview Get the region details of the customer bill data totaled by region through the api.
     */
    ...
    /**
     * Set Get the region details of the customer bill data totaled by region through the api.
     * @param SummaryOverview Get the region details of the customer bill data totaled by region through the api.
     */
