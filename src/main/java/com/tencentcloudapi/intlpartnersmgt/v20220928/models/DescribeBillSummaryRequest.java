...
public class DescribeBillSummaryRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Billing dimension. Optional parameters: product, project, tag 
    ...
    /**
     * Set Billing dimension. Optional parameters: product, project, tag
     * @param GroupType Billing dimension. Optional parameters: product, project, tag
     */
