...
public class DescribeCustomerOwnVoucherUsageDetailsRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeCustomerOwnVoucherUsageDetailsRequest() {
    }
     ...
     */
    public DescribeCustomerOwnVoucherUsageDetailsRequest(DescribeCustomerOwnVoucherUsageDetailsRequest source) {
        if (source.Page != null) {
