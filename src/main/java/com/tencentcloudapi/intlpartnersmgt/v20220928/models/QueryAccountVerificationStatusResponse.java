...
public class QueryAccountVerificationStatusResponse extends AbstractModel {
    ...
    */
     ...
     * @return AccountStatus Account verification status
     */
     ...
     * @param AccountStatus Account verification status
     */
     ...
     */
    public QueryAccountVerificationStatusResponse(QueryAccountVerificationStatusResponse source) {
        if (source.AccountStatus != null) {
            this.AccountStatus = new Boolean(source.AccountStatus);
        }
