...
public class EnableWhiteBoxKeyRequest extends AbstractModel {
    ...
    */
    ...
    public EnableWhiteBoxKeyRequest() {
    }
     ...
     */
    public EnableWhiteBoxKeyRequest(EnableWhiteBoxKeyRequest source) {
