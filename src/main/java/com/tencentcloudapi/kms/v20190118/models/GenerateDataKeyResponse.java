...
If `EncryptionPublicKey` is specified, this field will return the Base64-encoded ciphertext encrypted with the specified public key. To get the plaintext, you need to decode the ciphertext and upload the corresponding private key.
    ...
    /**
     * Get Globally unique id of the data key, returned when KMS hosting is enabled. 
    ...
    /**
     * Set Globally unique id of the data key, returned when KMS hosting is enabled.
     * @param DataKeyId Globally unique id of the data key, returned when KMS hosting is enabled.
     */
