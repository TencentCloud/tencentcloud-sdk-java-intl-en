...
public class DescribeDataKeysRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Specifies the ID list of datakeys to query. supports up to 100 DataKey ids in a batch query. 
    ...
    /**
     * Set Specifies the ID list of datakeys to query. supports up to 100 DataKey ids in a batch query.
     * @param DataKeyIds Specifies the ID list of datakeys to query. supports up to 100 DataKey ids in a batch query.
     */
