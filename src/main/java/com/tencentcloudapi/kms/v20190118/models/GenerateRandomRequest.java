...
public class GenerateRandomRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Length of the random number. Minimum value: 1. Maximum value: 1024 
    ...
    /**
     * Set Length of the random number. Minimum value: 1. Maximum value: 1024
     ...
     */
    public GenerateRandomRequest(GenerateRandomRequest source) {
