...
public class DeleteWhiteBoxKeyRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteWhiteBoxKeyRequest() {
    }
     ...
     */
    public DeleteWhiteBoxKeyRequest(DeleteWhiteBoxKeyRequest source) {
