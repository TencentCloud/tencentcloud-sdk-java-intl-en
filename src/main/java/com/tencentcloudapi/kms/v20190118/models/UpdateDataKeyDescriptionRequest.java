...
public class UpdateDataKeyDescriptionRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Specifies the unique identifier of the data key. 
    ...
    /**
     * Set Specifies the unique identifier of the data key.
     * @param DataKeyId Specifies the unique identifier of the data key.
     */
    ...
    /**
     * Get Data key description of up to 100 bytes. 
    ...
    /**
     * Set Data key description of up to 100 bytes.
     * @param Description Data key description of up to 100 bytes.
     */
