...
public class UserGroupInfoSearchCriteria extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Search by name. The match criteria include user group name and user group ID. 
    ...
    /**
     * Set Search by name. The match criteria include user group name and user group ID.
