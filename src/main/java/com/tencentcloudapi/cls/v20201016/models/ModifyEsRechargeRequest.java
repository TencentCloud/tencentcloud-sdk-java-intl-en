...
- Obtain the log topic Id through [Create Log Topic](https://www.tencentcloud.com/document/product/614/56456?from_cn_redirect=1).
    ...
    /**
     * Get Task status. 1: Running, 2: Suspended. 
     * @return Status Task status. 1: Running, 2: Suspended.
     */
    ...
    /**
     * Set Task status. 1: Running, 2: Suspended.
     * @param Status Task status. 1: Running, 2: Suspended.
     */
