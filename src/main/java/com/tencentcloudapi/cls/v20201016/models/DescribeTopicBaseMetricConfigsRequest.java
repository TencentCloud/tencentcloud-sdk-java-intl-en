...
public class DescribeTopicBaseMetricConfigsRequest extends AbstractModel {
...
- Obtain the log topic Id through [Create Log Topic](https://www.tencentcloud.com/document/product/614/56456?from_cn_redirect=1). Note that BizType 0: log topic (default value), 1: metric topic.
    ...
    /**
     * Get groupId is filtered by [Bound machine group id]. Type: String. Required: No.
The maximum number of Filters per request is 10, and the total upper limit for ALL Filter.Values is 100. 
...
The maximum number of Filters per request is 10, and the total upper limit for ALL Filter.Values is 100.
    ...
    /**
     * Set groupId is filtered by [Bound machine group id]. Type: String. Required: No.
The maximum number of Filters per request is 10, and the total upper limit for ALL Filter.Values is 100.
     * @param Filters groupId is filtered by [Bound machine group id]. Type: String. Required: No.
The maximum number of Filters per request is 10, and the total upper limit for ALL Filter.Values is 100.
     */
    ...
    public DescribeTopicBaseMetricConfigsRequest() {
    }
     ...
     */
    public DescribeTopicBaseMetricConfigsRequest(DescribeTopicBaseMetricConfigsRequest source) {
