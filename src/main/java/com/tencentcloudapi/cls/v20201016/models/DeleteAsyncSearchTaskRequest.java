...
public class DeleteAsyncSearchTaskRequest extends AbstractModel{
    ...
    */
    ...
    public DeleteAsyncSearchTaskRequest() {
    }
     ...
     */
    public DeleteAsyncSearchTaskRequest(DeleteAsyncSearchTaskRequest source) {
