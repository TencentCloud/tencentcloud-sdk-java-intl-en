...
public class CreateConsoleRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Login method</p><p>Enumeration value:</p><ul><li>0: Account password authentication</li><li>1: Anonymous login</li><li>2: Third-party authentication login</li></ul> 
    ...
    /**
     * Set <p>Login method</p><p>Enumeration value:</p><ul><li>0: Account password authentication</li><li>1: Anonymous login</li><li>2: Third-party authentication login</li></ul>
     * @param LoginMode <p>Login method</p><p>Enumeration value:</p><ul><li>0: Account password authentication</li><li>1: Anonymous login</li><li>2: Third-party authentication login</li></ul>
     */
    ...
    /**
     * Get <p>User account information</p><p>"Account password authentication" is required for login method</p> 
    ...
    /**
     * Set <p>User account information</p><p>"Account password authentication" is required for login method</p>
     * @param Accounts <p>User account information</p><p>"Account password authentication" is required for login method</p>
     */
    ...
    /**
     * Get <p>Anonymous login account information</p><p>"Anonymous login" is a required login method.</p> 
    ...
    /**
     * Set <p>Anonymous login account information</p><p>"Anonymous login" is a required login method.</p>
     * @param AnonymousLogin <p>Anonymous login account information</p><p>"Anonymous login" is a required login method.</p>
     */
    ...
    /**
     * Get <p>Auth role information</p><p>"Third-party authentication login" is a required login method.</p> 
    ...
    /**
     * Set <p>Auth role information</p><p>"Third-party authentication login" is a required login method.</p>
     * @param AuthRoles <p>Auth role information</p><p>"Third-party authentication login" is a required login method.</p>
     */
    ...
    /**
     * Get <p>Tag description list. By specifying this parameter, you can simultaneously bind tags to the corresponding log topic. Supports up to 10 tag key-value pairs. The same resource can only be bound to the same tag key.</p> 
    ...
    /**
     * Set <p>Tag description list. By specifying this parameter, you can simultaneously bind tags to the corresponding log topic. Supports up to 10 tag key-value pairs. The same resource can only be bound to the same tag key.</p>
     * @param Tags <p>Tag description list. By specifying this parameter, you can simultaneously bind tags to the corresponding log topic. Supports up to 10 tag key-value pairs. The same resource can only be bound to the same tag key.</p>
     */
     ...
     */
    public CreateConsoleRequest(CreateConsoleRequest source) {
