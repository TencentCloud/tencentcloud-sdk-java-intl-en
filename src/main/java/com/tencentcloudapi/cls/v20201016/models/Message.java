...
public class Message extends AbstractModel {
    ...
    */
    ...
    /**
     * Set <p>Text content</p>
     * @param Content <p>Text content</p>
     */
    ...
    /**
     * Get <p>Thought chain content.<br>Used to show the model thinking process, only available in deep thinking mode. Returned as an output parameter only. No need to import it into the input parameter during multi-round dialogue.</p> 
    ...
    /**
     * Set <p>Thought chain content.<br>Used to show the model thinking process, only available in deep thinking mode. Returned as an output parameter only. No need to import it into the input parameter during multi-round dialogue.</p>
     * @param ReasoningContent <p>Thought chain content.<br>Used to show the model thinking process, only available in deep thinking mode. Returned as an output parameter only. No need to import it into the input parameter during multi-round dialogue.</p>
     */
    ...
    /**
     * Get <p>Tool call generated by the model. Only support output parameter return.</p> 
    ...
    /**
     * Set <p>Tool call generated by the model. Only support output parameter return.</p>
     * @param ToolCalls <p>Tool call generated by the model. Only support output parameter return.</p>
     */
