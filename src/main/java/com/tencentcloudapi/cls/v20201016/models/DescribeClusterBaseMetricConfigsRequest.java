...
public class DescribeClusterBaseMetricConfigsRequest extends AbstractModel {
...
<li>Each request can have up to 10 Filters. The total upper limit of ALL Filter.Values is 100.</li>
    ...
    */
    ...
    /**
     * Get <li> Filter the topicId by [metric topic id]. Type: String. Required: No</li>
<li>Each request can have up to 10 Filters. The total upper limit of ALL Filter.Values is 100.</li> 
...
<li>Each request can have up to 10 Filters. The total upper limit of ALL Filter.Values is 100.</li>
    ...
    /**
     * Set <li> Filter the topicId by [metric topic id]. Type: String. Required: No</li>
<li>Each request can have up to 10 Filters. The total upper limit of ALL Filter.Values is 100.</li>
     * @param Filters <li> Filter the topicId by [metric topic id]. Type: String. Required: No</li>
<li>Each request can have up to 10 Filters. The total upper limit of ALL Filter.Values is 100.</li>
     */
    ...
    public DescribeClusterBaseMetricConfigsRequest() {
    }
     ...
     */
    public DescribeClusterBaseMetricConfigsRequest(DescribeClusterBaseMetricConfigsRequest source) {
