...
public class NetworkApplicationDetail extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Update time (a second-level timestamp) 
    ...
    /**
     * Set Update time (a second-level timestamp)
     * @param UpdateTime Update time (a second-level timestamp)
     */
    public void setUpdateTime(Long UpdateTime) {
        this.UpdateTime = UpdateTime;
    }

    public NetworkApplicationDetail() {
    }
     ...
     */
    public NetworkApplicationDetail(NetworkApplicationDetail source) {
