...
public class CreateAsyncContextTaskResponse extends AbstractModel{
    ...
    */
    ...
    public CreateAsyncContextTaskResponse() {
    }
     ...
     */
    public CreateAsyncContextTaskResponse(CreateAsyncContextTaskResponse source) {
