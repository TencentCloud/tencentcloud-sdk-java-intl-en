...
public class DescribeRemoteWriteTasksRequest extends AbstractModel {
...
Each request can have up to 10 Filters. The maximum of Filter.Values is 10.
    ...
    public DescribeRemoteWriteTasksRequest() {
    }
     ...
     */
    public DescribeRemoteWriteTasksRequest(DescribeRemoteWriteTasksRequest source) {
