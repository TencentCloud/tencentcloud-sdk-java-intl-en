...
public class DescribeTopicMetricConfigsRequest extends AbstractModel {
...
-Obtain the log topic Id through [Create Log Topic](https://www.tencentcloud.com/document/product/614/56456?from_cn_redirect=1). Note that BizType 0: log topic (default value), 1: metric topic.
    ...
    /**
     * Get configId is filtered by [metric collection configuration id]. Type: String. Required: No
Filter the name by [configuration name]. Type: String. Required: No.
Each request can have up to 10 Filters. The total upper limit of ALL Filter.Values is 100. 
...
Each request can have up to 10 Filters. The total upper limit of ALL Filter.Values is 100.
    ...
    /**
     * Set configId is filtered by [metric collection configuration id]. Type: String. Required: No
Filter the name by [configuration name]. Type: String. Required: No.
Each request can have up to 10 Filters. The total upper limit of ALL Filter.Values is 100.
     * @param Filters configId is filtered by [metric collection configuration id]. Type: String. Required: No
Filter the name by [configuration name]. Type: String. Required: No.
Each request can have up to 10 Filters. The total upper limit of ALL Filter.Values is 100.
     */
    ...
    public DescribeTopicMetricConfigsRequest() {
    }
     ...
     */
    public DescribeTopicMetricConfigsRequest(DescribeTopicMetricConfigsRequest source) {
