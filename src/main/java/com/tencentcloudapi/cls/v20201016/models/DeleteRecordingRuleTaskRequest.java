...
public class DeleteRecordingRuleTaskRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteRecordingRuleTaskRequest() {
    }
     ...
     */
    public DeleteRecordingRuleTaskRequest(DeleteRecordingRuleTaskRequest source) {
