...
public class DescribeDashboardSubscribesRequest extends AbstractModel {
...
Each request can have up to 10 Filters. The upper limit of Filter.Values is 100.
    ...
    public DescribeDashboardSubscribesRequest() {
    }
     ...
     */
    public DescribeDashboardSubscribesRequest(DescribeDashboardSubscribesRequest source) {
