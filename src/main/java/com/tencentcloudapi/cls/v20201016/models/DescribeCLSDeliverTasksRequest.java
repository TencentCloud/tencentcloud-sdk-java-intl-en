...
public class DescribeCLSDeliverTasksRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <ul><li>taskId Filter by task id. Type: String. Required: No.  </li><li>taskName Filter by task name. Type: String. Required: No.  </li><li>sourceLogsetId Filter by source logset. Type: String. Required: No.  </li><li>targetLogsetId Filter by destination log set. Type: String. Required: No.<br>The maximum number of Filters per request is 10, and the maximum number of Filter.Values is 10.</li></ul> 
     * @return Filters <ul><li>taskId Filter by task id. Type: String. Required: No.  </li><li>taskName Filter by task name. Type: String. Required: No.  </li><li>sourceLogsetId Filter by source logset. Type: String. Required: No.  </li><li>targetLogsetId Filter by destination log set. Type: String. Required: No.<br>The maximum number of Filters per request is 10, and the maximum number of Filter.Values is 10.</li></ul>
     */
    ...
    /**
     * Set <ul><li>taskId Filter by task id. Type: String. Required: No.  </li><li>taskName Filter by task name. Type: String. Required: No.  </li><li>sourceLogsetId Filter by source logset. Type: String. Required: No.  </li><li>targetLogsetId Filter by destination log set. Type: String. Required: No.<br>The maximum number of Filters per request is 10, and the maximum number of Filter.Values is 10.</li></ul>
     * @param Filters <ul><li>taskId Filter by task id. Type: String. Required: No.  </li><li>taskName Filter by task name. Type: String. Required: No.  </li><li>sourceLogsetId Filter by source logset. Type: String. Required: No.  </li><li>targetLogsetId Filter by destination log set. Type: String. Required: No.<br>The maximum number of Filters per request is 10, and the maximum number of Filter.Values is 10.</li></ul>
     */
    ...
    public DescribeCLSDeliverTasksRequest() {
    }
     ...
     */
    public DescribeCLSDeliverTasksRequest(DescribeCLSDeliverTasksRequest source) {
