...
public class DescribeHostMetricConfigsRequest extends AbstractModel {
...
- Obtain the log topic Id through [Create Log Topic](https://www.tencentcloud.com/document/product/614/56456?from_cn_redirect=1). Note that BizType 0: log topic (default value), 1: metric topic.
    ...
    /**
     * Get -configId - String - required: no - filter by [configId].
-Filter the name by [configuration name]. Type: String. Required: No.

Each request can have up to 10 Filters. The upper limit of Filter.Values is 10. 
     * @return Filters -configId - String - required: no - filter by [configId].
-Filter the name by [configuration name]. Type: String. Required: No.
...
Each request can have up to 10 Filters. The upper limit of Filter.Values is 10.
    ...
    /**
     * Set -configId - String - required: no - filter by [configId].
-Filter the name by [configuration name]. Type: String. Required: No.

Each request can have up to 10 Filters. The upper limit of Filter.Values is 10.
     * @param Filters -configId - String - required: no - filter by [configId].
-Filter the name by [configuration name]. Type: String. Required: No.
...
Each request can have up to 10 Filters. The upper limit of Filter.Values is 10.
    ...
    public DescribeHostMetricConfigsRequest() {
    }
     ...
     */
    public DescribeHostMetricConfigsRequest(DescribeHostMetricConfigsRequest source) {
