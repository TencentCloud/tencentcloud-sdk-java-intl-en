...
public class DeleteMetricSubscribeRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Set Metric collection task ID.
     * @param TaskId Metric collection task ID.
     */
    ...
    /**
     * Get Log topic ID of a metric collection task configuration. 
    ...
    /**
     * Set Log topic ID of a metric collection task configuration.
     * @param TopicId Log topic ID of a metric collection task configuration.
     */
