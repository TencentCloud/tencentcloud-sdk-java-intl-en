...
public class CreateSplunkDeliverRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>The splunk delivery task name has the following restrictions: - Cannot be empty - Length not greater than 256 - Can only contain aA-zZ, underscore, -, 0-9</p> 
    ...
    /**
     * Set <p>The splunk delivery task name has the following restrictions: - Cannot be empty - Length not greater than 256 - Can only contain aA-zZ, underscore, -, 0-9</p>
     * @param Name <p>The splunk delivery task name has the following restrictions: - Cannot be empty - Length not greater than 256 - Can only contain aA-zZ, underscore, -, 0-9</p>
     */
    ...
    /**
     * Get <p>Splunk delivery task - target configuration - network info</p> 
    ...
    /**
     * Set <p>Splunk delivery task - target configuration - network info</p>
     * @param NetInfo <p>Splunk delivery task - target configuration - network info</p>
     */
    ...
    /**
     * Get <p>Whether service logs are enabled 1: Disabled; 2: Enabled; Enabled by default</p> 
    ...
    /**
     * Set <p>Whether service logs are enabled 1: Disabled; 2: Enabled; Enabled by default</p>
     * @param HasServiceLog <p>Whether service logs are enabled 1: Disabled; 2: Enabled; Enabled by default</p>
     */
    ...
    /**
     * Get <p>Advanced configuration - Whether to enable the indexer; 1 - Disable; 2 - Enable;<br>Default: 1</p> 
    ...
    /**
     * Set <p>Advanced configuration - Whether to enable the indexer; 1 - Disable; 2 - Enable;<br>Default: 1</p>
     * @param IndexAck <p>Advanced configuration - Whether to enable the indexer; 1 - Disable; 2 - Enable;<br>Default: 1</p>
     */
    ...
    /**
     * Get <p>Advanced configuration - Channel.<br>To meet the limitation: If the indexer is enabled, then Channel is required.</p> 
    ...
    /**
     * Set <p>Advanced configuration - Channel.<br>To meet the limitation: If the indexer is enabled, then Channel is required.</p>
     * @param Channel <p>Advanced configuration - Channel.<br>To meet the limitation: If the indexer is enabled, then Channel is required.</p>
     */
    ...
    /**
     * Get <p>Log pre-filtering - filter out original data before writing to Splunk</p> 
    ...
    /**
     * Set <p>Log pre-filtering - filter out original data before writing to Splunk</p>
     * @param DSLFilter <p>Log pre-filtering - filter out original data before writing to Splunk</p>
     */
