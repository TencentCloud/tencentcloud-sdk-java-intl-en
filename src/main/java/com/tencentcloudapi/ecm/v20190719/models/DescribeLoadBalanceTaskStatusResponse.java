...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    */
    ...
    /**
     * Get Current task status. 0: succeeded; 1: failed; 2: in progress.
Note: this field may return null, indicating that no valid values can be obtained. 
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Set Current task status. 0: succeeded; 1: failed; 2: in progress.
Note: this field may return null, indicating that no valid values can be obtained.
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeLoadBalanceTaskStatusResponse() {
    }
     ...
     */
    public DescribeLoadBalanceTaskStatusResponse(DescribeLoadBalanceTaskStatusResponse source) {
