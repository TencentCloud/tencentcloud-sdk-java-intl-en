...
public class CreateModuleResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Module ID. It is the ID assigned to a module after it is created successfully. 
    ...
    /**
     * Set Module ID. It is the ID assigned to a module after it is created successfully.
     ...
     */
    public CreateModuleResponse(CreateModuleResponse source) {
