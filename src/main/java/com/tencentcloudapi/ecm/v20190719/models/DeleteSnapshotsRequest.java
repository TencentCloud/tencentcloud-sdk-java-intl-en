...
public class DeleteSnapshotsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get List of IDs of the snapshots to be deleted, which can be queried through [DescribeSnapshots](https://intl.cloud.tencent.com/document/product/362/15647?from_cn_redirect=1). 
    ...
    /**
     * Set List of IDs of the snapshots to be deleted, which can be queried through [DescribeSnapshots](https://intl.cloud.tencent.com/document/product/362/15647?from_cn_redirect=1).
    ...
    /**
     * Get Whether to force delete the images associated with the snapshot. 
    ...
    /**
     * Set Whether to force delete the images associated with the snapshot.
