...
public class DisassociateSecurityGroupsRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get ID of the security group to be unbound, such as `esg-efil73jd`. You can unbind only one security group at a time. 
    ...
    /**
     * Set ID of the security group to be unbound, such as `esg-efil73jd`. You can unbind only one security group at a time.
    ...
    /**
     * Get ID of the instance to be unbound, such as `ein-lesecurk`. You can specify multiple instances. 
    ...
    /**
     * Set ID of the instance to be unbound, such as `ein-lesecurk`. You can specify multiple instances.
