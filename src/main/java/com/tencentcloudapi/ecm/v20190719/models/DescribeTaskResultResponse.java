...
public class DescribeTaskResultResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Execution result. Valid values: SUCCESS; FAILED; RUNNING. 
     * @return Result Execution result. Valid values: SUCCESS; FAILED; RUNNING.
     */
    ...
    /**
     * Set Execution result. Valid values: SUCCESS; FAILED; RUNNING.
