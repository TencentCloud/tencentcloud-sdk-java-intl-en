...
public class DescribeSecurityGroupLimitsResponse extends AbstractModel{
    ...
    */
    @SerializedName("SecurityGroupLimitSet")
    @Expose
    private SecurityGroupLimitSet SecurityGroupLimitSet;
    ...
    */
     ...
     * @return SecurityGroupLimitSet Security group quota limit.
     */
    public SecurityGroupLimitSet getSecurityGroupLimitSet() {
        return this.SecurityGroupLimitSet;
    }
    ...
    public void setSecurityGroupLimitSet(SecurityGroupLimitSet SecurityGroupLimitSet) {
        this.SecurityGroupLimitSet = SecurityGroupLimitSet;
    }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamObj(map, prefix + "SecurityGroupLimitSet.", this.SecurityGroupLimitSet);
