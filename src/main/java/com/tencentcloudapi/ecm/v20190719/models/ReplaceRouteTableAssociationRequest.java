...
public class ReplaceRouteTableAssociationRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Subnet instance ID, such as `subnet-3x5lf5q0`, which can be queried through the `DescribeSubnets` API. 
    ...
    /**
     * Set Subnet instance ID, such as `subnet-3x5lf5q0`, which can be queried through the `DescribeSubnets` API.
