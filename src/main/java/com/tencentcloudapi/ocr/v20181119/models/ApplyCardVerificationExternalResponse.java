...
public class ApplyCardVerificationExternalResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Process token, which is used to obtain the result. 
    ...
    /**
     * Set Process token, which is used to obtain the result.
     * @param CardVerificationToken Process token, which is used to obtain the result.
     */
    ...
    public ApplyCardVerificationExternalResponse() {
    }
     ...
     */
    public ApplyCardVerificationExternalResponse(ApplyCardVerificationExternalResponse source) {
