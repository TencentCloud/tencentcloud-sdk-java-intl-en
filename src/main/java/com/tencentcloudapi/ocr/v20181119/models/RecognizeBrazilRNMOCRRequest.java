...
public class RecognizeBrazilRNMOCRRequest extends AbstractModel {
    ...
    */
    ...
    public RecognizeBrazilRNMOCRRequest() {
    }
     ...
     */
    public RecognizeBrazilRNMOCRRequest(RecognizeBrazilRNMOCRRequest source) {
