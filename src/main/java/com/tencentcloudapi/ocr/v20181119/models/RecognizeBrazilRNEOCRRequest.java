...
public class RecognizeBrazilRNEOCRRequest extends AbstractModel {
    ...
    */
    ...
    public RecognizeBrazilRNEOCRRequest() {
    }
     ...
     */
    public RecognizeBrazilRNEOCRRequest(RecognizeBrazilRNEOCRRequest source) {
