...
The download speed and stability of non-Tencent Cloud URLs may be low.
    ...
    /**
     * Get Whether to return the ID photo. By default, the ID photo is not returned. 
     * @return RetProfile Whether to return the ID photo. By default, the ID photo is not returned.
     */
    ...
    /**
     * Set Whether to return the ID photo. By default, the ID photo is not returned.
