...
public class RecognizeGeneralInvoiceResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Mixed invoice/ticket recognition result. Please click the link on the left for details. 
    ...
    /**
     * Set Mixed invoice/ticket recognition result. Please click the link on the left for details.
    ...
    /**
     * Set Total number of pages in the PDF file.
