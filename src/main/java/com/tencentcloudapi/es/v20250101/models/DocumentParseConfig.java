...
1:Return the text content extracted from the image
    */
    ...
    /**
     * Get 0: Images are returned in link format
1:Return the text content extracted from the image 
     * @return ImageResponseType 0: Images are returned in link format
1:Return the text content extracted from the image
     */
    ...
    /**
     * Set 0: Images are returned in link format
1:Return the text content extracted from the image
     * @param ImageResponseType 0: Images are returned in link format
1:Return the text content extracted from the image
     */
