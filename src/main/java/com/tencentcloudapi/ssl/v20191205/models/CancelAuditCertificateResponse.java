...
public class CancelAuditCertificateResponse extends AbstractModel{
    ...
    */
    ...
    public CancelAuditCertificateResponse() {
    }
     ...
     */
    public CancelAuditCertificateResponse(CancelAuditCertificateResponse source) {
