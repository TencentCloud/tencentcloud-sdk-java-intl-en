...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Set The list of WAF instances.	
Note: This field may return null, indicating that no valid values can be obtained.
     * @param InstanceList The list of WAF instances.	
Note: This field may return null, indicating that no valid values can be obtained.
     */
    ...
    /**
     * Get The total number of WAF instances in this region.	 
    ...
    /**
     * Set The total number of WAF instances in this region.	
     * @param TotalCount The total number of WAF instances in this region.	
     */
