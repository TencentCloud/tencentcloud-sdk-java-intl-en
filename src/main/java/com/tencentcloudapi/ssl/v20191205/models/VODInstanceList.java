...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    */
    ...
    /**
     * Get The list of VOD instances.	
Note: This field may return null, indicating that no valid values can be obtained. 
     * @return InstanceList The list of VOD instances.	
Note: This field may return null, indicating that no valid values can be obtained.
     */
    ...
    /**
     * Set The list of VOD instances.	
Note: This field may return null, indicating that no valid values can be obtained.
     * @param InstanceList The list of VOD instances.	
Note: This field may return null, indicating that no valid values can be obtained.
     */
    ...
    /**
     * Get The total number of VOD instances in this region.	 
     * @return TotalCount The total number of VOD instances in this region.	
     */
    ...
    /**
     * Set The total number of VOD instances in this region.	
     * @param TotalCount The total number of VOD instances in this region.	
     */
