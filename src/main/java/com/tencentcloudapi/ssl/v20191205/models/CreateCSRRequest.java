...
public class CreateCSRRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get The country or region code that complies with ISO 3166, such as CN and US. 
     * @return Country The country or region code that complies with ISO 3166, such as CN and US.
     */
    ...
    /**
     * Set The country or region code that complies with ISO 3166, such as CN and US.
     * @param Country The country or region code that complies with ISO 3166, such as CN and US.
     */
     ...
     */
    public CreateCSRRequest(CreateCSRRequest source) {
