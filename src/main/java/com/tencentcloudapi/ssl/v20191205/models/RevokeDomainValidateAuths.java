...
public class RevokeDomainValidateAuths extends AbstractModel {
    ...
    */
    ...
    /**
     * Get DV authentication value path. 
    ...
    /**
     * Set DV authentication value path.
     * @param DomainValidateAuthPath DV authentication value path.
     */
     ...
     * @param DomainValidateAuthKey DV authentication KEY.
     */
     ...
     * @param DomainValidateAuthValue DV authentication value.
     */
    ...
    /**
     * Get DV authentication domain name. 
    ...
    /**
     * Set DV authentication domain name.
     * @param DomainValidateAuthDomain DV authentication domain name.
     */
