...
public class ModifyRocketMQEnvironmentRoleRequest extends AbstractModel {
    ...
    */
     ...
     */
    public ModifyRocketMQEnvironmentRoleRequest(ModifyRocketMQEnvironmentRoleRequest source) {
