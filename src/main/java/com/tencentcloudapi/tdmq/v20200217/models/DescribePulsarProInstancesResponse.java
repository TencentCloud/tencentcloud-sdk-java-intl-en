...
public class DescribePulsarProInstancesResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private PulsarProInstance [] Instances;
    ...
    */
    ...
    public DescribePulsarProInstancesResponse() {
    }
     ...
     */
    public DescribePulsarProInstancesResponse(DescribePulsarProInstancesResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.Instances != null) {
            this.Instances = new PulsarProInstance[source.Instances.length];
            for (int i = 0; i < source.Instances.length; i++) {
                this.Instances[i] = new PulsarProInstance(source.Instances[i]);
            }
        }
