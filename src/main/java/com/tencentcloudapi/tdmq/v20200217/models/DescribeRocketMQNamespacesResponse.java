...
public class DescribeRocketMQNamespacesResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setNamespaces(RocketMQNamespace [] Namespaces) {
     ...
     */
    public DescribeRocketMQNamespacesResponse(DescribeRocketMQNamespacesResponse source) {
        if (source.Namespaces != null) {
            this.Namespaces = new RocketMQNamespace[source.Namespaces.length];
            for (int i = 0; i < source.Namespaces.length; i++) {
                this.Namespaces[i] = new RocketMQNamespace(source.Namespaces[i]);
            }
        }
