...
public class CreateCmqQueueResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get `queueId` of a successfully created queue 
    ...
    /**
     * Set `queueId` of a successfully created queue
     ...
     */
    public CreateCmqQueueResponse(CreateCmqQueueResponse source) {
