...
public class DeleteEnvironmentsRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Array of environments (namespaces). Up to 20 environments can be deleted at a time. 
    ...
    /**
     * Set Array of environments (namespaces). Up to 20 environments can be deleted at a time.
