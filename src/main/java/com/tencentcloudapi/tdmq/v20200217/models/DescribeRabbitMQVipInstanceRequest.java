...
public class DescribeRabbitMQVipInstanceRequest extends AbstractModel {
    ...
    */
     ...
     * @return ClusterId Instance ID, such as amqp-xxxxxxxx. valid InstanceId can be queried by logging in to the TDMQ RabbitMQ console (https://console.cloud.tencent.com/trabbitmq/cluster?rid=1).
     */
     ...
     * @param ClusterId Instance ID, such as amqp-xxxxxxxx. valid InstanceId can be queried by logging in to the TDMQ RabbitMQ console (https://console.cloud.tencent.com/trabbitmq/cluster?rid=1).
     */
    public void setClusterId(String ClusterId) {
        this.ClusterId = ClusterId;
    }

    public DescribeRabbitMQVipInstanceRequest() {
    }
     ...
     */
    public DescribeRabbitMQVipInstanceRequest(DescribeRabbitMQVipInstanceRequest source) {
