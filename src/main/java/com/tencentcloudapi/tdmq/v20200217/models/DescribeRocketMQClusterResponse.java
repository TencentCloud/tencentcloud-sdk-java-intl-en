...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    */
    ...
    /**
     * Get Cluster recent usage, about to be deprecated. Use TCOP to obtain related data.
Note: This field may return null, indicating that no valid values can be obtained. 
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Set Cluster recent usage, about to be deprecated. Use TCOP to obtain related data.
Note: This field may return null, indicating that no valid values can be obtained.
     * @param ClusterStats Cluster recent usage, about to be deprecated. Use TCOP to obtain related data.
Note: This field may return null, indicating that no valid values can be obtained.
     */
