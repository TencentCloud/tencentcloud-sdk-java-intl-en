...
public class ModifyEnvironmentRoleRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyEnvironmentRoleRequest() {
    }
     ...
     */
    public ModifyEnvironmentRoleRequest(ModifyEnvironmentRoleRequest source) {
