...
public class PublishCmqMsgResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get `true` indicates that the sending is successful 
    ...
    /**
     * Set `true` indicates that the sending is successful
     ...
     */
    public PublishCmqMsgResponse(PublishCmqMsgResponse source) {
