...
public class DeleteRocketMQRolesRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteRocketMQRolesRequest() {
    }
     ...
     */
    public DeleteRocketMQRolesRequest(DeleteRocketMQRolesRequest source) {
