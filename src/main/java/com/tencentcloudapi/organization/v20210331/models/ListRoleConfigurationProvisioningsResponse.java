...
public class ListRoleConfigurationProvisioningsResponse extends AbstractModel {
    ...
    */
    @SerializedName("RoleConfigurationProvisionings")
    @Expose
    private RoleConfigurationProvisionings [] RoleConfigurationProvisionings;
    ...
    */
    ...
    /**
     * Get Department member account list. 
     * @return RoleConfigurationProvisionings Department member account list.
     */
    public RoleConfigurationProvisionings [] getRoleConfigurationProvisionings() {
        return this.RoleConfigurationProvisionings;
    }

    /**
     * Set Department member account list.
     * @param RoleConfigurationProvisionings Department member account list.
     */
    public void setRoleConfigurationProvisionings(RoleConfigurationProvisionings [] RoleConfigurationProvisionings) {
        this.RoleConfigurationProvisionings = RoleConfigurationProvisionings;
    }
    ...
    public ListRoleConfigurationProvisioningsResponse() {
    }
     ...
     */
    public ListRoleConfigurationProvisioningsResponse(ListRoleConfigurationProvisioningsResponse source) {
        ...
        if (source.RoleConfigurationProvisionings != null) {
            this.RoleConfigurationProvisionings = new RoleConfigurationProvisionings[source.RoleConfigurationProvisionings.length];
            for (int i = 0; i < source.RoleConfigurationProvisionings.length; i++) {
                this.RoleConfigurationProvisionings[i] = new RoleConfigurationProvisionings(source.RoleConfigurationProvisionings[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamArrayObj(map, prefix + "RoleConfigurationProvisionings.", this.RoleConfigurationProvisionings);
