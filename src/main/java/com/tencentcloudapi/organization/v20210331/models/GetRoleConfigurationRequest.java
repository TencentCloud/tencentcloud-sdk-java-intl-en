...
public class GetRoleConfigurationRequest extends AbstractModel {
    ...
    */
    ...
    public GetRoleConfigurationRequest() {
    }
     ...
     */
    public GetRoleConfigurationRequest(GetRoleConfigurationRequest source) {
