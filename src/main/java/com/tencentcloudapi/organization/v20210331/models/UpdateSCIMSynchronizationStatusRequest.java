...
public class UpdateSCIMSynchronizationStatusRequest extends AbstractModel {
    ...
    */
     ...
     * @param SCIMSynchronizationStatus SCIM synchronization status. Enabled: enabled. Disabled: disabled.
     */
    public void setSCIMSynchronizationStatus(String SCIMSynchronizationStatus) {
        this.SCIMSynchronizationStatus = SCIMSynchronizationStatus;
    }

    public UpdateSCIMSynchronizationStatusRequest() {
    }
     ...
     */
    public UpdateSCIMSynchronizationStatusRequest(UpdateSCIMSynchronizationStatusRequest source) {
        if (source.ZoneId != null) {
            this.ZoneId = new String(source.ZoneId);
        }
        if (source.SCIMSynchronizationStatus != null) {
            this.SCIMSynchronizationStatus = new String(source.SCIMSynchronizationStatus);
        }
    }
