...
public class AttachPolicyRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Bind policy target ID. member Uin or department ID</p>. 
     * @return TargetId <p>Bind policy target ID. member Uin or department ID</p>.
     */
    ...
    /**
     * Set <p>Bind policy target ID. member Uin or department ID</p>.
     * @param TargetId <p>Bind policy target ID. member Uin or department ID</p>.
     */
     ...
     */
    public AttachPolicyRequest(AttachPolicyRequest source) {
