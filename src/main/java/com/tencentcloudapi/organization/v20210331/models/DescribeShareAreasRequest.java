...
public class DescribeShareAreasRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeShareAreasRequest() {
    }
     ...
     */
    public DescribeShareAreasRequest(DescribeShareAreasRequest source) {
        if (source.Lang != null) {
