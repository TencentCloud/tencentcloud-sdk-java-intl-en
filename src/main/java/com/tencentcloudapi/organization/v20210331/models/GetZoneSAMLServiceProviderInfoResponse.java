...
public class GetZoneSAMLServiceProviderInfoResponse extends AbstractModel {
    ...
    */
     ...
     * @param SAMLServiceProvider SAML service provider configuration information.
     */
    ...
    public GetZoneSAMLServiceProviderInfoResponse(GetZoneSAMLServiceProviderInfoResponse source) {
        if (source.SAMLServiceProvider != null) {
            this.SAMLServiceProvider = new SAMLServiceProvider(source.SAMLServiceProvider);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamObj(map, prefix + "SAMLServiceProvider.", this.SAMLServiceProvider);
