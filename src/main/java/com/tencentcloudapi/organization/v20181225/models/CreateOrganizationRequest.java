...
public class CreateOrganizationRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Organization type; currently its value is fixed as `1` 
     * @return OrgType Organization type; currently its value is fixed as `1`
     */
    ...
    /**
     * Set Organization type; currently its value is fixed as `1`
