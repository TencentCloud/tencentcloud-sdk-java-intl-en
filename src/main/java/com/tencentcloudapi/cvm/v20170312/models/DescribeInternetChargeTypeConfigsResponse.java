...
public class DescribeInternetChargeTypeConfigsResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeInternetChargeTypeConfigsResponse() {
    }
     ...
     */
    public DescribeInternetChargeTypeConfigsResponse(DescribeInternetChargeTypeConfigsResponse source) {
        if (source.InternetChargeTypeConfigSet != null) {
            this.InternetChargeTypeConfigSet = new InternetChargeTypeConfig[source.InternetChargeTypeConfigSet.length];
            for (int i = 0; i < source.InternetChargeTypeConfigSet.length; i++) {
                this.InternetChargeTypeConfigSet[i] = new InternetChargeTypeConfig(source.InternetChargeTypeConfigSet[i]);
            }
        }
