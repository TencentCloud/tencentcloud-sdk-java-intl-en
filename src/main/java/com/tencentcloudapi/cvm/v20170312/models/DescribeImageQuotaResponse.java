...
public class DescribeImageQuotaResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeImageQuotaResponse() {
    }
     ...
     */
    public DescribeImageQuotaResponse(DescribeImageQuotaResponse source) {
        if (source.ImageNumQuota != null) {
            this.ImageNumQuota = new Long(source.ImageNumQuota);
        }
