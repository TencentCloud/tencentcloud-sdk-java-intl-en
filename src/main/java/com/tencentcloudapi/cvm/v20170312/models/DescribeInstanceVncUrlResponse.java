...
public class DescribeInstanceVncUrlResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeInstanceVncUrlResponse() {
    }
     ...
     */
    public DescribeInstanceVncUrlResponse(DescribeInstanceVncUrlResponse source) {
        if (source.InstanceVncUrl != null) {
            this.InstanceVncUrl = new String(source.InstanceVncUrl);
        }
