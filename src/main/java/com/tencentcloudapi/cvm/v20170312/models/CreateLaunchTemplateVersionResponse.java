...
public class CreateLaunchTemplateVersionResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Version number of the new instance launch template. 
    ...
    /**
     * Set Version number of the new instance launch template.
    ...
    public CreateLaunchTemplateVersionResponse() {
    }
     ...
     */
    public CreateLaunchTemplateVersionResponse(CreateLaunchTemplateVersionResponse source) {
        if (source.LaunchTemplateVersionNumber != null) {
            this.LaunchTemplateVersionNumber = new Long(source.LaunchTemplateVersionNumber);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamSimple(map, prefix + "LaunchTemplateVersionNumber", this.LaunchTemplateVersionNumber);
