...
- DESC: descending order.
    */
    ...
    /**
     * Get Queries consumer groups under a specified topic. 
    ...
    /**
     * Set Queries consumer groups under a specified topic.
     * @param FromTopic Queries consumer groups under a specified topic.
     */
    ...
    /**
     * Get Sort by specified field, with the enumerated values as follows:
-subscribeNum: Number of topics subscribed 
...
-subscribeNum: Number of topics subscribed
    ...
    /**
     * Set Sort by specified field, with the enumerated values as follows:
-subscribeNum: Number of topics subscribed
     * @param SortedBy Sort by specified field, with the enumerated values as follows:
-subscribeNum: Number of topics subscribed
     */
    ...
    /**
     * Get Sort in ascending or descending order, with the enumerated values as follows:
...
- DESC: descending order.
    ...
    /**
     * Set Sort in ascending or descending order, with the enumerated values as follows:

-asc: Ascending
- DESC: descending order.
     * @param SortOrder Sort in ascending or descending order, with the enumerated values as follows:
