...
public class DescribeTopicListByGroupRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeTopicListByGroupRequest() {
    }
     ...
     */
    public DescribeTopicListByGroupRequest(DescribeTopicListByGroupRequest source) {
