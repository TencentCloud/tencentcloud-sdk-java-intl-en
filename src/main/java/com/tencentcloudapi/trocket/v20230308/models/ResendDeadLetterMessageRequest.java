...
public class ResendDeadLetterMessageRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get List of dead letter message ids. 
     * @return MessageIds List of dead letter message ids.
     */
    ...
    /**
     * Set List of dead letter message ids.
     * @param MessageIds List of dead letter message ids.
     */
