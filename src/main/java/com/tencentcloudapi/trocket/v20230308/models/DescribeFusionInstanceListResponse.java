...
public class DescribeFusionInstanceListResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setData(FusionInstanceItem [] Data) {
        this.Data = Data;
    }
     ...
     */
    public DescribeFusionInstanceListResponse(DescribeFusionInstanceListResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.Data != null) {
            this.Data = new FusionInstanceItem[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new FusionInstanceItem(source.Data[i]);
            }
        }
