...
public class DescribeMessageTraceRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeMessageTraceRequest() {
    }
     ...
     */
    public DescribeMessageTraceRequest(DescribeMessageTraceRequest source) {
