...
public class DescribeSlowLogsResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Number of eligible slow logs. 
     * @return TotalCount Number of eligible slow logs.
     */
    ...
    /**
     * Set Number of eligible slow logs.
    ...
    /**
     * Get Details of eligible slow logs. 
     * @return Items Details of eligible slow logs.
     */
    ...
    /**
     * Set Details of eligible slow logs.
    ...
    public DescribeSlowLogsResponse(DescribeSlowLogsResponse source) {
        ...
        if (source.Items != null) {
            this.Items = new SlowLogInfo[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new SlowLogInfo(source.Items[i]);
            }
        }
