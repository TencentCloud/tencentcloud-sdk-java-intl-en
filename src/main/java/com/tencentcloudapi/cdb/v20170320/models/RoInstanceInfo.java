...
public class RoInstanceInfo extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Canonical name of the RO Availability Zone, for example ap-shanghai-2 
    ...
    /**
     * Set Canonical name of the RO Availability Zone, for example ap-shanghai-2
     * @param Zone Canonical name of the RO Availability Zone, for example ap-shanghai-2
     */
