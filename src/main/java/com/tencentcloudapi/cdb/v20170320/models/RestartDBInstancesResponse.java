...
public class RestartDBInstancesResponse extends AbstractModel {
    ...
    */
    ...
    public RestartDBInstancesResponse() {
    }
     ...
     */
    public RestartDBInstancesResponse(RestartDBInstancesResponse source) {
