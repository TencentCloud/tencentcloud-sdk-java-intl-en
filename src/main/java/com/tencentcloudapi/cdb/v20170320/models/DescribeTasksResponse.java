...
public class DescribeTasksResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Information of an instance task. 
     * @return Items Information of an instance task.
     */
    ...
    /**
     * Set Information of an instance task.
    ...
    public DescribeTasksResponse(DescribeTasksResponse source) {
        ...
        if (source.Items != null) {
            this.Items = new TaskDetail[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new TaskDetail(source.Items[i]);
            }
        }
