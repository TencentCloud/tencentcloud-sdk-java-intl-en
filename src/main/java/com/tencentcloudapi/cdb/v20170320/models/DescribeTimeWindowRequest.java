...
public class DescribeTimeWindowRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeTimeWindowRequest() {
    }
     ...
     */
    public DescribeTimeWindowRequest(DescribeTimeWindowRequest source) {
