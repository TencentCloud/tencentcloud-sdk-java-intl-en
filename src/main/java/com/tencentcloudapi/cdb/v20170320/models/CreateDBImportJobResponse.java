...
public class CreateDBImportJobResponse extends AbstractModel{
    ...
    */
    ...
    public CreateDBImportJobResponse() {
    }
     ...
     */
    public CreateDBImportJobResponse(CreateDBImportJobResponse source) {
