...
public class DescribeBackupsResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Details of eligible backups. 
     * @return Items Details of eligible backups.
     */
    ...
    /**
     * Set Details of eligible backups.
     ...
     */
    public DescribeBackupsResponse(DescribeBackupsResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.Items != null) {
            this.Items = new BackupInfo[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new BackupInfo(source.Items[i]);
            }
        }
