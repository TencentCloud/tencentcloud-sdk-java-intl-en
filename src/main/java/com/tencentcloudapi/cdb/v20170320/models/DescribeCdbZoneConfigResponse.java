...
public class DescribeCdbZoneConfigResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get List of purchasable specification and region information 
     * @return DataResult List of purchasable specification and region information
     */
    ...
    /**
     * Set List of purchasable specification and region information
     * @param DataResult List of purchasable specification and region information
     */
    public void setDataResult(CdbZoneDataResult DataResult) {
     ...
     */
    public DescribeCdbZoneConfigResponse(DescribeCdbZoneConfigResponse source) {
        if (source.DataResult != null) {
            this.DataResult = new CdbZoneDataResult(source.DataResult);
        }
