...
public class DescribeDBInstanceCharsetResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Default character set of the instance, such as "latin1" and "utf8". 
    ...
    /**
     * Set Default character set of the instance, such as "latin1" and "utf8".
    ...
    public DescribeDBInstanceCharsetResponse() {
    }
     ...
     */
    public DescribeDBInstanceCharsetResponse(DescribeDBInstanceCharsetResponse source) {
