...
public class DescribeBackupDecryptionKeyResponse extends AbstractModel{
    ...
    */
     ...
     * @return DecryptionKey The decryption key of a backup file
     */
    ...
    public DescribeBackupDecryptionKeyResponse(DescribeBackupDecryptionKeyResponse source) {
        if (source.DecryptionKey != null) {
            this.DecryptionKey = new String(source.DecryptionKey);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamSimple(map, prefix + "DecryptionKey", this.DecryptionKey);
