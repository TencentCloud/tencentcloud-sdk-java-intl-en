...
public class DescribeBackupSummariesResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Statistical items of instance backup. 
    ...
    /**
     * Set Statistical items of instance backup.
    ...
    /**
     * Get Total number of instance backups. 
    ...
    /**
     * Set Total number of instance backups.
    ...
    public DescribeBackupSummariesResponse(DescribeBackupSummariesResponse source) {
        if (source.Items != null) {
            this.Items = new BackupSummaryItem[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new BackupSummaryItem(source.Items[i]);
            }
        }
