...
public class ModifyAccountPasswordResponse extends AbstractModel {
    ...
    */
    ...
    public ModifyAccountPasswordResponse() {
    }
     ...
     */
    public ModifyAccountPasswordResponse(ModifyAccountPasswordResponse source) {
