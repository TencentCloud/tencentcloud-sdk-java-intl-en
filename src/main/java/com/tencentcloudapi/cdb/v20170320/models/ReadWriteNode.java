...
public class ReadWriteNode extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Availability zone where the RW node is located. 
     * @return Zone Availability zone where the RW node is located.
     */
    ...
    /**
     * Set Availability zone where the RW node is located.
     * @param Zone Availability zone where the RW node is located.
     */
