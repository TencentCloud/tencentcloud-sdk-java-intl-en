...
public class DescribeRollbackRangeTimeResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeRollbackRangeTimeResponse() {
    }
     ...
     */
    public DescribeRollbackRangeTimeResponse(DescribeRollbackRangeTimeResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.Items != null) {
            this.Items = new InstanceRollbackRangeTime[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new InstanceRollbackRangeTime(source.Items[i]);
            }
        }
