...
public class CreateCdbProxyAddressResponse extends AbstractModel {
    ...
    */
    ...
    public CreateCdbProxyAddressResponse() {
    }
     ...
     */
    public CreateCdbProxyAddressResponse(CreateCdbProxyAddressResponse source) {
