...
public class DescribeBackupEncryptionStatusResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Whether the physical cold backup is enabled for the instance. Valid values: `on`, `off`. 
    ...
    /**
     * Set Whether the physical cold backup is enabled for the instance. Valid values: `on`, `off`.
