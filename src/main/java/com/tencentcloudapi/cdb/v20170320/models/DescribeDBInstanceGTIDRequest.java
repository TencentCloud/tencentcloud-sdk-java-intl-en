...
public class DescribeDBInstanceGTIDRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeDBInstanceGTIDRequest() {
    }
     ...
     */
    public DescribeDBInstanceGTIDRequest(DescribeDBInstanceGTIDRequest source) {
