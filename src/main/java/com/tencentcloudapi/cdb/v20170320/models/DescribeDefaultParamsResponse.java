...
public class DescribeDefaultParamsResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeDefaultParamsResponse() {
    }
     ...
     */
    public DescribeDefaultParamsResponse(DescribeDefaultParamsResponse source) {
