...
public class DescribeWebhookTriggerLogResponse extends AbstractModel {
    ...
    */
    @SerializedName("Logs")
    @Expose
    private WebhookTriggerLog [] Logs;
    ...
    */
     ...
     */
    public WebhookTriggerLog [] getLogs() {
        return this.Logs;
    }
    ...
    public DescribeWebhookTriggerLogResponse(DescribeWebhookTriggerLogResponse source) {
        ...
        if (source.Logs != null) {
            this.Logs = new WebhookTriggerLog[source.Logs.length];
            for (int i = 0; i < source.Logs.length; i++) {
                this.Logs[i] = new WebhookTriggerLog(source.Logs[i]);
            }
        }
