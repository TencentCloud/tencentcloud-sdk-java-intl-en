...
public class ModifyCustomAccountRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Expiry time of the custom account (timestamp) 
     * @return ExpiresAt Expiry time of the custom account (timestamp)
     */
    ...
    /**
     * Set Expiry time of the custom account (timestamp)
     * @param ExpiresAt Expiry time of the custom account (timestamp)
     */
