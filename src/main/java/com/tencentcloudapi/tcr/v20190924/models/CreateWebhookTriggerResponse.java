...
public class CreateWebhookTriggerResponse extends AbstractModel {
    ...
    */
    ...
    public CreateWebhookTriggerResponse() {
    }
     ...
     */
    public CreateWebhookTriggerResponse(CreateWebhookTriggerResponse source) {
