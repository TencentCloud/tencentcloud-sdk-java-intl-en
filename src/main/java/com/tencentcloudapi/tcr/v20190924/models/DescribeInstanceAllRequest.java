...
public class DescribeInstanceAllRequest extends AbstractModel{
...
it indicates to get all instances under the current account)
    ...
    public DescribeInstanceAllRequest() {
    }
     ...
     */
    public DescribeInstanceAllRequest(DescribeInstanceAllRequest source) {
