...
Note: This field may return null, indicating that no valid values can be obtained.
    */
    @SerializedName("AccessVpcSet")
    @Expose
    private AccessVpc [] AccessVpcSet;
    ...
    */
    ...
    /**
     * Get List of private network access addresses
Note: This field may return null, indicating that no valid values can be obtained. 
     * @return AccessVpcSet List of private network access addresses
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public AccessVpc [] getAccessVpcSet() {
        return this.AccessVpcSet;
    }

    /**
     * Set List of private network access addresses
Note: This field may return null, indicating that no valid values can be obtained.
     * @param AccessVpcSet List of private network access addresses
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public void setAccessVpcSet(AccessVpc [] AccessVpcSet) {
        this.AccessVpcSet = AccessVpcSet;
    }

    /**
     * Get Total number of private network access addresses 
     * @return TotalCount Total number of private network access addresses
     */
    ...
    /**
     * Set Total number of private network access addresses
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "AccessVpcSet.", this.AccessVpcSet);
