...
public class GetDevicesResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Set Device authorization list.
     * @param Devices Device authorization list.
     */
     ...
     * @param TotalCount Number of tables in the list.
     */
    ...
    public GetDevicesResponse(GetDevicesResponse source) {
        if (source.Devices != null) {
            this.Devices = new Device[source.Devices.length];
            for (int i = 0; i < source.Devices.length; i++) {
                this.Devices[i] = new Device(source.Devices[i]);
            }
        }
