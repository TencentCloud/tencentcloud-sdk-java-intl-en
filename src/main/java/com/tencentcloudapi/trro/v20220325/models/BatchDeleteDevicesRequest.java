...
public class BatchDeleteDevicesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Project id of the targeted deleted device. 
    ...
    /**
     * Set Project id of the targeted deleted device.
     * @param ProjectId Project id of the targeted deleted device.
     */
    ...
    /**
     * Get Device id array of the targeted deleted device. 
    ...
    /**
     * Set Device id array of the targeted deleted device.
     * @param DeviceIds Device id array of the targeted deleted device.
     */
