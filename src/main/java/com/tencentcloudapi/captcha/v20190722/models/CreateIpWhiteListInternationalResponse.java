...
public class CreateIpWhiteListInternationalResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>IP allowlist resource id</p> 
     * @return IdList <p>IP allowlist resource id</p>
     */
    ...
    /**
     * Set <p>IP allowlist resource id</p>
     * @param IdList <p>IP allowlist resource id</p>
     */
    ...
    public CreateIpWhiteListInternationalResponse() {
    }
     ...
     */
    public CreateIpWhiteListInternationalResponse(CreateIpWhiteListInternationalResponse source) {
        if (source.Data != null) {
