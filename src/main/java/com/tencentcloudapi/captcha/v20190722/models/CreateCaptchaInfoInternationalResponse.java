...
public class CreateCaptchaInfoInternationalResponse extends AbstractModel {
    ...
    */
    ...
    public CreateCaptchaInfoInternationalResponse() {
    }
     ...
     */
    public CreateCaptchaInfoInternationalResponse(CreateCaptchaInfoInternationalResponse source) {
        if (source.Data != null) {
