...
public class RemoveCaptchaInfoInternationalResponse extends AbstractModel {
    ...
    */
    ...
    public RemoveCaptchaInfoInternationalResponse() {
    }
     ...
     */
    public RemoveCaptchaInfoInternationalResponse(RemoveCaptchaInfoInternationalResponse source) {
        if (source.Data != null) {
