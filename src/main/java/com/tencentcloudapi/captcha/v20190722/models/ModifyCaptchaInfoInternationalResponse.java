...
public class ModifyCaptchaInfoInternationalResponse extends AbstractModel {
    ...
    */
    ...
    public ModifyCaptchaInfoInternationalResponse() {
    }
     ...
     */
    public ModifyCaptchaInfoInternationalResponse(ModifyCaptchaInfoInternationalResponse source) {
        if (source.Data != null) {
