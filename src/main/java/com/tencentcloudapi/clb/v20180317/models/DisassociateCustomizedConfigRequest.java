...
public class DisassociateCustomizedConfigRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Specifies the list of unbinding. 
     * @return BindList Specifies the list of unbinding.
     */
    ...
    /**
     * Set Specifies the list of unbinding.
     * @param BindList Specifies the list of unbinding.
     */
