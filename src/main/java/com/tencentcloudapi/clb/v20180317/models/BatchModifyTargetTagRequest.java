...
public class BatchModifyTargetTagRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get List of tags to be modified in batches. 
     * @return ModifyList List of tags to be modified in batches.
     */
    ...
    /**
     * Set List of tags to be modified in batches.
     * @param ModifyList List of tags to be modified in batches.
     */
