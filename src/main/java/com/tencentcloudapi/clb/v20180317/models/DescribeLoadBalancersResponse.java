...
public class DescribeLoadBalancersResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Total number of CLB instances that meet the filter criteria. This value is independent of the Limit in the input parameter. 
    ...
    /**
     * Set Total number of CLB instances that meet the filter criteria. This value is independent of the Limit in the input parameter.
