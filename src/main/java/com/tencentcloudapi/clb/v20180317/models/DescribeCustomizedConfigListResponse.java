...
public class DescribeCustomizedConfigListResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setConfigList(ConfigListItem [] ConfigList) {
     ...
     */
    public DescribeCustomizedConfigListResponse(DescribeCustomizedConfigListResponse source) {
        if (source.ConfigList != null) {
            this.ConfigList = new ConfigListItem[source.ConfigList.length];
            for (int i = 0; i < source.ConfigList.length; i++) {
                this.ConfigList[i] = new ConfigListItem(source.ConfigList[i]);
            }
        }
