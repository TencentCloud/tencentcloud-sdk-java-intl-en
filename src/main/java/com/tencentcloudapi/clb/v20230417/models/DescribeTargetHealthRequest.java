...
public class DescribeTargetHealthRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get List of CLB instance IDs to query. 
    ...
    /**
     * Set List of CLB instance IDs to query.
     * @param LoadBalancerIds List of CLB instance IDs to query.
     */
    ...
    /**
     * Set Listener ID list to query.
     * @param ListenerIds Listener ID list to query.
     */
    ...
    /**
     * Get List of forwarding rule IDs to query. 
    ...
    /**
     * Set List of forwarding rule IDs to query.
     * @param LocationIds List of forwarding rule IDs to query.
     */
