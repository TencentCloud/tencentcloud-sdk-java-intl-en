...
public class ExtraInfo extends AbstractModel {
    ...
    */
     ...
     * @return Dnat Whether to enable VIP Direct Connect
     */
    public Boolean getDnat() {
        return this.Dnat;
    }

    /**
     * Set Whether to enable VIP Direct Connect
     * @param Dnat Whether to enable VIP Direct Connect
     */
    public void setDnat(Boolean Dnat) {
        this.Dnat = Dnat;
    }
    ...
    public ExtraInfo(ExtraInfo source) {
        if (source.Dnat != null) {
            this.Dnat = new Boolean(source.Dnat);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamSimple(map, prefix + "Dnat", this.Dnat);
