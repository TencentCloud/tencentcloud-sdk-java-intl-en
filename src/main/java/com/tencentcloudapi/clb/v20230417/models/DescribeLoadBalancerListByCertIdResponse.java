...
public class DescribeLoadBalancerListByCertIdResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Certificate ID and the list of CLB instances associated with the certificate ID 
     * @return CertSet Certificate ID and the list of CLB instances associated with the certificate ID
     */
    ...
    /**
     * Set Certificate ID and the list of CLB instances associated with the certificate ID
     * @param CertSet Certificate ID and the list of CLB instances associated with the certificate ID
     */
