...
public class SnatIp extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Unique ID of the VPC subnet, such as subnet-12345678 
     * @return SubnetId Unique ID of the VPC subnet, such as subnet-12345678
     */
    ...
    /**
     * Set Unique ID of the VPC subnet, such as subnet-12345678
     * @param SubnetId Unique ID of the VPC subnet, such as subnet-12345678
     */
