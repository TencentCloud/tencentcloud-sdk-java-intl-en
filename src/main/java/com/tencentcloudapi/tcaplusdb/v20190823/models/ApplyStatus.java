...
public class ApplyStatus extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Value format: cluster ID-application ID 
    ...
    /**
     * Set Value format: cluster ID-application ID
    ...
    /**
     * Get Status. Valid values: `-1` (canceled), `0` (pending approval), `1` (application approved and task submitted), `2` (rejected). Only applications in the pending approval status can be updated. 
    ...
    /**
     * Set Status. Valid values: `-1` (canceled), `0` (pending approval), `1` (application approved and task submitted), `2` (rejected). Only applications in the pending approval status can be updated.
