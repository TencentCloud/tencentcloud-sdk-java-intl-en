...
public class ModifySnapshotsResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get The number of snapshots modified in batches 
     * @return TotalCount The number of snapshots modified in batches
     */
    ...
    /**
     * Set The number of snapshots modified in batches
     ...
     * @return TableResults The result list of snapshots modified in batches
     */
