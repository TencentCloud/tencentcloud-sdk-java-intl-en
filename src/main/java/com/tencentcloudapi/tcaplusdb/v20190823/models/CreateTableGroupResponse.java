...
public class CreateTableGroupResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get ID of table group successfully created 
    ...
    /**
     * Set ID of table group successfully created
    ...
    public CreateTableGroupResponse() {
    }
     ...
     */
    public CreateTableGroupResponse(CreateTableGroupResponse source) {
