...
public class DescribeMachineResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeMachineResponse() {
    }
     ...
     */
    public DescribeMachineResponse(DescribeMachineResponse source) {
        if (source.PoolList != null) {
            this.PoolList = new PoolInfo[source.PoolList.length];
            for (int i = 0; i < source.PoolList.length; i++) {
                this.PoolList[i] = new PoolInfo(source.PoolList[i]);
            }
        }
