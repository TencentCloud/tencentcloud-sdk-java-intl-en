...
public class DisableRestProxyResponse extends AbstractModel{
    ...
    */
    ...
    public DisableRestProxyResponse() {
    }
     ...
     */
    public DisableRestProxyResponse(DisableRestProxyResponse source) {
