...
public class ModifyTableTagsResponse extends AbstractModel{
    ...
    */
     ...
     * @return TableResults Returned results
     */
    ...
    public ModifyTableTagsResponse() {
    }
     ...
     */
    public ModifyTableTagsResponse(ModifyTableTagsResponse source) {
