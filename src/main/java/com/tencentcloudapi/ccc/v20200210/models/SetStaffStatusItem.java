...
public class SetStaffStatusItem extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Status. specifies the instance status. valid values: free (idle), notReady (busy), rest (short break).	 
    ...
    /**
     * Set Status. specifies the instance status. valid values: free (idle), notReady (busy), rest (short break).	
     * @param Status Status. specifies the instance status. valid values: free (idle), notReady (busy), rest (short break).	
     */
    ...
    /**
     * Get Specifies the reason if the break state is set. 
    ...
    /**
     * Set Specifies the reason if the break state is set.
     * @param Reason Specifies the reason if the break state is set.
     */
