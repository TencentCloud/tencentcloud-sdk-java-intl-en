...
public class CreateIVRSessionResponse extends AbstractModel {
    ...
    */
    ...
    public CreateIVRSessionResponse() {
    }
     ...
     */
    public CreateIVRSessionResponse(CreateIVRSessionResponse source) {
