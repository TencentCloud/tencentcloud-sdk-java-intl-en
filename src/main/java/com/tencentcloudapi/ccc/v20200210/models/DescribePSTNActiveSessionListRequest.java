...
public class DescribePSTNActiveSessionListRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Number of returned data entries, up to 25. 
     * @return Limit Number of returned data entries, up to 25.
     */
    ...
    /**
     * Set Number of returned data entries, up to 25.
     * @param Limit Number of returned data entries, up to 25.
     */
