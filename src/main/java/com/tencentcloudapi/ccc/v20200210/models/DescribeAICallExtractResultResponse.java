...
public class DescribeAICallExtractResultResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setResultList(AICallExtractResultElement [] ResultList) {
     ...
     */
    public DescribeAICallExtractResultResponse(DescribeAICallExtractResultResponse source) {
        if (source.ResultList != null) {
            this.ResultList = new AICallExtractResultElement[source.ResultList.length];
            for (int i = 0; i < source.ResultList.length; i++) {
                this.ResultList[i] = new AICallExtractResultElement(source.ResultList[i]);
            }
        }
