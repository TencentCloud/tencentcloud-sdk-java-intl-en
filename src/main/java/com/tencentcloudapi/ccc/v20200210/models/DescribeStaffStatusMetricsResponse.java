...
public class DescribeStaffStatusMetricsResponse extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeStaffStatusMetricsResponse(DescribeStaffStatusMetricsResponse source) {
        if (source.Metrics != null) {
            this.Metrics = new StaffStatusMetrics[source.Metrics.length];
            for (int i = 0; i < source.Metrics.length; i++) {
                this.Metrics[i] = new StaffStatusMetrics(source.Metrics[i]);
            }
        }
