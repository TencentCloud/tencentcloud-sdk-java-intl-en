...
public class DescribeStaffStatusHistoryRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get End timestamp, Unix second-level timestamp. the interval range between end time and start time is less than 7 days. 
    ...
    /**
     * Set End timestamp, Unix second-level timestamp. the interval range between end time and start time is less than 7 days.
     * @param EndTimestamp End timestamp, Unix second-level timestamp. the interval range between end time and start time is less than 7 days.
     */
     ...
     * @param Cursor Specifies the cursor used during paginated retrieval.
     */
     ...
     * @param PageSize Specifies the pagination size.
     */
