...
public class DeleteStaffRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get List of customer service emails to be deleted. 
    ...
    /**
     * Set List of customer service emails to be deleted.
     * @param StaffList List of customer service emails to be deleted.
     */
