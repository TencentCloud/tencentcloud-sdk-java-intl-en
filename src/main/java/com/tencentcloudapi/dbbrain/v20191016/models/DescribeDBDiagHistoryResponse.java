...
public class DescribeDBDiagHistoryResponse extends AbstractModel{
    ...
    */
     ...
     */
    public DescribeDBDiagHistoryResponse(DescribeDBDiagHistoryResponse source) {
        if (source.Events != null) {
            this.Events = new DiagHistoryEventItem[source.Events.length];
            for (int i = 0; i < source.Events.length; i++) {
                this.Events[i] = new DiagHistoryEventItem(source.Events[i]);
            }
        }
