...
Note: this field may return `null`, indicating that no valid value is obtained.
    ...
    */
    ...
    /**
     * Get ID of an async task request, which can be used to query the execution result of an async task.
Note: this field may return `null`, indicating that no valid value is obtained. 
...
Note: this field may return `null`, indicating that no valid value is obtained.
    ...
    /**
     * Set ID of an async task request, which can be used to query the execution result of an async task.
Note: this field may return `null`, indicating that no valid value is obtained.
