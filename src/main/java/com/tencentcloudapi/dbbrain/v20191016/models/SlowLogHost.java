...
public class SlowLogHost extends AbstractModel{
    ...
    */
    ...
    /**
     * Get The proportion (in %) of slow logs from this source address to the total number of slow logs 
     * @return Ratio The proportion (in %) of slow logs from this source address to the total number of slow logs
     */
    ...
    /**
     * Set The proportion (in %) of slow logs from this source address to the total number of slow logs
