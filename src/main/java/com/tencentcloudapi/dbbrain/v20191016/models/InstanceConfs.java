...
public class InstanceConfs extends AbstractModel{
    ...
    */
    ...
    /**
     * Get The switch of database inspection. Valid values: Yes/No. 
     * @return DailyInspection The switch of database inspection. Valid values: Yes/No.
     */
    ...
    /**
     * Set The switch of database inspection. Valid values: Yes/No.
