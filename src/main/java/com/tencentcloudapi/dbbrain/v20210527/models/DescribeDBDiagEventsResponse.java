...
public class DescribeDBDiagEventsResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Total number of diagnosis events. 
    ...
    /**
     * Set Total number of diagnosis events.
     ...
     */
    public DescribeDBDiagEventsResponse(DescribeDBDiagEventsResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.Items != null) {
            this.Items = new DiagHistoryEventItem[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new DiagHistoryEventItem(source.Items[i]);
            }
        }
