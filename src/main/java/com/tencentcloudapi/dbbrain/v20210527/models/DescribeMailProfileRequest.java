...
public class DescribeMailProfileRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Number of results per page in paginated queries. Maximum value: `50`. 
    ...
    /**
     * Set Number of results per page in paginated queries. Maximum value: `50`.
    ...
    /**
     * Get Query by email configuration name. The name of the scheduled task email configuration should be in the format of "scheduler_"+{instanceId}. 
    ...
    /**
     * Set Query by email configuration name. The name of the scheduled task email configuration should be in the format of "scheduler_"+{instanceId}.
