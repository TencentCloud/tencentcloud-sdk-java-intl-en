...
public class MailConfiguration extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Contact ID. Either `ContactPerson` or `ContactGroup` should be passed in. 
     * @return ContactPerson Contact ID. Either `ContactPerson` or `ContactGroup` should be passed in.
     */
    ...
    /**
     * Set Contact ID. Either `ContactPerson` or `ContactGroup` should be passed in.
    ...
    /**
     * Get Contact group ID. Either `ContactPerson` or `ContactGroup` should be passed in. 
     * @return ContactGroup Contact group ID. Either `ContactPerson` or `ContactGroup` should be passed in.
     */
    ...
    /**
     * Set Contact group ID. Either `ContactPerson` or `ContactGroup` should be passed in.
