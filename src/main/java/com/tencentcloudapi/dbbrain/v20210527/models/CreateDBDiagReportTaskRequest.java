...
public class CreateDBDiagReportTaskRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Array of contact IDs to receive email. 
     * @return ContactPerson Array of contact IDs to receive email.
     */
    ...
    /**
     * Set Array of contact IDs to receive email.
    ...
    /**
     * Get Array of contact group IDs to receive email. 
     * @return ContactGroup Array of contact group IDs to receive email.
     */
    ...
    /**
     * Set Array of contact group IDs to receive email.
