...
public class SlowLogTopSqlItem extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Ratio of total duration in % 
     * @return QueryTimeRatio Ratio of total duration in %
     */
    ...
    /**
     * Set Ratio of total duration in %
    ...
    /**
     * Get Ratio of total SQL lock wait time in % 
     * @return LockTimeRatio Ratio of total SQL lock wait time in %
     */
    ...
    /**
     * Set Ratio of total SQL lock wait time in %
