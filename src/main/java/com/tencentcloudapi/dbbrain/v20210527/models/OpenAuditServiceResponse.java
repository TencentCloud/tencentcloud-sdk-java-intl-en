...
public class OpenAuditServiceResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Audit is successfully enabled only when the value of this parameter is `0`. 
    ...
    /**
     * Set Audit is successfully enabled only when the value of this parameter is `0`.
     * @param TaskId Audit is successfully enabled only when the value of this parameter is `0`.
     */
