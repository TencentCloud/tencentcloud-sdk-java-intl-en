...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Get List of risk levels. 0: no risk; 1: low risk; 2: medium risk; 3 high risk.
Note: this field may return null, indicating that no valid values can be obtained. 
     * @return DangerLevels List of risk levels. 0: no risk; 1: low risk; 2: medium risk; 3 high risk.
Note: this field may return null, indicating that no valid values can be obtained.
     */
    ...
    /**
     * Set List of risk levels. 0: no risk; 1: low risk; 2: medium risk; 3 high risk.
Note: this field may return null, indicating that no valid values can be obtained.
