...
public class KillMySqlThreadsRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get The ID list of MySQL sessions to be killed. This parameter is used in the “Prepare” stage. 
     * @return Threads The ID list of MySQL sessions to be killed. This parameter is used in the “Prepare” stage.
     */
    ...
    /**
     * Set The ID list of MySQL sessions to be killed. This parameter is used in the “Prepare” stage.
