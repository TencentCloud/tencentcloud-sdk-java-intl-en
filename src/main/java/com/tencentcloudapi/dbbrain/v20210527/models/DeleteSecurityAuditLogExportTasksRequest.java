...
public class DeleteSecurityAuditLogExportTasksRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Log export task ID list. This API will ignore task IDs that do not exist or have been deleted. 
    ...
    /**
     * Set Log export task ID list. This API will ignore task IDs that do not exist or have been deleted.
