...
public class CreateProxySessionKillTaskResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Async task ID that is returned after the session killing task is created. 
    ...
    /**
     * Set Async task ID that is returned after the session killing task is created.
    ...
    public CreateProxySessionKillTaskResponse() {
    }
     ...
     */
    public CreateProxySessionKillTaskResponse(CreateProxySessionKillTaskResponse source) {
