...
public class CreateSecurityAuditLogExportTaskRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Service type. Valid values: mysql (TencentDB for MySQL). 
    ...
    /**
     * Set Service type. Valid values: mysql (TencentDB for MySQL).
    ...
    /**
     * Get Log risk level list. Valid values: 0 (no risk), 1 (low risk), 2 (medium risk), 3 (high risk). 
     * @return DangerLevels Log risk level list. Valid values: 0 (no risk), 1 (low risk), 2 (medium risk), 3 (high risk).
     */
    ...
    /**
     * Set Log risk level list. Valid values: 0 (no risk), 1 (low risk), 2 (medium risk), 3 (high risk).
