...
public class CreateDBDiagReportUrlRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Health report task ID, which can be queried through `DescribeDBDiagReportTasks`. 
    ...
    /**
     * Set Health report task ID, which can be queried through `DescribeDBDiagReportTasks`.
