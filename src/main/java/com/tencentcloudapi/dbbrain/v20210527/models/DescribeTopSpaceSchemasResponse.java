...
public class DescribeTopSpaceSchemasResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Timestamp (in seconds) of database space data collection points 
     * @return Timestamp Timestamp (in seconds) of database space data collection points
     */
    ...
    /**
     * Set Timestamp (in seconds) of database space data collection points
