...
public class DescribeDBDiagReportTasksRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Array of instance IDs, which is used to filter the task list of a specified instance. 
     * @return InstanceIds Array of instance IDs, which is used to filter the task list of a specified instance.
     */
    ...
    /**
     * Set Array of instance IDs, which is used to filter the task list of a specified instance.
    ...
    /**
     * Get Task status. Valid values: `created` (created), `chosen` (to be executed), `running` (being executed), `failed` (failed), and `finished` (completed). 
    ...
    /**
     * Set Task status. Valid values: `created` (created), `chosen` (to be executed), `running` (being executed), `failed` (failed), and `finished` (completed).
