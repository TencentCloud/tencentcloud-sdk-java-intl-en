...
public class DescribeDBDiagReportTasksRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Array of instance IDs, which is used to filter the task list of the specified instance. 
    ...
    /**
     * Set Array of instance IDs, which is used to filter the task list of the specified instance.
