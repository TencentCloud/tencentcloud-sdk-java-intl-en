...
public class DescribeSampleQueryRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Label filtering condition. For supported labels, refer to all metrics and labels returned by the DescribeMetricLabelWithValues API. 
    ...
    /**
     * Set Label filtering condition. For supported labels, refer to all metrics and labels returned by the DescribeMetricLabelWithValues API.
     * @param Labels Label filtering condition. For supported labels, refer to all metrics and labels returned by the DescribeMetricLabelWithValues API.
     */
