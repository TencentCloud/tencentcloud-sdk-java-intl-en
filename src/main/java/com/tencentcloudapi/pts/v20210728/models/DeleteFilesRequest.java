...
public class DeleteFilesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Array of File ID to be deleted. 
     * @return FileIds Array of File ID to be deleted.
     */
    ...
    /**
     * Set Array of File ID to be deleted.
     * @param FileIds Array of File ID to be deleted.
     */
