...
Note: This field may return null, indicating that no valid value is found.
    */
    ...
    @Expose
    private RegionDetail [] RegionSet;
...
Note: This field may return null, indicating that no valid value is found. 
     * @return RegionSet Array of regions.

Note: This field may return null, indicating that no valid value is found.
     */
    public RegionDetail [] getRegionSet() {
...
Note: This field may return null, indicating that no valid value is found.
     * @param RegionSet Array of regions.

Note: This field may return null, indicating that no valid value is found.
     */
    public void setRegionSet(RegionDetail [] RegionSet) {
    ...
    public DescribeRegionsResponse(DescribeRegionsResponse source) {
        if (source.RegionSet != null) {
            this.RegionSet = new RegionDetail[source.RegionSet.length];
            for (int i = 0; i < source.RegionSet.length; i++) {
                this.RegionSet[i] = new RegionDetail(source.RegionSet[i]);
            }
        }
