...
public class TokenPlanApiKeyListItem extends AbstractModel {
    ...
    */
    ...
    /**
     * Get API Key secret key value (masking). 
    ...
    /**
     * Set API Key secret key value (masking).
     * @param ApiKey API Key secret key value (masking).
     */
    ...
    /**
     * Get Main account UIN. Maximum 128 characters. 
    ...
    /**
     * Set Main account UIN. Maximum 128 characters.
     * @param Uin Main account UIN. Maximum 128 characters.
     */
    ...
    /**
     * Get Reason for disabling the API Key. Value: NORMAL (normal, default value), QUOTA_EXHAUSTED (API Key quota package exhausted), ABNORMAL (abnormal, requires human intervention) 
    ...
    /**
     * Set Reason for disabling the API Key. Value: NORMAL (normal, default value), QUOTA_EXHAUSTED (API Key quota package exhausted), ABNORMAL (abnormal, requires human intervention)
     * @param StopReason Reason for disabling the API Key. Value: NORMAL (normal, default value), QUOTA_EXHAUSTED (API Key quota package exhausted), ABNORMAL (abnormal, requires human intervention)
     */
    ...
    /**
     * Get API Key limit usage information 
    ...
    /**
     * Set API Key limit usage information
     * @param Balance API Key limit usage information
     */
