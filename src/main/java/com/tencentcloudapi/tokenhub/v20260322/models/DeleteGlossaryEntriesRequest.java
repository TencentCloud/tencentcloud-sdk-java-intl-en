...
public class DeleteGlossaryEntriesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Terminology entry list to be deleted. At a time 200. 
     * @return Entries Terminology entry list to be deleted. At a time 200.
     */
    ...
    /**
     * Set Terminology entry list to be deleted. At a time 200.
     * @param Entries Terminology entry list to be deleted. At a time 200.
     */
