...
public class ApiKeyDetail extends AbstractModel {
    ...
    */
    ...
    /**
     * Get API key value. The API response contains the masking value. 
    ...
    /**
     * Set API key value. The API response contains the masking value.
     * @param ApiKey API key value. The API response contains the masking value.
     */
    ...
    /**
     * Get Binding type. Value: all (all models and services), model_all_endpoint_custom (all models + custom service), model_custom_endpoint_all (custom model + all services), model_custom_endpoint_custom (custom model + custom service). 
    ...
    /**
     * Set Binding type. Value: all (all models and services), model_all_endpoint_custom (all models + custom service), model_custom_endpoint_all (custom model + all services), model_custom_endpoint_custom (custom model + custom service).
     * @param BindType Binding type. Value: all (all models and services), model_all_endpoint_custom (all models + custom service), model_custom_endpoint_all (custom model + all services), model_custom_endpoint_custom (custom model + custom service).
     */
    ...
    /**
     * Get Multi-dimensional list of Token quota information. This field is not returned when unconfigured. 
    ...
    /**
     * Set Multi-dimensional list of Token quota information. This field is not returned when unconfigured.
     * @param QuotaSet Multi-dimensional list of Token quota information. This field is not returned when unconfigured.
     */
     ...
     */
    public ApiKeyDetail(ApiKeyDetail source) {
