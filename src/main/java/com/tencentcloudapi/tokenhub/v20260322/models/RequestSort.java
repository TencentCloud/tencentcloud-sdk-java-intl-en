...
public class RequestSort extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Sorting order. Value: ASC (ascending), DESC (descending). 
     * @return Order Sorting order. Value: ASC (ascending), DESC (descending).
     */
    ...
    /**
     * Set Sorting order. Value: ASC (ascending), DESC (descending).
     * @param Order Sorting order. Value: ASC (ascending), DESC (descending).
     */
