...
public class DeleteGlossaryEntryInput extends AbstractModel {
    ...
    */
    ...
    public DeleteGlossaryEntryInput() {
    }
     ...
     */
    public DeleteGlossaryEntryInput(DeleteGlossaryEntryInput source) {
