...
public class OffsetTimeMap extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Kafka partition numberNote: This field may return null, indicating that no valid values can be obtained. 
    ...
    /**
     * Set Kafka partition numberNote: This field may return null, indicating that no valid values can be obtained.
     * @param PartitionNo Kafka partition numberNote: This field may return null, indicating that no valid values can be obtained.
     */
    ...
    /**
     * Get Kafka offsetNote: This field may return null, indicating that no valid values can be obtained. 
    ...
    /**
     * Set Kafka offsetNote: This field may return null, indicating that no valid values can be obtained.
     * @param Offset Kafka offsetNote: This field may return null, indicating that no valid values can be obtained.
     */
