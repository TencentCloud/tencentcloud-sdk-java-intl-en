...
public class ModifySubscribeNameRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Modified data subscription instance name. Value range: 1-60. 
     * @return SubscribeName Modified data subscription instance name. Value range: 1-60.
     */
    ...
    /**
     * Set Modified data subscription instance name. Value range: 1-60.
     * @param SubscribeName Modified data subscription instance name. Value range: 1-60.
     */
