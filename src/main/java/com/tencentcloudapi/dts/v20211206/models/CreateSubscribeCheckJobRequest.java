...
public class CreateSubscribeCheckJobRequest extends AbstractModel {
    ...
    */
    ...
    public CreateSubscribeCheckJobRequest() {
    }
     ...
     */
    public CreateSubscribeCheckJobRequest(CreateSubscribeCheckJobRequest source) {
