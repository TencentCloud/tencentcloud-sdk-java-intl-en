...
public class DestroyIsolatedSubscribeRequest extends AbstractModel {
    ...
    */
    ...
    public DestroyIsolatedSubscribeRequest() {
    }
     ...
     */
    public DestroyIsolatedSubscribeRequest(DestroyIsolatedSubscribeRequest source) {
