...
public class DeleteCloudNativeAPIGatewayRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Whether to delete the CLS log topic associated with the instance. 
    ...
    /**
     * Set Whether to delete the CLS log topic associated with the instance.
     * @param DeleteClsTopic Whether to delete the CLS log topic associated with the instance.
     */
