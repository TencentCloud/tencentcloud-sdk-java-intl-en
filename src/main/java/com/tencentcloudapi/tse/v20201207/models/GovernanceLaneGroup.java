...
public class GovernanceLaneGroup extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Get Lane rule list of ALL lane groups
Note: This field may return null, indicating that no valid values can be obtained. 
     * @return Rules Lane rule list of ALL lane groups
Note: This field may return null, indicating that no valid values can be obtained.
     */
    ...
    /**
     * Set Lane rule list of ALL lane groups
Note: This field may return null, indicating that no valid values can be obtained.
     * @param Rules Lane rule list of ALL lane groups
Note: This field may return null, indicating that no valid values can be obtained.
     */
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public GovernanceLaneGroup(GovernanceLaneGroup source) {
        if (source.Name != null) {
