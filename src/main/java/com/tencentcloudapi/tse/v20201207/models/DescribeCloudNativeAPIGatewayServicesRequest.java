...
public class DescribeCloudNativeAPIGatewayServicesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Filter criteria. Multiple filter conditions are in an AND relationship with each other. Support name and upstreamType. 
    ...
    /**
     * Set Filter criteria. Multiple filter conditions are in an AND relationship with each other. Support name and upstreamType.
     * @param Filters Filter criteria. Multiple filter conditions are in an AND relationship with each other. Support name and upstreamType.
     */
