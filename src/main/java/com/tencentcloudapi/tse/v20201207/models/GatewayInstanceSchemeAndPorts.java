...
public class GatewayInstanceSchemeAndPorts extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Port protocol, selectable HTTP, HTTPS, TCP, and UDP. 
     * @return Scheme Port protocol, selectable HTTP, HTTPS, TCP, and UDP.
     */
    ...
    /**
     * Set Port protocol, selectable HTTP, HTTPS, TCP, and UDP.
     * @param Scheme Port protocol, selectable HTTP, HTTPS, TCP, and UDP.
     */
