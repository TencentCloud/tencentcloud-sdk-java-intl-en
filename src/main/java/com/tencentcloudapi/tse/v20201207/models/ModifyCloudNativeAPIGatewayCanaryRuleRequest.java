...
public class ModifyCloudNativeAPIGatewayCanaryRuleRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Priority. The grayscale rule priority of a service is unique. 
    ...
    /**
     * Set Priority. The grayscale rule priority of a service is unique.
     * @param Priority Priority. The grayscale rule priority of a service is unique.
     */
    ...
    /**
     * Get Grayscale rule configuration list. If configured, this parameter takes precedence and the Priority and CanaryRule parameters are ignored. 
    ...
    /**
     * Set Grayscale rule configuration list. If configured, this parameter takes precedence and the Priority and CanaryRule parameters are ignored.
     * @param CanaryRuleList Grayscale rule configuration list. If configured, this parameter takes precedence and the Priority and CanaryRule parameters are ignored.
     */
