...
public class AccurateQpsThreshold extends AbstractModel {
    ...
    */
    ...
    /**
     * Get qps threshold control dimension, including: second, minute, hour, day, month, year. 
    ...
    /**
     * Set qps threshold control dimension, including: second, minute, hour, day, month, year.
     * @param Unit qps threshold control dimension, including: second, minute, hour, day, month, year.
     */
