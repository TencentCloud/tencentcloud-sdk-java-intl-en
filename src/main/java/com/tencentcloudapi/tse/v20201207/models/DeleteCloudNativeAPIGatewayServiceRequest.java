...
public class DeleteCloudNativeAPIGatewayServiceRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Service name, service ID 
     * @return Name Service name, service ID
     */
    ...
    /**
     * Set Service name, service ID
     * @param Name Service name, service ID
     */
    ...
    /**
     * Get Whether to synchronize the deletion of routes bound to the service 
     * @return DeleteRoutes Whether to synchronize the deletion of routes bound to the service
     */
    ...
    /**
     * Set Whether to synchronize the deletion of routes bound to the service
     * @param DeleteRoutes Whether to synchronize the deletion of routes bound to the service
     */
