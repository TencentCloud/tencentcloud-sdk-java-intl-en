...
public class CreateAccessKeyRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get UIN of the specified user. If this parameter is left empty, the access key will be created for the current user by default. 
    ...
    /**
     * Set UIN of the specified user. If this parameter is left empty, the access key will be created for the current user by default.
