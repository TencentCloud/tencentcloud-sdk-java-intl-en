...
public class CreateSAMLProviderResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get SAML identity provider resource descriptor 
     * @return ProviderArn SAML identity provider resource descriptor
     */
    ...
    /**
     * Set SAML identity provider resource descriptor
     ...
     */
    public CreateSAMLProviderResponse(CreateSAMLProviderResponse source) {
        if (source.ProviderArn != null) {
            this.ProviderArn = new String(source.ProviderArn);
        }
