...
public class ListAccessKeysRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get `UIN` of the specified user. If this parameter is left empty, access keys of the current user will be listed by default 
    ...
    /**
     * Set `UIN` of the specified user. If this parameter is left empty, access keys of the current user will be listed by default
     ...
     */
    public ListAccessKeysRequest(ListAccessKeysRequest source) {
