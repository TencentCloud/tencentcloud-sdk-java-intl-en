...
public class GetCustomMFATokenInfoResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Account ID corresponding to the custom multi-factor verification Token 
     * @return Uin Account ID corresponding to the custom multi-factor verification Token
     */
    public Long getUin() {
        return this.Uin;
    }
    ...
    /**
     * Set Account ID corresponding to the custom multi-factor verification Token
