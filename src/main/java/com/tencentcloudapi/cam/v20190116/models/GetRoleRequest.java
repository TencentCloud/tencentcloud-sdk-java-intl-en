...
public class GetRoleRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Role ID, used to specify role. Input either `RoleId` or `RoleName` 
    ...
    /**
     * Set Role ID, used to specify role. Input either `RoleId` or `RoleName`
    ...
    /**
     * Get Role name, used to specify role. Input either `RoleId` or `RoleName` 
    ...
    /**
     * Set Role name, used to specify role. Input either `RoleId` or `RoleName`
     ...
     */
    public GetRoleRequest(GetRoleRequest source) {
