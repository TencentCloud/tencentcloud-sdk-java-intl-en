...
public class UpdatePasswordRulesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Set Password rules
     * @param Rules Password rules
     */
    public void setRules(PassWordRule Rules) {
        this.Rules = Rules;
    }

    public UpdatePasswordRulesRequest() {
    }
     ...
     */
    public UpdatePasswordRulesRequest(UpdatePasswordRulesRequest source) {
