...
Note: this field may return null, indicating that no valid values can be obtained.
    */
    ...
    /**
    * List of tags associated with the policy
    */
    @SerializedName("Tags")
    @Expose
    private Tag [] Tags;
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Get List of tags associated with the policy 
     * @return Tags List of tags associated with the policy
     */
    public Tag [] getTags() {
        return this.Tags;
    }
    ...
    /**
     * Set List of tags associated with the policy
     * @param Tags List of tags associated with the policy
     */
