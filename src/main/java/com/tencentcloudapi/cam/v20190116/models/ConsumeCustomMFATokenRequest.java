...
public class ConsumeCustomMFATokenRequest extends AbstractModel {
    ...
    */
    ...
    public ConsumeCustomMFATokenRequest() {
    }
     ...
     */
    public ConsumeCustomMFATokenRequest(ConsumeCustomMFATokenRequest source) {
