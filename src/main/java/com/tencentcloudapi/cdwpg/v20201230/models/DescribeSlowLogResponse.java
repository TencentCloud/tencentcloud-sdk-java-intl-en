...
public class DescribeSlowLogResponse extends AbstractModel {
    ...
    */
     ...
     * @param TotalCount Total count of messages returned.
     */
    ...
    /**
     * Set Slow SQL log details.
     * @param SlowLogDetails Slow SQL log details.
     */
    public void setSlowLogDetails(SlowLogDetail SlowLogDetails) {
    ...
    public DescribeSlowLogResponse(DescribeSlowLogResponse source) {
        ...
        if (source.SlowLogDetails != null) {
            this.SlowLogDetails = new SlowLogDetail(source.SlowLogDetails);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamObj(map, prefix + "SlowLogDetails.", this.SlowLogDetails);
