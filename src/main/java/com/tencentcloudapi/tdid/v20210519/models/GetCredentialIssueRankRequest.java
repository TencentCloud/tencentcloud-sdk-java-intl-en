...
public class GetCredentialIssueRankRequest extends AbstractModel {
    ...
    */
    ...
    public GetCredentialIssueRankRequest() {
    }
     ...
     */
    public GetCredentialIssueRankRequest(GetCredentialIssueRankRequest source) {
