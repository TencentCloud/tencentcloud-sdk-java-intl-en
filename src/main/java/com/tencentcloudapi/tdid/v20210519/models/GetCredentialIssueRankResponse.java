...
public class GetCredentialIssueRankResponse extends AbstractModel {
    ...
    */
    ...
    public GetCredentialIssueRankResponse() {
    }
     ...
     */
    public GetCredentialIssueRankResponse(GetCredentialIssueRankResponse source) {
