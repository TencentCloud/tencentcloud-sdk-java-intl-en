...
public class GetCredentialStatusResponse extends AbstractModel{
    ...
    */
    ...
    public GetCredentialStatusResponse() {
    }
     ...
     */
    public GetCredentialStatusResponse(GetCredentialStatusResponse source) {
