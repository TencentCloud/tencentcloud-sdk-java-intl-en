...
public class CancelAuthorityIssuerRequest extends AbstractModel{
    ...
    */
    ...
    public CancelAuthorityIssuerRequest() {
    }
     ...
     */
    public CancelAuthorityIssuerRequest(CancelAuthorityIssuerRequest source) {
        if (source.Did != null) {
