...
public class GetCredentialStatusRequest extends AbstractModel {
    ...
    */
    ...
    public GetCredentialStatusRequest() {
    }
     ...
     */
    public GetCredentialStatusRequest(GetCredentialStatusRequest source) {
