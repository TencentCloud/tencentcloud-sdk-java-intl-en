...
public class DescribeWorkloadGroupResponse extends AbstractModel {
    ...
    */
     ...
     * @param WorkloadGroups Resource group information
     */
    ...
    /**
     * Get Whether to enable the resource group: open and close 
    ...
    /**
     * Set Whether to enable the resource group: open and close
     * @param Status Whether to enable the resource group: open and close
     */
