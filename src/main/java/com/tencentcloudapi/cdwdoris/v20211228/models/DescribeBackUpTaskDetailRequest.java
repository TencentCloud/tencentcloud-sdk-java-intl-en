...
public class DescribeBackUpTaskDetailRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeBackUpTaskDetailRequest() {
    }
     ...
     */
    public DescribeBackUpTaskDetailRequest(DescribeBackUpTaskDetailRequest source) {
