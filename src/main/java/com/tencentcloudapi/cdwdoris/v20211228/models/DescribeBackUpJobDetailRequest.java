...
public class DescribeBackUpJobDetailRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeBackUpJobDetailRequest() {
    }
     ...
     */
    public DescribeBackUpJobDetailRequest(DescribeBackUpJobDetailRequest source) {
