...
Note: This field may return null, indicating that no valid values can be obtained.
     * @param InstanceNodesList Total number of instance nodes
Note: This field may return null, indicating that no valid values can be obtained.
     */
    ...
    public DescribeInstanceNodesResponse(DescribeInstanceNodesResponse source) {
        ...
        if (source.InstanceNodesList != null) {
            this.InstanceNodesList = new InstanceNode[source.InstanceNodesList.length];
            for (int i = 0; i < source.InstanceNodesList.length; i++) {
