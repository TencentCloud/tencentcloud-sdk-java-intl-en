...
public class RabbitMQServerlessAccessInfo extends AbstractModel {
    ...
    */
    ...
    /**
     * Set Public network domain.
     * @param PublicAccessEndpoint Public network domain.
     */
     ...
     * @return PublicDataStreamStatus Public network status.
     */
     ...
     * @param PublicDataStreamStatus Public network status.
     */
