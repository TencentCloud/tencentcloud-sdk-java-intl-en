...
public class DescribeTaskLockStatusResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Task lock status information 
    ...
    /**
     * Set Task lock status information
     * @param TaskLockStatus Task lock status information
     */
     ...
     */
    public DescribeTaskLockStatusResponse(DescribeTaskLockStatusResponse source) {
        if (source.TaskLockStatus != null) {
            this.TaskLockStatus = new TaskLockStatus(source.TaskLockStatus);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamObj(map, prefix + "TaskLockStatus.", this.TaskLockStatus);
