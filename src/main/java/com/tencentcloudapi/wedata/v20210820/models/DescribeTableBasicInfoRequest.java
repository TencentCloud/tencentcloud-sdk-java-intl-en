...
public class DescribeTableBasicInfoRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeTableBasicInfoRequest() {
    }
     ...
     */
    public DescribeTableBasicInfoRequest(DescribeTableBasicInfoRequest source) {
