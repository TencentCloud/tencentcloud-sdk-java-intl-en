...
public class MakePlanTaskOpsDtoCollection extends AbstractModel {
...
Note: This field may return null, indicating that no valid value can be obtained.
    */
    ...
    @Expose
    private MakePlanTaskOpsDto [] Items;
...
Note: This field may return null, indicating that no valid value can be obtained.
     */
    public MakePlanTaskOpsDto [] getItems() {
        return this.Items;
    }
...
Note: This field may return null, indicating that no valid value can be obtained.
     */
    public void setItems(MakePlanTaskOpsDto [] Items) {
        this.Items = Items;
    }

    public MakePlanTaskOpsDtoCollection() {
    }
     ...
     */
    public MakePlanTaskOpsDtoCollection(MakePlanTaskOpsDtoCollection source) {
        ...
        if (source.Items != null) {
            this.Items = new MakePlanTaskOpsDto[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new MakePlanTaskOpsDto(source.Items[i]);
            }
        }
    }
