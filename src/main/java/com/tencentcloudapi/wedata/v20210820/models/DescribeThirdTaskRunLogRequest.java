...
public class DescribeThirdTaskRunLogRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeThirdTaskRunLogRequest() {
    }
     ...
     */
    public DescribeThirdTaskRunLogRequest(DescribeThirdTaskRunLogRequest source) {
