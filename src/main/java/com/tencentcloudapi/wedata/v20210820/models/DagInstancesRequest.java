...
public class DagInstancesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Query conditions, this interface requires the example information to be placed in this field 
     * @return SearchCondition Query conditions, this interface requires the example information to be placed in this field
     */
    ...
    /**
     * Set Query conditions, this interface requires the example information to be placed in this field
     * @param SearchCondition Query conditions, this interface requires the example information to be placed in this field
     */
     ...
     */
    public DagInstancesRequest(DagInstancesRequest source) {
