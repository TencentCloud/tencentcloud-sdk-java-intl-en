...
public class LineageParamRecord extends AbstractModel {
    ...
    */
     ...
     * @param Value Field valueNote: This field may return null, indicating that no valid value can be obtained.
     */
    public void setValue(String Value) {
        this.Value = Value;
    }

    public LineageParamRecord() {
    }
     ...
     */
    public LineageParamRecord(LineageParamRecord source) {
        if (source.Name != null) {
