...
public class CreateRuleResponse extends AbstractModel {
    ...
    */
     ...
     * @return Data RuleNote: This field may return null, indicating that no valid value can be obtained.
     */
    public Rule getData() {
        return this.Data;
    }
     ...
     * @param Data RuleNote: This field may return null, indicating that no valid value can be obtained.
     */
    ...
    public CreateRuleResponse(CreateRuleResponse source) {
        if (source.Data != null) {
            this.Data = new Rule(source.Data);
        }
