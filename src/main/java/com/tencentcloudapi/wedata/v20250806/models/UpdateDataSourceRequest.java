...
```
    ...
    */
    ...
    /**
     * Get Configuration message of data sources is stored in JSON KV. based on each data source type, the KV storage information varies.
...
```
    ...
    /**
     * Set Configuration message of data sources is stored in JSON KV. based on each data source type, the KV storage information varies.
...
```
     * @param ProdConProperties Configuration message of data sources is stored in JSON KV. based on each data source type, the KV storage information varies.
...
```
    ...
    /**
     * Get This field is required if the project is in standard mode. 
    ...
    /**
     * Set This field is required if the project is in standard mode.
     * @param DevConProperties This field is required if the project is in standard mode.
     */
    ...
    /**
     * Get Upload data source file in live production environment. 
    ...
    /**
     * Set Upload data source file in live production environment.
     * @param ProdFileUpload Upload data source file in live production environment.
     */
    ...
    /**
     * Get Upload data source file in development environment. 
    ...
    /**
     * Set Upload data source file in development environment.
     * @param DevFileUpload Upload data source file in development environment.
     */
