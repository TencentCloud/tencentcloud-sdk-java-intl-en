...
public class CreateDataBackfillPlanResponse extends AbstractModel {
    ...
    */
    @SerializedName("Data")
    @Expose
    private CreateDataReplenishmentPlan Data;
    ...
    */
     ...
     * @return Data Specifies the creation result of the data backfill plan.
     */
     ...
     * @param Data Specifies the creation result of the data backfill plan.
     */
    ...
    public CreateDataBackfillPlanResponse() {
    }
    ...
    public CreateDataBackfillPlanResponse(CreateDataBackfillPlanResponse source) {
        if (source.Data != null) {
            this.Data = new CreateDataReplenishmentPlan(source.Data);
        }
