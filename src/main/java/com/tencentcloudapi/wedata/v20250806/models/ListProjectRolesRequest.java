...
public class ListProjectRolesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Fuzzy query for the chinese display name of a role. can only pass one value. 
    ...
    /**
     * Set Fuzzy query for the chinese display name of a role. can only pass one value.
     * @param RoleDisplayName Fuzzy query for the chinese display name of a role. can only pass one value.
     */
