...
public class CreateTriggerTaskConfiguration extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Source data source ID, separated by semicolons, need to pass through DescribeDataSourceWithoutInfo to obtain. 
     * @return SourceServiceId Source data source ID, separated by semicolons, need to pass through DescribeDataSourceWithoutInfo to obtain.
     */
    ...
    /**
     * Set Source data source ID, separated by semicolons, need to pass through DescribeDataSourceWithoutInfo to obtain.
     * @param SourceServiceId Source data source ID, separated by semicolons, need to pass through DescribeDataSourceWithoutInfo to obtain.
     */
    ...
    /**
     * Get Target data source ID, use ; to separate, need to pass through DescribeDataSourceWithoutInfo to obtain. 
     * @return TargetServiceId Target data source ID, use ; to separate, need to pass through DescribeDataSourceWithoutInfo to obtain.
     */
    ...
    /**
     * Set Target data source ID, use ; to separate, need to pass through DescribeDataSourceWithoutInfo to obtain.
     * @param TargetServiceId Target data source ID, use ; to separate, need to pass through DescribeDataSourceWithoutInfo to obtain.
     */
    ...
    public CreateTriggerTaskConfiguration() {
    }
     ...
     */
    public CreateTriggerTaskConfiguration(CreateTriggerTaskConfiguration source) {
