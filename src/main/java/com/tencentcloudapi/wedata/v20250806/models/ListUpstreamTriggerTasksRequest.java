...
public class ListUpstreamTriggerTasksRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get The page number of the requested data. the default value is 1. the value must be equal to or greater than 1. 
     * @return PageSize The page number of the requested data. the default value is 1. the value must be equal to or greater than 1.
     */
    ...
    /**
     * Set The page number of the requested data. the default value is 1. the value must be equal to or greater than 1.
     * @param PageSize The page number of the requested data. the default value is 1. the value must be equal to or greater than 1.
     */
