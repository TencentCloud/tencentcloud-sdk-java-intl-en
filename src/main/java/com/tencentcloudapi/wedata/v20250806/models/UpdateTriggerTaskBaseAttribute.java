...
public class UpdateTriggerTaskBaseAttribute extends AbstractModel {
...
-If the tf_01 folder does not exist, first create this folder (use the CreateTaskFolder api) for the operation to succeed.
    ...
    public UpdateTriggerTaskBaseAttribute() {
    }
     ...
     */
    public UpdateTriggerTaskBaseAttribute(UpdateTriggerTaskBaseAttribute source) {
