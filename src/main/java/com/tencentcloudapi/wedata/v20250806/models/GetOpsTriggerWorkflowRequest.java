...
public class GetOpsTriggerWorkflowRequest extends AbstractModel {
    ...
    */
    ...
    public GetOpsTriggerWorkflowRequest() {
    }
     ...
     */
    public GetOpsTriggerWorkflowRequest(GetOpsTriggerWorkflowRequest source) {
