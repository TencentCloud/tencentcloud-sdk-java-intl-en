...
public class CreateResourceFolderRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Parent folder's absolute path. Example: /wedata/test. Use / to represent the root directory. 
    ...
    /**
     * Set Parent folder's absolute path. Example: /wedata/test. Use / to represent the root directory.
     * @param ParentFolderPath Parent folder's absolute path. Example: /wedata/test. Use / to represent the root directory.
     */
