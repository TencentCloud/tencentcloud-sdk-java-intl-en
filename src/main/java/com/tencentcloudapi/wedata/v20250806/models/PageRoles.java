...
Note: This field may return null, indicating that no valid values can be obtained. 
     * @return Items Role information.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public SystemRole [] getItems() {
        return this.Items;
    }
...
Note: This field may return null, indicating that no valid values can be obtained.
     * @param Items Role information.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public void setItems(SystemRole [] Items) {
        this.Items = Items;
    }
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public PageRoles(PageRoles source) {
        if (source.Items != null) {
            this.Items = new SystemRole[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new SystemRole(source.Items[i]);
            }
        }
