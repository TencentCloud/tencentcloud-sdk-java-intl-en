...
public class ListTenantRolesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Role chinese display name fuzzy query. can only pass one. 
     * @return RoleDisplayName Role chinese display name fuzzy query. can only pass one.
     */
    ...
    /**
     * Set Role chinese display name fuzzy query. can only pass one.
     * @param RoleDisplayName Role chinese display name fuzzy query. can only pass one.
     */
