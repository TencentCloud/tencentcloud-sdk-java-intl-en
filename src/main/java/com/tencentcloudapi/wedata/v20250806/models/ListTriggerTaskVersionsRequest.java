...
public class ListTriggerTaskVersionsRequest extends AbstractModel {
...
Default value: SAVE.
    ...
    */
    ...
    /**
     * Get SAVE version: SAVE.
SUBMIT version: SUBMIT.
Default value: SAVE. 
     * @return TaskVersionType SAVE version: SAVE.
SUBMIT version: SUBMIT.
Default value: SAVE.
     */
    ...
    /**
     * Set SAVE version: SAVE.
SUBMIT version: SUBMIT.
Default value: SAVE.
     * @param TaskVersionType SAVE version: SAVE.
SUBMIT version: SUBMIT.
Default value: SAVE.
     */
    ...
    /**
     * Get The number of requested data pages. the default value is 1. valid values: equal to or greater than 1. 
     * @return PageNumber The number of requested data pages. the default value is 1. valid values: equal to or greater than 1.
     */
    ...
    /**
     * Set The number of requested data pages. the default value is 1. valid values: equal to or greater than 1.
     * @param PageNumber The number of requested data pages. the default value is 1. valid values: equal to or greater than 1.
     */
    ...
    public ListTriggerTaskVersionsRequest() {
    }
     ...
     */
    public ListTriggerTaskVersionsRequest(ListTriggerTaskVersionsRequest source) {
