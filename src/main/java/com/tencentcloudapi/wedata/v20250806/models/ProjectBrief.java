...
public class ProjectBrief extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public void setItems(Project [] Items) {
        this.Items = Items;
    }
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public ProjectBrief(ProjectBrief source) {
        ...
        if (source.Items != null) {
            this.Items = new Project[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new Project(source.Items[i]);
            }
        }
