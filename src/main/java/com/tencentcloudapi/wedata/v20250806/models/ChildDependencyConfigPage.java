...
public class ChildDependencyConfigPage extends AbstractModel {
    ...
    */
    ...
    public ChildDependencyConfigPage() {
    }
     ...
     */
    public ChildDependencyConfigPage(ChildDependencyConfigPage source) {
