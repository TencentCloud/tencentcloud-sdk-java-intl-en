...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public CreateDataSourceResponse(CreateDataSourceResponse source) {
        if (source.Data != null) {
            this.Data = new DataSourceResult(source.Data);
        }
