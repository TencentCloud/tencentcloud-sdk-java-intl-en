...
public class ListTriggerTaskInfo extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
    */
    ...
    @Expose
    private TriggerTaskBaseAttribute [] Items;
...
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public TriggerTaskBaseAttribute [] getItems() {
        return this.Items;
    }
...
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public void setItems(TriggerTaskBaseAttribute [] Items) {
        this.Items = Items;
    }
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public ListTriggerTaskInfo(ListTriggerTaskInfo source) {
        if (source.Items != null) {
            this.Items = new TriggerTaskBaseAttribute[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new TriggerTaskBaseAttribute(source.Items[i]);
            }
        }
