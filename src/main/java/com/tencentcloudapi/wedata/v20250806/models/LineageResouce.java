...
public class LineageResouce extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Get Unique identifier symbol of the lineage node. 
     * @return LineageNodeId Unique identifier symbol of the lineage node.
     */
    ...
    /**
     * Set Unique identifier symbol of the lineage node.
     * @param LineageNodeId Unique identifier symbol of the lineage node.
     */
    public void setLineageNodeId(String LineageNodeId) {
        this.LineageNodeId = LineageNodeId;
    }

    public LineageResouce() {
    }
     ...
     */
    public LineageResouce(LineageResouce source) {
