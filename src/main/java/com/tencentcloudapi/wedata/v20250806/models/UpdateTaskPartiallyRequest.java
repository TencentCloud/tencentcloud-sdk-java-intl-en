...
public class UpdateTaskPartiallyRequest extends AbstractModel {
    ...
    */
    ...
    @Expose
    private UpdateTaskPart NewSetting;
    ...
    */
     ...
     */
    public UpdateTaskPart getNewSetting() {
     ...
     */
    public void setNewSetting(UpdateTaskPart NewSetting) {
    ...
    public UpdateTaskPartiallyRequest() {
    }
     ...
     */
    public UpdateTaskPartiallyRequest(UpdateTaskPartiallyRequest source) {
        ...
        if (source.NewSetting != null) {
            this.NewSetting = new UpdateTaskPart(source.NewSetting);
        }
