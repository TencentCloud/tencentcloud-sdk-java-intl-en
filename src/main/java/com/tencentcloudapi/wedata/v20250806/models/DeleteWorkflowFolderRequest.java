...
public class DeleteWorkflowFolderRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteWorkflowFolderRequest() {
    }
     ...
     */
    public DeleteWorkflowFolderRequest(DeleteWorkflowFolderRequest source) {
