...
public class CreateOpsAlarmRuleResponse extends AbstractModel {
    ...
    */
    @SerializedName("Data")
    @Expose
    private CreateAlarmRuleData Data;
    ...
    */
     ...
     * @return Data Specifies the unique id of the Alarm rule.
     */
     ...
     * @param Data Specifies the unique id of the Alarm rule.
     */
    ...
    public CreateOpsAlarmRuleResponse() {
    }
    ...
    public CreateOpsAlarmRuleResponse(CreateOpsAlarmRuleResponse source) {
        if (source.Data != null) {
            this.Data = new CreateAlarmRuleData(source.Data);
        }
