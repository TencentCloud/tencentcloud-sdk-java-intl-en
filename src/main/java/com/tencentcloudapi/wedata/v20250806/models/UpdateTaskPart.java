...
public class UpdateTaskPart extends AbstractModel {
    ...
    */
    ...
    @Expose
    private UpdateTaskBaseAttributePart TaskBaseAttribute;
    ...
    */
     ...
     */
    public UpdateTaskBaseAttributePart getTaskBaseAttribute() {
        return this.TaskBaseAttribute;
    }

    /**
     * Set Task basic attributes.
     * @param TaskBaseAttribute Task basic attributes.
     */
    public void setTaskBaseAttribute(UpdateTaskBaseAttributePart TaskBaseAttribute) {
     ...
     */
    public UpdateTaskPart(UpdateTaskPart source) {
        if (source.TaskBaseAttribute != null) {
            this.TaskBaseAttribute = new UpdateTaskBaseAttributePart(source.TaskBaseAttribute);
        }
