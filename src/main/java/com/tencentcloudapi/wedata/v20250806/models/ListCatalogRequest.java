...
public class ListCatalogRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Parent directory ID (this parameter is not supported). 
    ...
    /**
     * Set Parent directory ID (this parameter is not supported).
     * @param ParentCatalogId Parent directory ID (this parameter is not supported).
     */
