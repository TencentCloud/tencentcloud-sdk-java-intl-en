...
public class UpdateTriggerTaskPart extends AbstractModel {
    ...
    */
    ...
    @Expose
    private UpdateTriggerTaskBaseAttributePart TriggerTaskBaseAttribute;
    ...
    */
     ...
     */
    public UpdateTriggerTaskBaseAttributePart getTriggerTaskBaseAttribute() {
     ...
     */
    public void setTriggerTaskBaseAttribute(UpdateTriggerTaskBaseAttributePart TriggerTaskBaseAttribute) {
     ...
     */
    public UpdateTriggerTaskPart(UpdateTriggerTaskPart source) {
        if (source.TriggerTaskBaseAttribute != null) {
            this.TriggerTaskBaseAttribute = new UpdateTriggerTaskBaseAttributePart(source.TriggerTaskBaseAttribute);
        }
