...
If the image quality does not meet the requirement, the returned result will prompt that the detected image quality is unsatisfactory.
    ...
    */
    ...
    /**
     * Get List of groups to be searched in. Up to 100 groups are supported. 
     * @return GroupIds List of groups to be searched in. Up to 100 groups are supported.
     */
    ...
    /**
     * Set List of groups to be searched in. Up to 100 groups are supported.
...
If the image quality does not meet the requirement, the returned result will prompt that the detected image quality is unsatisfactory.
    ...
    /**
     * Get In the output parameter `Score`, the result will be returned only if the result value is greater than or equal to the `FaceMatchThreshold` value. Default value: 0. Value range: [0.0,100.0). 
    ...
    /**
     * Set In the output parameter `Score`, the result will be returned only if the result value is greater than or equal to the `FaceMatchThreshold` value. Default value: 0. Value range: [0.0,100.0).
