...
public class DescribeComputeEnvActivitiesResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get List of activities in the compute environment 
    ...
    /**
     * Set List of activities in the compute environment
     ...
     */
    public DescribeComputeEnvActivitiesResponse(DescribeComputeEnvActivitiesResponse source) {
