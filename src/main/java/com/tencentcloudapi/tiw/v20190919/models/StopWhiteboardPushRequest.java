...
public class StopWhiteboardPushRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get ID of the whiteboard push task to be stopped. 
    ...
    /**
     * Set ID of the whiteboard push task to be stopped.
    ...
    public StopWhiteboardPushRequest() {
    }
     ...
     */
    public StopWhiteboardPushRequest(StopWhiteboardPushRequest source) {
