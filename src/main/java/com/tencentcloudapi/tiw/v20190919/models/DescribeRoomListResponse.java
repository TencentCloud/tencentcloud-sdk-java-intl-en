...
public class DescribeRoomListResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get List of rooms of the whiteboard. 
    ...
    /**
     * Set List of rooms of the whiteboard.
     * @param RoomList List of rooms of the whiteboard.
     */
    public void setRoomList(RoomListItem [] RoomList) {
     ...
     */
    public DescribeRoomListResponse(DescribeRoomListResponse source) {
        if (source.RoomList != null) {
            this.RoomList = new RoomListItem[source.RoomList.length];
            for (int i = 0; i < source.RoomList.length; i++) {
                this.RoomList[i] = new RoomListItem(source.RoomList[i]);
            }
        }
