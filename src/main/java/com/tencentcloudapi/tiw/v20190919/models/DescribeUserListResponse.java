...
public class DescribeUserListResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Set User list of the room.
     * @param UserList User list of the room.
     */
    public void setUserList(UserListItem [] UserList) {
     ...
     */
    public DescribeUserListResponse(DescribeUserListResponse source) {
        if (source.UserList != null) {
            this.UserList = new UserListItem[source.UserList.length];
            for (int i = 0; i < source.UserList.length; i++) {
                this.UserList[i] = new UserListItem(source.UserList[i]);
            }
        }
