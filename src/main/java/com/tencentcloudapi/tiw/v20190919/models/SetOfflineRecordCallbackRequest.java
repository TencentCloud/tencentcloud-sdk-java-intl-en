...
public class SetOfflineRecordCallbackRequest extends AbstractModel{
    ...
    */
    ...
    public SetOfflineRecordCallbackRequest() {
    }
     ...
     */
    public SetOfflineRecordCallbackRequest(SetOfflineRecordCallbackRequest source) {
