...
public class CreateSnapshotTaskResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get ID of the whiteboard snapshot task. This parameter is returned only if a task is created successfully. 
    ...
    /**
     * Set ID of the whiteboard snapshot task. This parameter is returned only if a task is created successfully.
     ...
     */
    public CreateSnapshotTaskResponse(CreateSnapshotTaskResponse source) {
