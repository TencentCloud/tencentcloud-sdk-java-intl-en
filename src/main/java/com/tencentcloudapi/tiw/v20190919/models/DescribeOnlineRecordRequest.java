...
public class DescribeOnlineRecordRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeOnlineRecordRequest() {
    }
     ...
     */
    public DescribeOnlineRecordRequest(DescribeOnlineRecordRequest source) {
