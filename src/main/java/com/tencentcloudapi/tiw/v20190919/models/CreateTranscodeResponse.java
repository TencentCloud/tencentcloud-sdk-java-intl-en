...
public class CreateTranscodeResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Unique ID of the document transcoding task, which is used to query the task progress and transcoding result 
    ...
    /**
     * Set Unique ID of the document transcoding task, which is used to query the task progress and transcoding result
    ...
    public CreateTranscodeResponse() {
    }
     ...
     */
    public CreateTranscodeResponse(CreateTranscodeResponse source) {
