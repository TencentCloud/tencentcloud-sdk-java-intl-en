...
public class DescribeApplicationUsageResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Usage data required for drawing charts. 
    ...
    /**
     * Set Usage data required for drawing charts.
     ...
     */
    public DescribeApplicationUsageResponse(DescribeApplicationUsageResponse source) {
        if (source.Data != null) {
