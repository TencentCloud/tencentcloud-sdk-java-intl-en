...
public class DescribeAPIServiceResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Set Response data in JSON format.
     ...
     */
    public DescribeAPIServiceResponse(DescribeAPIServiceResponse source) {
        if (source.ResponseData != null) {
            this.ResponseData = new String(source.ResponseData);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamSimple(map, prefix + "ResponseData", this.ResponseData);
