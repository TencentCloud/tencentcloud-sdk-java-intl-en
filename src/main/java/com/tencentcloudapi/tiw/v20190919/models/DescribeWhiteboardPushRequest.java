...
public class DescribeWhiteboardPushRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeWhiteboardPushRequest() {
    }
     ...
     */
    public DescribeWhiteboardPushRequest(DescribeWhiteboardPushRequest source) {
