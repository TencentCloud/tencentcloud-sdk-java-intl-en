...
public class DescribeInstanceLogDeliveryResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Slow query log shipping information of the instance. 
    ...
    /**
     * Set Slow query log shipping information of the instance.
     * @param SlowLog Slow query log shipping information of the instance.
     */
    public void setSlowLog(LogDeliveryInfo SlowLog) {
     ...
     */
    public DescribeInstanceLogDeliveryResponse(DescribeInstanceLogDeliveryResponse source) {
        if (source.SlowLog != null) {
            this.SlowLog = new LogDeliveryInfo(source.SlowLog);
        }
