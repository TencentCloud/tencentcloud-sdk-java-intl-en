...
public class DescribeAutoBackupConfigRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeAutoBackupConfigRequest() {
    }
     ...
     */
    public DescribeAutoBackupConfigRequest(DescribeAutoBackupConfigRequest source) {
