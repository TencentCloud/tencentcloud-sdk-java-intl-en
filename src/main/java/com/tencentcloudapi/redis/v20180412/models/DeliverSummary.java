...
public class DeliverSummary extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Delivery Type, store (storage class), mq (message channel)</p> 
    ...
    /**
     * Set <p>Delivery Type, store (storage class), mq (message channel)</p>
     * @param DeliverType <p>Delivery Type, store (storage class), mq (message channel)</p>
     */
    ...
    /**
     * Get <p>Delivery subtype: cls, ckafka.</p> 
    ...
    /**
     * Set <p>Delivery subtype: cls, ckafka.</p>
     * @param DeliverSubType <p>Delivery subtype: cls, ckafka.</p>
     */
    ...
    /**
     * Set <p>Subscriber</p>
     * @param DeliverConsumer <p>Subscriber</p>
     */
    ...
    /**
     * Set <p>Subscriber name</p>
     * @param DeliverConsumerName <p>Subscriber name</p>
     */
    ...
    /**
     * Set <p>Delivery</p>
     * @param DeliverError <p>Delivery</p>
     */
