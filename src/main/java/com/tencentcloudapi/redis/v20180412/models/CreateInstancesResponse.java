...
public class CreateInstancesResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Instance ID (this field is during beta test and is not displayed in some regions) 
    ...
    /**
     * Set Instance ID (this field is during beta test and is not displayed in some regions)
