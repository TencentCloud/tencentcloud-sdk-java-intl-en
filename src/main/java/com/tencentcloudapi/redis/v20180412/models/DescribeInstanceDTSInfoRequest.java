...
public class DescribeInstanceDTSInfoRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeInstanceDTSInfoRequest() {
    }
     ...
     */
    public DescribeInstanceDTSInfoRequest(DescribeInstanceDTSInfoRequest source) {
