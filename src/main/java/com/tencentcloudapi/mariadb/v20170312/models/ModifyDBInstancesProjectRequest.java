...
public class ModifyDBInstancesProjectRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get List of IDs of instances to be modified. The ID is in the format of `tdsql-ow728lmc` and can be obtained through the `DescribeDBInstances` API. 
    ...
    /**
     * Set List of IDs of instances to be modified. The ID is in the format of `tdsql-ow728lmc` and can be obtained through the `DescribeDBInstances` API.
