...
public class ModifyDBSyncModeRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get ID of an instance for which to modify the sync mode. The ID is in the format of tdsql-ow728lmc. 
     * @return InstanceId ID of an instance for which to modify the sync mode. The ID is in the format of tdsql-ow728lmc.
     */
    ...
    /**
     * Set ID of an instance for which to modify the sync mode. The ID is in the format of tdsql-ow728lmc.
