...
public class AssociateSecurityGroupsRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get ID(s) of the instance(s) to be associated in the format of tdsql-lesecurk. You can specify multiple instances. 
    ...
    /**
     * Set ID(s) of the instance(s) to be associated in the format of tdsql-lesecurk. You can specify multiple instances.
