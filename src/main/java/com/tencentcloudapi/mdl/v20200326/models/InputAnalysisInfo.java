...
public class InputAnalysisInfo extends AbstractModel {
    ...
    */
     ...
     */
    public InputAnalysisInfo(InputAnalysisInfo source) {
        if (source.HighlightSetting != null) {
            this.HighlightSetting = new HighlightInfo(source.HighlightSetting);
        }
    }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamObj(map, prefix + "HighlightSetting.", this.HighlightSetting);
