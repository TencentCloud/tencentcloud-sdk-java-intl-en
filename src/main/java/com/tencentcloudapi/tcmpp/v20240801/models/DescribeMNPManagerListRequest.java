...
public class DescribeMNPManagerListRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeMNPManagerListRequest() {
    }
     ...
     */
    public DescribeMNPManagerListRequest(DescribeMNPManagerListRequest source) {
