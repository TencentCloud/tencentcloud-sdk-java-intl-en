...
public class CreateOnlineApplyRequest extends AbstractModel {
    ...
    */
    ...
    public CreateOnlineApplyRequest() {
    }
     ...
     */
    public CreateOnlineApplyRequest(CreateOnlineApplyRequest source) {
