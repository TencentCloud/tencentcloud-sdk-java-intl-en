...
public class CreateSensitiveApiApplyRequest extends AbstractModel {
    ...
    */
    ...
    public CreateSensitiveApiApplyRequest() {
    }
     ...
     */
    public CreateSensitiveApiApplyRequest(CreateSensitiveApiApplyRequest source) {
