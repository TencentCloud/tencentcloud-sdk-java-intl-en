...
public class ModifyOnlineVersionRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyOnlineVersionRequest() {
    }
     ...
     */
    public ModifyOnlineVersionRequest(ModifyOnlineVersionRequest source) {
