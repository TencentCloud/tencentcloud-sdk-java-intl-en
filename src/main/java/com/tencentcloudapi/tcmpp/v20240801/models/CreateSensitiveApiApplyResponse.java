...
public class CreateSensitiveApiApplyResponse extends AbstractModel {
    ...
    */
    ...
    public CreateSensitiveApiApplyResponse() {
    }
     ...
     */
    public CreateSensitiveApiApplyResponse(CreateSensitiveApiApplyResponse source) {
        if (source.Data != null) {
