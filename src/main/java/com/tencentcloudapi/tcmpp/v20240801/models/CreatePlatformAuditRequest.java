...
public class CreatePlatformAuditRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get submit - submit the review ticket, cancel - cancel the review ticket 
    ...
    /**
     * Set submit - submit the review ticket, cancel - cancel the review ticket
     * @param ApplyAction submit - submit the review ticket, cancel - cancel the review ticket
     */
    ...
    public CreatePlatformAuditRequest() {
    }
     ...
     */
    public CreatePlatformAuditRequest(CreatePlatformAuditRequest source) {
