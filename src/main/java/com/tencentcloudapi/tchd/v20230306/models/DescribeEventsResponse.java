...
public class DescribeEventsResponse extends AbstractModel {
    ...
    */
     ...
     * @return Data Detailed event information.
     */
    public ProductEventList getData() {
        return this.Data;
    }

    /**
     * Set Detailed event information.
     * @param Data Detailed event information.
     */
    public void setData(ProductEventList Data) {
        this.Data = Data;
    }
    ...
    public DescribeEventsResponse(DescribeEventsResponse source) {
        if (source.Data != null) {
            this.Data = new ProductEventList(source.Data);
        }
