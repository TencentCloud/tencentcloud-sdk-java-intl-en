...
public class AddAclRuleResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get ID list of the added rules, in the same sequence as Rules. 
     * @return RuleUuid ID list of the added rules, in the same sequence as Rules.
     */
    ...
    /**
     * Set ID list of the added rules, in the same sequence as Rules.
     * @param RuleUuid ID list of the added rules, in the same sequence as Rules.
     */
     ...
     */
    public AddAclRuleResponse(AddAclRuleResponse source) {
