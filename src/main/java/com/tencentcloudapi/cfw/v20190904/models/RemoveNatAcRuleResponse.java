...
public class RemoveNatAcRuleResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get UUID list of the deleted rules. 
     * @return RuleUuid UUID list of the deleted rules.
     */
    ...
    /**
     * Set UUID list of the deleted rules.
     ...
     */
    public RemoveNatAcRuleResponse(RemoveNatAcRuleResponse source) {
