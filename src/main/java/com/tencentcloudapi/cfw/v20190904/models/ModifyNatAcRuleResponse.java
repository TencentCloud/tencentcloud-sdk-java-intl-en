...
public class ModifyNatAcRuleResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get ID list of new rules that have been successfully modified. 
    ...
    /**
     * Set ID list of new rules that have been successfully modified.
    ...
    public ModifyNatAcRuleResponse() {
    }
     ...
     */
    public ModifyNatAcRuleResponse(ModifyNatAcRuleResponse source) {
