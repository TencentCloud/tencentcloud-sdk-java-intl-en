...
public class SecurityGroupOrderIndexData extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Current priority of enterprise security group rules 
    ...
    /**
     * Set Current priority of enterprise security group rules
    ...
    /**
     * Get New priority of enterprise security group rules 
    ...
    /**
     * Set New priority of enterprise security group rules
