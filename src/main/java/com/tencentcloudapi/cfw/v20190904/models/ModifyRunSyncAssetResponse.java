...
public class ModifyRunSyncAssetResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 0: synced successfully, 1: updating assets, 2: failed to sync by calling the API at the backend 
    ...
    /**
     * Set 0: synced successfully, 1: updating assets, 2: failed to sync by calling the API at the backend
