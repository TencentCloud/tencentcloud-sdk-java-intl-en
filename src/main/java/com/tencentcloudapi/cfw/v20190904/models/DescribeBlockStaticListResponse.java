...
public class DescribeBlockStaticListResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeBlockStaticListResponse() {
    }
     ...
     */
    public DescribeBlockStaticListResponse(DescribeBlockStaticListResponse source) {
        if (source.Data != null) {
            this.Data = new StaticInfo[source.Data.length];
