...
public class ListAsyncEventsResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Total number of events that meet the filter 
    ...
    /**
     * Set Total number of events that meet the filter
    ...
    /**
     * Set Async event list
     * @param EventList Async event list
     */
    public void setEventList(AsyncEvent [] EventList) {
