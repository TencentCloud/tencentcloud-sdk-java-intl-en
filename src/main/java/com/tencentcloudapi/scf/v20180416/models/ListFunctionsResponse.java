...
public class ListFunctionsResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Function list 
     * @return Functions Function list
     */
     ...
     */
    public ListFunctionsResponse(ListFunctionsResponse source) {
        if (source.Functions != null) {
            this.Functions = new Function[source.Functions.length];
            for (int i = 0; i < source.Functions.length; i++) {
                this.Functions[i] = new Function(source.Functions[i]);
            }
        }
