...
public class DescribeReadOnlyGroupDetailsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Read-only group ID, in the format of mssqlrg-3l3fgqn7. 
    ...
    /**
     * Set Read-only group ID, in the format of mssqlrg-3l3fgqn7.
     * @param ReadOnlyGroupId Read-only group ID, in the format of mssqlrg-3l3fgqn7.
     */
