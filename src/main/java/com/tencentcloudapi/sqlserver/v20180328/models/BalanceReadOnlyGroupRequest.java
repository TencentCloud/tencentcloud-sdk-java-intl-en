...
public class BalanceReadOnlyGroupRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Read-only group ID, in the format of mssqlrg-dj5i29c5n. 
     * @return ReadOnlyGroupId Read-only group ID, in the format of mssqlrg-dj5i29c5n.
     */
    ...
    /**
     * Set Read-only group ID, in the format of mssqlrg-dj5i29c5n.
     * @param ReadOnlyGroupId Read-only group ID, in the format of mssqlrg-dj5i29c5n.
     */
    public void setReadOnlyGroupId(String ReadOnlyGroupId) {
        this.ReadOnlyGroupId = ReadOnlyGroupId;
    }

    public BalanceReadOnlyGroupRequest() {
    }
     ...
     */
    public BalanceReadOnlyGroupRequest(BalanceReadOnlyGroupRequest source) {
