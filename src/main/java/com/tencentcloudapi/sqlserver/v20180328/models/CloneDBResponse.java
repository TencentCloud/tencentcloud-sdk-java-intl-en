...
public class CloneDBResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Async task request ID, which can be used in the `DescribeFlowStatus` API to query the execution result of an async task 
    ...
    /**
     * Set Async task request ID, which can be used in the `DescribeFlowStatus` API to query the execution result of an async task
     ...
     */
    public CloneDBResponse(CloneDBResponse source) {
