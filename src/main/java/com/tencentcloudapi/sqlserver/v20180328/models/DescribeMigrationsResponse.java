...
public class DescribeMigrationsResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeMigrationsResponse() {
    }
     ...
     */
    public DescribeMigrationsResponse(DescribeMigrationsResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.MigrateTaskSet != null) {
            this.MigrateTaskSet = new MigrateTask[source.MigrateTaskSet.length];
            for (int i = 0; i < source.MigrateTaskSet.length; i++) {
                this.MigrateTaskSet[i] = new MigrateTask(source.MigrateTaskSet[i]);
            }
        }
