...
public class ModifyBackupMigrationResponse extends AbstractModel{
    ...
    */
    ...
    public ModifyBackupMigrationResponse() {
    }
     ...
     */
    public ModifyBackupMigrationResponse(ModifyBackupMigrationResponse source) {
