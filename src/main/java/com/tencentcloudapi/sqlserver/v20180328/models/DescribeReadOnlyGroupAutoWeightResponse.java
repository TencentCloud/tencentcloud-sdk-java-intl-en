...
public class DescribeReadOnlyGroupAutoWeightResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get AZ of the read-only group, which is the same as that of the primary instance. 
    ...
    /**
     * Set AZ of the read-only group, which is the same as that of the primary instance.
     * @param ZoneId AZ of the read-only group, which is the same as that of the primary instance.
     */
    ...
    /**
     * Get Whether to enable the delayed read-only instance removal feature. 1 - enabled; 0 - disabled. 
    ...
    /**
     * Set Whether to enable the delayed read-only instance removal feature. 1 - enabled; 0 - disabled.
     * @param IsOfflineDelay Whether to enable the delayed read-only instance removal feature. 1 - enabled; 0 - disabled.
     */
