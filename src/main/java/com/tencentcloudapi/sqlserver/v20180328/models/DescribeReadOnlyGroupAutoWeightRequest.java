...
public class DescribeReadOnlyGroupAutoWeightRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Read-only group ID, in the format of mssqlro-3l3fgqn7. 
    ...
    /**
     * Set Read-only group ID, in the format of mssqlro-3l3fgqn7.
     * @param ReadOnlyGroupId Read-only group ID, in the format of mssqlro-3l3fgqn7.
     */
    public void setReadOnlyGroupId(String ReadOnlyGroupId) {
        this.ReadOnlyGroupId = ReadOnlyGroupId;
    }

    public DescribeReadOnlyGroupAutoWeightRequest() {
    }
     ...
     */
    public DescribeReadOnlyGroupAutoWeightRequest(DescribeReadOnlyGroupAutoWeightRequest source) {
