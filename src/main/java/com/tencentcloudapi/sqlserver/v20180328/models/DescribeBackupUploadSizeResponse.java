...
public class DescribeBackupUploadSizeResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Information of uploaded backups 
    ...
    /**
     * Set Information of uploaded backups
     * @param CosUploadBackupFileSet Information of uploaded backups
     */
    public void setCosUploadBackupFileSet(CosUploadBackupFile [] CosUploadBackupFileSet) {
        this.CosUploadBackupFileSet = CosUploadBackupFileSet;
    }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "CosUploadBackupFileSet.", this.CosUploadBackupFileSet);
