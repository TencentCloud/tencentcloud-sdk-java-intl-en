...
public class RunMigrationResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get After the migration task starts, the flow ID will be returned 
    ...
    /**
     * Set After the migration task starts, the flow ID will be returned
     ...
     */
    public RunMigrationResponse(RunMigrationResponse source) {
