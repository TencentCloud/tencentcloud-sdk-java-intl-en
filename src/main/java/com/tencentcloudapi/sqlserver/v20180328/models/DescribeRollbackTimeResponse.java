...
public class DescribeRollbackTimeResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Information of time range available for database rollback 
    ...
    /**
     * Set Information of time range available for database rollback
     * @param Details Information of time range available for database rollback
     */
    public void setDetails(DbRollbackTimeInfo [] Details) {
     ...
     */
    public DescribeRollbackTimeResponse(DescribeRollbackTimeResponse source) {
        if (source.Details != null) {
            this.Details = new DbRollbackTimeInfo[source.Details.length];
            for (int i = 0; i < source.Details.length; i++) {
                this.Details[i] = new DbRollbackTimeInfo(source.Details[i]);
            }
        }
