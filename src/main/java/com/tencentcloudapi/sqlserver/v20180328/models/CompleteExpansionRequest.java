...
public class CompleteExpansionRequest extends AbstractModel {
    ...
    */
    ...
    public CompleteExpansionRequest() {
    }
     ...
     */
    public CompleteExpansionRequest(CompleteExpansionRequest source) {
