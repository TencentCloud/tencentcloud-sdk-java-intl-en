...
public class ResetAccountPasswordResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get ID of async task flow for account password change 
     * @return FlowId ID of async task flow for account password change
     */
    ...
    /**
     * Set ID of async task flow for account password change
