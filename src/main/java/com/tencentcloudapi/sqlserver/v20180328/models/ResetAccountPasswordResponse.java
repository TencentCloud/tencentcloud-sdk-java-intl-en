...
public class ResetAccountPasswordResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get ID of asynchronous task flow for account password modification 
    ...
    /**
     * Set ID of asynchronous task flow for account password modification
     * @param FlowId ID of asynchronous task flow for account password modification
     */
