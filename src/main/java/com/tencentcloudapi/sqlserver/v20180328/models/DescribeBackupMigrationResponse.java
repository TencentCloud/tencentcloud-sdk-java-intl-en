...
public class DescribeBackupMigrationResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeBackupMigrationResponse() {
    }
     ...
     */
    public DescribeBackupMigrationResponse(DescribeBackupMigrationResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.BackupMigrationSet != null) {
            this.BackupMigrationSet = new Migration[source.BackupMigrationSet.length];
            for (int i = 0; i < source.BackupMigrationSet.length; i++) {
                this.BackupMigrationSet[i] = new Migration(source.BackupMigrationSet[i]);
            }
        }
