...
public class DisassociateSecurityGroupsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Instance ID list, which is an array of one or more instance IDs. Multiple instances should be in the same region, AZ, and project. 
    ...
    /**
     * Set Instance ID list, which is an array of one or more instance IDs. Multiple instances should be in the same region, AZ, and project.
     * @param InstanceIdSet Instance ID list, which is an array of one or more instance IDs. Multiple instances should be in the same region, AZ, and project.
     */
