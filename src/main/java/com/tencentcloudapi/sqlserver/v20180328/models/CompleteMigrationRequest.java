...
public class CompleteMigrationRequest extends AbstractModel {
    ...
    */
    ...
    public CompleteMigrationRequest() {
    }
     ...
     */
    public CompleteMigrationRequest(CompleteMigrationRequest source) {
