...
public class DescribeDBCharsetsRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeDBCharsetsRequest() {
    }
     ...
     */
    public DescribeDBCharsetsRequest(DescribeDBCharsetsRequest source) {
