...
public class DescribeDBsResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Set List of instance databases
     ...
     */
    public DescribeDBsResponse(DescribeDBsResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.DBInstances != null) {
            this.DBInstances = new InstanceDBDetail[source.DBInstances.length];
            for (int i = 0; i < source.DBInstances.length; i++) {
                this.DBInstances[i] = new InstanceDBDetail(source.DBInstances[i]);
            }
        }
