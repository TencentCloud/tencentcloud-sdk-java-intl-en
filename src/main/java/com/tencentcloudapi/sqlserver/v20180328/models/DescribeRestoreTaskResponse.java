...
public class DescribeRestoreTaskResponse extends AbstractModel {
    ...
    */
     ...
     * @return TotalCount Total number of rollback tasks.
     */
     ...
     * @param TotalCount Total number of rollback tasks.
     */
     ...
     * @return Tasks Rollback task record list.
     */
    public RestoreTask [] getTasks() {
        return this.Tasks;
    }

    /**
     * Set Rollback task record list.
     * @param Tasks Rollback task record list.
     */
    ...
    public DescribeRestoreTaskResponse(DescribeRestoreTaskResponse source) {
        ...
        if (source.Tasks != null) {
            this.Tasks = new RestoreTask[source.Tasks.length];
            for (int i = 0; i < source.Tasks.length; i++) {
                this.Tasks[i] = new RestoreTask(source.Tasks[i]);
            }
        }
