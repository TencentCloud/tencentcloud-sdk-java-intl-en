...
public class DescribeDBInstancesResponse extends AbstractModel{
    ...
    */
    ...
    @Expose
    private DBInstance [] DBInstances;
    ...
    */
    ...
    /**
     * Get Total number of eligible instances. If the results are returned in multiple pages, this value will be the number of all eligible instances but not the number of instances returned according to the current values of `Limit` and `Offset` 
    ...
    /**
     * Set Total number of eligible instances. If the results are returned in multiple pages, this value will be the number of all eligible instances but not the number of instances returned according to the current values of `Limit` and `Offset`
     ...
     */
    public DBInstance [] getDBInstances() {
     ...
     */
    public void setDBInstances(DBInstance [] DBInstances) {
    ...
    public DescribeDBInstancesResponse(DescribeDBInstancesResponse source) {
        ...
        if (source.DBInstances != null) {
            this.DBInstances = new DBInstance[source.DBInstances.length];
            for (int i = 0; i < source.DBInstances.length; i++) {
                this.DBInstances[i] = new DBInstance(source.DBInstances[i]);
            }
        }
