...
public class DescribeUploadBackupInfoRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeUploadBackupInfoRequest() {
    }
     ...
     */
    public DescribeUploadBackupInfoRequest(DescribeUploadBackupInfoRequest source) {
