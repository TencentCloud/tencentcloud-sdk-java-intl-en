...
public class DescribeCrossRegionZoneRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeCrossRegionZoneRequest() {
    }
     ...
     */
    public DescribeCrossRegionZoneRequest(DescribeCrossRegionZoneRequest source) {
