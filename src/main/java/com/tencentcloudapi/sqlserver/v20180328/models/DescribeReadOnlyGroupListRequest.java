...
public class DescribeReadOnlyGroupListRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeReadOnlyGroupListRequest() {
    }
     ...
     */
    public DescribeReadOnlyGroupListRequest(DescribeReadOnlyGroupListRequest source) {
