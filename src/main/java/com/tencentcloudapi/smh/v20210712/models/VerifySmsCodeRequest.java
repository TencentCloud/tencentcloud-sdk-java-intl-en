...
public class VerifySmsCodeRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Captcha target, currently supported: rebind super administrator account, BindSuperAdmin; trial version business upgrade verification, ChannelUpdateVerify. 
    ...
    /**
     * Set Captcha target, currently supported: rebind super administrator account, BindSuperAdmin; trial version business upgrade verification, ChannelUpdateVerify.
     * @param Purpose Captcha target, currently supported: rebind super administrator account, BindSuperAdmin; trial version business upgrade verification, ChannelUpdateVerify.
     */
    ...
    /**
     * Get Specifies the sms verification code. 
    ...
    /**
     * Set Specifies the sms verification code.
     * @param Code Specifies the sms verification code.
     */
