...
public class DescribeTrafficPackagesResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setList(TrafficPackage [] List) {
        this.List = List;
    }
    ...
    public DescribeTrafficPackagesResponse(DescribeTrafficPackagesResponse source) {
        if (source.List != null) {
            this.List = new TrafficPackage[source.List.length];
            for (int i = 0; i < source.List.length; i++) {
                this.List[i] = new TrafficPackage(source.List[i]);
            }
        }
