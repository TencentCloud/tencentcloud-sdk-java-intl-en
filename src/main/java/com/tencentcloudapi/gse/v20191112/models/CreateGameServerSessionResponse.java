...
public class CreateGameServerSessionResponse extends AbstractModel{
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    public CreateGameServerSessionResponse() {
    }
     ...
     */
    public CreateGameServerSessionResponse(CreateGameServerSessionResponse source) {
