...
public class CreateRuleResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get The ID of the successfully created forwarding rule 
    ...
    /**
     * Set The ID of the successfully created forwarding rule
     ...
     */
    public CreateRuleResponse(CreateRuleResponse source) {
