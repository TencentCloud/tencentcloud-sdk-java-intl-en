...
public class DescribeUDPListenersResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeUDPListenersResponse() {
    }
     ...
     */
    public DescribeUDPListenersResponse(DescribeUDPListenersResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.ListenerSet != null) {
            this.ListenerSet = new UDPListener[source.ListenerSet.length];
            for (int i = 0; i < source.ListenerSet.length; i++) {
                this.ListenerSet[i] = new UDPListener(source.ListenerSet[i]);
            }
        }
