...
public class CloseProxiesResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Only the running connection instance ID lists can be enabled. 
    ...
    /**
     * Set Only the running connection instance ID lists can be enabled.
     ...
     */
    public CloseProxiesResponse(CloseProxiesResponse source) {
