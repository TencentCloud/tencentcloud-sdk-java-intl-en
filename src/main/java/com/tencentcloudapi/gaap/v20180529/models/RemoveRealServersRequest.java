...
public class RemoveRealServersRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get List of origin server IDs 
     * @return RealServerIds List of origin server IDs
     */
    ...
    public RemoveRealServersRequest() {
    }
     ...
     */
    public RemoveRealServersRequest(RemoveRealServersRequest source) {
