...
public class DescribeCertificateDetailResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeCertificateDetailResponse(DescribeCertificateDetailResponse source) {
        if (source.CertificateDetail != null) {
            this.CertificateDetail = new CertificateDetail(source.CertificateDetail);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamObj(map, prefix + "CertificateDetail.", this.CertificateDetail);
