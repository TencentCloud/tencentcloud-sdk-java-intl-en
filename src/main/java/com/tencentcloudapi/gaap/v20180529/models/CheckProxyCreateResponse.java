...
public class CheckProxyCreateResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Queries whether a connection with the specified configuration can be created. 1: yes; 0: no. 
    ...
    /**
     * Set Queries whether a connection with the specified configuration can be created. 1: yes; 0: no.
    ...
    public CheckProxyCreateResponse() {
    }
     ...
     */
    public CheckProxyCreateResponse(CheckProxyCreateResponse source) {
