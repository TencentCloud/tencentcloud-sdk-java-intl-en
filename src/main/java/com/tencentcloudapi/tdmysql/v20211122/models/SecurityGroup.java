...
public class SecurityGroup extends AbstractModel {
    ...
    */
    ...
    /**
     * Get CreationTime, time format: yyyy-mm-dd hh:mm:ss. 
     * @return CreateTime CreationTime, time format: yyyy-mm-dd hh:mm:ss.
     */
    ...
    /**
     * Set CreationTime, time format: yyyy-mm-dd hh:mm:ss.
     * @param CreateTime CreationTime, time format: yyyy-mm-dd hh:mm:ss.
     */
