...
public class ConstraintRange extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Specifies the maximum value when the constraint type is section. 
     * @return Max Specifies the maximum value when the constraint type is section.
     */
    ...
    /**
     * Set Specifies the maximum value when the constraint type is section.
     * @param Max Specifies the maximum value when the constraint type is section.
     */
