...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    */
     ...
     * Get Log details.
Note: This field may return null, indicating that no valid values can be obtained. 
     * @return Items Log details.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public SlowLogData [] getItems() {
        return this.Items;
    }
     ...
     * Set Log details.
Note: This field may return null, indicating that no valid values can be obtained.
     * @param Items Log details.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public void setItems(SlowLogData [] Items) {
        this.Items = Items;
    }
    ...
    public DescribeSlowLogsResponse(DescribeSlowLogsResponse source) {
        ...
        if (source.Items != null) {
            this.Items = new SlowLogData[source.Items.length];
            for (int i = 0; i < source.Items.length; i++) {
                this.Items[i] = new SlowLogData(source.Items[i]);
            }
        }
