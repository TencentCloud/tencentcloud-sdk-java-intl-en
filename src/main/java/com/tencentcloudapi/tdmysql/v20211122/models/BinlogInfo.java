...
public class BinlogInfo extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Unique ID of the log service 
    ...
    /**
     * Set Unique ID of the log service
     * @param Sid Unique ID of the log service
     */
    ...
    /**
     * Set Log service type
     * @param Type Log service type
     */
    ...
    /**
     * Set Unique ID of the instance
     * @param InstanceId Unique ID of the instance
     */
