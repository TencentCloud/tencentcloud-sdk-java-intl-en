...
public class SecurityGroupBound extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Network protocol, supports UDP, TCP. 
     * @return IpProtocol Network protocol, supports UDP, TCP.
     */
    ...
    /**
     * Set Network protocol, supports UDP, TCP.
     * @param IpProtocol Network protocol, supports UDP, TCP.
     */
