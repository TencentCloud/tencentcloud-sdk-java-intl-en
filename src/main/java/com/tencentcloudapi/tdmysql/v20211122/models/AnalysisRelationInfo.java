...
public class AnalysisRelationInfo extends AbstractModel {
    ...
    */
     ...
     * @param PrimaryInstanceId <p>Source instance Id</p>
     */
    ...
    /**
     * Get <p>Analysis engine instance Id</p> 
    ...
    /**
     * Set <p>Analysis engine instance Id</p>
     * @param AnalysisInstanceId <p>Analysis engine instance Id</p>
     */
    ...
    /**
     * Get <p>Analysis engine relationship status</p><p>Enumeration values:</p><ul><li>creating: Creating</li><li>running: Running</li><li>destroyed: Terminated</li></ul> 
    ...
    /**
     * Set <p>Analysis engine relationship status</p><p>Enumeration values:</p><ul><li>creating: Creating</li><li>running: Running</li><li>destroyed: Terminated</li></ul>
     * @param Status <p>Analysis engine relationship status</p><p>Enumeration values:</p><ul><li>creating: Creating</li><li>running: Running</li><li>destroyed: Terminated</li></ul>
     */
     ...
     * @param CreateAt <p>Creation time.</p>
     */
    ...
    /**
     * Set <p>Update time.</p>
     * @param UpdateAt <p>Update time.</p>
     */
