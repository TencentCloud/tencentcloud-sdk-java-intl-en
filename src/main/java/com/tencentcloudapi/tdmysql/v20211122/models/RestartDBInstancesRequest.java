...
public class RestartDBInstancesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Array of instance IDs that must be restarted</p> 
    ...
    /**
     * Set <p>Array of instance IDs that must be restarted</p>
     * @param InstanceIds <p>Array of instance IDs that must be restarted</p>
     */
    ...
    /**
     * Get <p>Restart time. Leave it blank to restart now.</p> 
    ...
    /**
     * Set <p>Restart time. Leave it blank to restart now.</p>
     * @param RestartTime <p>Restart time. Leave it blank to restart now.</p>
     */
