...
public class DescribeDatabasesResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Passthrough instance ID</p> 
     * @return InstanceId <p>Passthrough instance ID</p>
     */
    ...
    /**
     * Set <p>Passthrough instance ID</p>
     * @param InstanceId <p>Passthrough instance ID</p>
     */
    ...
    /**
     * Get <p>The database list on the instance.</p> 
     * @return Databases <p>The database list on the instance.</p>
     */
    ...
    /**
     * Set <p>The database list on the instance.</p>
     * @param Databases <p>The database list on the instance.</p>
     */
