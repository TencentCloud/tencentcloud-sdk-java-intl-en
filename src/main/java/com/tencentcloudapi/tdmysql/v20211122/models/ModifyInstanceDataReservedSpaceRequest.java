...
public class ModifyInstanceDataReservedSpaceRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Target reserved space size to modify</p><p>Unit: GB</p> 
     * @return ReservedSpaceGB <p>Target reserved space size to modify</p><p>Unit: GB</p>
     */
    ...
    /**
     * Set <p>Target reserved space size to modify</p><p>Unit: GB</p>
     * @param ReservedSpaceGB <p>Target reserved space size to modify</p><p>Unit: GB</p>
     */
