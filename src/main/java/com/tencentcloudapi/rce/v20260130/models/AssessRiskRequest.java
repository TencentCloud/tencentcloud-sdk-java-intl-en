...
public class AssessRiskRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Client IP address (IPv4 or IPv6)</p> 
    ...
    /**
     * Set <p>Client IP address (IPv4 or IPv6)</p>
     * @param UserIp <p>Client IP address (IPv4 or IPv6)</p>
     */
    ...
    /**
     * Get <p>Event details. The event information is imported based on the event code you input.</p> 
    ...
    /**
     * Set <p>Event details. The event information is imported based on the event code you input.</p>
     * @param EventDetail <p>Event details. The event information is imported based on the event code you input.</p>
     */
     ...
     */
    public AssessRiskRequest(AssessRiskRequest source) {
