...
public class AddPromotionEvent extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>The coupon associated with the promotion</p> 
     * @return Coupon <p>The coupon associated with the promotion</p>
     */
    ...
    /**
     * Set <p>The coupon associated with the promotion</p>
     * @param Coupon <p>The coupon associated with the promotion</p>
     */
    ...
    /**
     * Get <p>The point associated with the promotion</p> 
     * @return Point <p>The point associated with the promotion</p>
     */
    public CreditPoint getPoint() {
        return this.Point;
    }

    /**
     * Set <p>The point associated with the promotion</p>
     * @param Point <p>The point associated with the promotion</p>
     */
    public void setPoint(CreditPoint Point) {
        this.Point = Point;
    }

    /**
     * Get <p>The result of participating the promotion</p> 
     * @return Result <p>The result of participating the promotion</p>
     */
    ...
    /**
     * Set <p>The result of participating the promotion</p>
     * @param Result <p>The result of participating the promotion</p>
     */
    ...
    /**
     * Get <p>The custom parameters agreed with RCE. An array of objects in K:V format. e.g.[{"Key": "ApproverName", "Value": "bob"},{"Key":"ApproverPhone","Value": "+86131***85678"}]</p> 
     * @return Cust <p>The custom parameters agreed with RCE. An array of objects in K:V format. e.g.[{"Key": "ApproverName", "Value": "bob"},{"Key":"ApproverPhone","Value": "+86131***85678"}]</p>
     */
    public Cust [] getCust() {
        return this.Cust;
    }
    ...
    /**
     * Set <p>The custom parameters agreed with RCE. An array of objects in K:V format. e.g.[{"Key": "ApproverName", "Value": "bob"},{"Key":"ApproverPhone","Value": "+86131***85678"}]</p>
     * @param Cust <p>The custom parameters agreed with RCE. An array of objects in K:V format. e.g.[{"Key": "ApproverName", "Value": "bob"},{"Key":"ApproverPhone","Value": "+86131***85678"}]</p>
     */
    public void setCust(Cust [] Cust) {
        this.Cust = Cust;
    }

    public AddPromotionEvent() {
    }
     ...
     */
    public AddPromotionEvent(AddPromotionEvent source) {
        ...
        if (source.Point != null) {
            this.Point = new CreditPoint(source.Point);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamObj(map, prefix + "Point.", this.Point);
