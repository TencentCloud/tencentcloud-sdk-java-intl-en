...
public class Environment extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>The geographical location of the IP address</p> 
    ...
    /**
     * Set <p>The geographical location of the IP address</p>
     * @param Location <p>The geographical location of the IP address</p>
     */
    ...
    /**
     * Get <p>The basic IP network information</p> 
    ...
    /**
     * Set <p>The basic IP network information</p>
     * @param Network <p>The basic IP network information</p>
     */
