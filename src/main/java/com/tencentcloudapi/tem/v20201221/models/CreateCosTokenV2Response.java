...
public class CreateCosTokenV2Response extends AbstractModel{
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    */
    ...
    /**
     * Get `CosToken` object in case of success and `null` in case of failure
Note: this field may return null, indicating that no valid values can be obtained. 
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Set `CosToken` object in case of success and `null` in case of failure
Note: this field may return null, indicating that no valid values can be obtained.
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    public CreateCosTokenV2Response() {
    }
     ...
     */
    public CreateCosTokenV2Response(CreateCosTokenV2Response source) {
