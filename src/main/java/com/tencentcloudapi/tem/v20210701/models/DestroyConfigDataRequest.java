...
public class DestroyConfigDataRequest extends AbstractModel{
    ...
    */
    ...
    public DestroyConfigDataRequest() {
    }
     ...
     */
    public DestroyConfigDataRequest(DestroyConfigDataRequest source) {
