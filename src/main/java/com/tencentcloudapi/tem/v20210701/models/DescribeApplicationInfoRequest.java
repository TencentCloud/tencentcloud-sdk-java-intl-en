...
public class DescribeApplicationInfoRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeApplicationInfoRequest() {
    }
     ...
     */
    public DescribeApplicationInfoRequest(DescribeApplicationInfoRequest source) {
