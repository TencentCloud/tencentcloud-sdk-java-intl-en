...
public class DescribeConfigDataRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeConfigDataRequest() {
    }
     ...
     */
    public DescribeConfigDataRequest(DescribeConfigDataRequest source) {
