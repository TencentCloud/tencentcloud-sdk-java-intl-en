...
public class L3ConnInfo extends AbstractModel {
    ...
    */
    ...
    /**
     * Set interworking device ID
     * @param DeviceId1 interworking device ID
     */
    ...
    /**
     * Set Interconnection rule CIDR
     * @param Cidr1 Interconnection rule CIDR
     */
    ...
    /**
     * Set interworking device ID
     * @param DeviceId2 interworking device ID
     */
    ...
    /**
     * Set Interconnection rule CIDR
     * @param Cidr2 Interconnection rule CIDR
     */
    ...
    /**
     * Get Interconnection rule description 
    ...
    /**
     * Set Interconnection rule description
     * @param Description Interconnection rule description
     */
