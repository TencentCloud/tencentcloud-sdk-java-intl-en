...
public class GetFlowStatisticRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Device ID list. Used for querying traffic volume across devices. When this field is enabled, DeviceId can be "-1". 
     * @return DeviceList Device ID list. Used for querying traffic volume across devices. When this field is enabled, DeviceId can be "-1".
     */
    ...
    /**
     * Set Device ID list. Used for querying traffic volume across devices. When this field is enabled, DeviceId can be "-1".
     * @param DeviceList Device ID list. Used for querying traffic volume across devices. When this field is enabled, DeviceId can be "-1".
     */
