...
public class GroupDeleteDeviceRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Set Device list to be deleted
     * @param DeviceList Device list to be deleted
     */
     ...
     */
    public GroupDeleteDeviceRequest(GroupDeleteDeviceRequest source) {
