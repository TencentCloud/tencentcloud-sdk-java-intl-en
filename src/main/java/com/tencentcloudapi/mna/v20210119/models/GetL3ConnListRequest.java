...
public class GetL3ConnListRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Search for groups by DeviceId. Match all groups when empty. 
    ...
    /**
     * Set Search for groups by DeviceId. Match all groups when empty.
     * @param DeviceId Search for groups by DeviceId. Match all groups when empty.
     */
