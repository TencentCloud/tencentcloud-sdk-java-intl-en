...
public class DownloadActiveDeviceCountRequest extends AbstractModel {
    ...
    */
    ...
    public DownloadActiveDeviceCountRequest() {
    }
     ...
     */
    public DownloadActiveDeviceCountRequest(DownloadActiveDeviceCountRequest source) {
