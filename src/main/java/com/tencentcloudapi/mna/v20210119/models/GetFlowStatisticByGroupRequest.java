...
public class GetFlowStatisticByGroupRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Application ID. No need to use when querying group traffic. When querying application traffic, this field is the application ID. Fill "-1" for GroupId. 
     * @return MpApplicationId Application ID. No need to use when querying group traffic. When querying application traffic, this field is the application ID. Fill "-1" for GroupId.
     */
    ...
    /**
     * Set Application ID. No need to use when querying group traffic. When querying application traffic, this field is the application ID. Fill "-1" for GroupId.
     * @param MpApplicationId Application ID. No need to use when querying group traffic. When querying application traffic, this field is the application ID. Fill "-1" for GroupId.
     */
