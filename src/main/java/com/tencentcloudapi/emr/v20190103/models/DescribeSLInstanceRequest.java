...
public class DescribeSLInstanceRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeSLInstanceRequest() {
    }
     ...
     */
    public DescribeSLInstanceRequest(DescribeSLInstanceRequest source) {
