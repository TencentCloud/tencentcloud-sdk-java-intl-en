...
public class CreateSLInstanceResponse extends AbstractModel {
    ...
    */
    ...
    public CreateSLInstanceResponse() {
    }
     ...
     */
    public CreateSLInstanceResponse(CreateSLInstanceResponse source) {
