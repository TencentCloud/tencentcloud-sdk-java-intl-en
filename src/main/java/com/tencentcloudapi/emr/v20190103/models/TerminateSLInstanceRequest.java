...
public class TerminateSLInstanceRequest extends AbstractModel {
    ...
    */
    ...
    public TerminateSLInstanceRequest() {
    }
     ...
     */
    public TerminateSLInstanceRequest(TerminateSLInstanceRequest source) {
