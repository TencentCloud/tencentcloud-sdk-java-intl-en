...
The period queried per request cannot be longer than 31 days.
    ...
    /**
     * Get Whether to query single-stream or mixed-stream recording. Valid values: `single`, `multi`. 
     * @return MixType Whether to query single-stream or mixed-stream recording. Valid values: `single`, `multi`.
     */
    ...
    /**
     * Set Whether to query single-stream or mixed-stream recording. Valid values: `single`, `multi`.
