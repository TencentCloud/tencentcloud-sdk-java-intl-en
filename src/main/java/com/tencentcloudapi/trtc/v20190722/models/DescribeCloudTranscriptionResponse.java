...
- Exited: Indicates the current transcription task is in the process of exiting.
    ...
    */
    ...
    /**
     * Get Time of starting the transcription task. 
    ...
    /**
     * Set Time of starting the transcription task.
     * @param StartTime Time of starting the transcription task.
     */
...
- Exited: Indicates the current transcription task is in the process of exiting.
    ...
    /**
     * Set Transcription task status. 

- Idle: Indicates the current transcription task is idle. 
- InProgress: Indicates the current transcription task is in progress. 
- Exited: Indicates the current transcription task is in the process of exiting.
     * @param Status Transcription task status. 
...
- Exited: Indicates the current transcription task is in the process of exiting.
    ...
    /**
     * Get Unique Id of the transcribe task. 
    ...
    /**
     * Set Unique Id of the transcribe task.
     * @param TaskId Unique Id of the transcribe task.
     */
