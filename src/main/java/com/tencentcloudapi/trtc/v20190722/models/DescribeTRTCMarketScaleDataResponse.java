...
public class DescribeTRTCMarketScaleDataResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeTRTCMarketScaleDataResponse() {
    }
     ...
     */
    public DescribeTRTCMarketScaleDataResponse(DescribeTRTCMarketScaleDataResponse source) {
        if (source.Data != null) {
