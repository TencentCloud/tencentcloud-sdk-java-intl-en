...
2: Video streams only
    ...
    /**
     * Get The format of recording files. 0 (default): HLS; 1: HLS + MP4 (recorded in HLS and converted to MP4). 
    ...
    /**
     * Set The format of recording files. 0 (default): HLS; 1: HLS + MP4 (recorded in HLS and converted to MP4).
