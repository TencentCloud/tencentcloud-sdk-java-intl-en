...
public class DeleteCloudRecordingResponse extends AbstractModel{
    ...
    */
    ...
    public DeleteCloudRecordingResponse() {
    }
     ...
     */
    public DeleteCloudRecordingResponse(DeleteCloudRecordingResponse source) {
