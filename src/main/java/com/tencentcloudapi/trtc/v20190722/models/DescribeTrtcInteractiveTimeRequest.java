...
public class DescribeTrtcInteractiveTimeRequest extends AbstractModel{
...
The period queried in a request cannot be longer than 31 days.
    ...
    public DescribeTrtcInteractiveTimeRequest() {
    }
     ...
     */
    public DescribeTrtcInteractiveTimeRequest(DescribeTrtcInteractiveTimeRequest source) {
