...
public class DeleteCloudRecordingRequest extends AbstractModel{
    ...
    */
    ...
    public DeleteCloudRecordingRequest() {
    }
     ...
     */
    public DeleteCloudRecordingRequest(DeleteCloudRecordingRequest source) {
