...
public class ModifyCloudRecordingResponse extends AbstractModel{
    ...
    */
    ...
    public ModifyCloudRecordingResponse() {
    }
     ...
     */
    public ModifyCloudRecordingResponse(ModifyCloudRecordingResponse source) {
