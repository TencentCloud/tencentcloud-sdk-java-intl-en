...
public class DescribeListIPAlarmConfigResponse extends AbstractModel{
    ...
    */
    ...
    @Expose
    private IPAlarmThresholdRelation [] ConfigList;
    ...
    */
     ...
     */
    public IPAlarmThresholdRelation [] getConfigList() {
     ...
     */
    public void setConfigList(IPAlarmThresholdRelation [] ConfigList) {
    ...
    public DescribeListIPAlarmConfigResponse() {
    }
     ...
     */
    public DescribeListIPAlarmConfigResponse(DescribeListIPAlarmConfigResponse source) {
        if (source.Total != null) {
            this.Total = new Long(source.Total);
        }
        if (source.ConfigList != null) {
            this.ConfigList = new IPAlarmThresholdRelation[source.ConfigList.length];
            for (int i = 0; i < source.ConfigList.length; i++) {
                this.ConfigList[i] = new IPAlarmThresholdRelation(source.ConfigList[i]);
            }
        }
