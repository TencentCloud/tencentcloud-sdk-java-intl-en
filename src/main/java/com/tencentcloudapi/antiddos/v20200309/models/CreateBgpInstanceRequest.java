...
public class CreateBgpInstanceRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Payment type: payment mode: PREPAID (prepayment) POSTPAID_BY_MONTH (pay-as-you-go). 
     * @return InstanceChargeType Payment type: payment mode: PREPAID (prepayment) POSTPAID_BY_MONTH (pay-as-you-go).
     */
    ...
    /**
     * Set Payment type: payment mode: PREPAID (prepayment) POSTPAID_BY_MONTH (pay-as-you-go).
     * @param InstanceChargeType Payment type: payment mode: PREPAID (prepayment) POSTPAID_BY_MONTH (pay-as-you-go).
     */
    ...
    /**
     * Get High-Protection package type: specifies the high-protection package type. valid values: Enterprise (Enterprise edition), Standard (Standard version), StandardPlus (Standard version 2.0). 
     * @return PackageType High-Protection package type: specifies the high-protection package type. valid values: Enterprise (Enterprise edition), Standard (Standard version), StandardPlus (Standard version 2.0).
     */
    ...
    /**
     * Set High-Protection package type: specifies the high-protection package type. valid values: Enterprise (Enterprise edition), Standard (Standard version), StandardPlus (Standard version 2.0).
     * @param PackageType High-Protection package type: specifies the high-protection package type. valid values: Enterprise (Enterprise edition), Standard (Standard version), StandardPlus (Standard version 2.0).
     */
    ...
    /**
     * Get Specifies the number of anti-ddos packages to purchase. valid values: one-time purchase of no more than 10. 
     * @return InstanceCount Specifies the number of anti-ddos packages to purchase. valid values: one-time purchase of no more than 10.
     */
    ...
    /**
     * Set Specifies the number of anti-ddos packages to purchase. valid values: one-time purchase of no more than 10.
     * @param InstanceCount Specifies the number of anti-ddos packages to purchase. valid values: one-time purchase of no more than 10.
     */
    ...
    /**
     * Get false by default. true indicates to perform parameter validation only without actual purchase. 
     * @return DryRun false by default. true indicates to perform parameter validation only without actual purchase.
     */
    ...
    /**
     * Set false by default. true indicates to perform parameter validation only without actual purchase.
     * @param DryRun false by default. true indicates to perform parameter validation only without actual purchase.
     */
