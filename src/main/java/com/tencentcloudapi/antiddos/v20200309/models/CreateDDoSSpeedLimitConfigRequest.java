...
public class CreateDDoSSpeedLimitConfigRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Access rate limit configuration. The configuration ID should be cleared when you set this parameter. 
    ...
    /**
     * Set Access rate limit configuration. The configuration ID should be cleared when you set this parameter.
    ...
    public CreateDDoSSpeedLimitConfigRequest() {
    }
     ...
     */
    public CreateDDoSSpeedLimitConfigRequest(CreateDDoSSpeedLimitConfigRequest source) {
