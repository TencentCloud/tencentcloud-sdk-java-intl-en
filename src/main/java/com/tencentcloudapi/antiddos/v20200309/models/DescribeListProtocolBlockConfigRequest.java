...
public class DescribeListProtocolBlockConfigRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeListProtocolBlockConfigRequest() {
    }
     ...
     */
    public DescribeListProtocolBlockConfigRequest(DescribeListProtocolBlockConfigRequest source) {
