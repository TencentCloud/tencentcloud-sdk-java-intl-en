...
public class DescribeListDDoSAIRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeListDDoSAIRequest() {
    }
     ...
     */
    public DescribeListDDoSAIRequest(DescribeListDDoSAIRequest source) {
