...
public class DescribeListDDoSAIResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get List of AI protection switches 
     * @return ConfigList List of AI protection switches
     */
    ...
    /**
     * Set List of AI protection switches
     * @param ConfigList List of AI protection switches
     */
    public void setConfigList(DDoSAIRelation [] ConfigList) {
     ...
     */
    public DescribeListDDoSAIResponse(DescribeListDDoSAIResponse source) {
        if (source.Total != null) {
            this.Total = new Long(source.Total);
        }
        if (source.ConfigList != null) {
            this.ConfigList = new DDoSAIRelation[source.ConfigList.length];
            for (int i = 0; i < source.ConfigList.length; i++) {
                this.ConfigList[i] = new DDoSAIRelation(source.ConfigList[i]);
            }
        }
