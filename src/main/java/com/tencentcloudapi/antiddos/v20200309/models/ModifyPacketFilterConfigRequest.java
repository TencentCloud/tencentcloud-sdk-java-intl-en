...
public class ModifyPacketFilterConfigRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyPacketFilterConfigRequest() {
    }
     ...
     */
    public ModifyPacketFilterConfigRequest(ModifyPacketFilterConfigRequest source) {
