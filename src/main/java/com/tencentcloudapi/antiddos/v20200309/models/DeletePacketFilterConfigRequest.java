...
public class DeletePacketFilterConfigRequest extends AbstractModel {
    ...
    */
    ...
    public DeletePacketFilterConfigRequest() {
    }
     ...
     */
    public DeletePacketFilterConfigRequest(DeletePacketFilterConfigRequest source) {
