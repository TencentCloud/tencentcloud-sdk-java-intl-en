...
public class DescribeListSchedulingDomainResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private SchedulingDomainInfo [] DomainList;
    ...
    */
     ...
     */
    public SchedulingDomainInfo [] getDomainList() {
    ...
    public DescribeListSchedulingDomainResponse() {
    }
    ...
    public DescribeListSchedulingDomainResponse(DescribeListSchedulingDomainResponse source) {
        ...
        if (source.DomainList != null) {
            this.DomainList = new SchedulingDomainInfo[source.DomainList.length];
            for (int i = 0; i < source.DomainList.length; i++) {
                this.DomainList[i] = new SchedulingDomainInfo(source.DomainList[i]);
            }
        }
