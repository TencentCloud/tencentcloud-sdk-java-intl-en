...
public class ListCosEnableRegionResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private CosRegionInfo [] EnableRegions;
    ...
    */
    ...
    /**
     * Get CloudAudit-enabled COS AZs 
    ...
    /**
     * Set CloudAudit-enabled COS AZs
    ...
    public ListCosEnableRegionResponse() {
    }
     ...
     */
    public ListCosEnableRegionResponse(ListCosEnableRegionResponse source) {
        if (source.EnableRegions != null) {
            this.EnableRegions = new CosRegionInfo[source.EnableRegions.length];
            for (int i = 0; i < source.EnableRegions.length; i++) {
                this.EnableRegions[i] = new CosRegionInfo(source.EnableRegions[i]);
            }
        }
