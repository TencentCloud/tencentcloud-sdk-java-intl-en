...
public class InquireAuditCreditResponse extends AbstractModel {
    ...
    */
    ...
    public InquireAuditCreditResponse() {
    }
     ...
     */
    public InquireAuditCreditResponse(InquireAuditCreditResponse source) {
        if (source.AuditAmount != null) {
            this.AuditAmount = new Long(source.AuditAmount);
        }
