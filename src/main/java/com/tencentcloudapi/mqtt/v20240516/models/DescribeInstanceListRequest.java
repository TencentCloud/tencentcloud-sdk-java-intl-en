...
Note: The query condition is not effective when TagFilters is configured.
    ...
    */
    ...
    /**
     * Get Query criteria list, support the following fields
InstanceName: Fuzzy search for cluster name
InstanceId: Cluster id for exact search
InstanceStatus: Cluster status search (RUNNING - running, CREATING - creating, MODIFYING - modifying, DELETING - deleting)
Note: The query condition is not effective when TagFilters is configured. 
...
Note: The query condition is not effective when TagFilters is configured.
    ...
    /**
     * Set Query criteria list, support the following fields
InstanceName: Fuzzy search for cluster name
InstanceId: Cluster id for exact search
InstanceStatus: Cluster status search (RUNNING - running, CREATING - creating, MODIFYING - modifying, DELETING - deleting)
Note: The query condition is not effective when TagFilters is configured.
     * @param Filters Query criteria list, support the following fields
InstanceName: Fuzzy search for cluster name
InstanceId: Cluster id for exact search
InstanceStatus: Cluster status search (RUNNING - running, CREATING - creating, MODIFYING - modifying, DELETING - deleting)
Note: The query condition is not effective when TagFilters is configured.
    ...
    /**
     * Get Query start position, default 0 
    ...
    /**
     * Set Query start position, default 0
     * @param Offset Query start position, default 0
     */
    ...
    /**
     * Get Query result limit count. Default 20. Maximum 100. 
    ...
    /**
     * Set Query result limit count. Default 20. Maximum 100.
     * @param Limit Query result limit count. Default 20. Maximum 100.
     */
