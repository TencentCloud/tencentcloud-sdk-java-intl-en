...
public class DescribeUserListResponse extends AbstractModel {
    ...
    */
     ...
     * @return Data Role information list
     */
    ...
    /**
     * Set Role information list
     * @param Data Role information list
     */
    public void setData(MQTTUserItem [] Data) {
        this.Data = Data;
    }
    ...
    public DescribeUserListResponse(DescribeUserListResponse source) {
        ...
        if (source.Data != null) {
            this.Data = new MQTTUserItem[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new MQTTUserItem(source.Data[i]);
            }
        }
