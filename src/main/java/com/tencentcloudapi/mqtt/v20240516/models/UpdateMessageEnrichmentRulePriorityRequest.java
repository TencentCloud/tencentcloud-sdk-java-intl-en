...
public class UpdateMessageEnrichmentRulePriorityRequest extends AbstractModel {
    ...
    */
    ...
    @Expose
    private MessageEnrichmentRulePriority [] Priorities;
     ...
     */
    public MessageEnrichmentRulePriority [] getPriorities() {
     ...
     */
    public void setPriorities(MessageEnrichmentRulePriority [] Priorities) {
        this.Priorities = Priorities;
    }

    public UpdateMessageEnrichmentRulePriorityRequest() {
    }
     ...
     */
    public UpdateMessageEnrichmentRulePriorityRequest(UpdateMessageEnrichmentRulePriorityRequest source) {
        if (source.InstanceId != null) {
            this.InstanceId = new String(source.InstanceId);
        }
        if (source.Priorities != null) {
            this.Priorities = new MessageEnrichmentRulePriority[source.Priorities.length];
            for (int i = 0; i < source.Priorities.length; i++) {
                this.Priorities[i] = new MessageEnrichmentRulePriority(source.Priorities[i]);
            }
        }
    }
