...
public class DescribeTaskStatusResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Returned result of the recording recognition request. 
     * @return Data Returned result of the recording recognition request.
     */
    ...
    /**
     * Set Returned result of the recording recognition request.
     * @param Data Returned result of the recording recognition request.
     */
    ...
    public DescribeTaskStatusResponse(DescribeTaskStatusResponse source) {
        if (source.Data != null) {
            this.Data = new TaskStatus(source.Data);
        }
