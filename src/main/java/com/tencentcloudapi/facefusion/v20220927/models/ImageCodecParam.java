...
public class ImageCodecParam extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Metadata. The number of metadata entries cannot exceed 1. 
    ...
    /**
     * Set Metadata. The number of metadata entries cannot exceed 1.
     * @param MetaData Metadata. The number of metadata entries cannot exceed 1.
     */
