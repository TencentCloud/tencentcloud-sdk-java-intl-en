...
public class DescribeAllocationMonthOverviewResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Monthly overview of a cost allocation bill 
     * @return Detail Monthly overview of a cost allocation bill
     */
    ...
    /**
     * Set Monthly overview of a cost allocation bill
     * @param Detail Monthly overview of a cost allocation bill
     */
     ...
     */
    public DescribeAllocationMonthOverviewResponse(DescribeAllocationMonthOverviewResponse source) {
        if (source.Detail != null) {
            this.Detail = new AllocationOverviewNode[source.Detail.length];
            for (int i = 0; i < source.Detail.length; i++) {
                this.Detail[i] = new AllocationOverviewNode(source.Detail[i]);
            }
        }
