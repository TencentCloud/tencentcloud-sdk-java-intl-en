...
public class DescribeGatherRuleDetailRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Specifies the ID of the queried collection rule. 
    ...
    /**
     * Set Specifies the ID of the queried collection rule.
     * @param Id Specifies the ID of the queried collection rule.
     */
