...
public class DescribeAllocationSummaryByItemResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private AllocationSummaryByItem [] Detail;
    ...
    */
    ...
    /**
     * Get Details of a Cost Allocation Bill by item
 
     * @return Detail Details of a Cost Allocation Bill by item
    ...
    /**
     * Set Details of a Cost Allocation Bill by item

     * @param Detail Details of a Cost Allocation Bill by item
    ...
    public DescribeAllocationSummaryByItemResponse() {
    }
     ...
     */
    public DescribeAllocationSummaryByItemResponse(DescribeAllocationSummaryByItemResponse source) {
        ...
        if (source.Detail != null) {
            this.Detail = new AllocationSummaryByItem[source.Detail.length];
            for (int i = 0; i < source.Detail.length; i++) {
                this.Detail[i] = new AllocationSummaryByItem(source.Detail[i]);
            }
        }
