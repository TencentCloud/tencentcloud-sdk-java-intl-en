...
public class DescribeAllocationUnitDetailRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get ID of the queried cost allocation unit. 
    ...
    /**
     * Set ID of the queried cost allocation unit.
     * @param Id ID of the queried cost allocation unit.
     */
    ...
    public DescribeAllocationUnitDetailRequest() {
    }
     ...
     */
    public DescribeAllocationUnitDetailRequest(DescribeAllocationUnitDetailRequest source) {
        if (source.Id != null) {
