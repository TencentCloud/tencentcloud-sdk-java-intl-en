...
public class AllocationUnit extends AbstractModel {
    ...
    */
     ...
     * @param NodeId Cost allocation unit ID.
     */
    ...
    /**
     * Get Specifies the name of a cost allocation rule. 
    ...
    /**
     * Set Specifies the name of a cost allocation rule.
     * @param TreeNodeUniqKeyName Specifies the name of a cost allocation rule.
     */
