...
public class CreateAllocationTagRequest extends AbstractModel {
    ...
    */
    ...
    public CreateAllocationTagRequest() {
    }
     ...
     */
    public CreateAllocationTagRequest(CreateAllocationTagRequest source) {
