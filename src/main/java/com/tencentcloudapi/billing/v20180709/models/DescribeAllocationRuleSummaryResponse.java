...
public class DescribeAllocationRuleSummaryResponse extends AbstractModel {
    ...
    */
     ...
     * @param RuleList Sharing rule expression.
     */
    ...
    public DescribeAllocationRuleSummaryResponse(DescribeAllocationRuleSummaryResponse source) {
        if (source.RuleList != null) {
            this.RuleList = new AllocationRuleOverview[source.RuleList.length];
            for (int i = 0; i < source.RuleList.length; i++) {
                this.RuleList[i] = new AllocationRuleOverview(source.RuleList[i]);
            }
        }
