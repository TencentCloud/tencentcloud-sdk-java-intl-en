...
public class CreateInstanceResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Instance id list. Empty list will be returned once product delivery is delayed.  
     * @return InstanceIdList Instance id list. Empty list will be returned once product delivery is delayed. 
     */
    ...
    /**
     * Set Instance id list. Empty list will be returned once product delivery is delayed. 
     * @param InstanceIdList Instance id list. Empty list will be returned once product delivery is delayed. 
     */
