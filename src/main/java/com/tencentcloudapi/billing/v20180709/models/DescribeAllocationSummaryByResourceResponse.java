...
public class DescribeAllocationSummaryByResourceResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Detailed summary of the cost allocation bill by resource
 
     * @return Detail Detailed summary of the cost allocation bill by resource
    ...
    /**
     * Set Detailed summary of the cost allocation bill by resource

     * @param Detail Detailed summary of the cost allocation bill by resource
     ...
     */
    public DescribeAllocationSummaryByResourceResponse(DescribeAllocationSummaryByResourceResponse source) {
        ...
        if (source.Detail != null) {
            this.Detail = new AllocationSummaryByResource[source.Detail.length];
            for (int i = 0; i < source.Detail.length; i++) {
                this.Detail[i] = new AllocationSummaryByResource(source.Detail[i]);
            }
        }
