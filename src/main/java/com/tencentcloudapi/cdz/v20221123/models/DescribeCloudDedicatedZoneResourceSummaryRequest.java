...
public class DescribeCloudDedicatedZoneResourceSummaryRequest extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeCloudDedicatedZoneResourceSummaryRequest(DescribeCloudDedicatedZoneResourceSummaryRequest source) {
        if (source.CdzId != null) {
            this.CdzId = new String(source.CdzId);
        }
    }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamSimple(map, prefix + "CdzId", this.CdzId);
