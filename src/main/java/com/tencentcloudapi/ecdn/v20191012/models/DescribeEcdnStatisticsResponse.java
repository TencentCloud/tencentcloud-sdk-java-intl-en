...
public class DescribeEcdnStatisticsResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeEcdnStatisticsResponse() {
    }
     ...
     */
    public DescribeEcdnStatisticsResponse(DescribeEcdnStatisticsResponse source) {
        if (source.Data != null) {
