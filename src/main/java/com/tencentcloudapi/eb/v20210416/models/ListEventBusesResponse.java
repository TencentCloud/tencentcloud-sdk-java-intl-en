...
public class ListEventBusesResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Total number of event buses 
    ...
    /**
     * Set Total number of event buses
     ...
     */
    public ListEventBusesResponse(ListEventBusesResponse source) {
        if (source.EventBuses != null) {
            this.EventBuses = new EventBus[source.EventBuses.length];
            for (int i = 0; i < source.EventBuses.length; i++) {
                this.EventBuses[i] = new EventBus(source.EventBuses[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "EventBuses.", this.EventBuses);
