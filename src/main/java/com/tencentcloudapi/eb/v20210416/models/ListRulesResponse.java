...
public class ListRulesResponse extends AbstractModel{
    ...
    */
     ...
     * @return Rules Event rule information
     */
    ...
    /**
     * Get Total number of event rules 
     * @return TotalCount Total number of event rules
     */
    ...
    /**
     * Set Total number of event rules
     ...
     */
    public ListRulesResponse(ListRulesResponse source) {
