...
public class Convert3DFormatResponse extends AbstractModel {
    ...
    */
    ...
    public Convert3DFormatResponse() {
    }
     ...
     */
    public Convert3DFormatResponse(Convert3DFormatResponse source) {
        if (source.ResultFile3D != null) {
            this.ResultFile3D = new String(source.ResultFile3D);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamSimple(map, prefix + "ResultFile3D", this.ResultFile3D);
