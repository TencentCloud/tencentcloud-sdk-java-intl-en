...
public class File3D extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Specifies the file Url (valid for 24 hours). 
     * @return Url Specifies the file Url (valid for 24 hours).
     */
    ...
    /**
     * Set Specifies the file Url (valid for 24 hours).
     * @param Url Specifies the file Url (valid for 24 hours).
     */
