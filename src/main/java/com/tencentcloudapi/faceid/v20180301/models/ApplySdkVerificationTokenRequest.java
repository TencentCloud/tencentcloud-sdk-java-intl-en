...
false : Expired HKID is rejected and cannot enter the liveness process.
    ...
    */
    @SerializedName("SkipOcrConfirmPage")
    @Expose
    private Boolean SkipOcrConfirmPage;
    ...
    */
    @SerializedName("AllowUploadPhoto")
    @Expose
    private Boolean AllowUploadPhoto;
...
false : Expired HKID is rejected and cannot enter the liveness process.
    ...
    /**
     * Get <p>Controls visibility of the final result page</p><p>Enumeration values:</p><ul><li>true: Do not display the result page</li><li>false: Display the result page</li></ul><p>Default value: false</p> 
    ...
    /**
     * Set <p>Controls visibility of the final result page</p><p>Enumeration values:</p><ul><li>true: Do not display the result page</li><li>false: Display the result page</li></ul><p>Default value: false</p>
     * @param SkipResultPage <p>Controls visibility of the final result page</p><p>Enumeration values:</p><ul><li>true: Do not display the result page</li><li>false: Display the result page</li></ul><p>Default value: false</p>
     */
    ...
    /**
     * Get Encrypted metadata generated by the SDK 
    ...
    /**
     * Set Encrypted metadata generated by the SDK
     * @param MetaData Encrypted metadata generated by the SDK
     */
    ...
    /**
     * Get <p>Controls visibility of the launch page</p><p>Enumeration values:</p><ul><li>true: Do not display the launch page</li><li>false: Display the launch page</li></ul><p>Default value: false</p> 
     ...
     */
    public Boolean getSkipLaunchPage() {
        return this.SkipLaunchPage;
    }

    /**
     * Set <p>Controls visibility of the launch page</p><p>Enumeration values:</p><ul><li>true: Do not display the launch page</li><li>false: Display the launch page</li></ul><p>Default value: false</p>
     * @param SkipLaunchPage <p>Controls visibility of the launch page</p><p>Enumeration values:</p><ul><li>true: Do not display the launch page</li><li>false: Display the launch page</li></ul><p>Default value: false</p>
     */
    ...
    /**
     * Get <p>Controls visibility of the information confirmation page </p><p>Enumeration values:</p><ul><li>true: Do not display the information confirmation page</li><li>false: Display the information confirmation page</li></ul><p>Default value: false</p> 
     ...
     */
    public Boolean getSkipOcrConfirmPage() {
        return this.SkipOcrConfirmPage;
    }

    /**
     * Set <p>Controls visibility of the information confirmation page </p><p>Enumeration values:</p><ul><li>true: Do not display the information confirmation page</li><li>false: Display the information confirmation page</li></ul><p>Default value: false</p>
     * @param SkipOcrConfirmPage <p>Controls visibility of the information confirmation page </p><p>Enumeration values:</p><ul><li>true: Do not display the information confirmation page</li><li>false: Display the information confirmation page</li></ul><p>Default value: false</p>
     */
    public void setSkipOcrConfirmPage(Boolean SkipOcrConfirmPage) {
        this.SkipOcrConfirmPage = SkipOcrConfirmPage;
    }

    /**
     * Get <p>Controls whether to hide the top progress bar across all pages of the entire process </p><p>Enumeration values:</p><ul><li>true: Do not display the progress bar</li><li>false: Display the progress bar</li></ul><p>Default value: false</p> 
    ...
    /**
     * Set <p>Controls whether to hide the top progress bar across all pages of the entire process </p><p>Enumeration values:</p><ul><li>true: Do not display the progress bar</li><li>false: Display the progress bar</li></ul><p>Default value: false</p>
     * @param HideProgressBar <p>Controls whether to hide the top progress bar across all pages of the entire process </p><p>Enumeration values:</p><ul><li>true: Do not display the progress bar</li><li>false: Display the progress bar</li></ul><p>Default value: false</p>
     */
    ...
    /**
     * Get <p>Whether uploading photos from the album is permitted for verification during the ID validation phase (prohibited when single-angle multi-image forgery detection is enabled)
 </p><p>Enumeration values:</p><ul><li>true: Album photo upload for verification enabled</li><li>false: Album photo upload for verification disabled</li></ul><p>Default value: false</p> 
     ...
     */
    public Boolean getAllowUploadPhoto() {
        return this.AllowUploadPhoto;
    }

    /**
     * Set <p>Whether uploading photos from the album is permitted for verification during the ID validation phase (prohibited when single-angle multi-image forgery detection is enabled)
 </p><p>Enumeration values:</p><ul><li>true: Album photo upload for verification enabled</li><li>false: Album photo upload for verification disabled</li></ul><p>Default value: false</p>
     * @param AllowUploadPhoto <p>Whether uploading photos from the album is permitted for verification during the ID validation phase (prohibited when single-angle multi-image forgery detection is enabled)
 </p><p>Enumeration values:</p><ul><li>true: Album photo upload for verification enabled</li><li>false: Album photo upload for verification disabled</li></ul><p>Default value: false</p>
     */
    public void setAllowUploadPhoto(Boolean AllowUploadPhoto) {
        this.AllowUploadPhoto = AllowUploadPhoto;
    }
    ...
    public ApplySdkVerificationTokenRequest(ApplySdkVerificationTokenRequest source) {
        ...
        if (source.SkipLaunchPage != null) {
            this.SkipLaunchPage = new Boolean(source.SkipLaunchPage);
        }
        if (source.SkipOcrConfirmPage != null) {
            this.SkipOcrConfirmPage = new Boolean(source.SkipOcrConfirmPage);
        }
        if (source.HideProgressBar != null) {
            this.HideProgressBar = new Boolean(source.HideProgressBar);
        }
        if (source.AllowUploadPhoto != null) {
            this.AllowUploadPhoto = new Boolean(source.AllowUploadPhoto);
        }
    }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamSimple(map, prefix + "SkipLaunchPage", this.SkipLaunchPage);
