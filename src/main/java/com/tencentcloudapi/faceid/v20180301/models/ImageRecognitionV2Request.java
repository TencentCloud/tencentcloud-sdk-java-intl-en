...
public class ImageRecognitionV2Request extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Name.</p><ul><li>For Chinese, please use UTF-8 encode.</li></ul> 
    ...
    /**
     * Set <p>Name.</p><ul><li>For Chinese, please use UTF-8 encode.</li></ul>
     * @param Name <p>Name.</p><ul><li>For Chinese, please use UTF-8 encode.</li></ul>
     */
    ...
    /**
     * Get <p>Sensitive data encryption information.</p><ul><li>Users with encryption requirements for incoming information (name, identity card number) can use this parameter. For details, please click the left-side link.</li></ul> 
    ...
    /**
     * Set <p>Sensitive data encryption information.</p><ul><li>Users with encryption requirements for incoming information (name, identity card number) can use this parameter. For details, please click the left-side link.</li></ul>
     * @param Encryption <p>Sensitive data encryption information.</p><ul><li>Users with encryption requirements for incoming information (name, identity card number) can use this parameter. For details, please click the left-side link.</li></ul>
     */
    ...
    /**
     * Get <p>Customized description field.</p><ul><li>For description of invoke business info. This description field will return in the output.</li><li>Each customized description field supports [1,10] characters.</li></ul> 
    ...
    /**
     * Set <p>Customized description field.</p><ul><li>For description of invoke business info. This description field will return in the output.</li><li>Each customized description field supports [1,10] characters.</li></ul>
     * @param Extra <p>Customized description field.</p><ul><li>For description of invoke business info. This description field will return in the output.</li><li>Each customized description field supports [1,10] characters.</li></ul>
     */
