...
public class ApplySdkVerificationTokenResponse extends AbstractModel {
    ...
    */
    @SerializedName("ServerParamInfo")
    @Expose
    private String ServerParamInfo;
    ...
    */
    ...
    /**
     * Get Encrypted string of server-side parameters 
     * @return ServerParamInfo Encrypted string of server-side parameters
     */
    public String getServerParamInfo() {
        return this.ServerParamInfo;
    }

    /**
     * Set Encrypted string of server-side parameters
     * @param ServerParamInfo Encrypted string of server-side parameters
     */
    public void setServerParamInfo(String ServerParamInfo) {
        this.ServerParamInfo = ServerParamInfo;
    }
    ...
    public ApplySdkVerificationTokenResponse(ApplySdkVerificationTokenResponse source) {
        ...
        if (source.ServerParamInfo != null) {
            this.ServerParamInfo = new String(source.ServerParamInfo);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamSimple(map, prefix + "ServerParamInfo", this.ServerParamInfo);
