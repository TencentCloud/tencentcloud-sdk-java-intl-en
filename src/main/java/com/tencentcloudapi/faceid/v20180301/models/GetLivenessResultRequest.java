...
public class GetLivenessResultRequest extends AbstractModel {
    ...
    */
    ...
    public GetLivenessResultRequest() {
    }
     ...
     */
    public GetLivenessResultRequest(GetLivenessResultRequest source) {
