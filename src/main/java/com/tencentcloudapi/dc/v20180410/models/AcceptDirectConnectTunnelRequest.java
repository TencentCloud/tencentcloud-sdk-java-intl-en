...
public class AcceptDirectConnectTunnelRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get The connection owner accepts an application for sharing the dedicated tunnel 
    ...
    /**
     * Set The connection owner accepts an application for sharing the dedicated tunnel
