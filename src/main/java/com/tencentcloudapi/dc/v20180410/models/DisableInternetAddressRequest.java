...
public class DisableInternetAddressRequest extends AbstractModel{
    ...
    */
    ...
    public DisableInternetAddressRequest() {
    }
     ...
     */
    public DisableInternetAddressRequest(DisableInternetAddressRequest source) {
