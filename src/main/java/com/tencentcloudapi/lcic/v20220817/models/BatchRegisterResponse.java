...
public class BatchRegisterResponse extends AbstractModel{
    ...
    */
     ...
     */
    public BatchRegisterResponse(BatchRegisterResponse source) {
        if (source.Users != null) {
            this.Users = new BatchUserInfo[source.Users.length];
            for (int i = 0; i < source.Users.length; i++) {
                this.Users[i] = new BatchUserInfo(source.Users[i]);
            }
        }
