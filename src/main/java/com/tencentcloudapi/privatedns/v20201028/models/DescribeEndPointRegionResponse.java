...
public class DescribeEndPointRegionResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeEndPointRegionResponse() {
    }
     ...
     */
    public DescribeEndPointRegionResponse(DescribeEndPointRegionResponse source) {
