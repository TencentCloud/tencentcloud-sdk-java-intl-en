...
public class DeletePrivateZoneRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Array of private domain IDs. `ZoneId` takes precedence. 
     * @return ZoneIdSet Array of private domain IDs. `ZoneId` takes precedence.
     */
    ...
    /**
     * Set Array of private domain IDs. `ZoneId` takes precedence.
