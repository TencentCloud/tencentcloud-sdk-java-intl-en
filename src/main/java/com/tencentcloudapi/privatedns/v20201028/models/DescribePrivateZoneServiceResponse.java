...
public class DescribePrivateZoneServiceResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Private DNS service activation status. Valid values: ENABLED, DISABLED 
    ...
    /**
     * Set Private DNS service activation status. Valid values: ENABLED, DISABLED
    ...
    public DescribePrivateZoneServiceResponse() {
    }
     ...
     */
    public DescribePrivateZoneServiceResponse(DescribePrivateZoneServiceResponse source) {
