...
public class DescribeExtendEndpointListRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Filter parameters. Valid values: EndpointName, EndpointId. 
     * @return Filters Filter parameters. Valid values: EndpointName, EndpointId.
     */
    ...
    /**
     * Set Filter parameters. Valid values: EndpointName, EndpointId.
     * @param Filters Filter parameters. Valid values: EndpointName, EndpointId.
     */
    public void setFilters(Filter [] Filters) {
        this.Filters = Filters;
    }

    public DescribeExtendEndpointListRequest() {
    }
     ...
     */
    public DescribeExtendEndpointListRequest(DescribeExtendEndpointListRequest source) {
