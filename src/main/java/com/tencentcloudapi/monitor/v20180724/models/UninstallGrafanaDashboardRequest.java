...
public class UninstallGrafanaDashboardRequest extends AbstractModel {
...
<li>etcd</li>
    */
    ...
    /**
     * Get Prometheus integration code, indicating to delete the corresponding dashboard. Valid values:
<li>spring_mvc</li>
<li>mysql</li>
<li>go</li>
<li>redis</li>
...
<li>istio</li>
<li>etcd</li> 
     * @return IntegrationCodes Prometheus integration code, indicating to delete the corresponding dashboard. Valid values:
<li>spring_mvc</li>
<li>mysql</li>
<li>go</li>
<li>redis</li>
...
<li>etcd</li>
    ...
    /**
     * Set Prometheus integration code, indicating to delete the corresponding dashboard. Valid values:
<li>spring_mvc</li>
<li>mysql</li>
<li>go</li>
<li>redis</li>
...
<li>etcd</li>
    ...
    public UninstallGrafanaDashboardRequest() {
    }
     ...
     */
    public UninstallGrafanaDashboardRequest(UninstallGrafanaDashboardRequest source) {
