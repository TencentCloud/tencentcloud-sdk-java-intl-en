...
public class DescribeGrafanaNotificationChannelsResponse extends AbstractModel{
    ...
    */
    ...
    @Expose
    private GrafanaNotificationChannel [] NotificationChannelSet;
    ...
    */
    ...
    /**
     * Get Array of notification channels 
     * @return NotificationChannelSet Array of notification channels
     */
    ...
    /**
     * Set Array of notification channels
    ...
    public DescribeGrafanaNotificationChannelsResponse() {
    }
     ...
     */
    public DescribeGrafanaNotificationChannelsResponse(DescribeGrafanaNotificationChannelsResponse source) {
        if (source.NotificationChannelSet != null) {
            this.NotificationChannelSet = new GrafanaNotificationChannel[source.NotificationChannelSet.length];
            for (int i = 0; i < source.NotificationChannelSet.length; i++) {
                this.NotificationChannelSet[i] = new GrafanaNotificationChannel(source.NotificationChannelSet[i]);
            }
        }
