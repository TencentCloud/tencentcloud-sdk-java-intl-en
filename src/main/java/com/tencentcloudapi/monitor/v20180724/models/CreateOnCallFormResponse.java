...
public class CreateOnCallFormResponse extends AbstractModel {
    ...
    */
    ...
    public CreateOnCallFormResponse() {
    }
     ...
     */
    public CreateOnCallFormResponse(CreateOnCallFormResponse source) {
