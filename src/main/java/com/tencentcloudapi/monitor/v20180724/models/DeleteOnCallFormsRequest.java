...
public class DeleteOnCallFormsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get ID of the on-call schedule to be deleted. 
     * @return OnCallFormIDs ID of the on-call schedule to be deleted.
     */
    ...
    /**
     * Set ID of the on-call schedule to be deleted.
     * @param OnCallFormIDs ID of the on-call schedule to be deleted.
     */
