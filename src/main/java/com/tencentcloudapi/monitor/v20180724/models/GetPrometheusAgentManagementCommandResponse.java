...
public class GetPrometheusAgentManagementCommandResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Set Agent management command
     * @param Command Agent management command
     */
    public void setCommand(ManagementCommand Command) {
     ...
     */
    public GetPrometheusAgentManagementCommandResponse(GetPrometheusAgentManagementCommandResponse source) {
        if (source.Command != null) {
            this.Command = new ManagementCommand(source.Command);
        }
