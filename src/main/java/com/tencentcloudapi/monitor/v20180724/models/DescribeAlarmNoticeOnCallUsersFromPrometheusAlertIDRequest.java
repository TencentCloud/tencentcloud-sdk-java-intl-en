...
public class DescribeAlarmNoticeOnCallUsersFromPrometheusAlertIDRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>prometheus alarm group ID</p><p>Parameter format: alert-xxxxxxxx</p> 
     * @return AlertId <p>prometheus alarm group ID</p><p>Parameter format: alert-xxxxxxxx</p>
     */
    ...
    /**
     * Set <p>prometheus alarm group ID</p><p>Parameter format: alert-xxxxxxxx</p>
     * @param AlertId <p>prometheus alarm group ID</p><p>Parameter format: alert-xxxxxxxx</p>
     */
