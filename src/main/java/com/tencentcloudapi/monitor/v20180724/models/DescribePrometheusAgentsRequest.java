...
public class DescribePrometheusAgentsRequest extends AbstractModel {
    ...
    */
    ...
    public DescribePrometheusAgentsRequest() {
    }
     ...
     */
    public DescribePrometheusAgentsRequest(DescribePrometheusAgentsRequest source) {
