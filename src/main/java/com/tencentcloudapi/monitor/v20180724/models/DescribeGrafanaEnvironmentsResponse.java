...
public class DescribeGrafanaEnvironmentsResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeGrafanaEnvironmentsResponse() {
    }
     ...
     */
    public DescribeGrafanaEnvironmentsResponse(DescribeGrafanaEnvironmentsResponse source) {
        if (source.Envs != null) {
