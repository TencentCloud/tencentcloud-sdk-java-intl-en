...
public class ListAIWorkbenchSessionsResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Session list</p> 
     * @return Sessions <p>Session list</p>
     */
    ...
    /**
     * Set <p>Session list</p>
     * @param Sessions <p>Session list</p>
     */
    ...
    public ListAIWorkbenchSessionsResponse() {
    }
     ...
     */
    public ListAIWorkbenchSessionsResponse(ListAIWorkbenchSessionsResponse source) {
        if (source.Sessions != null) {
            this.Sessions = new SessionInfo[source.Sessions.length];
            for (int i = 0; i < source.Sessions.length; i++) {
                this.Sessions[i] = new SessionInfo(source.Sessions[i]);
            }
        }
