...
public class TaskInfo extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Associated MCP endpoint ID list</p> 
     * @return McpEndpointIds <p>Associated MCP endpoint ID list</p>
     */
    ...
    /**
     * Set <p>Associated MCP endpoint ID list</p>
     * @param McpEndpointIds <p>Associated MCP endpoint ID list</p>
     */
    ...
    /**
     * Get <p>Notification id</p> 
     * @return NotifyIds <p>Notification id</p>
     */
    ...
    /**
     * Set <p>Notification id</p>
     * @param NotifyIds <p>Notification id</p>
     */
