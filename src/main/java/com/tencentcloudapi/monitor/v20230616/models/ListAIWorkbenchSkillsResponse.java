...
public class ListAIWorkbenchSkillsResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Set <p>List of skills</p>
     * @param Skills <p>List of skills</p>
     */
    ...
    public ListAIWorkbenchSkillsResponse() {
    }
     ...
     */
    public ListAIWorkbenchSkillsResponse(ListAIWorkbenchSkillsResponse source) {
        if (source.Skills != null) {
            this.Skills = new SkillInfo[source.Skills.length];
            for (int i = 0; i < source.Skills.length; i++) {
                this.Skills[i] = new SkillInfo(source.Skills[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "Skills.", this.Skills);
