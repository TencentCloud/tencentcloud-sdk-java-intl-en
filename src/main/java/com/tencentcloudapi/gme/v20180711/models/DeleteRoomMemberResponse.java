...
public class DeleteRoomMemberResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Result of the operation to delete a room or remove a member 
    ...
    /**
     * Set Result of the operation to delete a room or remove a member
    ...
    public DeleteRoomMemberResponse() {
    }
     ...
     */
    public DeleteRoomMemberResponse(DeleteRoomMemberResponse source) {
        if (source.DeleteResult != null) {
            this.DeleteResult = new DeleteResult(source.DeleteResult);
        }
