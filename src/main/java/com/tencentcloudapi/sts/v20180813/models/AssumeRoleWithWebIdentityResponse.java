...
public class AssumeRoleWithWebIdentityResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Expiration time of the temporary access credentials (timestamp). 
    ...
    /**
     * Set Expiration time of the temporary access credentials (timestamp).
     * @param ExpiredTime Expiration time of the temporary access credentials (timestamp).
     */
    ...
    /**
     * Get Expiration time of the temporary access credentials. 
    ...
    /**
     * Set Expiration time of the temporary access credentials.
     * @param Expiration Expiration time of the temporary access credentials.
     */
