...
public class AssumeRoleWithSAMLResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Indicates the expiration time of the temporary access credentials. A Unix timestamp will be returned which is accurate to the second. 
    ...
    /**
     * Set Indicates the expiration time of the temporary access credentials. A Unix timestamp will be returned which is accurate to the second.
     * @param ExpiredTime Indicates the expiration time of the temporary access credentials. A Unix timestamp will be returned which is accurate to the second.
     */
    ...
    /**
     * Get Indicates the expiration time of the temporary access credentials in UTC time in ISO 8601 format. 
    ...
    /**
     * Set Indicates the expiration time of the temporary access credentials in UTC time in ISO 8601 format.
     * @param Expiration Indicates the expiration time of the temporary access credentials in UTC time in ISO 8601 format.
     */
