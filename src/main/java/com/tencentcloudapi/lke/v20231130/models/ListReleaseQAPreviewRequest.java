...
public class ListReleaseQAPreviewRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Status (1: newly-added; 2: modified; 3: deleted). 
     * @return Actions Status (1: newly-added; 2: modified; 3: deleted).
     */
    ...
    /**
     * Set Status (1: newly-added; 2: modified; 3: deleted).
     * @param Actions Status (1: newly-added; 2: modified; 3: deleted).
     */
    ...
    /**
     * Get Release status (4: release successful; 5: release failed). 
     * @return ReleaseStatus Release status (4: release successful; 5: release failed).
     */
    ...
    /**
     * Set Release status (4: release successful; 5: release failed).
     * @param ReleaseStatus Release status (4: release successful; 5: release failed).
     */
