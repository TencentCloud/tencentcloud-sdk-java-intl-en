...
public class CateInfo extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Quantity of records (such as documents, synonyms, etc.) under the category. 
    ...
    /**
     * Set Quantity of records (such as documents, synonyms, etc.) under the category.
     * @param Total Quantity of records (such as documents, synonyms, etc.) under the category.
     */
