...
public class CheckAttributeLabelExistRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Set Attribute name.
     * @param LabelName Attribute name.
     */
    ...
    /**
     * Get Log in to the user's root account (required in integrator mode). 
    ...
    /**
     * Set Log in to the user's root account (required in integrator mode).
     * @param LoginUin Log in to the user's root account (required in integrator mode).
     */
    ...
    /**
     * Get Log in to the user's sub-account (required in integrator mode). 
    ...
    /**
     * Set Log in to the user's sub-account (required in integrator mode).
     * @param LoginSubAccountUin Log in to the user's sub-account (required in integrator mode).
     */
    ...
    /**
     * Get Scroll loading, the last attribute label ID. 
    ...
    /**
     * Set Scroll loading, the last attribute label ID.
     * @param LastLabelBizId Scroll loading, the last attribute label ID.
     */
