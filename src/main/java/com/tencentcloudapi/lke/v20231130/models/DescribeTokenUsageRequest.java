...
public class DescribeTokenUsageRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Filter sub-scenario (used in document parsing scenario). 
    ...
    /**
     * Set Filter sub-scenario (used in document parsing scenario).
     * @param SubScenes Filter sub-scenario (used in document parsing scenario).
     */
