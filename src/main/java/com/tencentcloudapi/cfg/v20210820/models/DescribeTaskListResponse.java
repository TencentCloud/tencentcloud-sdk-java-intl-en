...
public class DescribeTaskListResponse extends AbstractModel {
    ...
    */
     ...
     * @param TaskList None
     */
    public void setTaskList(TaskListItem [] TaskList) {
     ...
     * @param Total Number of tables in the list
     */
    ...
    public DescribeTaskListResponse(DescribeTaskListResponse source) {
        if (source.TaskList != null) {
            this.TaskList = new TaskListItem[source.TaskList.length];
            for (int i = 0; i < source.TaskList.length; i++) {
                this.TaskList[i] = new TaskListItem(source.TaskList[i]);
            }
        }
