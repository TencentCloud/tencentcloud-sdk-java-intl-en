...
public class DescribeStorageRegionsRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeStorageRegionsRequest() {
    }
     ...
     */
    public DescribeStorageRegionsRequest(DescribeStorageRegionsRequest source) {
