...
public class AiRecognitionTaskObjectResult extends AbstractModel {
    ...
    */
    ...
    /**
    * Object recognition task completion time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
    */
    ...
    /**
     * Get Object recognition task input. 
    ...
    /**
     * Set Object recognition task input.
     * @param Input Object recognition task input.
     */
    ...
    /**
     * Get Object recognition task progress, in the range of [0,100]. 
     * @return Progress Object recognition task progress, in the range of [0,100].
     */
    ...
    /**
     * Set Object recognition task progress, in the range of [0,100].
     * @param Progress Object recognition task progress, in the range of [0,100].
     */
    ...
    /**
     * Get Object identification task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I). 
     * @return BeginProcessTime Object identification task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
    ...
    /**
     * Set Object identification task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     * @param BeginProcessTime Object identification task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
    ...
    /**
     * Get Object recognition task completion time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I). 
     * @return FinishTime Object recognition task completion time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
    ...
    /**
     * Set Object recognition task completion time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     * @param FinishTime Object recognition task completion time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
    public void setFinishTime(String FinishTime) {
        this.FinishTime = FinishTime;
    }

    public AiRecognitionTaskObjectResult() {
    }
     ...
     */
    public AiRecognitionTaskObjectResult(AiRecognitionTaskObjectResult source) {
        ...
        if (source.Input != null) {
            this.Input = new AiRecognitionTaskObjectResultInput(source.Input);
        }
        if (source.Output != null) {
            this.Output = new AiRecognitionTaskObjectResultOutput(source.Output);
        }
