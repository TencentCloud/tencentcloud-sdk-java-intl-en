...
public class NoiseConfigureInfoForUpdate extends AbstractModel {
...
<li>OFF: disabled.</li>
    ...
    public NoiseConfigureInfoForUpdate() {
    }
     ...
     */
    public NoiseConfigureInfoForUpdate(NoiseConfigureInfoForUpdate source) {
