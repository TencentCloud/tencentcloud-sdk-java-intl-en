...
public class DescribeAigcFaceInfoRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Need to get the input video info containing face information. It can contain up to one file. 
     * @return FileInfos Need to get the input video info containing face information. It can contain up to one file.
     */
    ...
    /**
     * Set Need to get the input video info containing face information. It can contain up to one file.
     * @param FileInfos Need to get the input video info containing face information. It can contain up to one file.
     */
    public void setFileInfos(AigcFaceInputFileInfo [] FileInfos) {
        this.FileInfos = FileInfos;
    }

    public DescribeAigcFaceInfoRequest() {
    }
     ...
     */
    public DescribeAigcFaceInfoRequest(DescribeAigcFaceInfoRequest source) {
