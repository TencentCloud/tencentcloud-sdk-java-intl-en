...
public class DescribeHeadTailTemplatesRequest extends AbstractModel {
    ...
    */
    ...
    /**
    * Opening and ending template ID. Array length limit: 100.
    */
    ...
    */
    ...
    /**
     * Get Opening and ending template ID. Array length limit: 100. 
     * @return Definitions Opening and ending template ID. Array length limit: 100.
     */
    ...
    /**
     * Set Opening and ending template ID. Array length limit: 100.
     * @param Definitions Opening and ending template ID. Array length limit: 100.
     */
