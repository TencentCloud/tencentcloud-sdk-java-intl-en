...
public class SceneAigcVideoTask extends AbstractModel {
    ...
    */
     ...
     */
    public SceneAigcVideoTask(SceneAigcVideoTask source) {
        ...
        if (source.Input != null) {
            this.Input = new SceneAigcVideoTaskInput(source.Input);
        }
        if (source.Output != null) {
            this.Output = new SceneAigcVideoTaskOutput(source.Output);
        }
