...
public class AigcVideoRedrawTask extends AbstractModel {
    ...
    */
    ...
    /**
    * <p>Output information of the AIGC video conversion task.</p>
    */
    ...
    */
    ...
    /**
     * Get <p>Output information of the AIGC video conversion task.</p> 
     * @return Output <p>Output information of the AIGC video conversion task.</p>
     */
    ...
    /**
     * Set <p>Output information of the AIGC video conversion task.</p>
     * @param Output <p>Output information of the AIGC video conversion task.</p>
     */
