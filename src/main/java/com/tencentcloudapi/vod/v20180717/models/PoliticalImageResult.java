...
<li>block</li>
    ...
    */
    ...
    /**
     * Get The confidence score for the politically sensitive content recognition result. Value range: 0-100. 
     * @return Confidence The confidence score for the politically sensitive content recognition result. Value range: 0-100.
     */
    ...
    /**
     * Set The confidence score for the politically sensitive content recognition result. Value range: 0-100.
...
<li>block</li>
    ...
    /**
     * Get The coordinates (pixel) of the top-left and bottom-right corners of the frame where politically sensitive content or a banned icon appears. Format: [x1, y1, x2, y2]. 
     * @return AreaCoordSet The coordinates (pixel) of the top-left and bottom-right corners of the frame where politically sensitive content or a banned icon appears. Format: [x1, y1, x2, y2].
     */
    ...
    /**
     * Set The coordinates (pixel) of the top-left and bottom-right corners of the frame where politically sensitive content or a banned icon appears. Format: [x1, y1, x2, y2].
