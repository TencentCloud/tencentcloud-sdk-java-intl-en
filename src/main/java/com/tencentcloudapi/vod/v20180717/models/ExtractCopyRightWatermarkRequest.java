...
public class ExtractCopyRightWatermarkRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Identify source context, used to pass through user request information. This field value will be returned in ExtractCopyRightWatermarkComplete callback and task flow status change callback. Maximum length: 1000 characters. 
    ...
    /**
     * Set Identify source context, used to pass through user request information. This field value will be returned in ExtractCopyRightWatermarkComplete callback and task flow status change callback. Maximum length: 1000 characters.
     * @param SessionContext Identify source context, used to pass through user request information. This field value will be returned in ExtractCopyRightWatermarkComplete callback and task flow status change callback. Maximum length: 1000 characters.
     */
