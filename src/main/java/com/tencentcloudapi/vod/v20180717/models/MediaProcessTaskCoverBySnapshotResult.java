...
public class MediaProcessTaskCoverBySnapshotResult extends AbstractModel {
    ...
    */
    ...
    /**
    * Output of the screencapturing for cover image task for videos.
    */
    ...
    */
    ...
    /**
     * Get Output of the screencapturing for cover image task for videos. 
     * @return Output Output of the screencapturing for cover image task for videos.
     */
    ...
    /**
     * Set Output of the screencapturing for cover image task for videos.
     * @param Output Output of the screencapturing for cover image task for videos.
     */
