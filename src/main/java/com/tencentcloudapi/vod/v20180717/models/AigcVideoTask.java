...
public class AigcVideoTask extends AbstractModel {
    ...
    */
    ...
    /**
    * <p>Input information for the AIGC video generation task.</p>
    */
    ...
    */
    ...
    /**
     * Get <p>Input information for the AIGC video generation task.</p> 
     * @return Input <p>Input information for the AIGC video generation task.</p>
     */
    ...
    /**
     * Set <p>Input information for the AIGC video generation task.</p>
     * @param Input <p>Input information for the AIGC video generation task.</p>
     */
     ...
     */
    public AigcVideoTask(AigcVideoTask source) {
        ...
        if (source.Input != null) {
            this.Input = new AigcVideoTaskInput(source.Input);
        }
        if (source.Output != null) {
            this.Output = new AigcVideoTaskOutput(source.Output);
        }
