...
public class MPSSmartEraseTemplateForUpdate extends AbstractModel {
    ...
    */
    ...
    public MPSSmartEraseTemplateForUpdate() {
    }
     ...
     */
    public MPSSmartEraseTemplateForUpdate(MPSSmartEraseTemplateForUpdate source) {
