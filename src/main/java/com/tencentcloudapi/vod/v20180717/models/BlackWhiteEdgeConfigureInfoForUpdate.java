...
public class BlackWhiteEdgeConfigureInfoForUpdate extends AbstractModel {
...
<li>OFF: turn off. </li>
    ...
    public BlackWhiteEdgeConfigureInfoForUpdate() {
    }
     ...
     */
    public BlackWhiteEdgeConfigureInfoForUpdate(BlackWhiteEdgeConfigureInfoForUpdate source) {
