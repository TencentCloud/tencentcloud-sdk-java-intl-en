...
public class AigcVideoTaskInputSubjectInfo extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Fixed name.</p><ul><li>Vidu subject <strong>required</strong>. It can be used by adding [@name] in the prompt. For example, if the name is Xiao Ming, describe it as [@Xiao Ming] in the prompt.</li><li>Kling subject selectable.</li></ul> 
    ...
    /**
     * Set <p>Fixed name.</p><ul><li>Vidu subject <strong>required</strong>. It can be used by adding [@name] in the prompt. For example, if the name is Xiao Ming, describe it as [@Xiao Ming] in the prompt.</li><li>Kling subject selectable.</li></ul>
     * @param Name <p>Fixed name.</p><ul><li>Vidu subject <strong>required</strong>. It can be used by adding [@name] in the prompt. For example, if the name is Xiao Ming, describe it as [@Xiao Ming] in the prompt.</li><li>Kling subject selectable.</li></ul>
     */
    ...
    /**
     * Get <p><strong>Valid only for Vidu.</strong> The voice type ID is used to determine the timbre of the sound in the video. If empty, the system will automatically recommend one.</p> 
    ...
    /**
     * Set <p><strong>Valid only for Vidu.</strong> The voice type ID is used to determine the timbre of the sound in the video. If empty, the system will automatically recommend one.</p>
     * @param VoiceId <p><strong>Valid only for Vidu.</strong> The voice type ID is used to determine the timbre of the sound in the video. If empty, the system will automatically recommend one.</p>
     */
    ...
    /**
     * Get <p><strong>Valid only for Vidu.</strong> Temporary subject images, up to 3 images<br>Note 1: Input image URLs are supported (ensure they are accessible);<br>Note 2: Images in png, jpeg, jpg, and webp formats are supported;<br>Note 3: Image pixels cannot be less than 128*128, and the ratio must be less than 1:4 or 4:1.</p> 
    ...
    /**
     * Set <p><strong>Valid only for Vidu.</strong> Temporary subject images, up to 3 images<br>Note 1: Input image URLs are supported (ensure they are accessible);<br>Note 2: Images in png, jpeg, jpg, and webp formats are supported;<br>Note 3: Image pixels cannot be less than 128*128, and the ratio must be less than 1:4 or 4:1.</p>
     * @param ImageUrls <p><strong>Valid only for Vidu.</strong> Temporary subject images, up to 3 images<br>Note 1: Input image URLs are supported (ensure they are accessible);<br>Note 2: Images in png, jpeg, jpg, and webp formats are supported;<br>Note 3: Image pixels cannot be less than 128*128, and the ratio must be less than 1:4 or 4:1.</p>
     */
    ...
    /**
     * Get <p><strong>Valid only for Vidu.</strong> Temporary subject video, a maximum of 1 5-second video. Note 1: Only the viduq2-pro model supports the use of video subjects for reference; Note 2: Supports uploading up to 1 5-second video; Note 3: Video supports mp4, avi, mov formats; Note 4: Video pixel cannot be less than 128*128, and the ratio must be less than 1:4 or 4:1;</p> 
    ...
    /**
     * Set <p><strong>Valid only for Vidu.</strong> Temporary subject video, a maximum of 1 5-second video. Note 1: Only the viduq2-pro model supports the use of video subjects for reference; Note 2: Supports uploading up to 1 5-second video; Note 3: Video supports mp4, avi, mov formats; Note 4: Video pixel cannot be less than 128*128, and the ratio must be less than 1:4 or 4:1;</p>
     * @param VideoUrls <p><strong>Valid only for Vidu.</strong> Temporary subject video, a maximum of 1 5-second video. Note 1: Only the viduq2-pro model supports the use of video subjects for reference; Note 2: Supports uploading up to 1 5-second video; Note 3: Video supports mp4, avi, mov formats; Note 4: Video pixel cannot be less than 128*128, and the ratio must be less than 1:4 or 4:1;</p>
     */
