...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    */
    ...
    /**
     * Get Input of intelligent cover generating task. 
    ...
    /**
     * Set Input of intelligent cover generating task.
     * @param Input Input of intelligent cover generating task.
     */
    public void setInput(AiAnalysisTaskCoverInput Input) {
        this.Input = Input;
    }
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Get The progress of an intelligent thumbnail generation task. Value range: 0-100. 
     * @return Progress The progress of an intelligent thumbnail generation task. Value range: 0-100.
     */
    ...
    /**
     * Set The progress of an intelligent thumbnail generation task. Value range: 0-100.
    ...
    /**
     * Get The time when the smart cover task started to be executed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format). 
     * @return BeginProcessTime The time when the smart cover task started to be executed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
    ...
    /**
     * Set The time when the smart cover task started to be executed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     * @param BeginProcessTime The time when the smart cover task started to be executed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
    ...
    /**
     * Get The time when the smart cover task is completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format). 
     * @return FinishTime The time when the smart cover task is completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
    ...
    /**
     * Set The time when the smart cover task is completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     * @param FinishTime The time when the smart cover task is completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
