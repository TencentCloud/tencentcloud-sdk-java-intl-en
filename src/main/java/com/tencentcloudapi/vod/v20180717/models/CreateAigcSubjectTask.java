...
public class CreateAigcSubjectTask extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Input of the task to create an AIGC subject.</p> 
    ...
    /**
     * Set <p>Input of the task to create an AIGC subject.</p>
     * @param Input <p>Input of the task to create an AIGC subject.</p>
     */
    ...
    /**
     * Get <p>Output of the task to create an AIGC subject.</p> 
    ...
    /**
     * Set <p>Output of the task to create an AIGC subject.</p>
     * @param Output <p>Output of the task to create an AIGC subject.</p>
     */
