...
public class CreateAigcCustomVoiceTask extends AbstractModel {
    ...
    */
    ...
    /**
    * <p>Create AIGC custom voice type output message.</p>
    */
    ...
    */
    ...
    /**
     * Get <p>Create AIGC custom voice type output message.</p> 
     * @return Output <p>Create AIGC custom voice type output message.</p>
     */
    ...
    /**
     * Set <p>Create AIGC custom voice type output message.</p>
     * @param Output <p>Create AIGC custom voice type output message.</p>
     */
