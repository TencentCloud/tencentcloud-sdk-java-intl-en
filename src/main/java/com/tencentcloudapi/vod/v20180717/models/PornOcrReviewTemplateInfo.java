...
<li>OFF: disables porn information detection in text task.</li>
    ...
    */
    ...
    /**
     * Get Switch of porn information detection in text task. Valid values:
<li>ON: enables porn information detection in text task;</li>
<li>OFF: disables porn information detection in text task.</li> 
     * @return Switch Switch of porn information detection in text task. Valid values:
<li>ON: enables porn information detection in text task;</li>
<li>OFF: disables porn information detection in text task.</li>
     */
    ...
    /**
     * Set Switch of porn information detection in text task. Valid values:
<li>ON: enables porn information detection in text task;</li>
<li>OFF: disables porn information detection in text task.</li>
...
<li>OFF: disables porn information detection in text task.</li>
    ...
    public PornOcrReviewTemplateInfo() {
    }
     ...
     */
    public PornOcrReviewTemplateInfo(PornOcrReviewTemplateInfo source) {
