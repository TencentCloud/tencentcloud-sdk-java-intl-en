...
public class DescribeAigcQuotasResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeAigcQuotasResponse() {
    }
     ...
     */
    public DescribeAigcQuotasResponse(DescribeAigcQuotasResponse source) {
        if (source.QuotaSet != null) {
            this.QuotaSet = new AigcQuotaItem[source.QuotaSet.length];
            for (int i = 0; i < source.QuotaSet.length; i++) {
                this.QuotaSet[i] = new AigcQuotaItem(source.QuotaSet[i]);
            }
        }
