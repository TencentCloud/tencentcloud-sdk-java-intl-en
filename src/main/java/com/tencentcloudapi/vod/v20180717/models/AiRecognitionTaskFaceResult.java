...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    */
    ...
    /**
     * Get Input information of face recognition task. 
     * @return Input Input information of face recognition task.
     */
    ...
    /**
     * Set Input information of face recognition task.
     * @param Input Input information of face recognition task.
     */
    public void setInput(AiRecognitionTaskFaceResultInput Input) {
        this.Input = Input;
    }
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Get The progress of a face recognition task. Value range: 0-100. 
     * @return Progress The progress of a face recognition task. Value range: 0-100.
     */
    ...
    /**
     * Set The progress of a face recognition task. Value range: 0-100.
    ...
    /**
     * Get The time when the face recognition task started, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format). 
     * @return BeginProcessTime The time when the face recognition task started, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
    ...
    /**
     * Set The time when the face recognition task started, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     * @param BeginProcessTime The time when the face recognition task started, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
    ...
    /**
     * Get The time when the face recognition task was completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format). 
     * @return FinishTime The time when the face recognition task was completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
    ...
    /**
     * Set The time when the face recognition task was completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     * @param FinishTime The time when the face recognition task was completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
     ...
     */
    public AiRecognitionTaskFaceResult(AiRecognitionTaskFaceResult source) {
        ...
        if (source.Input != null) {
            this.Input = new AiRecognitionTaskFaceResultInput(source.Input);
        }
        if (source.Output != null) {
            this.Output = new AiRecognitionTaskFaceResultOutput(source.Output);
        }
