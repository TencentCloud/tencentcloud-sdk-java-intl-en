...
public class AiRecognitionTaskFaceResult extends AbstractModel {
    ...
    */
    ...
    /**
    * Output information of the face recognition task.
    */
    ...
    */
    ...
    /**
    * Face recognition task completion time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
    */
    ...
    /**
     * Get Face recognition task input. 
     * @return Input Face recognition task input.
     */
    ...
    /**
     * Set Face recognition task input.
     * @param Input Face recognition task input.
     */
    ...
    /**
     * Get Output information of the face recognition task. 
     * @return Output Output information of the face recognition task.
     */
    ...
    /**
     * Set Output information of the face recognition task.
     * @param Output Output information of the face recognition task.
     */
    ...
    /**
     * Get Face recognition task completion time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I). 
     * @return FinishTime Face recognition task completion time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
    ...
    /**
     * Set Face recognition task completion time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     * @param FinishTime Face recognition task completion time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
