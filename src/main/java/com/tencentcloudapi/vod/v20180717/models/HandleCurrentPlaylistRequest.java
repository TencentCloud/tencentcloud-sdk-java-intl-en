...
public class HandleCurrentPlaylistRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Index number of the M3U8 file shard. The SegmentIndex of the first shard in an M3U8 file is 0. This parameter is valid when Operation is InsertTemporary and ItemId has a value. 
    ...
    /**
     * Set Index number of the M3U8 file shard. The SegmentIndex of the first shard in an M3U8 file is 0. This parameter is valid when Operation is InsertTemporary and ItemId has a value.
     * @param SegmentIndex Index number of the M3U8 file shard. The SegmentIndex of the first shard in an M3U8 file is 0. This parameter is valid when Operation is InsertTemporary and ItemId has a value.
     */
    ...
    /**
     * Get Program list. Required when Operation is Insert, InsertTemporary, or Delete. Indicates the program list to operate. Maximum list length: 10. 
    ...
    /**
     * Set Program list. Required when Operation is Insert, InsertTemporary, or Delete. Indicates the program list to operate. Maximum list length: 10.
     * @param RoundPlaylist Program list. Required when Operation is Insert, InsertTemporary, or Delete. Indicates the program list to operate. Maximum list length: 10.
     */
