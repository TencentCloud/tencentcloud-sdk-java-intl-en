...
public class FaceConfigureInfo extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Face recognition filter score. When the recognition result reaches this score or above, the recognition result will be returned. Default: 95 points. Value range: 0-100.</p> 
    ...
    /**
     * Set <p>Face recognition filter score. When the recognition result reaches this score or above, the recognition result will be returned. Default: 95 points. Value range: 0-100.</p>
     * @param Score <p>Face recognition filter score. When the recognition result reaches this score or above, the recognition result will be returned. Default: 95 points. Value range: 0-100.</p>
     */
    ...
    /**
     * Get <p>Filter tag for default characters, specifying the tags of default characters to return. If not filled or left empty, all default character results will be returned. Available tag values:</p><li>entertainment: entertainment star;</li><li>sport: sports celebrity;</li><li>politician: relevant people.</li> 
    ...
    /**
     * Set <p>Filter tag for default characters, specifying the tags of default characters to return. If not filled or left empty, all default character results will be returned. Available tag values:</p><li>entertainment: entertainment star;</li><li>sport: sports celebrity;</li><li>politician: relevant people.</li>
     * @param DefaultLibraryLabelSet <p>Filter tag for default characters, specifying the tags of default characters to return. If not filled or left empty, all default character results will be returned. Available tag values:</p><li>entertainment: entertainment star;</li><li>sport: sports celebrity;</li><li>politician: relevant people.</li>
     */
    ...
    /**
     * Get <p>Filter tags for user-defined characters, specifying the tags of user-defined characters to return. If not specified or empty, all user-defined character results are returned.<br>The number of tags can be up to 100, and each tag can be up to 16 characters in length.</p> 
    ...
    /**
     * Set <p>Filter tags for user-defined characters, specifying the tags of user-defined characters to return. If not specified or empty, all user-defined character results are returned.<br>The number of tags can be up to 100, and each tag can be up to 16 characters in length.</p>
     * @param UserDefineLibraryLabelSet <p>Filter tags for user-defined characters, specifying the tags of user-defined characters to return. If not specified or empty, all user-defined character results are returned.<br>The number of tags can be up to 100, and each tag can be up to 16 characters in length.</p>
     */
