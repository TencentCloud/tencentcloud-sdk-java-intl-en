...
Up to 10 labels are allowed, each containing no more than 16 characters.
    ...
    */
    ...
    /**
     * Get Whether to enable custom facial recognition. Valid values:
<li>ON</li>
<li>OFF</li> 
...
<li>OFF</li>
    ...
    /**
     * Set Whether to enable custom facial recognition. Valid values:
<li>ON</li>
<li>OFF</li>
...
<li>OFF</li>
    ...
    /**
     * Get Filter labels for custom facial recognition. Results containing the specified labels are returned. If no labels are specified, all results are returned. To filter by labels, specify the labels when adding custom facial libraries.
Up to 10 labels are allowed, each containing no more than 16 characters. 
...
Up to 10 labels are allowed, each containing no more than 16 characters.
    ...
    /**
     * Set Filter labels for custom facial recognition. Results containing the specified labels are returned. If no labels are specified, all results are returned. To filter by labels, specify the labels when adding custom facial libraries.
Up to 10 labels are allowed, each containing no more than 16 characters.
