...
public class DescribeAdaptiveDynamicStreamingTemplatesRequest extends AbstractModel {
    ...
    */
    ...
    /**
    * Filtering condition for the unique identifier of the adaptive bitstream template. The array length cannot exceed 100.
    */
...
<li>Custom: custom template.</li>
    */
    ...
    /**
     * Get Filtering condition for the unique identifier of the adaptive bitstream template. The array length cannot exceed 100. 
     * @return Definitions Filtering condition for the unique identifier of the adaptive bitstream template. The array length cannot exceed 100.
     */
    ...
    /**
     * Set Filtering condition for the unique identifier of the adaptive bitstream template. The array length cannot exceed 100.
     * @param Definitions Filtering condition for the unique identifier of the adaptive bitstream template. The array length cannot exceed 100.
     */
