...
<li>hlg: refers to the hlg standard.</li>
    */
    ...
    /**
     * Get Frame dynamic range information. Valid values:
<li>SDR: Standard Dynamic Range;</li>
<li>HDR: High Dynamic Range.</li> 
...
<li>HDR: High Dynamic Range.</li>
    ...
    /**
     * Set Frame dynamic range information. Valid values:
<li>SDR: Standard Dynamic Range;</li>
<li>HDR: High Dynamic Range.</li>
     * @param Type Frame dynamic range information. Valid values:
<li>SDR: Standard Dynamic Range;</li>
<li>HDR: High Dynamic Range.</li>
     */
