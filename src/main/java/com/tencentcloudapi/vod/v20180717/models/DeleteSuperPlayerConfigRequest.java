...
public class DeleteSuperPlayerConfigRequest extends AbstractModel{
    ...
    */
    ...
    public DeleteSuperPlayerConfigRequest() {
    }
     ...
     */
    public DeleteSuperPlayerConfigRequest(DeleteSuperPlayerConfigRequest source) {
        if (source.Name != null) {
