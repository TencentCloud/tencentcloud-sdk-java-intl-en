...
public class AigcVideoRedrawOutputFileInfo extends AbstractModel {
    ...
    */
    ...
    /**
    * <p>Meta-information of the output video. Valid when StorageMode is Permanent.</p>
    */
    ...
    /**
     * Get <p>Meta-information of the output video. Valid when StorageMode is Permanent.</p> 
     * @return MetaData <p>Meta-information of the output video. Valid when StorageMode is Permanent.</p>
     */
    ...
    /**
     * Set <p>Meta-information of the output video. Valid when StorageMode is Permanent.</p>
     * @param MetaData <p>Meta-information of the output video. Valid when StorageMode is Permanent.</p>
     */
