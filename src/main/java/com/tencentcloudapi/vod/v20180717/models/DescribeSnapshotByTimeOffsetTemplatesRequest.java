...
<li>Custom: custom template.</li>
    */
    ...
    /**
     * Get Filtering condition for the unique identifier of the screenshot template at the specified time point. The array length cannot exceed 100. 
     * @return Definitions Filtering condition for the unique identifier of the screenshot template at the specified time point. The array length cannot exceed 100.
     */
    ...
    /**
     * Set Filtering condition for the unique identifier of the screenshot template at the specified time point. The array length cannot exceed 100.
     * @param Definitions Filtering condition for the unique identifier of the screenshot template at the specified time point. The array length cannot exceed 100.
     */
