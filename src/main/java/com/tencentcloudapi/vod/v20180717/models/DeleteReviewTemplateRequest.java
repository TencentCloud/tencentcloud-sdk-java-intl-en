...
public class DeleteReviewTemplateRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteReviewTemplateRequest() {
    }
     ...
     */
    public DeleteReviewTemplateRequest(DeleteReviewTemplateRequest source) {
