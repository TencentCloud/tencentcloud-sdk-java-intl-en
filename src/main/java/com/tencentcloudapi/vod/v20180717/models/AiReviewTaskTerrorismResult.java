...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Get Input for intelligent recognition of terrorism content 
    ...
    /**
     * Set Input for intelligent recognition of terrorism content
...
Note: This field may return `null`, indicating that no valid value can be found.
    ...
    /**
     * Get The progress of a moderation task (terrorist content). Value range: 0-100. 
     * @return Progress The progress of a moderation task (terrorist content). Value range: 0-100.
     */
    ...
    /**
     * Set The progress of a moderation task (terrorist content). Value range: 0-100.
