...
public class AiRecognitionTaskAsrWordsResult extends AbstractModel {
    ...
    */
    ...
    /**
    * Input information on the speech keyword recognition task.
    */
    ...
    /**
    * Output information on the speech keyword recognition task.
    */
    ...
    */
    ...
    /**
    * Speech keyword recognition task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
    */
    ...
    */
    ...
    /**
     * Get Input information on the speech keyword recognition task. 
     * @return Input Input information on the speech keyword recognition task.
     */
    ...
    /**
     * Set Input information on the speech keyword recognition task.
     * @param Input Input information on the speech keyword recognition task.
     */
    ...
    /**
     * Get Output information on the speech keyword recognition task. 
     * @return Output Output information on the speech keyword recognition task.
     */
    ...
    /**
     * Set Output information on the speech keyword recognition task.
     * @param Output Output information on the speech keyword recognition task.
     */
    ...
    /**
     * Get Speech keyword recognition task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I). 
     * @return BeginProcessTime Speech keyword recognition task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
    ...
    /**
     * Set Speech keyword recognition task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     * @param BeginProcessTime Speech keyword recognition task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
