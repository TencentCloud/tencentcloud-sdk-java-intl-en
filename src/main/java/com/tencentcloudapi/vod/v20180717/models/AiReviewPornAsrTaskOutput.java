...
<font color=red>Note</font>: This list can only display up to the first 100 elements. To obtain the complete result, get it from the file corresponding to SegmentSetFileUrl.
    ...
    */
    ...
    /**
     * Get Result suggestions for Asr text involving offensive content. Value range:
<li>pass.</li>
<li>review.</li>
<li>block.</li> 
...
<li>block.</li>
    ...
    /**
     * Set Result suggestions for Asr text involving offensive content. Value range:
<li>pass.</li>
<li>review.</li>
<li>block.</li>
     * @param Suggestion Result suggestions for Asr text involving offensive content. Value range:
<li>pass.</li>
<li>review.</li>
<li>block.</li>
     */
