...
public class CloneVoiceAsyncTask extends AbstractModel {
    ...
    */
    ...
    /**
    * <p>Error code. 0 indicates success, and other values indicate failure:</p><li>40000: Invalid parameters. Check the input parameters.</li><li>60000: Source file error (for example, video data corruption). Confirm whether the source file is normal.</li><li>70000: Internal service error. Retry is recommended.</li>
    */
    ...
    */
    ...
    /**
    * <p>Error code. An empty string indicates that the task is successful, while other values indicate that the task has failed. For valid values, see the list of <a href="https://www.tencentcloud.com/document/product/266/50368?from_cn_redirect=1#.E8.A7.86.E9.A2.91.E5.A4.84.E7.90.86.E7.B1.BB.E9.94.99.E8.AF.AF.E7.A0.81">video processing error codes</a>.</p>
    */
    ...
    /**
    * <p>Voice type clone task input information.</p>
    */
    @SerializedName("Input")
    @Expose
    private CloneVoiceAsyncInput Input;

    /**
    * <p>Voice type clone task output information.</p>
    */
    @SerializedName("Output")
    @Expose
    private CloneVoiceAsyncOutput Output;
    ...
    */
    ...
    /**
     * Get <p>Error code. 0 indicates success, and other values indicate failure:</p><li>40000: Invalid parameters. Check the input parameters.</li><li>60000: Source file error (for example, video data corruption). Confirm whether the source file is normal.</li><li>70000: Internal service error. Retry is recommended.</li> 
     * @return ErrCode <p>Error code. 0 indicates success, and other values indicate failure:</p><li>40000: Invalid parameters. Check the input parameters.</li><li>60000: Source file error (for example, video data corruption). Confirm whether the source file is normal.</li><li>70000: Internal service error. Retry is recommended.</li>
     */
    ...
    /**
     * Set <p>Error code. 0 indicates success, and other values indicate failure:</p><li>40000: Invalid parameters. Check the input parameters.</li><li>60000: Source file error (for example, video data corruption). Confirm whether the source file is normal.</li><li>70000: Internal service error. Retry is recommended.</li>
    ...
    /**
     * Get <p>Error code. An empty string indicates that the task is successful, while other values indicate that the task has failed. For valid values, see the list of <a href="https://www.tencentcloud.com/document/product/266/50368?from_cn_redirect=1#.E8.A7.86.E9.A2.91.E5.A4.84.E7.90.86.E7.B1.BB.E9.94.99.E8.AF.AF.E7.A0.81">video processing error codes</a>.</p> 
     * @return ErrCodeExt <p>Error code. An empty string indicates that the task is successful, while other values indicate that the task has failed. For valid values, see the list of <a href="https://www.tencentcloud.com/document/product/266/50368?from_cn_redirect=1#.E8.A7.86.E9.A2.91.E5.A4.84.E7.90.86.E7.B1.BB.E9.94.99.E8.AF.AF.E7.A0.81">video processing error codes</a>.</p>
     */
    ...
    /**
     * Set <p>Error code. An empty string indicates that the task is successful, while other values indicate that the task has failed. For valid values, see the list of <a href="https://www.tencentcloud.com/document/product/266/50368?from_cn_redirect=1#.E8.A7.86.E9.A2.91.E5.A4.84.E7.90.86.E7.B1.BB.E9.94.99.E8.AF.AF.E7.A0.81">video processing error codes</a>.</p>
     * @param ErrCodeExt <p>Error code. An empty string indicates that the task is successful, while other values indicate that the task has failed. For valid values, see the list of <a href="https://www.tencentcloud.com/document/product/266/50368?from_cn_redirect=1#.E8.A7.86.E9.A2.91.E5.A4.84.E7.90.86.E7.B1.BB.E9.94.99.E8.AF.AF.E7.A0.81">video processing error codes</a>.</p>
     */
    ...
    /**
     * Get <p>Voice type clone task input information.</p> 
     * @return Input <p>Voice type clone task input information.</p>
     */
    public CloneVoiceAsyncInput getInput() {
        return this.Input;
    }

    /**
     * Set <p>Voice type clone task input information.</p>
     * @param Input <p>Voice type clone task input information.</p>
     */
    public void setInput(CloneVoiceAsyncInput Input) {
        this.Input = Input;
    }

    /**
     * Get <p>Voice type clone task output information.</p> 
     * @return Output <p>Voice type clone task output information.</p>
     */
    public CloneVoiceAsyncOutput getOutput() {
        return this.Output;
    }

    /**
     * Set <p>Voice type clone task output information.</p>
     * @param Output <p>Voice type clone task output information.</p>
     */
    public void setOutput(CloneVoiceAsyncOutput Output) {
        this.Output = Output;
    }
     ...
     */
    public CloneVoiceAsyncTask(CloneVoiceAsyncTask source) {
        ...
        if (source.Input != null) {
            this.Input = new CloneVoiceAsyncInput(source.Input);
        }
        if (source.Output != null) {
            this.Output = new CloneVoiceAsyncOutput(source.Output);
        }
