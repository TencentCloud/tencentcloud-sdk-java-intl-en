...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    */
    ...
    /**
     * Get Input for an intelligent highlight generating task. 
    ...
    /**
     * Set Input for an intelligent highlight generating task.
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Get The progress of an intelligent highlight generation task. Value range: 0-100. 
     * @return Progress The progress of an intelligent highlight generation task. Value range: 0-100.
     */
    ...
    /**
     * Set The progress of an intelligent highlight generation task. Value range: 0-100.
    ...
    /**
     * Get The time when the smart highlight task started execution, in [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format). 
     * @return BeginProcessTime The time when the smart highlight task started execution, in [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
    ...
    /**
     * Set The time when the smart highlight task started execution, in [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     * @param BeginProcessTime The time when the smart highlight task started execution, in [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
    ...
    /**
     * Get The time the smart highlight task completed, in [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format). 
     * @return FinishTime The time the smart highlight task completed, in [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
    ...
    /**
     * Set The time the smart highlight task completed, in [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     * @param FinishTime The time the smart highlight task completed, in [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
