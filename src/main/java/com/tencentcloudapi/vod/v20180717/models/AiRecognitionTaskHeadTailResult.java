...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    */
    ...
    /**
     * Get Input information of video opening and ending credits recognition task. 
     * @return Input Input information of video opening and ending credits recognition task.
     */
    ...
    /**
     * Set Input information of video opening and ending credits recognition task.
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Get The progress of an opening/closing segment recognition task. Value range: 0-100. 
     * @return Progress The progress of an opening/closing segment recognition task. Value range: 0-100.
     */
    ...
    /**
     * Set The progress of an opening/closing segment recognition task. Value range: 0-100.
    ...
    /**
     * Get The time when the video start and end recognition task starts, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format). 
     * @return BeginProcessTime The time when the video start and end recognition task starts, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
    ...
    /**
     * Set The time when the video start and end recognition task starts, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     * @param BeginProcessTime The time when the video start and end recognition task starts, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
    ...
    /**
     * Get The time when the video start and end recognition task is completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format). 
     * @return FinishTime The time when the video start and end recognition task is completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
    ...
    /**
     * Set The time when the video start and end recognition task is completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     * @param FinishTime The time when the video start and end recognition task is completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
    public void setFinishTime(String FinishTime) {
        this.FinishTime = FinishTime;
    }

    public AiRecognitionTaskHeadTailResult() {
    }
     ...
     */
    public AiRecognitionTaskHeadTailResult(AiRecognitionTaskHeadTailResult source) {
        ...
        if (source.Input != null) {
            this.Input = new AiRecognitionTaskHeadTailResultInput(source.Input);
        }
        if (source.Output != null) {
            this.Output = new AiRecognitionTaskHeadTailResultOutput(source.Output);
        }
