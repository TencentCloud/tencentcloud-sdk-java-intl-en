...
public class SetCLSPushTargetRequest extends AbstractModel {
    ...
    */
    ...
    /**
    * Log push destination to set in the Chinese mainland.
    */
    ...
    */
    ...
    /**
     * Get Log push destination to set in the Chinese mainland. 
     * @return ChineseMainlandCLSTargetInfo Log push destination to set in the Chinese mainland.
     */
    ...
    /**
     * Set Log push destination to set in the Chinese mainland.
     * @param ChineseMainlandCLSTargetInfo Log push destination to set in the Chinese mainland.
     */
