...
public class DescribeProcessImageAsyncTemplatesResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private ProcessImageAsyncTemplateItem [] ProcessImageAsyncTemplateSet;
    ...
    */
    ...
    public DescribeProcessImageAsyncTemplatesResponse() {
    }
     ...
     */
    public DescribeProcessImageAsyncTemplatesResponse(DescribeProcessImageAsyncTemplatesResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.ProcessImageAsyncTemplateSet != null) {
            this.ProcessImageAsyncTemplateSet = new ProcessImageAsyncTemplateItem[source.ProcessImageAsyncTemplateSet.length];
            for (int i = 0; i < source.ProcessImageAsyncTemplateSet.length; i++) {
                this.ProcessImageAsyncTemplateSet[i] = new ProcessImageAsyncTemplateItem(source.ProcessImageAsyncTemplateSet[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamArrayObj(map, prefix + "ProcessImageAsyncTemplateSet.", this.ProcessImageAsyncTemplateSet);
