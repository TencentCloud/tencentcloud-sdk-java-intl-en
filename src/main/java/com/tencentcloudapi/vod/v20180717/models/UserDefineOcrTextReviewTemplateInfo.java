...
public class UserDefineOcrTextReviewTemplateInfo extends AbstractModel {
    ...
    /**
    * Switch for custom text, audio, and video moderation tasks. Available values:
...
The number of tags can be up to 10, and each tag can contain up to 16 characters.
    ...
    */
    ...
    /**
     * Get Switch for custom text, audio, and video moderation tasks. Available values:
<li>ON: enable custom text, audio, and video moderation tasks;</li>
<li>OFF: disables the custom text audio/video moderation task.</li> 
     * @return Switch Switch for custom text, audio, and video moderation tasks. Available values:
<li>ON: enable custom text, audio, and video moderation tasks;</li>
<li>OFF: disables the custom text audio/video moderation task.</li>
     */
    ...
    /**
     * Set Switch for custom text, audio, and video moderation tasks. Available values:
<li>ON: enable custom text, audio, and video moderation tasks;</li>
<li>OFF: disables the custom text audio/video moderation task.</li>
     * @param Switch Switch for custom text, audio, and video moderation tasks. Available values:
<li>ON: enable custom text, audio, and video moderation tasks;</li>
<li>OFF: disables the custom text audio/video moderation task.</li>
     */
