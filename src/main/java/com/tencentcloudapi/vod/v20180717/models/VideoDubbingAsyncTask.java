...
public class VideoDubbingAsyncTask extends AbstractModel {
    ...
    */
    ...
    @Expose
    private VideoDubbingAsyncInput Input;
    ...
    */
    ...
    @Expose
    private VideoDubbingAsyncOutput Output;
    ...
    */
    ...
    /**
     * Get <p>Video dubbing task output information.</p> 
     * @return Output <p>Video dubbing task output information.</p>
     */
    public VideoDubbingAsyncOutput getOutput() {
        return this.Output;
    }

    /**
     * Set <p>Video dubbing task output information.</p>
     * @param Output <p>Video dubbing task output information.</p>
     */
    public void setOutput(VideoDubbingAsyncOutput Output) {
        this.Output = Output;
    }
     ...
     */
    public VideoDubbingAsyncTask(VideoDubbingAsyncTask source) {
        ...
        if (source.Input != null) {
            this.Input = new VideoDubbingAsyncInput(source.Input);
        }
        if (source.Output != null) {
            this.Output = new VideoDubbingAsyncOutput(source.Output);
        }
