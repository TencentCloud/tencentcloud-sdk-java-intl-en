...
public class AiReviewTaskPornAsrResult extends AbstractModel {
    ...
    */
    ...
    /**
    * Task progress of audio/video moderation involving offensive content in Asr text, in the range of [0,100].
    */
    ...
    /**
     * Get Task progress of audio/video moderation involving offensive content in Asr text, in the range of [0,100]. 
     * @return Progress Task progress of audio/video moderation involving offensive content in Asr text, in the range of [0,100].
     */
    ...
    /**
     * Set Task progress of audio/video moderation involving offensive content in Asr text, in the range of [0,100].
     * @param Progress Task progress of audio/video moderation involving offensive content in Asr text, in the range of [0,100].
     */
    ...
    public AiReviewTaskPornAsrResult(AiReviewTaskPornAsrResult source) {
        ...
        if (source.Input != null) {
            this.Input = new AiReviewPornAsrTaskInput(source.Input);
        }
        if (source.Output != null) {
            this.Output = new AiReviewPornAsrTaskOutput(source.Output);
        }
