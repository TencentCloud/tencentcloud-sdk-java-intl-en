...
public class DescribeReviewTemplatesRequest extends AbstractModel {
    ...
    */
    ...
    /**
    * Audit template unique identifier filter condition, with an array length limit of 100.
    */
...
<li>Custom: custom template.</li>
    ...
    */
    ...
    /**
     * Get Audit template unique identifier filter condition, with an array length limit of 100. 
     * @return Definitions Audit template unique identifier filter condition, with an array length limit of 100.
     */
    ...
    /**
     * Set Audit template unique identifier filter condition, with an array length limit of 100.
     * @param Definitions Audit template unique identifier filter condition, with an array length limit of 100.
     */
