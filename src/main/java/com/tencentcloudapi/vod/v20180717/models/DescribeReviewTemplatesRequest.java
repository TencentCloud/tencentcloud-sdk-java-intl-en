...
public class DescribeReviewTemplatesRequest extends AbstractModel {
    ...
    */
    ...
    /**
    * Filter condition for audit template unique identifiers, with an array length limit of 100.
    */
...
<li>Custom: custom template.</li>
    ...
    */
    ...
    /**
     * Get Filter condition for audit template unique identifiers, with an array length limit of 100. 
     * @return Definitions Filter condition for audit template unique identifiers, with an array length limit of 100.
     */
    ...
    /**
     * Set Filter condition for audit template unique identifiers, with an array length limit of 100.
     * @param Definitions Filter condition for audit template unique identifiers, with an array length limit of 100.
     */
