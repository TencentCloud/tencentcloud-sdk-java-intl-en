...
public class AiAnalysisTaskClassificationResult extends AbstractModel {
    ...
    */
    ...
    /**
    * Output of intelligent categorization tasks.
    */
    ...
    /**
    * Progress of the intelligent classification task. Value range: 0–100.
    */
    ...
    /**
    * Intelligent classification task start execution time in [ISO date format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
    */
    ...
    /**
    * Task completion time of intelligent classification in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
    */
    ...
    /**
     * Get Output of intelligent categorization tasks. 
     * @return Output Output of intelligent categorization tasks.
     */
    ...
    /**
     * Set Output of intelligent categorization tasks.
     * @param Output Output of intelligent categorization tasks.
     */
    ...
    /**
     * Get Progress of the intelligent classification task. Value range: 0–100. 
     * @return Progress Progress of the intelligent classification task. Value range: 0–100.
     */
    ...
    /**
     * Set Progress of the intelligent classification task. Value range: 0–100.
     * @param Progress Progress of the intelligent classification task. Value range: 0–100.
     */
    ...
    /**
     * Get Intelligent classification task start execution time in [ISO date format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I). 
     * @return BeginProcessTime Intelligent classification task start execution time in [ISO date format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
    ...
    /**
     * Set Intelligent classification task start execution time in [ISO date format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     * @param BeginProcessTime Intelligent classification task start execution time in [ISO date format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
    ...
    /**
     * Get Task completion time of intelligent classification in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I). 
     * @return FinishTime Task completion time of intelligent classification in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
    ...
    /**
     * Set Task completion time of intelligent classification in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     * @param FinishTime Task completion time of intelligent classification in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
