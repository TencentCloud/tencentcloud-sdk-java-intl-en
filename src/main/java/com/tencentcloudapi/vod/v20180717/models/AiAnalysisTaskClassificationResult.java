...
public class AiAnalysisTaskClassificationResult extends AbstractModel {
    ...
    */
    ...
    /**
    * Output of the intelligent classification task.
    */
    ...
    /**
    * Intelligent categorization task progress, in the range of [0,100].
    */
    ...
    /**
    * Intelligent categorization task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
    */
    ...
    /**
    * Task completion time of intelligent categorization in [ISO date format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
    */
    ...
    /**
     * Get Intelligent classification task input. 
     * @return Input Intelligent classification task input.
     */
    ...
    /**
     * Set Intelligent classification task input.
     * @param Input Intelligent classification task input.
     */
    ...
    /**
     * Get Output of the intelligent classification task. 
     * @return Output Output of the intelligent classification task.
     */
    ...
    /**
     * Set Output of the intelligent classification task.
     * @param Output Output of the intelligent classification task.
     */
    ...
    /**
     * Get Intelligent categorization task progress, in the range of [0,100]. 
     * @return Progress Intelligent categorization task progress, in the range of [0,100].
     */
    ...
    /**
     * Set Intelligent categorization task progress, in the range of [0,100].
     * @param Progress Intelligent categorization task progress, in the range of [0,100].
     */
    ...
    /**
     * Get Intelligent categorization task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I). 
     * @return BeginProcessTime Intelligent categorization task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
    ...
    /**
     * Set Intelligent categorization task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     * @param BeginProcessTime Intelligent categorization task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
    ...
    /**
     * Get Task completion time of intelligent categorization in [ISO date format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I). 
     * @return FinishTime Task completion time of intelligent categorization in [ISO date format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
    ...
    /**
     * Set Task completion time of intelligent categorization in [ISO date format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     * @param FinishTime Task completion time of intelligent categorization in [ISO date format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
