...
public class DescribeImageSpriteTemplatesRequest extends AbstractModel {
    ...
    */
    ...
    /**
    * Sprite template unique identifier filter condition, with an array length limit of 100.
    */
...
<li>Custom: custom template.</li>
    */
    ...
    /**
     * Get Sprite template unique identifier filter condition, with an array length limit of 100. 
     * @return Definitions Sprite template unique identifier filter condition, with an array length limit of 100.
     */
    ...
    /**
     * Set Sprite template unique identifier filter condition, with an array length limit of 100.
     * @param Definitions Sprite template unique identifier filter condition, with an array length limit of 100.
     */
