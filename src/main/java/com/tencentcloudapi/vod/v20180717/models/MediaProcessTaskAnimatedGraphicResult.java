...
public class MediaProcessTaskAnimatedGraphicResult extends AbstractModel {
    ...
    */
    ...
    /**
    * Output of rotating image tasks.
    */
    ...
    */
    ...
    /**
    * Animated image task completion time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
    */
    ...
    /**
     * Get Output of rotating image tasks. 
     * @return Output Output of rotating image tasks.
     */
    ...
    /**
     * Set Output of rotating image tasks.
     * @param Output Output of rotating image tasks.
     */
    ...
    /**
     * Get Animated image task completion time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I). 
     * @return FinishTime Animated image task completion time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
    ...
    /**
     * Set Animated image task completion time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     * @param FinishTime Animated image task completion time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
     */
