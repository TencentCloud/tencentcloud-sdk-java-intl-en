...
public class QualityInspectConfig extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Sampling interval time</p><p>Unit: ms.</p> 
    ...
    /**
     * Set <p>Sampling interval time</p><p>Unit: ms.</p>
     * @param IntervalTime <p>Sampling interval time</p><p>Unit: ms.</p>
     */
    ...
    /**
     * Get <p>Duration of abnormality.</p><p>Measurement unit: ms.</p> 
    ...
    /**
     * Set <p>Duration of abnormality.</p><p>Measurement unit: ms.</p>
     * @param Duration <p>Duration of abnormality.</p><p>Measurement unit: ms.</p>
     */
    ...
    /**
     * Get <p>Threshold corresponding to the detection item. Different detection items have different thresholds.</p> 
    ...
    /**
     * Set <p>Threshold corresponding to the detection item. Different detection items have different thresholds.</p>
     * @param Threshold <p>Threshold corresponding to the detection item. Different detection items have different thresholds.</p>
     */
