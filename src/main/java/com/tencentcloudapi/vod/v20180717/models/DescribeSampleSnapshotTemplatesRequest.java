...
public class DescribeSampleSnapshotTemplatesRequest extends AbstractModel {
    ...
    */
    ...
    /**
    * Filter condition for the sampling screenshot template unique identifier. The array length cannot exceed 100.
    */
...
<li>Custom: User-defined template.</li>
    */
    ...
    /**
     * Get Filter condition for the sampling screenshot template unique identifier. The array length cannot exceed 100. 
     * @return Definitions Filter condition for the sampling screenshot template unique identifier. The array length cannot exceed 100.
     */
    ...
    /**
     * Set Filter condition for the sampling screenshot template unique identifier. The array length cannot exceed 100.
     * @param Definitions Filter condition for the sampling screenshot template unique identifier. The array length cannot exceed 100.
     */
