...
public class QualityInspectResultItem extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Exception type. Value range:</p><li>Jitter: jitter;</li><li>Blur: blurry;</li><li>LowLighting: low illumination;</li><li>HighLighting: overexposure;</li><li>CrashScreen: screen glitch;</li><li>BlackWhiteEdge: black and white edges;</li><li>SolidColorScreen: solid color screen;</li><li>Noise: noise;</li><li>Mosaic: mosaic;</li><li>QRCode: QR code;</li><li>AppletCode: mini program code;</li><li>BarCode: barcode;</li><li>LowVoice: low voice;</li><li>HighVoice: high voice;</li><li>NoVoice: mute;</li><li>LowEvaluation: no reference scoring below threshold.</li><li> LowColorfulness: color richness info.</li><li> AudioVideoAsync: audio and video synchronization issues.</li><li> AudioSubtitleAsync: audio and subtitle synchronization issues.</li><li> VideoAesthetic: low video aesthetic score.</li><li> AudioDiscontinuity: discontinuous audio.</li><li> AudioVolume: volume information.</li><li> AudioLoudnessJitter: severe volume change.</li><li> BackgroundMusic: background music exists.</li><li> AudioEvaluation: poor bass quality.</li><li> AudioNoise: noise.</li><li> AudioSpeechQuality: low speech definition.</li><li> AudioReverb: high reverberation level.</li><li> AudioHighLoudness: loudness distortion.</li> 
    ...
    /**
     * Set <p>Exception type. Value range:</p><li>Jitter: jitter;</li><li>Blur: blurry;</li><li>LowLighting: low illumination;</li><li>HighLighting: overexposure;</li><li>CrashScreen: screen glitch;</li><li>BlackWhiteEdge: black and white edges;</li><li>SolidColorScreen: solid color screen;</li><li>Noise: noise;</li><li>Mosaic: mosaic;</li><li>QRCode: QR code;</li><li>AppletCode: mini program code;</li><li>BarCode: barcode;</li><li>LowVoice: low voice;</li><li>HighVoice: high voice;</li><li>NoVoice: mute;</li><li>LowEvaluation: no reference scoring below threshold.</li><li> LowColorfulness: color richness info.</li><li> AudioVideoAsync: audio and video synchronization issues.</li><li> AudioSubtitleAsync: audio and subtitle synchronization issues.</li><li> VideoAesthetic: low video aesthetic score.</li><li> AudioDiscontinuity: discontinuous audio.</li><li> AudioVolume: volume information.</li><li> AudioLoudnessJitter: severe volume change.</li><li> BackgroundMusic: background music exists.</li><li> AudioEvaluation: poor bass quality.</li><li> AudioNoise: noise.</li><li> AudioSpeechQuality: low speech definition.</li><li> AudioReverb: high reverberation level.</li><li> AudioHighLoudness: loudness distortion.</li>
     * @param Type <p>Exception type. Value range:</p><li>Jitter: jitter;</li><li>Blur: blurry;</li><li>LowLighting: low illumination;</li><li>HighLighting: overexposure;</li><li>CrashScreen: screen glitch;</li><li>BlackWhiteEdge: black and white edges;</li><li>SolidColorScreen: solid color screen;</li><li>Noise: noise;</li><li>Mosaic: mosaic;</li><li>QRCode: QR code;</li><li>AppletCode: mini program code;</li><li>BarCode: barcode;</li><li>LowVoice: low voice;</li><li>HighVoice: high voice;</li><li>NoVoice: mute;</li><li>LowEvaluation: no reference scoring below threshold.</li><li> LowColorfulness: color richness info.</li><li> AudioVideoAsync: audio and video synchronization issues.</li><li> AudioSubtitleAsync: audio and subtitle synchronization issues.</li><li> VideoAesthetic: low video aesthetic score.</li><li> AudioDiscontinuity: discontinuous audio.</li><li> AudioVolume: volume information.</li><li> AudioLoudnessJitter: severe volume change.</li><li> BackgroundMusic: background music exists.</li><li> AudioEvaluation: poor bass quality.</li><li> AudioNoise: noise.</li><li> AudioSpeechQuality: low speech definition.</li><li> AudioReverb: high reverberation level.</li><li> AudioHighLoudness: loudness distortion.</li>
     */
    ...
    /**
     * Get <p>Abnormal fragment list.<br><font color="red">Note:</font> This list can only display up to the first 100 elements. To obtain the complete result, get it from the file corresponding to SegmentSetFileUrl.</p> 
    ...
    /**
     * Set <p>Abnormal fragment list.<br><font color="red">Note:</font> This list can only display up to the first 100 elements. To obtain the complete result, get it from the file corresponding to SegmentSetFileUrl.</p>
     * @param SegmentSet <p>Abnormal fragment list.<br><font color="red">Note:</font> This list can only display up to the first 100 elements. To obtain the complete result, get it from the file corresponding to SegmentSetFileUrl.</p>
     */
    ...
    /**
     * Get <p>URL of the abnormal fragment list file. The file content is in JSON format, and its data structure is consistent with the fields of SegmentSet. (The file will not be retained permanently. It will be deleted after reaching the SegmentSetFileUrlExpireTime time point.)</p> 
    ...
    /**
     * Set <p>URL of the abnormal fragment list file. The file content is in JSON format, and its data structure is consistent with the fields of SegmentSet. (The file will not be retained permanently. It will be deleted after reaching the SegmentSetFileUrlExpireTime time point.)</p>
     * @param SegmentSetFileUrl <p>URL of the abnormal fragment list file. The file content is in JSON format, and its data structure is consistent with the fields of SegmentSet. (The file will not be retained permanently. It will be deleted after reaching the SegmentSetFileUrlExpireTime time point.)</p>
     */
    ...
    /**
     * Get <p>Expiration time of the URL of the exception segment list file, in <a href="https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I">ISO date format</a>.</p> 
    ...
    /**
     * Set <p>Expiration time of the URL of the exception segment list file, in <a href="https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I">ISO date format</a>.</p>
     * @param SegmentSetFileUrlExpireTime <p>Expiration time of the URL of the exception segment list file, in <a href="https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I">ISO date format</a>.</p>
     */
