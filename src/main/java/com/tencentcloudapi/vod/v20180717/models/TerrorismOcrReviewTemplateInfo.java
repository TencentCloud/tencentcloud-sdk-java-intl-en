...
<li>OFF</li>
    ...
    */
    ...
    /**
     * Get Whether to enable OCR-based recognition of terrorism content. Valid values:
<li>ON</li>
<li>OFF</li> 
     * @return Switch Whether to enable OCR-based recognition of terrorism content. Valid values:
<li>ON</li>
<li>OFF</li>
     */
    ...
    /**
     * Set Whether to enable OCR-based recognition of terrorism content. Valid values:
<li>ON</li>
<li>OFF</li>
...
<li>OFF</li>
    ...
    public TerrorismOcrReviewTemplateInfo() {
    }
     ...
     */
    public TerrorismOcrReviewTemplateInfo(TerrorismOcrReviewTemplateInfo source) {
