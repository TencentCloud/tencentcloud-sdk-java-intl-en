...
public class PushUrlCacheRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get List of prefetched URLs. Up to 20 ones can be specified at a time. 
     * @return Urls List of prefetched URLs. Up to 20 ones can be specified at a time.
     */
    ...
    /**
     * Set List of prefetched URLs. Up to 20 ones can be specified at a time.
