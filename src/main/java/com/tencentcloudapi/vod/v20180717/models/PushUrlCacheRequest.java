...
public class PushUrlCacheRequest extends AbstractModel {
    ...
    /**
    * Preheated URL list. You can specify up to 20 URLs at a time.
    */
    @SerializedName("Urls")
    @Expose
    private String [] Urls;
    ...
    */
    ...
    /**
     * Get Preheated URL list. You can specify up to 20 URLs at a time. 
     * @return Urls Preheated URL list. You can specify up to 20 URLs at a time.
     */
    ...
    /**
     * Set Preheated URL list. You can specify up to 20 URLs at a time.
     * @param Urls Preheated URL list. You can specify up to 20 URLs at a time.
     */
