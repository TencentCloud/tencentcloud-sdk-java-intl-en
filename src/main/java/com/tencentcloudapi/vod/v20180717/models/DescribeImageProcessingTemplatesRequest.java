...
public class DescribeImageProcessingTemplatesRequest extends AbstractModel {
    ...
    */
    ...
    /**
    * List of image processing template IDs. The length cannot exceed 100.
    */
...
<li>Custom: custom template.</li>
    ...
    */
    ...
    /**
     * Get List of image processing template IDs. The length cannot exceed 100. 
     * @return Definitions List of image processing template IDs. The length cannot exceed 100.
     */
    ...
    /**
     * Set List of image processing template IDs. The length cannot exceed 100.
     * @param Definitions List of image processing template IDs. The length cannot exceed 100.
     */
