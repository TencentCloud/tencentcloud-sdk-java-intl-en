...
public class ModifySnapshotByTimeOffsetTemplateRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Unique identifier of screenshot template at specified time point.</p> 
    ...
    /**
     * Set <p>Unique identifier of screenshot template at specified time point.</p>
     * @param Definition <p>Unique identifier of screenshot template at specified time point.</p>
     */
    ...
    /**
     * Get <p><b>On-demand <a href="/document/product/266/14574">application</a> ID. For customers who activate on-demand services from December 25, 2023, if they access resources in on-demand applications (whether the default application or a newly created application), this field must be filled with the app ID.</b></p> 
    ...
    /**
     * Set <p><b>On-demand <a href="/document/product/266/14574">application</a> ID. For customers who activate on-demand services from December 25, 2023, if they access resources in on-demand applications (whether the default application or a newly created application), this field must be filled with the app ID.</b></p>
    ...
    /**
     * Get <p>Screenshot template name at specified time point. Length limit: 64 characters.</p> 
    ...
    /**
     * Set <p>Screenshot template name at specified time point. Length limit: 64 characters.</p>
     * @param Name <p>Screenshot template name at specified time point. Length limit: 64 characters.</p>
     */
    ...
    /**
     * Get <p>Resolution adaptation. Available values:</p><li>open: enable. At this point, Width represents the long side of the video, and Height represents the short side;</li><li>close: disable. At this point, Width represents the width of the video, and Height represents the height.</li>Default value: open. 
    ...
    /**
     * Set <p>Resolution adaptation. Available values:</p><li>open: enable. At this point, Width represents the long side of the video, and Height represents the short side;</li><li>close: disable. At this point, Width represents the width of the video, and Height represents the height.</li>Default value: open.
