...
public class DescribeAigcAdvancedCustomElementsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Starting offset amount for pagination return. It will return records from Offset to Offset+Limit-1.</p><p>Default value: 0</p><p>Offset must be a multiple of Limit.</p> 
    ...
    /**
     * Set <p>Starting offset amount for pagination return. It will return records from Offset to Offset+Limit-1.</p><p>Default value: 0</p><p>Offset must be a multiple of Limit.</p>
     * @param Offset <p>Starting offset amount for pagination return. It will return records from Offset to Offset+Limit-1.</p><p>Default value: 0</p><p>Offset must be a multiple of Limit.</p>
     */
    ...
    /**
     * Get <p>Number of records returned in pages.</p><p>Value range: [1, 300]</p><p>Default value: 10</p><p>Offset must be an integral multiple of Limit.</p> 
    ...
    /**
     * Set <p>Number of records returned in pages.</p><p>Value range: [1, 300]</p><p>Default value: 10</p><p>Offset must be an integral multiple of Limit.</p>
     * @param Limit <p>Number of records returned in pages.</p><p>Value range: [1, 300]</p><p>Default value: 10</p><p>Offset must be an integral multiple of Limit.</p>
     */
