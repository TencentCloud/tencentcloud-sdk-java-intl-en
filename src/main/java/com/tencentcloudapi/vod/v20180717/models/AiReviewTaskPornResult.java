...
public class AiReviewTaskPornResult extends AbstractModel {
    ...
    */
    ...
    /**
    * Task output of audio/video moderation involving offensive content.
    */
    ...
    /**
    * Task progress of audio/video moderation involving offensive content, in the range of [0,100].
    */
    ...
    /**
     * Get Task output of audio/video moderation involving offensive content. 
     * @return Output Task output of audio/video moderation involving offensive content.
     */
    ...
    /**
     * Set Task output of audio/video moderation involving offensive content.
     * @param Output Task output of audio/video moderation involving offensive content.
     */
    ...
    /**
     * Get Task progress of audio/video moderation involving offensive content, in the range of [0,100]. 
     * @return Progress Task progress of audio/video moderation involving offensive content, in the range of [0,100].
     */
    ...
    /**
     * Set Task progress of audio/video moderation involving offensive content, in the range of [0,100].
     * @param Progress Task progress of audio/video moderation involving offensive content, in the range of [0,100].
     */
     ...
     */
    public AiReviewTaskPornResult(AiReviewTaskPornResult source) {
        ...
        if (source.Input != null) {
            this.Input = new AiReviewPornTaskInput(source.Input);
        }
        if (source.Output != null) {
            this.Output = new AiReviewPornTaskOutput(source.Output);
        }
