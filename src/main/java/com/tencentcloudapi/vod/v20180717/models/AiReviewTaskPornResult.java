...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Get Video moderation involves offensive content in task output. 
    ...
    /**
     * Set Video moderation involves offensive content in task output.
     * @param Output Video moderation involves offensive content in task output.
     */
    ...
    /**
     * Get The progress of a moderation task (pornographic content). Value range: 0-100. 
     * @return Progress The progress of a moderation task (pornographic content). Value range: 0-100.
     */
    ...
    /**
     * Set The progress of a moderation task (pornographic content). Value range: 0-100.
