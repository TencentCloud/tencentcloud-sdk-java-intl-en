...
public class DescribeCurrentPlaylistResponse extends AbstractModel {
    ...
    */
     ...
     * @param CurrentPlaylist Current playlist information.
     */
     ...
     */
    public DescribeCurrentPlaylistResponse(DescribeCurrentPlaylistResponse source) {
        if (source.CurrentPlaylist != null) {
            this.CurrentPlaylist = new RoundPlayFilePlayInfo[source.CurrentPlaylist.length];
            for (int i = 0; i < source.CurrentPlaylist.length; i++) {
                this.CurrentPlaylist[i] = new RoundPlayFilePlayInfo(source.CurrentPlaylist[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "CurrentPlaylist.", this.CurrentPlaylist);
