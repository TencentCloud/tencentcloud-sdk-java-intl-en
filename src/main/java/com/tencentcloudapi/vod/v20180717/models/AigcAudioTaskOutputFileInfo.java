...
public class AigcAudioTaskOutputFileInfo extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Expiry date of the output file. The file will be deleted after this time. It is permanent with no expiration by default. The format is based on ISO 8601. For details, see <a href="https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I">ISO date format description</a>.</p> 
    ...
    /**
     * Set <p>Expiry date of the output file. The file will be deleted after this time. It is permanent with no expiration by default. The format is based on ISO 8601. For details, see <a href="https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I">ISO date format description</a>.</p>
     * @param ExpireTime <p>Expiry date of the output file. The file will be deleted after this time. It is permanent with no expiration by default. The format is based on ISO 8601. For details, see <a href="https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I">ISO date format description</a>.</p>
     */
    ...
    /**
     * Get <p>Meta-information of the output audio.</p> 
     * @return MetaData <p>Meta-information of the output audio.</p>
     */
    ...
    /**
     * Set <p>Meta-information of the output audio.</p>
     * @param MetaData <p>Meta-information of the output audio.</p>
     */
