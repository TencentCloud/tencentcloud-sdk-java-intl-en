...
public class DescribeCLSPushTargetsRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeCLSPushTargetsRequest() {
    }
     ...
     */
    public DescribeCLSPushTargetsRequest(DescribeCLSPushTargetsRequest source) {
