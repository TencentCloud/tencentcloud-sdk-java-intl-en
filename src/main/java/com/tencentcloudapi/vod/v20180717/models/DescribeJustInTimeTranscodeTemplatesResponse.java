...
public class DescribeJustInTimeTranscodeTemplatesResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private JustInTimeTranscodeTemplate [] JustInTimeTranscodeTemplateSet;
    ...
    */
    ...
    public DescribeJustInTimeTranscodeTemplatesResponse() {
    }
     ...
     */
    public DescribeJustInTimeTranscodeTemplatesResponse(DescribeJustInTimeTranscodeTemplatesResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.JustInTimeTranscodeTemplateSet != null) {
            this.JustInTimeTranscodeTemplateSet = new JustInTimeTranscodeTemplate[source.JustInTimeTranscodeTemplateSet.length];
            for (int i = 0; i < source.JustInTimeTranscodeTemplateSet.length; i++) {
                this.JustInTimeTranscodeTemplateSet[i] = new JustInTimeTranscodeTemplate(source.JustInTimeTranscodeTemplateSet[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamArrayObj(map, prefix + "JustInTimeTranscodeTemplateSet.", this.JustInTimeTranscodeTemplateSet);
