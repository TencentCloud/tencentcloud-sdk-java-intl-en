...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Get Input for OCR-based recognition of pornographic content 
     * @return Input Input for OCR-based recognition of pornographic content
     */
    ...
    /**
     * Set Input for OCR-based recognition of pornographic content
    ...
    /**
     * Get Video moderation Ocr text involves offensive content in task output. 
    ...
    /**
     * Set Video moderation Ocr text involves offensive content in task output.
     * @param Output Video moderation Ocr text involves offensive content in task output.
     */
    ...
    /**
     * Get The progress of an OCR-based moderation task (pornographic content). Value range: 0-100. 
     * @return Progress The progress of an OCR-based moderation task (pornographic content). Value range: 0-100.
     */
    ...
    /**
     * Set The progress of an OCR-based moderation task (pornographic content). Value range: 0-100.
