...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Get Input of OCR-based porn information detection in text task in content audit. 
     * @return Input Input of OCR-based porn information detection in text task in content audit.
     */
    ...
    /**
     * Set Input of OCR-based porn information detection in text task in content audit.
    ...
    /**
     * Get Output of OCR-based porn information detection in text task in content audit.
Note: this field may return null, indicating that no valid values can be obtained. 
     * @return Output Output of OCR-based porn information detection in text task in content audit.
Note: this field may return null, indicating that no valid values can be obtained.
     */
    ...
    /**
     * Set Output of OCR-based porn information detection in text task in content audit.
Note: this field may return null, indicating that no valid values can be obtained.
