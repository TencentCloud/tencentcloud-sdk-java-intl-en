...
public class AiReviewTaskPornOcrResult extends AbstractModel {
    ...
    */
    ...
    /**
    * Task input of Ocr text involving offensive content in audio/video moderation.
    */
    ...
    /**
    * Task output of Ocr text, audio, and video moderation involving offensive content.
    */
    ...
    */
    ...
    /**
     * Get Task input of Ocr text involving offensive content in audio/video moderation. 
     * @return Input Task input of Ocr text involving offensive content in audio/video moderation.
     */
    ...
    /**
     * Set Task input of Ocr text involving offensive content in audio/video moderation.
     * @param Input Task input of Ocr text involving offensive content in audio/video moderation.
     */
    ...
    /**
     * Get Task output of Ocr text, audio, and video moderation involving offensive content. 
     * @return Output Task output of Ocr text, audio, and video moderation involving offensive content.
     */
    ...
    /**
     * Set Task output of Ocr text, audio, and video moderation involving offensive content.
     * @param Output Task output of Ocr text, audio, and video moderation involving offensive content.
     */
