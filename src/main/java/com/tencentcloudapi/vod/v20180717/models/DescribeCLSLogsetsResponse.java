...
public class DescribeCLSLogsetsResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Set Queried logset list.
     * @param Logsets Queried logset list.
     */
     ...
     */
    public DescribeCLSLogsetsResponse(DescribeCLSLogsetsResponse source) {
        if (source.Logsets != null) {
            this.Logsets = new CLSLogsetInfo[source.Logsets.length];
            for (int i = 0; i < source.Logsets.length; i++) {
                this.Logsets[i] = new CLSLogsetInfo(source.Logsets[i]);
            }
        }
