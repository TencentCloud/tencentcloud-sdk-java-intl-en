...
public class AiRecognitionTaskOcrFullTextResult extends AbstractModel {
    ...
    */
    ...
    /**
    * Output information on the full text recognition task.
    */
    ...
    */
    ...
    /**
     * Get Input information on the full text recognition task. 
     * @return Input Input information on the full text recognition task.
     */
    ...
    /**
     * Set Input information on the full text recognition task.
     * @param Input Input information on the full text recognition task.
     */
    ...
    /**
     * Get Output information on the full text recognition task. 
     * @return Output Output information on the full text recognition task.
     */
    ...
    /**
     * Set Output information on the full text recognition task.
     * @param Output Output information on the full text recognition task.
     */
