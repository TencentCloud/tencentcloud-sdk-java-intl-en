...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Get The progress of a full text recognition task. Value range: 0-100. 
    ...
    /**
     * Set The progress of a full text recognition task. Value range: 0-100.
    ...
    /**
     * Get The time when the full text recognition task started, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format). 
     * @return BeginProcessTime The time when the full text recognition task started, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
    ...
    /**
     * Set The time when the full text recognition task started, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     * @param BeginProcessTime The time when the full text recognition task started, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
    ...
    /**
     * Get The time when the full text recognition task was completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format). 
     * @return FinishTime The time when the full text recognition task was completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
    ...
    /**
     * Set The time when the full text recognition task was completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     * @param FinishTime The time when the full text recognition task was completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
     */
    public void setFinishTime(String FinishTime) {
        this.FinishTime = FinishTime;
    }

    public AiRecognitionTaskOcrFullTextResult() {
    }
     ...
     */
    public AiRecognitionTaskOcrFullTextResult(AiRecognitionTaskOcrFullTextResult source) {
        ...
        if (source.Input != null) {
            this.Input = new AiRecognitionTaskOcrFullTextResultInput(source.Input);
        }
        if (source.Output != null) {
            this.Output = new AiRecognitionTaskOcrFullTextResultOutput(source.Output);
        }
