...
<li>`off`: Cache.</li>
    ...
    */
    ...
    /**
     * Get Switch for authentication configuration for origin-pull from Alibaba Cloud OSS. Valid values:
<li>`on`: Enable;</li>
<li>`off`: Cache.</li> 
...
<li>`off`: Cache.</li>
    ...
    /**
     * Set Switch for authentication configuration for origin-pull from Alibaba Cloud OSS. Valid values:
<li>`on`: Enable;</li>
<li>`off`: Cache.</li>
     * @param Switch Switch for authentication configuration for origin-pull from Alibaba Cloud OSS. Valid values:
<li>`on`: Enable;</li>
<li>`off`: Cache.</li>
     */
