...
<li>`off`: Cache.</li>
    ...
    */
    ...
    /**
     * Get Aliyun OSS origin-pull authentication configuration switch. Valid values:
<li>`on`: Enable;</li>
<li>`off`: Cache.</li> 
...
<li>`off`: Cache.</li>
    ...
    /**
     * Set Aliyun OSS origin-pull authentication configuration switch. Valid values:
<li>`on`: Enable;</li>
<li>`off`: Cache.</li>
     * @param Switch Aliyun OSS origin-pull authentication configuration switch. Valid values:
<li>`on`: Enable;</li>
<li>`off`: Cache.</li>
     */
