...
public class TextToSpeechAsyncTask extends AbstractModel {
    ...
    */
    ...
    /**
    * <p>Text to speech task input information.</p>
    */
    @SerializedName("Input")
    @Expose
    private TextToSpeechAsyncInput Input;

    /**
    * <p>Text to speech task output information.</p>
    */
    @SerializedName("Output")
    @Expose
    private TextToSpeechAsyncOutput Output;
    ...
    */
    ...
    /**
     * Set <p>Error code. An empty string indicates success, while other values indicate failure. For valid values, see the list of <a href="https://www.tencentcloud.com/document/product/266/50368?from_cn_redirect=1#.E8.A7.86.E9.A2.91.E5.A4.84.E7.90.86.E7.B1.BB.E9.94.99.E8.AF.AF.E7.A0.81">video processing error codes</a>.</p>
     * @param ErrCodeExt <p>Error code. An empty string indicates success, while other values indicate failure. For valid values, see the list of <a href="https://www.tencentcloud.com/document/product/266/50368?from_cn_redirect=1#.E8.A7.86.E9.A2.91.E5.A4.84.E7.90.86.E7.B1.BB.E9.94.99.E8.AF.AF.E7.A0.81">video processing error codes</a>.</p>
     */
    ...
    /**
     * Get <p>Text to speech task input information.</p> 
     * @return Input <p>Text to speech task input information.</p>
     */
    public TextToSpeechAsyncInput getInput() {
        return this.Input;
    }

    /**
     * Set <p>Text to speech task input information.</p>
     * @param Input <p>Text to speech task input information.</p>
     */
    public void setInput(TextToSpeechAsyncInput Input) {
        this.Input = Input;
    }

    /**
     * Get <p>Text to speech task output information.</p> 
     * @return Output <p>Text to speech task output information.</p>
     */
    public TextToSpeechAsyncOutput getOutput() {
        return this.Output;
    }

    /**
     * Set <p>Text to speech task output information.</p>
     * @param Output <p>Text to speech task output information.</p>
     */
    public void setOutput(TextToSpeechAsyncOutput Output) {
        this.Output = Output;
    }
     ...
     */
    public TextToSpeechAsyncTask(TextToSpeechAsyncTask source) {
        ...
        if (source.Input != null) {
            this.Input = new TextToSpeechAsyncInput(source.Input);
        }
        if (source.Output != null) {
            this.Output = new TextToSpeechAsyncOutput(source.Output);
        }
