...
public class MaxAgeRule extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>MaxAge time setting, in seconds; <br><b>Note: 0 means no cache.</b></p> 
    ...
    /**
     * Set <p>MaxAge time setting, in seconds; <br><b>Note: 0 means no cache.</b></p>
     * @param MaxAgeTime <p>MaxAge time setting, in seconds; <br><b>Note: 0 means no cache.</b></p>
     */
