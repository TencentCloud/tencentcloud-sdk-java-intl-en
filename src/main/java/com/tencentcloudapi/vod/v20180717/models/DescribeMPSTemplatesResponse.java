...
public class DescribeMPSTemplatesResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private MPSTemplate [] MPSTemplateSet;
    ...
    */
    ...
    public DescribeMPSTemplatesResponse() {
    }
     ...
     */
    public DescribeMPSTemplatesResponse(DescribeMPSTemplatesResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.MPSTemplateSet != null) {
            this.MPSTemplateSet = new MPSTemplate[source.MPSTemplateSet.length];
            for (int i = 0; i < source.MPSTemplateSet.length; i++) {
                this.MPSTemplateSet[i] = new MPSTemplate(source.MPSTemplateSet[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamArrayObj(map, prefix + "MPSTemplateSet.", this.MPSTemplateSet);
