...
public class MPSSmartSubtitleTemplateForUpdate extends AbstractModel {
    ...
    */
    ...
    public MPSSmartSubtitleTemplateForUpdate() {
    }
     ...
     */
    public MPSSmartSubtitleTemplateForUpdate(MPSSmartSubtitleTemplateForUpdate source) {
