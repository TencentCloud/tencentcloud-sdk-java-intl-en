...
public class CreateAigcAudioCloneTask extends AbstractModel {
    ...
    */
    ...
    /**
    * <p>Input information of the AIGC audio clone task.</p>
    */
    ...
    */
    ...
    /**
     * Get <p>Input information of the AIGC audio clone task.</p> 
     * @return Input <p>Input information of the AIGC audio clone task.</p>
     */
    ...
    /**
     * Set <p>Input information of the AIGC audio clone task.</p>
     * @param Input <p>Input information of the AIGC audio clone task.</p>
     */
