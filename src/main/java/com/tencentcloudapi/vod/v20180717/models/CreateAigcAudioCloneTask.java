...
public class CreateAigcAudioCloneTask extends AbstractModel {
    ...
    */
    ...
    /**
    * <p>Error code. Returns a non-zero error code in case of a source error. Please use the ErrCode of each specific task when 0 is returned.</p>
    */
    ...
    /**
    * <p>Error code expansion. A null string indicates success, while other values indicate failure.</p>
    */
    ...
    */
    ...
    /**
    * <p>Input information for the AIGC audio clone task.</p>
    */
    ...
    /**
    * <p>Output information for the AIGC audio clone task.</p>
    */
    @SerializedName("Output")
    @Expose
    private CreateAigcAudioCloneOutput Output;
    ...
    */
    ...
    /**
     * Get <p>Error code. Returns a non-zero error code in case of a source error. Please use the ErrCode of each specific task when 0 is returned.</p> 
     * @return ErrCode <p>Error code. Returns a non-zero error code in case of a source error. Please use the ErrCode of each specific task when 0 is returned.</p>
     */
    ...
    /**
     * Set <p>Error code. Returns a non-zero error code in case of a source error. Please use the ErrCode of each specific task when 0 is returned.</p>
     * @param ErrCode <p>Error code. Returns a non-zero error code in case of a source error. Please use the ErrCode of each specific task when 0 is returned.</p>
     */
    ...
    /**
     * Get <p>Error code expansion. A null string indicates success, while other values indicate failure.</p> 
     * @return ErrCodeExt <p>Error code expansion. A null string indicates success, while other values indicate failure.</p>
     */
    ...
    /**
     * Set <p>Error code expansion. A null string indicates success, while other values indicate failure.</p>
     * @param ErrCodeExt <p>Error code expansion. A null string indicates success, while other values indicate failure.</p>
     */
    ...
    /**
     * Get <p>Input information for the AIGC audio clone task.</p> 
     * @return Input <p>Input information for the AIGC audio clone task.</p>
     */
    public CreateAigcAudioCloneInput getInput() {
        return this.Input;
    }

    /**
     * Set <p>Input information for the AIGC audio clone task.</p>
     * @param Input <p>Input information for the AIGC audio clone task.</p>
     */
    public void setInput(CreateAigcAudioCloneInput Input) {
        this.Input = Input;
    }

    /**
     * Get <p>Output information for the AIGC audio clone task.</p> 
     * @return Output <p>Output information for the AIGC audio clone task.</p>
     */
    ...
    /**
     * Set <p>Output information for the AIGC audio clone task.</p>
     * @param Output <p>Output information for the AIGC audio clone task.</p>
     */
     ...
     */
    public CreateAigcAudioCloneTask(CreateAigcAudioCloneTask source) {
        ...
        if (source.Input != null) {
            this.Input = new CreateAigcAudioCloneInput(source.Input);
        }
        if (source.Output != null) {
            this.Output = new CreateAigcAudioCloneOutput(source.Output);
        }
