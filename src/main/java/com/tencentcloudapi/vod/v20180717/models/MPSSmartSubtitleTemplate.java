...
public class MPSSmartSubtitleTemplate extends AbstractModel {
    ...
    */
    ...
    public MPSSmartSubtitleTemplate() {
    }
     ...
     */
    public MPSSmartSubtitleTemplate(MPSSmartSubtitleTemplate source) {
        if (source.Name != null) {
