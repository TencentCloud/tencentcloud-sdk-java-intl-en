...
public class CreateStorageResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get The unique identifier ID of the storage bucket. 
    ...
    /**
     * Set The unique identifier ID of the storage bucket.
     * @param BucketId The unique identifier ID of the storage bucket.
     */
     ...
     */
    public CreateStorageResponse(CreateStorageResponse source) {
