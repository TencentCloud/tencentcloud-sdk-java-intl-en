...
public class IncrementalMigrationOriginFixedFileConfig extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Fixed file path: If you fill in `example/test.png`, the origin-pull address will be: `http(s)://<origin domain>/example/test.png`. 
    ...
    /**
     * Set Fixed file path: If you fill in `example/test.png`, the origin-pull address will be: `http(s)://<origin domain>/example/test.png`.
     * @param FixedFilePath Fixed file path: If you fill in `example/test.png`, the origin-pull address will be: `http(s)://<origin domain>/example/test.png`.
     */
