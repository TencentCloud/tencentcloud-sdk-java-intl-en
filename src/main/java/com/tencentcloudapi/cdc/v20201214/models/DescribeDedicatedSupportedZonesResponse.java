...
public class DescribeDedicatedSupportedZonesResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get List of supported AZs 
     * @return ZoneSet List of supported AZs
     */
    ...
    /**
     * Set List of supported AZs
     * @param ZoneSet List of supported AZs
     */
     ...
     */
    public DescribeDedicatedSupportedZonesResponse(DescribeDedicatedSupportedZonesResponse source) {
        if (source.ZoneSet != null) {
            this.ZoneSet = new RegionZoneInfo[source.ZoneSet.length];
            for (int i = 0; i < source.ZoneSet.length; i++) {
                this.ZoneSet[i] = new RegionZoneInfo(source.ZoneSet[i]);
            }
        }
