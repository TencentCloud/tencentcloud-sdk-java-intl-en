...
public class DescribeProductsResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Product detailed information list. 
     * @return Products Product detailed information list.
     */
    ...
    /**
     * Set Product detailed information list.
     * @param Products Product detailed information list.
     */
    public void setProducts(RegionProduct [] Products) {
    ...
    public DescribeProductsResponse(DescribeProductsResponse source) {
        if (source.Products != null) {
            this.Products = new RegionProduct[source.Products.length];
            for (int i = 0; i < source.Products.length; i++) {
                this.Products[i] = new RegionProduct(source.Products[i]);
            }
        }
