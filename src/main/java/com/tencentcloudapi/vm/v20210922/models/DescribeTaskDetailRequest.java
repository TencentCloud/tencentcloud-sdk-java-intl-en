...
public class DescribeTaskDetailRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Whether to show all segments. If it’s not specified, only hit segments are shown. 
    ...
    /**
     * Set Whether to show all segments. If it’s not specified, only hit segments are shown.
