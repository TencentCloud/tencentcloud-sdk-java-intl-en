...
Note: This field may return null, indicating that no valid value can be obtained.
    ...
    */
    ...
    /**
     * Get Current status of task. Valid values: 0 (succeeded), 1 (failed), 2 (in progress). 
    ...
    /**
     * Set Current status of task. Valid values: 0 (succeeded), 1 (failed), 2 (in progress).
     * @param Status Current status of task. Valid values: 0 (succeeded), 1 (failed), 2 (in progress).
     */
...
Note: This field may return null, indicating that no valid value can be obtained.
     * @param Message Auxiliary description information, such as failure causes.
Note: This field may return null, indicating that no valid value can be obtained.
     */
