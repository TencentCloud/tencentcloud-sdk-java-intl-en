...
public class CreateGatewayLoadBalancerRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get GWLB instance name. It supports 1-60 characters, including letters, digits, Chinese characters, "-", "_", and ".". If left blank, it will be automatically generated by default. 
     * @return LoadBalancerName GWLB instance name. It supports 1-60 characters, including letters, digits, Chinese characters, "-", "_", and ".". If left blank, it will be automatically generated by default.
     */
    ...
    /**
     * Set GWLB instance name. It supports 1-60 characters, including letters, digits, Chinese characters, "-", "_", and ".". If left blank, it will be automatically generated by default.
     * @param LoadBalancerName GWLB instance name. It supports 1-60 characters, including letters, digits, Chinese characters, "-", "_", and ".". If left blank, it will be automatically generated by default.
     */
