...
public class CreateInstanceNameResponse extends AbstractModel {
    ...
    */
    ...
    public CreateInstanceNameResponse() {
    }
     ...
     */
    public CreateInstanceNameResponse(CreateInstanceNameResponse source) {
