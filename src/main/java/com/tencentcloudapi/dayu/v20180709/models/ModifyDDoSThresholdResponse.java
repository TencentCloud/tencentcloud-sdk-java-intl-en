...
public class ModifyDDoSThresholdResponse extends AbstractModel {
    ...
    */
    ...
    public ModifyDDoSThresholdResponse() {
    }
     ...
     */
    public ModifyDDoSThresholdResponse(ModifyDDoSThresholdResponse source) {
