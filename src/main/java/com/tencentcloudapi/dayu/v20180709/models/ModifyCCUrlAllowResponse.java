...
public class ModifyCCUrlAllowResponse extends AbstractModel {
    ...
    */
    ...
    public ModifyCCUrlAllowResponse() {
    }
     ...
     */
    public ModifyCCUrlAllowResponse(ModifyCCUrlAllowResponse source) {
