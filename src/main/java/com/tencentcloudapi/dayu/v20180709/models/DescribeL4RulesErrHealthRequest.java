...
public class DescribeL4RulesErrHealthRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeL4RulesErrHealthRequest() {
    }
     ...
     */
    public DescribeL4RulesErrHealthRequest(DescribeL4RulesErrHealthRequest source) {
