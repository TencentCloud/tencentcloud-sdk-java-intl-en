...
public class ModifyResourceRenewFlagResponse extends AbstractModel{
    ...
    */
    ...
    public ModifyResourceRenewFlagResponse() {
    }
     ...
     */
    public ModifyResourceRenewFlagResponse(ModifyResourceRenewFlagResponse source) {
