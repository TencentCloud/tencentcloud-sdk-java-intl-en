...
public class ModifyDDoSPolicyCaseResponse extends AbstractModel{
    ...
    */
    ...
    public ModifyDDoSPolicyCaseResponse() {
    }
     ...
     */
    public ModifyDDoSPolicyCaseResponse(ModifyDDoSPolicyCaseResponse source) {
