...
public class ModifyCCHostProtectionRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Enables/disables CC domain name protection. Valid values: [open (enable), close (disable)] 
    ...
    /**
     * Set Enables/disables CC domain name protection. Valid values: [open (enable), close (disable)]
