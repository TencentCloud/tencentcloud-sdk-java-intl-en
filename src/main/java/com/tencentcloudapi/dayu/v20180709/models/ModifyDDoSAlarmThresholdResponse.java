...
public class ModifyDDoSAlarmThresholdResponse extends AbstractModel{
    ...
    */
    ...
    public ModifyDDoSAlarmThresholdResponse() {
    }
     ...
     */
    public ModifyDDoSAlarmThresholdResponse(ModifyDDoSAlarmThresholdResponse source) {
