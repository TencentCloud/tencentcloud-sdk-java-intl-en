...
public class ModifyDDoSDefendStatusResponse extends AbstractModel {
    ...
    */
    ...
    public ModifyDDoSDefendStatusResponse() {
    }
     ...
     */
    public ModifyDDoSDefendStatusResponse(ModifyDDoSDefendStatusResponse source) {
