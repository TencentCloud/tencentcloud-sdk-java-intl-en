...
public class ModifyCCIpAllowDenyResponse extends AbstractModel {
    ...
    */
    ...
    public ModifyCCIpAllowDenyResponse() {
    }
     ...
     */
    public ModifyCCIpAllowDenyResponse(ModifyCCIpAllowDenyResponse source) {
