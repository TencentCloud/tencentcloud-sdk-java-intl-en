...
public class ModifyNewDomainRulesResponse extends AbstractModel {
    ...
    */
    ...
    public ModifyNewDomainRulesResponse() {
    }
     ...
     */
    public ModifyNewDomainRulesResponse(ModifyNewDomainRulesResponse source) {
