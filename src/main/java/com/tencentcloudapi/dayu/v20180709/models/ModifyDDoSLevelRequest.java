...
public class ModifyDDoSLevelRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Protection level, which is required if `Method` is `set`. Valid values: [low,middle,high] 
    ...
    /**
     * Set Protection level, which is required if `Method` is `set`. Valid values: [low,middle,high]
