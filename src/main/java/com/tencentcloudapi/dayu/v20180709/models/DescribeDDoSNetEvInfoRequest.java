...
public class DescribeDDoSNetEvInfoRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeDDoSNetEvInfoRequest() {
    }
     ...
     */
    public DescribeDDoSNetEvInfoRequest(DescribeDDoSNetEvInfoRequest source) {
