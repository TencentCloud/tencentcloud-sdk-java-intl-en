...
public class DescribeDDoSEvInfoRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeDDoSEvInfoRequest() {
    }
     ...
     */
    public DescribeDDoSEvInfoRequest(DescribeDDoSEvInfoRequest source) {
