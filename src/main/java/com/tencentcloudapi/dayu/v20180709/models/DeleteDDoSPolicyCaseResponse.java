...
public class DeleteDDoSPolicyCaseResponse extends AbstractModel{
    ...
    */
    ...
    public DeleteDDoSPolicyCaseResponse() {
    }
     ...
     */
    public DeleteDDoSPolicyCaseResponse(DeleteDDoSPolicyCaseResponse source) {
