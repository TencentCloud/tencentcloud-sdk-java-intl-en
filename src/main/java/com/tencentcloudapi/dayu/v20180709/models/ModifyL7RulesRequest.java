...
public class ModifyL7RulesRequest extends AbstractModel{
    ...
    */
     ...
     * @param Rule Rule
     */
    public void setRule(L7RuleEntry Rule) {
        this.Rule = Rule;
    }

    public ModifyL7RulesRequest() {
    }
     ...
     */
    public ModifyL7RulesRequest(ModifyL7RulesRequest source) {
        ...
        if (source.Rule != null) {
            this.Rule = new L7RuleEntry(source.Rule);
        }
    }
