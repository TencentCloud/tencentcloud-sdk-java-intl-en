...
public class CreateL4HealthConfigResponse extends AbstractModel {
    ...
    */
    ...
    public CreateL4HealthConfigResponse() {
    }
     ...
     */
    public CreateL4HealthConfigResponse(CreateL4HealthConfigResponse source) {
