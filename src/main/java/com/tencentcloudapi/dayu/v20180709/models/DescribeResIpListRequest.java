...
public class DescribeResIpListRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Resource ID. If this field is left empty, it means to get all resources IP of the current user 
     * @return IdList Resource ID. If this field is left empty, it means to get all resources IP of the current user
     */
    ...
    /**
     * Set Resource ID. If this field is left empty, it means to get all resources IP of the current user
