...
public class DescribeDDoSPolicyRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Resource ID, which is optional. If a value is entered, it indicates the advanced DDoS policy bound to the resource 
     * @return Id Resource ID, which is optional. If a value is entered, it indicates the advanced DDoS policy bound to the resource
     */
    public String getId() {
        return this.Id;
    }
    ...
    /**
     * Set Resource ID, which is optional. If a value is entered, it indicates the advanced DDoS policy bound to the resource
