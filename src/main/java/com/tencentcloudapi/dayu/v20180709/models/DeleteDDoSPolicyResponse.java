...
public class DeleteDDoSPolicyResponse extends AbstractModel {
    ...
    */
    ...
    public DeleteDDoSPolicyResponse() {
    }
     ...
     */
    public DeleteDDoSPolicyResponse(DeleteDDoSPolicyResponse source) {
