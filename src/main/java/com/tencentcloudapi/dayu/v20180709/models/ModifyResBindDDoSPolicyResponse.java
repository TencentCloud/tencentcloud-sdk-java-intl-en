...
public class ModifyResBindDDoSPolicyResponse extends AbstractModel{
    ...
    */
    ...
    public ModifyResBindDDoSPolicyResponse() {
    }
     ...
     */
    public ModifyResBindDDoSPolicyResponse(ModifyResBindDDoSPolicyResponse source) {
