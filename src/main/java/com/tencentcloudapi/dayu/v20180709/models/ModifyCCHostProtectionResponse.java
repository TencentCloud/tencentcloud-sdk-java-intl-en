...
public class ModifyCCHostProtectionResponse extends AbstractModel {
    ...
    */
    ...
    public ModifyCCHostProtectionResponse() {
    }
     ...
     */
    public ModifyCCHostProtectionResponse(ModifyCCHostProtectionResponse source) {
