...
public class ModifyElasticLimitResponse extends AbstractModel{
    ...
    */
    ...
    public ModifyElasticLimitResponse() {
    }
     ...
     */
    public ModifyElasticLimitResponse(ModifyElasticLimitResponse source) {
