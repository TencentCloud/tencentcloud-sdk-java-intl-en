...
public class DeleteCCFrequencyRulesResponse extends AbstractModel{
    ...
    */
    ...
    public DeleteCCFrequencyRulesResponse() {
    }
     ...
     */
    public DeleteCCFrequencyRulesResponse(DeleteCCFrequencyRulesResponse source) {
