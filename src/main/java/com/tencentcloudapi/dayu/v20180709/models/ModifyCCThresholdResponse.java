...
public class ModifyCCThresholdResponse extends AbstractModel {
    ...
    */
    ...
    public ModifyCCThresholdResponse() {
    }
     ...
     */
    public ModifyCCThresholdResponse(ModifyCCThresholdResponse source) {
