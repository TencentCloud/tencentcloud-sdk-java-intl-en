...
public class ModifyDDoSPolicyNameResponse extends AbstractModel {
    ...
    */
    ...
    public ModifyDDoSPolicyNameResponse() {
    }
     ...
     */
    public ModifyDDoSPolicyNameResponse(ModifyDDoSPolicyNameResponse source) {
