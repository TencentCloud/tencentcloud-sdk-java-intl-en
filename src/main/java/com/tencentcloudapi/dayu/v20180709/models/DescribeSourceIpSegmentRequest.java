...
public class DescribeSourceIpSegmentRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeSourceIpSegmentRequest() {
    }
     ...
     */
    public DescribeSourceIpSegmentRequest(DescribeSourceIpSegmentRequest source) {
