...
public class CreateCCSelfDefinePolicyRequest extends AbstractModel {
    ...
    */
     ...
     * @return Policy Details of the CC protection policy
     */
    public CCPolicy getPolicy() {
        return this.Policy;
    }
     ...
     */
    public void setPolicy(CCPolicy Policy) {
        this.Policy = Policy;
    }

    public CreateCCSelfDefinePolicyRequest() {
    }
     ...
     */
    public CreateCCSelfDefinePolicyRequest(CreateCCSelfDefinePolicyRequest source) {
        ...
        if (source.Policy != null) {
            this.Policy = new CCPolicy(source.Policy);
        }
    }
