...
public class ModifyL4RulesRequest extends AbstractModel {
    ...
    */
     ...
     */
    public ModifyL4RulesRequest(ModifyL4RulesRequest source) {
        ...
        if (source.Rule != null) {
            this.Rule = new L4RuleEntry(source.Rule);
        }
    }
