...
public class ModifyCCSelfDefinePolicyResponse extends AbstractModel{
    ...
    */
    ...
    public ModifyCCSelfDefinePolicyResponse() {
    }
     ...
     */
    public ModifyCCSelfDefinePolicyResponse(ModifyCCSelfDefinePolicyResponse source) {
