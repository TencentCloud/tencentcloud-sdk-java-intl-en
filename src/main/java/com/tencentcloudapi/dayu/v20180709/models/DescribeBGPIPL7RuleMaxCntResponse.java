...
public class DescribeBGPIPL7RuleMaxCntResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Maximum number of layer-7 rules that can be added for Anti-DDoS Advanced 
    ...
    /**
     * Set Maximum number of layer-7 rules that can be added for Anti-DDoS Advanced
    ...
    public DescribeBGPIPL7RuleMaxCntResponse() {
    }
     ...
     */
    public DescribeBGPIPL7RuleMaxCntResponse(DescribeBGPIPL7RuleMaxCntResponse source) {
