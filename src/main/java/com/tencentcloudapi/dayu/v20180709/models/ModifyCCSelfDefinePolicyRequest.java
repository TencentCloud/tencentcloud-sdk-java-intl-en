...
public class ModifyCCSelfDefinePolicyRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyCCSelfDefinePolicyRequest() {
    }
     ...
     */
    public ModifyCCSelfDefinePolicyRequest(ModifyCCSelfDefinePolicyRequest source) {
