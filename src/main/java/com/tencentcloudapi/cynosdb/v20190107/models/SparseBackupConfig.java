...
public class SparseBackupConfig extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Sparse backup switch: ON/OFF 
     * @return SparseBackupSwitch Sparse backup switch: ON/OFF
     */
    ...
    /**
     * Set Sparse backup switch: ON/OFF
     * @param SparseBackupSwitch Sparse backup switch: ON/OFF
     */
    ...
    /**
     * Get Sparse backup policy list (1-3) 
     * @return SparseBackupConfigInfos Sparse backup policy list (1-3)
     */
    ...
    /**
     * Set Sparse backup policy list (1-3)
     * @param SparseBackupConfigInfos Sparse backup policy list (1-3)
     */
