...
public class OfflineLibraDBInstanceRequest extends AbstractModel {
    ...
    */
    ...
    public OfflineLibraDBInstanceRequest() {
    }
     ...
     */
    public OfflineLibraDBInstanceRequest(OfflineLibraDBInstanceRequest source) {
