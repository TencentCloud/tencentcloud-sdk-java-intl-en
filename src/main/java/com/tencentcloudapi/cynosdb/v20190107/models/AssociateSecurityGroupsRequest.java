...
Description: To get the instance group ID of a cluster, perform [query cluster instance group](https://www.tencentcloud.com/document/product/1003/103934?from_cn_redirect=1).
    ...
    */
    ...
    /**
     * Get Array of instance group IDs, starting with the prefix cynosdbmysql-grp- or a cluster ID.
Description: To get the instance group ID of a cluster, perform [query cluster instance group](https://www.tencentcloud.com/document/product/1003/103934?from_cn_redirect=1). 
...
Description: To get the instance group ID of a cluster, perform [query cluster instance group](https://www.tencentcloud.com/document/product/1003/103934?from_cn_redirect=1).
    ...
    /**
     * Set Array of instance group IDs, starting with the prefix cynosdbmysql-grp- or a cluster ID.
Description: To get the instance group ID of a cluster, perform [query cluster instance group](https://www.tencentcloud.com/document/product/1003/103934?from_cn_redirect=1).
     * @param InstanceIds Array of instance group IDs, starting with the prefix cynosdbmysql-grp- or a cluster ID.
Description: To get the instance group ID of a cluster, perform [query cluster instance group](https://www.tencentcloud.com/document/product/1003/103934?from_cn_redirect=1).
     */
    ...
    /**
     * Get Security group ID list to be modified. An array of one or more security group IDs. 
    ...
    /**
     * Set Security group ID list to be modified. An array of one or more security group IDs.
     * @param SecurityGroupIds Security group ID list to be modified. An array of one or more security group IDs.
     */
