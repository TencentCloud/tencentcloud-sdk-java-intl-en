...
public class DescribeLibraDBInstanceDetailRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Read-only analysis engine instance ID</p> 
     * @return InstanceId <p>Read-only analysis engine instance ID</p>
     */
    ...
    /**
     * Set <p>Read-only analysis engine instance ID</p>
     * @param InstanceId <p>Read-only analysis engine instance ID</p>
     */
