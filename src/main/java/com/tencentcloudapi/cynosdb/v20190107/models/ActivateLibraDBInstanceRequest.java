...
public class ActivateLibraDBInstanceRequest extends AbstractModel {
    ...
    */
    ...
    public ActivateLibraDBInstanceRequest() {
    }
     ...
     */
    public ActivateLibraDBInstanceRequest(ActivateLibraDBInstanceRequest source) {
