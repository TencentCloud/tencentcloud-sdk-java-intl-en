...
public class DescribeResourcePackageSaleSpecResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Total number of available resource packs 
    ...
    /**
     * Set Total number of available resource packs
     * @param Total Total number of available resource packs
     */
     ...
     */
    public DescribeResourcePackageSaleSpecResponse(DescribeResourcePackageSaleSpecResponse source) {
        if (source.Total != null) {
            this.Total = new Long(source.Total);
        }
        if (source.Detail != null) {
            this.Detail = new SalePackageSpec[source.Detail.length];
            for (int i = 0; i < source.Detail.length; i++) {
                this.Detail[i] = new SalePackageSpec(source.Detail[i]);
            }
        }
