...
public class BackupFileInfo extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Region where backup files are located</p> 
    ...
    /**
     * Set <p>Region where backup files are located</p>
     * @param ExistRegions <p>Region where backup files are located</p>
     */
