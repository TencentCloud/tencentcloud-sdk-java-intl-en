...
public class CloseProxyEndPointRequest extends AbstractModel {
    ...
    */
    ...
    public CloseProxyEndPointRequest() {
    }
     ...
     */
    public CloseProxyEndPointRequest(CloseProxyEndPointRequest source) {
