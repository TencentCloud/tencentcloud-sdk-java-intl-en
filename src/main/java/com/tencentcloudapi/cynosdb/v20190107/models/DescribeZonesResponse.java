...
public class DescribeZonesResponse extends AbstractModel {
    ...
    */
     ...
     * @return RegionSet Region information
     */
     ...
     */
    public void setRegionSet(SaleRegion [] RegionSet) {
    ...
    public DescribeZonesResponse(DescribeZonesResponse source) {
        if (source.RegionSet != null) {
            this.RegionSet = new SaleRegion[source.RegionSet.length];
            for (int i = 0; i < source.RegionSet.length; i++) {
                this.RegionSet[i] = new SaleRegion(source.RegionSet[i]);
            }
        }
