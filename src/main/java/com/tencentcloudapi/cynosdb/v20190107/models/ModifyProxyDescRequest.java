...
public class ModifyProxyDescRequest extends AbstractModel{
    ...
    */
     ...
     * @return Description Database proxy description
     */
     ...
     * @param Description Database proxy description
     */
    public void setDescription(String Description) {
        this.Description = Description;
    }

    public ModifyProxyDescRequest() {
    }
     ...
     */
    public ModifyProxyDescRequest(ModifyProxyDescRequest source) {
