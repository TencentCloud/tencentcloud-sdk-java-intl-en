...
public class RestartLibraDBInstanceRequest extends AbstractModel {
    ...
    */
    ...
    public RestartLibraDBInstanceRequest() {
    }
     ...
     */
    public RestartLibraDBInstanceRequest(RestartLibraDBInstanceRequest source) {
