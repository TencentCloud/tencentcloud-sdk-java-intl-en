...
Note: This field may return null, indicating that no valid values can be obtained.
    */
    ...
    @Expose
    private RegionInstanceSpecInfo [] InstanceSpecSet;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeLibraDBInstanceSpecsResponse() {
    }
     ...
     */
    public DescribeLibraDBInstanceSpecsResponse(DescribeLibraDBInstanceSpecsResponse source) {
        if (source.InstanceSpecSet != null) {
            this.InstanceSpecSet = new RegionInstanceSpecInfo[source.InstanceSpecSet.length];
            for (int i = 0; i < source.InstanceSpecSet.length; i++) {
                this.InstanceSpecSet[i] = new RegionInstanceSpecInfo(source.InstanceSpecSet[i]);
            }
        }
