...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeBinlogsResponse(DescribeBinlogsResponse source) {
        ...
        if (source.Binlogs != null) {
            this.Binlogs = new BinlogItem[source.Binlogs.length];
            for (int i = 0; i < source.Binlogs.length; i++) {
                this.Binlogs[i] = new BinlogItem(source.Binlogs[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamArrayObj(map, prefix + "Binlogs.", this.Binlogs);
