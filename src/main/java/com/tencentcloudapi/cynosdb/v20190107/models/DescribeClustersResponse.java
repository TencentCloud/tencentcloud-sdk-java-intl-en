...
public class DescribeClustersResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private CynosdbCluster [] ClusterSet;
    ...
    */
     ...
     */
    public CynosdbCluster [] getClusterSet() {
     ...
     */
    public void setClusterSet(CynosdbCluster [] ClusterSet) {
    ...
    public DescribeClustersResponse(DescribeClustersResponse source) {
        ...
        if (source.ClusterSet != null) {
            this.ClusterSet = new CynosdbCluster[source.ClusterSet.length];
            for (int i = 0; i < source.ClusterSet.length; i++) {
                this.ClusterSet[i] = new CynosdbCluster(source.ClusterSet[i]);
            }
        }
