...
public class Tenant extends AbstractModel {
    ...
    */
    @SerializedName("IsPasswordEncrypted")
    @Expose
    private Boolean IsPasswordEncrypted;

    /**
     * Get Whether the password is encrypted. 
    ...
    /**
     * Set Whether the password is encrypted.
     * @param IsPasswordEncrypted Whether the password is encrypted.
     */
    ...
    public Tenant(Tenant source) {
        if (source.IsPasswordEncrypted != null) {
            this.IsPasswordEncrypted = new Boolean(source.IsPasswordEncrypted);
        }
    }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamSimple(map, prefix + "IsPasswordEncrypted", this.IsPasswordEncrypted);
