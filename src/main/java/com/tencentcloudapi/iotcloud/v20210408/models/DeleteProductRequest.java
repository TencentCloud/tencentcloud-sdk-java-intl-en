...
public class DeleteProductRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get ID of the product to delete 
    ...
    /**
     * Set ID of the product to delete
    ...
    /**
     * Get Skey, which is required to delete a LoRa product 
    ...
    /**
     * Set Skey, which is required to delete a LoRa product
