...
public class DeleteHealthCheckPolicyRequest extends AbstractModel {
    ...
    */
     ...
     * @return HealthCheckPolicyName Health check policy name
     */
     ...
     * @param HealthCheckPolicyName Health check policy name
     */
     ...
     */
    public DeleteHealthCheckPolicyRequest(DeleteHealthCheckPolicyRequest source) {
