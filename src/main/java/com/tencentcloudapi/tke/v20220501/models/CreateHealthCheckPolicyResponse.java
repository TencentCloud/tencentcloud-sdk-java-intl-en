...
public class CreateHealthCheckPolicyResponse extends AbstractModel {
    ...
    */
    ...
    public CreateHealthCheckPolicyResponse() {
    }
     ...
     */
    public CreateHealthCheckPolicyResponse(CreateHealthCheckPolicyResponse source) {
