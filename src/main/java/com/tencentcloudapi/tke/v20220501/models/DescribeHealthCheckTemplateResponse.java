...
public class DescribeHealthCheckTemplateResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Health check policy template 
    ...
    /**
     * Set Health check policy template
     * @param HealthCheckTemplate Health check policy template
     */
     ...
     */
    public DescribeHealthCheckTemplateResponse(DescribeHealthCheckTemplateResponse source) {
        if (source.HealthCheckTemplate != null) {
            this.HealthCheckTemplate = new HealthCheckTemplate(source.HealthCheckTemplate);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamObj(map, prefix + "HealthCheckTemplate.", this.HealthCheckTemplate);
