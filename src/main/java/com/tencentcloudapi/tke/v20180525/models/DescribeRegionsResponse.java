...
Note: this field may return null, indicating that no valid values can be obtained.
    */
    ...
    @Expose
    private RegionInstance [] RegionInstanceSet;
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeRegionsResponse(DescribeRegionsResponse source) {
        ...
        if (source.RegionInstanceSet != null) {
            this.RegionInstanceSet = new RegionInstance[source.RegionInstanceSet.length];
            for (int i = 0; i < source.RegionInstanceSet.length; i++) {
                this.RegionInstanceSet[i] = new RegionInstance(source.RegionInstanceSet[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamArrayObj(map, prefix + "RegionInstanceSet.", this.RegionInstanceSet);
