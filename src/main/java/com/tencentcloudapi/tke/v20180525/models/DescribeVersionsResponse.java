...
Note: this field may return `null`, indicating that no valid values can be obtained.
     ...
     */
    public DescribeVersionsResponse(DescribeVersionsResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.VersionInstanceSet != null) {
            this.VersionInstanceSet = new VersionInstance[source.VersionInstanceSet.length];
            for (int i = 0; i < source.VersionInstanceSet.length; i++) {
                this.VersionInstanceSet[i] = new VersionInstance(source.VersionInstanceSet[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamArrayObj(map, prefix + "VersionInstanceSet.", this.VersionInstanceSet);
