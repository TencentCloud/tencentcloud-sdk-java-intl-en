...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    */
    ...
    /**
     * Get Array of TKE Edge cluster log switches
Note: This field may return `null`, indicating that no valid values can be obtained. 
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    /**
     * Set Array of TKE Edge cluster log switches
Note: This field may return `null`, indicating that no valid values can be obtained.
...
Note: This field may return `null`, indicating that no valid values can be obtained.
     ...
     */
    public DescribeEdgeLogSwitchesResponse(DescribeEdgeLogSwitchesResponse source) {
        if (source.SwitchSet != null) {
            this.SwitchSet = new String[source.SwitchSet.length];
            for (int i = 0; i < source.SwitchSet.length; i++) {
                this.SwitchSet[i] = new String(source.SwitchSet[i]);
            }
        }
