...
public class DescribeAddonValuesResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Parameters list. If the add-on has been installed, the configured parameters are used for rendering, in a JSON string. 
    ...
    /**
     * Set Parameters list. If the add-on has been installed, the configured parameters are used for rendering, in a JSON string.
     * @param Values Parameters list. If the add-on has been installed, the configured parameters are used for rendering, in a JSON string.
     */
