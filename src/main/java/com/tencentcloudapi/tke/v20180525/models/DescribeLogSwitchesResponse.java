...
Note: This field may return "null", indicating that no valid value can be obtained.
     * @param SwitchSet Cluster log switch collection
Note: This field may return "null", indicating that no valid value can be obtained.
     */
    ...
    public DescribeLogSwitchesResponse(DescribeLogSwitchesResponse source) {
        if (source.SwitchSet != null) {
            this.SwitchSet = new Switch[source.SwitchSet.length];
            for (int i = 0; i < source.SwitchSet.length; i++) {
                this.SwitchSet[i] = new Switch(source.SwitchSet[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "SwitchSet.", this.SwitchSet);
