...
public class DescribeBackupStorageLocationsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Names of repositories. If it’s not specified, all storage repository names in the current region are returned. 
    ...
    /**
     * Set Names of repositories. If it’s not specified, all storage repository names in the current region are returned.
