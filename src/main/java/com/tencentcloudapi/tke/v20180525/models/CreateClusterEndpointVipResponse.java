...
public class CreateClusterEndpointVipResponse extends AbstractModel {
    ...
    */
    ...
    public CreateClusterEndpointVipResponse() {
    }
     ...
     */
    public CreateClusterEndpointVipResponse(CreateClusterEndpointVipResponse source) {
        if (source.RequestFlowId != null) {
            this.RequestFlowId = new Long(source.RequestFlowId);
        }
