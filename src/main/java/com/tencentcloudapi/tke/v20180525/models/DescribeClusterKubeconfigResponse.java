...
public class DescribeClusterKubeconfigResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Sub-account kubeconfig file, used to access the cluster kube-apiserver directly 
    ...
    /**
     * Set Sub-account kubeconfig file, used to access the cluster kube-apiserver directly
