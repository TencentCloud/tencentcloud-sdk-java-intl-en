...
public class DescribeControlPlaneLogsRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeControlPlaneLogsRequest() {
    }
     ...
     */
    public DescribeControlPlaneLogsRequest(DescribeControlPlaneLogsRequest source) {
