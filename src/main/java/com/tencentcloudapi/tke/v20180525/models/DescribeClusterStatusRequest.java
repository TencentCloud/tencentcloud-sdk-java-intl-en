...
public class DescribeClusterStatusRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Cluster ID list. All clusters are pulled if it is left empty. 
     * @return ClusterIds Cluster ID list. All clusters are pulled if it is left empty.
     */
    ...
    /**
     * Set Cluster ID list. All clusters are pulled if it is left empty.
