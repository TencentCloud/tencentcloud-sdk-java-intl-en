...
public class DescribeAuditLogFilesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Set <p>Log file name</p>
     * @param FileName <p>Log file name</p>
     */
    ...
    /**
     * Get <p>Query limit</p><p>Value range: [1, 300]</p> 
    ...
    /**
     * Set <p>Query limit</p><p>Value range: [1, 300]</p>
     * @param Limit <p>Query limit</p><p>Value range: [1, 300]</p>
     */
    ...
    /**
     * Get <p>Offset</p><p>Value range: [0, 1000]</p> 
    ...
    /**
     * Set <p>Offset</p><p>Value range: [0, 1000]</p>
     * @param Offset <p>Offset</p><p>Value range: [0, 1000]</p>
     */
