...
public class DescribeDBVersionsResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeDBVersionsResponse() {
    }
     ...
     */
    public DescribeDBVersionsResponse(DescribeDBVersionsResponse source) {
        if (source.VersionSet != null) {
            this.VersionSet = new Version[source.VersionSet.length];
            for (int i = 0; i < source.VersionSet.length; i++) {
                this.VersionSet[i] = new Version(source.VersionSet[i]);
            }
        }
