...
public class DescribeBackupPlansResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get The set of instance backup plans 
    ...
    /**
     * Set The set of instance backup plans
     * @param Plans The set of instance backup plans
     */
    public void setPlans(BackupPlan [] Plans) {
        this.Plans = Plans;
    }
     ...
     */
    public DescribeBackupPlansResponse(DescribeBackupPlansResponse source) {
        if (source.Plans != null) {
            this.Plans = new BackupPlan[source.Plans.length];
            for (int i = 0; i < source.Plans.length; i++) {
                this.Plans[i] = new BackupPlan(source.Plans[i]);
            }
        }
