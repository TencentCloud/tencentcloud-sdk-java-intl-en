...
public class DescribeInstancesDiskNumResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get The quantity of mounted and mountable elastic cloud disks for each cloud virtual machine 
    ...
    /**
     * Set The quantity of mounted and mountable elastic cloud disks for each cloud virtual machine
    ...
    public DescribeInstancesDiskNumResponse(DescribeInstancesDiskNumResponse source) {
        if (source.AttachDetail != null) {
            this.AttachDetail = new AttachDetail[source.AttachDetail.length];
            for (int i = 0; i < source.AttachDetail.length; i++) {
                this.AttachDetail[i] = new AttachDetail(source.AttachDetail[i]);
            }
        }
