...
public class DescribeMigrationTaskResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Migration details list 
     * @return TaskStatus Migration details list
     */
     ...
     */
    public DescribeMigrationTaskResponse(DescribeMigrationTaskResponse source) {
        if (source.TaskStatus != null) {
            this.TaskStatus = new TaskStatus[source.TaskStatus.length];
            for (int i = 0; i < source.TaskStatus.length; i++) {
                this.TaskStatus[i] = new TaskStatus(source.TaskStatus[i]);
            }
        }
