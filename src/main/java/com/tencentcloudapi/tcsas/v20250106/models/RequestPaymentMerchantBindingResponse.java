...
public class RequestPaymentMerchantBindingResponse extends AbstractModel {
    ...
    */
    @SerializedName("Data")
    @Expose
    private MerchantBindApprovalResp Data;
    ...
    */
    ...
    public RequestPaymentMerchantBindingResponse() {
    }
     ...
     */
    public RequestPaymentMerchantBindingResponse(RequestPaymentMerchantBindingResponse source) {
        if (source.Data != null) {
            this.Data = new MerchantBindApprovalResp(source.Data);
        }
