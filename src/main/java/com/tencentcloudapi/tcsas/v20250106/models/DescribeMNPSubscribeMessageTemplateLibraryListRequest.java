...
public class DescribeMNPSubscribeMessageTemplateLibraryListRequest extends AbstractModel {
    ...
    */
     ...
     * @return QueryType <p>Subscription message template type. Valid values: 2: One-time message; 3: Long-term subscription message.</p>
     */
     ...
     * @param QueryType <p>Subscription message template type. Valid values: 2: One-time message; 3: Long-term subscription message.</p>
     */
     ...
     * @return QueryStr <p>Search keyword.</p>
     */
     ...
     * @param QueryStr <p>Search keyword.</p>
     */
    public void setQueryStr(String QueryStr) {
        this.QueryStr = QueryStr;
    }

    public DescribeMNPSubscribeMessageTemplateLibraryListRequest() {
    }
     ...
     */
    public DescribeMNPSubscribeMessageTemplateLibraryListRequest(DescribeMNPSubscribeMessageTemplateLibraryListRequest source) {
