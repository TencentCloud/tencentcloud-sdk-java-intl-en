...
public class CreateMNPAppSecretRequest extends AbstractModel {
    ...
    */
    ...
    public CreateMNPAppSecretRequest() {
    }
     ...
     */
    public CreateMNPAppSecretRequest(CreateMNPAppSecretRequest source) {
