...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public DescribeMNPSensitiveAPIPermissionListResp(DescribeMNPSensitiveAPIPermissionListResp source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.DataList != null) {
            this.DataList = new DescribeMNPSensitiveAPIPermissionListData[source.DataList.length];
            for (int i = 0; i < source.DataList.length; i++) {
                this.DataList[i] = new DescribeMNPSensitiveAPIPermissionListData(source.DataList[i]);
            }
        }
    }
