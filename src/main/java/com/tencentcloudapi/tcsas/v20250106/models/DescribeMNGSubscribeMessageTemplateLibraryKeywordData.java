...
public class DescribeMNGSubscribeMessageTemplateLibraryKeywordData extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Subscription message template library keyword.</p> 
    ...
    /**
     * Set <p>Subscription message template library keyword.</p>
     * @param Keyword <p>Subscription message template library keyword.</p>
     */
    ...
    /**
     * Get <p>Subscription message template library keyword multilingual list.</p> 
    ...
    /**
     * Set <p>Subscription message template library keyword multilingual list.</p>
     * @param KeywordList <p>Subscription message template library keyword multilingual list.</p>
     */
    ...
    /**
     * Get <p>Subscription message template library keywords in multiple languages.</p> 
    ...
    /**
     * Set <p>Subscription message template library keywords in multiple languages.</p>
     * @param DefaultValueList <p>Subscription message template library keywords in multiple languages.</p>
     */
    public void setDefaultValueList(I18nItem [] DefaultValueList) {
        this.DefaultValueList = DefaultValueList;
    }

    public DescribeMNGSubscribeMessageTemplateLibraryKeywordData() {
    }
     ...
     */
    public DescribeMNGSubscribeMessageTemplateLibraryKeywordData(DescribeMNGSubscribeMessageTemplateLibraryKeywordData source) {
