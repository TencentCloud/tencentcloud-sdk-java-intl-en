...
public class ResetMNGAppSecretRequest extends AbstractModel {
    ...
    */
    ...
    public ResetMNGAppSecretRequest() {
    }
     ...
     */
    public ResetMNGAppSecretRequest(ResetMNGAppSecretRequest source) {
