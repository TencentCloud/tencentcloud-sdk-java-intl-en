...
public class DescribePaymentDataOverviewRequest extends AbstractModel {
    ...
    * Mini program appid
    */
    @SerializedName("MNPIds")
    @Expose
    private String [] MNPIds;
    ...
    */
     ...
     */
    public String [] getMNPIds() {
        return this.MNPIds;
    }

    /**
     * Set Mini program appid
     * @param MNPIds Mini program appid
     */
    public void setMNPIds(String [] MNPIds) {
        this.MNPIds = MNPIds;
    }
    ...
    public DescribePaymentDataOverviewRequest() {
    }
     ...
     */
    public DescribePaymentDataOverviewRequest(DescribePaymentDataOverviewRequest source) {
        if (source.TimeBegin != null) {
            this.TimeBegin = new Long(source.TimeBegin);
        }
        if (source.MNPIds != null) {
            this.MNPIds = new String[source.MNPIds.length];
            for (int i = 0; i < source.MNPIds.length; i++) {
                this.MNPIds[i] = new String(source.MNPIds[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamArraySimple(map, prefix + "MNPIds.", this.MNPIds);
