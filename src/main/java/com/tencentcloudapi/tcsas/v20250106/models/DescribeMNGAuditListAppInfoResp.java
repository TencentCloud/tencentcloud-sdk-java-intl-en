...
public class DescribeMNGAuditListAppInfoResp extends AbstractModel {
    ...
    */
    ...
    public DescribeMNGAuditListAppInfoResp() {
    }
     ...
     */
    public DescribeMNGAuditListAppInfoResp(DescribeMNGAuditListAppInfoResp source) {
