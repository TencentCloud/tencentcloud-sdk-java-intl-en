...
public class DescribeMNGVersionAuditInfoResp extends AbstractModel {
    ...
    */
    ...
    @Expose
    private DescribeMNGAuditListAppInfoResp [] AuditAppList;
    ...
    */
     ...
     */
    public DescribeMNGAuditListAppInfoResp [] getAuditAppList() {
     ...
     */
    public void setAuditAppList(DescribeMNGAuditListAppInfoResp [] AuditAppList) {
    ...
    public DescribeMNGVersionAuditInfoResp() {
    }
     ...
     */
    public DescribeMNGVersionAuditInfoResp(DescribeMNGVersionAuditInfoResp source) {
        ...
        if (source.AuditAppList != null) {
            this.AuditAppList = new DescribeMNGAuditListAppInfoResp[source.AuditAppList.length];
            for (int i = 0; i < source.AuditAppList.length; i++) {
                this.AuditAppList[i] = new DescribeMNGAuditListAppInfoResp(source.AuditAppList[i]);
            }
        }
