...
public class UnbindPaymentMerchantRequest extends AbstractModel {
    ...
    */
    ...
    public UnbindPaymentMerchantRequest() {
    }
     ...
     */
    public UnbindPaymentMerchantRequest(UnbindPaymentMerchantRequest source) {
