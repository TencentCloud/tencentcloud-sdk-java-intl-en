...
public class DescribeMNGMAUMonthlyComparisonMetricCardResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeMNGMAUMonthlyComparisonMetricCardResponse() {
    }
     ...
     */
    public DescribeMNGMAUMonthlyComparisonMetricCardResponse(DescribeMNGMAUMonthlyComparisonMetricCardResponse source) {
        if (source.Data != null) {
            this.Data = new MAUIndicatorCard(source.Data);
        }
