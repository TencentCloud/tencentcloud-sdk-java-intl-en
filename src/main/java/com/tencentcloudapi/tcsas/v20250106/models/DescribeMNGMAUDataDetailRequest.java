...
public class DescribeMNGMAUDataDetailRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeMNGMAUDataDetailRequest() {
    }
     ...
     */
    public DescribeMNGMAUDataDetailRequest(DescribeMNGMAUDataDetailRequest source) {
