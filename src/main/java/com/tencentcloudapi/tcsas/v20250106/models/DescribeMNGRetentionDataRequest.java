...
public class DescribeMNGRetentionDataRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeMNGRetentionDataRequest() {
    }
     ...
     */
    public DescribeMNGRetentionDataRequest(DescribeMNGRetentionDataRequest source) {
