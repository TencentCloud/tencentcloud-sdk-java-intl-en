...
public class DescribeMNGSubscribeMessageTemplateInfoResp extends AbstractModel {
    ...
    */
     ...
     * @param Keywords <p>Subscription message template keywords.</p>
     */
    ...
    /**
     * Get <p>Subscription message template keyword in multiple languages.</p> 
    ...
    /**
     * Set <p>Subscription message template keyword in multiple languages.</p>
     * @param KeywordI18nList <p>Subscription message template keyword in multiple languages.</p>
     */
    ...
    /**
     * Get <p>Subscription message template type. Valid values: 2: One-time message; 3: Long-term subscription message.</p> 
    ...
    /**
     * Set <p>Subscription message template type. Valid values: 2: One-time message; 3: Long-term subscription message.</p>
     * @param TemplateType <p>Subscription message template type. Valid values: 2: One-time message; 3: Long-term subscription message.</p>
     */
    ...
    public DescribeMNGSubscribeMessageTemplateInfoResp() {
    }
     ...
     */
    public DescribeMNGSubscribeMessageTemplateInfoResp(DescribeMNGSubscribeMessageTemplateInfoResp source) {
