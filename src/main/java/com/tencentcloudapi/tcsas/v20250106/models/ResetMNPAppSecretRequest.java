...
public class ResetMNPAppSecretRequest extends AbstractModel {
    ...
    */
    ...
    public ResetMNPAppSecretRequest() {
    }
     ...
     */
    public ResetMNPAppSecretRequest(ResetMNPAppSecretRequest source) {
