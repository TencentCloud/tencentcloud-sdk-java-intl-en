...
public class AgeRatingItem extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Age rating label.</p> 
     * @return Label <p>Age rating label.</p>
     */
    ...
    /**
     * Set <p>Age rating label.</p>
     * @param Label <p>Age rating label.</p>
     */
    public void setLabel(String Label) {
        this.Label = Label;
    }

    public AgeRatingItem() {
    }
     ...
     */
    public AgeRatingItem(AgeRatingItem source) {
