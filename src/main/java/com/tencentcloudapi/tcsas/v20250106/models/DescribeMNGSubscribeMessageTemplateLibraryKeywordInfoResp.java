...
public class DescribeMNGSubscribeMessageTemplateLibraryKeywordInfoResp extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Subscription message template library keyword default value list.</p> 
     * @return DefaultValueList <p>Subscription message template library keyword default value list.</p>
     */
    ...
    /**
     * Set <p>Subscription message template library keyword default value list.</p>
     * @param DefaultValueList <p>Subscription message template library keyword default value list.</p>
     */
    public void setDefaultValueList(I18nItem [] DefaultValueList) {
        this.DefaultValueList = DefaultValueList;
    }

    public DescribeMNGSubscribeMessageTemplateLibraryKeywordInfoResp() {
    }
     ...
     */
    public DescribeMNGSubscribeMessageTemplateLibraryKeywordInfoResp(DescribeMNGSubscribeMessageTemplateLibraryKeywordInfoResp source) {
