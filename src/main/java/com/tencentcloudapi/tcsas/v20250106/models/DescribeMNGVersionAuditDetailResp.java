...
public class DescribeMNGVersionAuditDetailResp extends AbstractModel {
    ...
    */
    ...
    @Expose
    private DescribeMNGAuditDetailAppAuditInfo [] AppAuditList;
     ...
     * @param AuditTime <p>Creation time.</p>
     */
     ...
     */
    public DescribeMNGAuditDetailAppAuditInfo [] getAppAuditList() {
     ...
     */
    public void setAppAuditList(DescribeMNGAuditDetailAppAuditInfo [] AppAuditList) {
        this.AppAuditList = AppAuditList;
    }

    public DescribeMNGVersionAuditDetailResp() {
    }
     ...
     */
    public DescribeMNGVersionAuditDetailResp(DescribeMNGVersionAuditDetailResp source) {
        ...
        if (source.AppAuditList != null) {
            this.AppAuditList = new DescribeMNGAuditDetailAppAuditInfo[source.AppAuditList.length];
            for (int i = 0; i < source.AppAuditList.length; i++) {
                this.AppAuditList[i] = new DescribeMNGAuditDetailAppAuditInfo(source.AppAuditList[i]);
            }
        }
    }
