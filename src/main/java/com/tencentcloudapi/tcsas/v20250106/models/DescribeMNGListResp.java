...
public class DescribeMNGListResp extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeMNGListResp(DescribeMNGListResp source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.DataList != null) {
            this.DataList = new DescribeMNGListData[source.DataList.length];
            for (int i = 0; i < source.DataList.length; i++) {
                this.DataList[i] = new DescribeMNGListData(source.DataList[i]);
            }
        }
    }
