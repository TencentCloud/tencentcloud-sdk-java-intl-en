...
public class DescribeMNGSubscribeMessageTemplateDetailResp extends AbstractModel {
    ...
    */
    ...
    @Expose
    private MNGSubscribeMessageTemplateDetailResp TemplateInfo;
     ...
     */
    public MNGSubscribeMessageTemplateDetailResp getTemplateInfo() {
     ...
     */
    public void setTemplateInfo(MNGSubscribeMessageTemplateDetailResp TemplateInfo) {
        this.TemplateInfo = TemplateInfo;
    }

    public DescribeMNGSubscribeMessageTemplateDetailResp() {
    }
     ...
     */
    public DescribeMNGSubscribeMessageTemplateDetailResp(DescribeMNGSubscribeMessageTemplateDetailResp source) {
        ...
        if (source.TemplateInfo != null) {
            this.TemplateInfo = new MNGSubscribeMessageTemplateDetailResp(source.TemplateInfo);
        }
    }
