...
public class DescribeMNGAccessAnalysisLineChartRequest extends AbstractModel {
...
avg_count_open_duration: Average visit duration per session
    ...
    public DescribeMNGAccessAnalysisLineChartRequest() {
    }
     ...
     */
    public DescribeMNGAccessAnalysisLineChartRequest(DescribeMNGAccessAnalysisLineChartRequest source) {
