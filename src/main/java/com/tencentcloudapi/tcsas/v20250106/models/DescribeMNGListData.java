...
public class DescribeMNGListData extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Effective mini game version ID bound to the superapp.</p> 
    ...
    /**
     * Set <p>Effective mini game version ID bound to the superapp.</p>
     * @param EffectMNPVersionId <p>Effective mini game version ID bound to the superapp.</p>
     */
    ...
    /**
     * Get <p>Effective mini game version number bound to the superapp. </p> 
    ...
    /**
     * Set <p>Effective mini game version number bound to the superapp. </p>
     * @param EffectMNPVersion <p>Effective mini game version number bound to the superapp. </p>
     */
