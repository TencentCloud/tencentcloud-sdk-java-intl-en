...
public class DescribeApplicationSensitiveAPIListResp extends AbstractModel {
    ...
    */
     ...
     */
    public void setDataList(DescribeApplicationSensitiveAPIListData [] DataList) {
     ...
     */
    public DescribeApplicationSensitiveAPIListResp(DescribeApplicationSensitiveAPIListResp source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.DataList != null) {
            this.DataList = new DescribeApplicationSensitiveAPIListData[source.DataList.length];
            for (int i = 0; i < source.DataList.length; i++) {
                this.DataList[i] = new DescribeApplicationSensitiveAPIListData(source.DataList[i]);
            }
        }
    }
