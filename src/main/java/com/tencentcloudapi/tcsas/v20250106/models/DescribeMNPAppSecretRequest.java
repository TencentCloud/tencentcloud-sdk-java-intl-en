...
public class DescribeMNPAppSecretRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeMNPAppSecretRequest() {
    }
     ...
     */
    public DescribeMNPAppSecretRequest(DescribeMNPAppSecretRequest source) {
