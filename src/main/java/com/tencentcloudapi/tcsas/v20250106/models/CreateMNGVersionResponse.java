...
public class CreateMNGVersionResponse extends AbstractModel {
    ...
    */
    @SerializedName("Data")
    @Expose
    private CreateMNGVersionResp Data;
    ...
    */
    ...
    public CreateMNGVersionResponse() {
    }
     ...
     */
    public CreateMNGVersionResponse(CreateMNGVersionResponse source) {
        if (source.Data != null) {
            this.Data = new CreateMNGVersionResp(source.Data);
        }
