...
public class MNPSubscribeMessageTemplateDetailResp extends AbstractModel {
    ...
    */
    ...
    @Expose
    private DescribeSubscribeMessageTemplateLibraryKeywordData [] KeywordList;
    ...
    */
     ...
     */
    public DescribeSubscribeMessageTemplateLibraryKeywordData [] getKeywordList() {
     ...
     */
    public void setKeywordList(DescribeSubscribeMessageTemplateLibraryKeywordData [] KeywordList) {
    ...
    public MNPSubscribeMessageTemplateDetailResp() {
    }
     ...
     */
    public MNPSubscribeMessageTemplateDetailResp(MNPSubscribeMessageTemplateDetailResp source) {
        ...
        if (source.KeywordList != null) {
            this.KeywordList = new DescribeSubscribeMessageTemplateLibraryKeywordData[source.KeywordList.length];
            for (int i = 0; i < source.KeywordList.length; i++) {
                this.KeywordList[i] = new DescribeSubscribeMessageTemplateLibraryKeywordData(source.KeywordList[i]);
            }
        }
