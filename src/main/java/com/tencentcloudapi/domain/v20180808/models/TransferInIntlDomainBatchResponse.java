...
public class TransferInIntlDomainBatchResponse extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public TransferInIntlDomainBatchResponse() {
    }
     ...
     */
    public TransferInIntlDomainBatchResponse(TransferInIntlDomainBatchResponse source) {
