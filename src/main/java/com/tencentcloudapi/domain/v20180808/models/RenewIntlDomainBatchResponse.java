...
public class RenewIntlDomainBatchResponse extends AbstractModel {
    ...
    */
    ...
    public RenewIntlDomainBatchResponse() {
    }
     ...
     */
    public RenewIntlDomainBatchResponse(RenewIntlDomainBatchResponse source) {
