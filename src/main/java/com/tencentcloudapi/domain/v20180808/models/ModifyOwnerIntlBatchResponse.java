...
public class ModifyOwnerIntlBatchResponse extends AbstractModel{
    ...
    */
    ...
    public ModifyOwnerIntlBatchResponse() {
    }
     ...
     */
    public ModifyOwnerIntlBatchResponse(ModifyOwnerIntlBatchResponse source) {
