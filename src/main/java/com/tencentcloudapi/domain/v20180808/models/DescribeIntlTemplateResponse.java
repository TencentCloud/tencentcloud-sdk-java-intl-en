...
public class DescribeIntlTemplateResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get The details of the registrant profile. 
    ...
    /**
     * Set The details of the registrant profile.
     * @param Template The details of the registrant profile.
     */
    public void setTemplate(IntlTemplateInfo Template) {
     ...
     */
    public DescribeIntlTemplateResponse(DescribeIntlTemplateResponse source) {
        if (source.Template != null) {
            this.Template = new IntlTemplateInfo(source.Template);
        }
