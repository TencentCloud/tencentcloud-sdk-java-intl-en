...
public class DescribeOpenPortStatisticsResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeOpenPortStatisticsResponse() {
    }
     ...
     */
    public DescribeOpenPortStatisticsResponse(DescribeOpenPortStatisticsResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.OpenPortStatistics != null) {
            this.OpenPortStatistics = new OpenPortStatistics[source.OpenPortStatistics.length];
            for (int i = 0; i < source.OpenPortStatistics.length; i++) {
                this.OpenPortStatistics[i] = new OpenPortStatistics(source.OpenPortStatistics[i]);
            }
        }
