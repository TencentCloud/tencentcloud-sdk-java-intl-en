...
public class ExportBruteAttacksResponse extends AbstractModel{
    ...
    */
    ...
    public ExportBruteAttacksResponse() {
    }
     ...
     */
    public ExportBruteAttacksResponse(ExportBruteAttacksResponse source) {
