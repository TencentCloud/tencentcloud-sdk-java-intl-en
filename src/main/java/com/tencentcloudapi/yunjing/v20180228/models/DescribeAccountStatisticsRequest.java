...
public class DescribeAccountStatisticsRequest extends AbstractModel{
...
<li>Username - String - Required: No - Account username</li>
    ...
    public DescribeAccountStatisticsRequest() {
    }
     ...
     */
    public DescribeAccountStatisticsRequest(DescribeAccountStatisticsRequest source) {
