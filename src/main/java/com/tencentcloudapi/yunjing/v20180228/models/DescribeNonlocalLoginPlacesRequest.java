...
public class DescribeNonlocalLoginPlacesRequest extends AbstractModel {
...
<li>Status - String - Required: No - Login status (NON_LOCAL_LOGIN: unusual login location, NORMAL_LOGIN: intended login)</li>
    ...
    public DescribeNonlocalLoginPlacesRequest() {
    }
     ...
     */
    public DescribeNonlocalLoginPlacesRequest(DescribeNonlocalLoginPlacesRequest source) {
        if (source.Uuid != null) {
