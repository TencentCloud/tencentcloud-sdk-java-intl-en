...
public class KillSessionRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Shard ID. Either `ShardId` or `ShardSerialId` is required. 
    ...
    /**
     * Set Shard ID. Either `ShardId` or `ShardSerialId` is required.
    ...
    /**
     * Get Shard sequence ID. Either `ShardId` or `ShardSerialId` is required. 
    ...
    /**
     * Set Shard sequence ID. Either `ShardId` or `ShardSerialId` is required.
