...
public class ModifyDBSyncModeResponse extends AbstractModel {
    ...
    */
    ...
    public ModifyDBSyncModeResponse() {
    }
     ...
     */
    public ModifyDBSyncModeResponse(ModifyDBSyncModeResponse source) {
