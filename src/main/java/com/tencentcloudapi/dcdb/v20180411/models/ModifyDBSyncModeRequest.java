...
public class ModifyDBSyncModeRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get ID of the instance for which to modify the sync mode. The ID is in the format of dcdbt-ow728lmc. 
    ...
    /**
     * Set ID of the instance for which to modify the sync mode. The ID is in the format of dcdbt-ow728lmc.
