...
public class DescribeDBParametersResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Requests the current parameter values of a DB 
     * @return Params Requests the current parameter values of a DB
     */
    ...
    /**
     * Set Requests the current parameter values of a DB
