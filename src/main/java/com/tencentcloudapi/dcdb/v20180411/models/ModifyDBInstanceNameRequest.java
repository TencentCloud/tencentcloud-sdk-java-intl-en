...
public class ModifyDBInstanceNameRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Instance ID in the format of tdsql-hdaprz0v 
     * @return InstanceId Instance ID in the format of tdsql-hdaprz0v
     */
    ...
    /**
     * Set Instance ID in the format of tdsql-hdaprz0v
