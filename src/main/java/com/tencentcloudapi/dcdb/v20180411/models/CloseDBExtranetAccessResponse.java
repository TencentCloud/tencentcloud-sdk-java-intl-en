...
public class CloseDBExtranetAccessResponse extends AbstractModel {
    ...
    */
    ...
    public CloseDBExtranetAccessResponse() {
    }
     ...
     */
    public CloseDBExtranetAccessResponse(CloseDBExtranetAccessResponse source) {
