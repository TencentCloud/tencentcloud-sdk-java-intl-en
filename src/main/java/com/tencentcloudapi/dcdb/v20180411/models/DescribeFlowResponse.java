...
public class DescribeFlowResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Task status. Valid values: `0` (succeeded), `1` (failed), `2` (running) 
     * @return Status Task status. Valid values: `0` (succeeded), `1` (failed), `2` (running)
     */
    ...
    /**
     * Set Task status. Valid values: `0` (succeeded), `1` (failed), `2` (running)
