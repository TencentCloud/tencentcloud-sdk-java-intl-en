...
public class ModifyDBParametersRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get List of parameters. Every element is a combination of `Param` and `Value`. 
     * @return Params List of parameters. Every element is a combination of `Param` and `Value`.
     */
    ...
    /**
     * Set List of parameters. Every element is a combination of `Param` and `Value`.
