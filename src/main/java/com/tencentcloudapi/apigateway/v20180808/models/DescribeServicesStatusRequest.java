...
public class DescribeServicesStatusRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Filter. Valid values: ServiceId, ServiceName, NotUsagePlanId, Environment, IpVersion. 
    ...
    /**
     * Set Filter. Valid values: ServiceId, ServiceName, NotUsagePlanId, Environment, IpVersion.
