...
Note: this field may return null, indicating that no valid values can be obtained.
     */
    public void setResult(ApiKeysStatus Result) {
        this.Result = Result;
    }
     ...
     */
    public DescribeApiKeysStatusResponse(DescribeApiKeysStatusResponse source) {
        if (source.Result != null) {
            this.Result = new ApiKeysStatus(source.Result);
        }
