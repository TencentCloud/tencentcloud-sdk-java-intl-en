...
public class DescribeAPIDocDetailRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeAPIDocDetailRequest() {
    }
     ...
     */
    public DescribeAPIDocDetailRequest(DescribeAPIDocDetailRequest source) {
