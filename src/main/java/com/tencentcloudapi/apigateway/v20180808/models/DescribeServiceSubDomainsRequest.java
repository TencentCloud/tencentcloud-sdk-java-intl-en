...
public class DescribeServiceSubDomainsRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeServiceSubDomainsRequest() {
    }
     ...
     */
    public DescribeServiceSubDomainsRequest(DescribeServiceSubDomainsRequest source) {
