...
public class DescribeUpstreamBindApisResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setResult(DescribeUpstreamBindApis Result) {
        this.Result = Result;
    }
     ...
     */
    public DescribeUpstreamBindApisResponse(DescribeUpstreamBindApisResponse source) {
        if (source.Result != null) {
            this.Result = new DescribeUpstreamBindApis(source.Result);
        }
