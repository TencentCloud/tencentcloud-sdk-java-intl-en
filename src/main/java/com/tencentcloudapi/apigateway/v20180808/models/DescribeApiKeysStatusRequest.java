...
public class DescribeApiKeysStatusRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Filter. Valid values: AccessKeyId, AccessKeySecret, SecretName, NotUsagePlanId, Status, KeyWord (match with `name` or `path`). 
     * @return Filters Filter. Valid values: AccessKeyId, AccessKeySecret, SecretName, NotUsagePlanId, Status, KeyWord (match with `name` or `path`).
     */
    ...
    /**
     * Set Filter. Valid values: AccessKeyId, AccessKeySecret, SecretName, NotUsagePlanId, Status, KeyWord (match with `name` or `path`).
    ...
    public DescribeApiKeysStatusRequest() {
    }
     ...
     */
    public DescribeApiKeysStatusRequest(DescribeApiKeysStatusRequest source) {
