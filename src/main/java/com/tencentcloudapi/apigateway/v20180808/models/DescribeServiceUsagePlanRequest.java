...
public class DescribeServiceUsagePlanRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeServiceUsagePlanRequest() {
    }
     ...
     */
    public DescribeServiceUsagePlanRequest(DescribeServiceUsagePlanRequest source) {
