...
public class DescribeApiUsagePlanRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeApiUsagePlanRequest() {
    }
     ...
     */
    public DescribeApiUsagePlanRequest(DescribeApiUsagePlanRequest source) {
