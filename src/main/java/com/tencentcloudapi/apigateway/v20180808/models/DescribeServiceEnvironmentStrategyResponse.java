...
public class DescribeServiceEnvironmentStrategyResponse extends AbstractModel{
...
Note: this field may return null, indicating that no valid values can be obtained.
    */
    ...
    @Expose
    private ServiceEnvironmentStrategyStatus Result;
...
Note: this field may return null, indicating that no valid values can be obtained. 
     * @return Result Throttling policy list.
Note: this field may return null, indicating that no valid values can be obtained.
     */
    public ServiceEnvironmentStrategyStatus getResult() {
        return this.Result;
    }
...
Note: this field may return null, indicating that no valid values can be obtained.
     */
    public void setResult(ServiceEnvironmentStrategyStatus Result) {
        this.Result = Result;
    }
