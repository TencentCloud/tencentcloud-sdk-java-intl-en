...
public class DescribePaiInstancesResponse extends AbstractModel{
    ...
    */
     ...
     */
    public DescribePaiInstancesResponse(DescribePaiInstancesResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.PaiInstanceSet != null) {
            this.PaiInstanceSet = new PaiInstance[source.PaiInstanceSet.length];
            for (int i = 0; i < source.PaiInstanceSet.length; i++) {
                this.PaiInstanceSet[i] = new PaiInstance(source.PaiInstanceSet[i]);
            }
        }
