...
public class StartInstanceRefreshResponse extends AbstractModel {
    ...
    */
    ...
    public StartInstanceRefreshResponse() {
    }
     ...
     */
    public StartInstanceRefreshResponse(StartInstanceRefreshResponse source) {
