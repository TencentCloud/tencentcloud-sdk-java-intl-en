...
public class ScaleOutInstancesResponse extends AbstractModel{
    ...
    */
    ...
    public ScaleOutInstancesResponse() {
    }
     ...
     */
    public ScaleOutInstancesResponse(ScaleOutInstancesResponse source) {
