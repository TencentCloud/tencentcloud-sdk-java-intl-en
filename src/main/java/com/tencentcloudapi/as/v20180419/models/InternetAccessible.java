...
Note: this field may return null, indicating that no valid value was found.
    ...
    /**
     * Get Line type. for details on various types of lines and supported regions, refer to [EIP IP address type](https://www.tencentcloud.com/zh/document/product/213/5733). default value: BGP.
...
Note: The static single-line IP is only supported in some regions.
     ...
     * @return InternetServiceProvider Line type. for details on various types of lines and supported regions, refer to [EIP IP address type](https://www.tencentcloud.com/zh/document/product/213/5733). default value: BGP.
...
Note: The static single-line IP is only supported in some regions.
    ...
    /**
     * Set Line type. for details on various types of lines and supported regions, refer to [EIP IP address type](https://www.tencentcloud.com/zh/document/product/213/5733). default value: BGP.
...
Note: The static single-line IP is only supported in some regions.
     ...
     * @param InternetServiceProvider Line type. for details on various types of lines and supported regions, refer to [EIP IP address type](https://www.tencentcloud.com/zh/document/product/213/5733). default value: BGP.
