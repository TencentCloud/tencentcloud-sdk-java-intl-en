...
public class ModifyWebshellStatusResponse extends AbstractModel {
    ...
    */
     ...
     * @param Success Successful status code, needs JSON decoding before use, the returned format is {Domain:Status}, successful status code is Success, others are failed status codes (YunAPI Defined Error Codes)
     */
    ...
    public ModifyWebshellStatusResponse() {
    }
     ...
     */
    public ModifyWebshellStatusResponse(ModifyWebshellStatusResponse source) {
