...
public class ModifyHostStatusResponse extends AbstractModel {
    ...
    */
    ...
    public ModifyHostStatusResponse() {
    }
     ...
     */
    public ModifyHostStatusResponse(ModifyHostStatusResponse source) {
