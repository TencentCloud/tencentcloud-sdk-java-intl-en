...
public class DescribeTlsVersionResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeTlsVersionResponse() {
    }
     ...
     */
    public DescribeTlsVersionResponse(DescribeTlsVersionResponse source) {
        if (source.TLS != null) {
            this.TLS = new TLSVersion[source.TLS.length];
            for (int i = 0; i < source.TLS.length; i++) {
                this.TLS[i] = new TLSVersion(source.TLS[i]);
            }
        }
