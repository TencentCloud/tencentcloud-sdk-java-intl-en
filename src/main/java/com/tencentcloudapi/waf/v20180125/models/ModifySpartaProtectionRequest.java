...
3: Enable SNI. SNI is the custom domain name.
    ...
    /**
     * Get 0: Disable probe test; 1: Enable probe test. The probe test is enabled by default. 
     * @return ProbeStatus 0: Disable probe test; 1: Enable probe test. The probe test is enabled by default.
     */
    ...
    /**
     * Set 0: Disable probe test; 1: Enable probe test. The probe test is enabled by default.
     * @param ProbeStatus 0: Disable probe test; 1: Enable probe test. The probe test is enabled by default.
     */
