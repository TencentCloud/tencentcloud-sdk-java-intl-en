...
public class DeleteCustomWhiteRuleResponse extends AbstractModel {
    ...
    */
    ...
    public DeleteCustomWhiteRuleResponse() {
    }
     ...
     */
    public DeleteCustomWhiteRuleResponse(DeleteCustomWhiteRuleResponse source) {
