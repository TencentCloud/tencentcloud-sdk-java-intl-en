...
public class DescribeHostLimitResponse extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained. 
     * @return Success Successfully returned status code
...
Note: This field may return null, indicating that no valid values can be obtained.
     * @param Success Successfully returned status code
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeHostLimitResponse() {
    }
     ...
     */
    public DescribeHostLimitResponse(DescribeHostLimitResponse source) {
