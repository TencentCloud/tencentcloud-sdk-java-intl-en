...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    */
    ...
    /**
     * Get Length of a protection domain list 
    ...
    /**
     * Set Length of a protection domain list
     * @param TotalCount Length of a protection domain list
     */
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Set List of protection domains

Note: This field may return null, indicating that no valid values can be obtained.
     * @param HostList List of protection domains
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeHostsResponse(DescribeHostsResponse source) {
        ...
        if (source.HostList != null) {
            this.HostList = new HostRecord[source.HostList.length];
            for (int i = 0; i < source.HostList.length; i++) {
                this.HostList[i] = new HostRecord(source.HostList[i]);
            }
        }
