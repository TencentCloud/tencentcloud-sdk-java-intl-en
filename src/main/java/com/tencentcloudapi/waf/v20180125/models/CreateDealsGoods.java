...
Note: This field may return null, indicating that no valid values can be obtained.
    */
     ...
     */
    public void setGoodsDetail(CreateDealsGoodsDetail GoodsDetail) {
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public CreateDealsGoods(CreateDealsGoods source) {
        if (source.GoodsNum != null) {
            this.GoodsNum = new Long(source.GoodsNum);
        }
        if (source.GoodsDetail != null) {
            this.GoodsDetail = new CreateDealsGoodsDetail(source.GoodsDetail);
        }
