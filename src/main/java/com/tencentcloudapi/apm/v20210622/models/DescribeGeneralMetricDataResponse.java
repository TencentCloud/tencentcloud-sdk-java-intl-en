...
public class DescribeGeneralMetricDataResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Set Indicator result set.
     * @param Records Indicator result set.
     */
     ...
     */
    public DescribeGeneralMetricDataResponse(DescribeGeneralMetricDataResponse source) {
        if (source.Records != null) {
            this.Records = new Line[source.Records.length];
            for (int i = 0; i < source.Records.length; i++) {
                this.Records[i] = new Line(source.Records[i]);
            }
        }
