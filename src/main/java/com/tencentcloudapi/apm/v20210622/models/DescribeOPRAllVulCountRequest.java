...
public class DescribeOPRAllVulCountRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeOPRAllVulCountRequest() {
    }
     ...
     */
    public DescribeOPRAllVulCountRequest(DescribeOPRAllVulCountRequest source) {
