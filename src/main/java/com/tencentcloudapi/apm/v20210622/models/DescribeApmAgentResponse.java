...
public class DescribeApmAgentResponse extends AbstractModel {
    ...
    */
     ...
     * @param ApmAgent Agent information.
     */
     ...
     */
    public DescribeApmAgentResponse(DescribeApmAgentResponse source) {
        if (source.ApmAgent != null) {
            this.ApmAgent = new ApmAgentInfo(source.ApmAgent);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamObj(map, prefix + "ApmAgent.", this.ApmAgent);
