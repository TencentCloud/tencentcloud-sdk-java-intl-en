...
public class DeleteApmSampleConfigRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteApmSampleConfigRequest() {
    }
     ...
     */
    public DeleteApmSampleConfigRequest(DeleteApmSampleConfigRequest source) {
