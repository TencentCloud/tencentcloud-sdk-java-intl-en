...
public class DescribeWorkGroupsResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get The total number of working groups 
    ...
    /**
     * Set The total number of working groups
     * @param TotalCount The total number of working groups
     */
     ...
     */
    public void setWorkGroupSet(WorkGroupInfo [] WorkGroupSet) {
     ...
     */
    public DescribeWorkGroupsResponse(DescribeWorkGroupsResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.WorkGroupSet != null) {
            this.WorkGroupSet = new WorkGroupInfo[source.WorkGroupSet.length];
            for (int i = 0; i < source.WorkGroupSet.length; i++) {
                this.WorkGroupSet[i] = new WorkGroupInfo(source.WorkGroupSet[i]);
            }
        }
