...
public class DescribeDMSDatabaseListResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get List of database objects for the DMS 
    ...
    /**
     * Set List of database objects for the DMS
     * @param DatabaseList List of database objects for the DMS
     */
    public void setDatabaseList(DMSDatabaseInfo [] DatabaseList) {
     ...
     */
    public DescribeDMSDatabaseListResponse(DescribeDMSDatabaseListResponse source) {
        if (source.DatabaseList != null) {
            this.DatabaseList = new DMSDatabaseInfo[source.DatabaseList.length];
            for (int i = 0; i < source.DatabaseList.length; i++) {
                this.DatabaseList[i] = new DMSDatabaseInfo(source.DatabaseList[i]);
            }
        }
