...
public class AttachDataMaskPolicyRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Collection of DMask permission objects that should be bound. 
    ...
    /**
     * Set Collection of DMask permission objects that should be bound.
     * @param DataMaskStrategyPolicySet Collection of DMask permission objects that should be bound.
     */
