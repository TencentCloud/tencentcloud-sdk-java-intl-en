...
public class PermissionResponseInfo extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained. 
     * @return Allowed Authentication result
Note: This field may return null, indicating that no valid values can be obtained.
     */
...
Note: This field may return null, indicating that no valid values can be obtained.
     * @param Allowed Authentication result
Note: This field may return null, indicating that no valid values can be obtained.
     */
     ...
     */
    public PermissionResponseInfo(PermissionResponseInfo source) {
