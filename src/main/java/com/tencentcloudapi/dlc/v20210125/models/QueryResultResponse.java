...
public class QueryResultResponse extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
     * @param NextToken Pagination information
Note: This field may return null, indicating that no valid values can be obtained.
     */
     ...
     */
    public QueryResultResponse(QueryResultResponse source) {
