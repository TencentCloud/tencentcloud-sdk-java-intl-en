...
public class Filter extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Attribute name. If more than one filter exists, the logical relationship between these filters is `OR`. 
    ...
    /**
     * Set Attribute name. If more than one filter exists, the logical relationship between these filters is `OR`.
