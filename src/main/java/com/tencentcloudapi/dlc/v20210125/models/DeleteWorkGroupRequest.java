...
public class DeleteWorkGroupRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Collection of IDs of working groups to be deleted 
    ...
    /**
     * Set Collection of IDs of working groups to be deleted
     * @param WorkGroupIds Collection of IDs of working groups to be deleted
     */
