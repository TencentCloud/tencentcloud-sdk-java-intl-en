...
public class CheckDataEngineImageCanBeUpgradeResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get ID of the minor version of the cluster image that can be updated under the major version 
    ...
    /**
     * Set ID of the minor version of the cluster image that can be updated under the major version
     * @param ChildImageVersionId ID of the minor version of the cluster image that can be updated under the major version
     */
    ...
    /**
     * Set Whether it can be updated
     * @param IsUpgrade Whether it can be updated
     */
