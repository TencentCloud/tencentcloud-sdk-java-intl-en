...
public class AddUsersToWorkGroupRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Information about working groups and users to be operated 
    ...
    /**
     * Set Information about working groups and users to be operated
     * @param AddInfo Information about working groups and users to be operated
     */
    public void setAddInfo(UserIdSetOfWorkGroupId AddInfo) {
        this.AddInfo = AddInfo;
    }

    public AddUsersToWorkGroupRequest() {
    }
     ...
     */
    public AddUsersToWorkGroupRequest(AddUsersToWorkGroupRequest source) {
