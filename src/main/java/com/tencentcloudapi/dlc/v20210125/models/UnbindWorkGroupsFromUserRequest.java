...
public class UnbindWorkGroupsFromUserRequest extends AbstractModel {
    ...
    */
     ...
     * @return AddInfo Association between the IDs of unbound working groups and user IDs
     */
     ...
     * @param AddInfo Association between the IDs of unbound working groups and user IDs
     */
