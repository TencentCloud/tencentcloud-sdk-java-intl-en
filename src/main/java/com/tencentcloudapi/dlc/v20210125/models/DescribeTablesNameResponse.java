...
public class DescribeTablesNameResponse extends AbstractModel {
    ...
    */
     ...
     * @param TableNameList Object list of data table names
     */
    ...
    /**
     * Set Total instances
     * @param TotalCount Total instances
     */
    ...
    public DescribeTablesNameResponse() {
    }
    ...
    public DescribeTablesNameResponse(DescribeTablesNameResponse source) {
        if (source.TableNameList != null) {
            this.TableNameList = new String[source.TableNameList.length];
            for (int i = 0; i < source.TableNameList.length; i++) {
                this.TableNameList[i] = new String(source.TableNameList[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArraySimple(map, prefix + "TableNameList.", this.TableNameList);
