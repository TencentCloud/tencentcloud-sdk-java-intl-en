...
-WaitExecute: pending execution.
    ...
    /**
     * Get Amount of document parsing task. 
    ...
    /**
     * Set Amount of document parsing task.
     * @param Usage Amount of document parsing task.
     */
    ...
    /**
     * Get Error message for failed document parsing task. When a document parsing task fails, a specific error message will be returned. 
    ...
    /**
     * Set Error message for failed document parsing task. When a document parsing task fails, a specific error message will be returned.
     * @param Error Error message for failed document parsing task. When a document parsing task fails, a specific error message will be returned.
     */
