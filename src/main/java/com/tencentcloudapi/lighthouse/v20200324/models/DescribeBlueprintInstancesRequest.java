...
public class DescribeBlueprintInstancesRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Instance ID list, which currently can contain only one instance. 
    ...
    /**
     * Set Instance ID list, which currently can contain only one instance.
    ...
    public DescribeBlueprintInstancesRequest() {
    }
     ...
     */
    public DescribeBlueprintInstancesRequest(DescribeBlueprintInstancesRequest source) {
