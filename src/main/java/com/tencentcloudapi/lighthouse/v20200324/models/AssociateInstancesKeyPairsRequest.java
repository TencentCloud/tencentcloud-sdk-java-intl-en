...
public class AssociateInstancesKeyPairsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Key pair ID list. Each request can contain up to 100 key pairs. 
     * @return KeyIds Key pair ID list. Each request can contain up to 100 key pairs.
     */
    ...
    /**
     * Set Key pair ID list. Each request can contain up to 100 key pairs.
