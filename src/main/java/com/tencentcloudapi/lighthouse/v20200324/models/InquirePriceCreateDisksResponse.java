...
public class InquirePriceCreateDisksResponse extends AbstractModel{
    ...
    */
    ...
    public InquirePriceCreateDisksResponse() {
    }
     ...
     */
    public InquirePriceCreateDisksResponse(InquirePriceCreateDisksResponse source) {
