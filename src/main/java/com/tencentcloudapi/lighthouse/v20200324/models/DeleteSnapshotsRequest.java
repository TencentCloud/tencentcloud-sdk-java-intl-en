...
public class DeleteSnapshotsRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get List of IDs of snapshots to be deleted, which can be queried through `DescribeSnapshots`. 
    ...
    /**
     * Set List of IDs of snapshots to be deleted, which can be queried through `DescribeSnapshots`.
