...
public class CreateMediaConnectFlowResponse extends AbstractModel{
    ...
    */
    ...
    public CreateMediaConnectFlowResponse() {
    }
     ...
     */
    public CreateMediaConnectFlowResponse(CreateMediaConnectFlowResponse source) {
        if (source.Info != null) {
