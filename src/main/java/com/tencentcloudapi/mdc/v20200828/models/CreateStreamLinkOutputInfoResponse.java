...
public class CreateStreamLinkOutputInfoResponse extends AbstractModel{
    ...
    */
     ...
     * @return Info The information of the created output.
     */
    ...
    public CreateStreamLinkOutputInfoResponse() {
    }
     ...
     */
    public CreateStreamLinkOutputInfoResponse(CreateStreamLinkOutputInfoResponse source) {
        if (source.Info != null) {
