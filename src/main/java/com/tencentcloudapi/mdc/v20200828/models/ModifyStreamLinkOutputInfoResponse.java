...
public class ModifyStreamLinkOutputInfoResponse extends AbstractModel{
    ...
    */
    ...
    public ModifyStreamLinkOutputInfoResponse() {
    }
     ...
     */
    public ModifyStreamLinkOutputInfoResponse(ModifyStreamLinkOutputInfoResponse source) {
        if (source.Info != null) {
