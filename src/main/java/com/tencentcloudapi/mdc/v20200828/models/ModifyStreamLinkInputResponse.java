...
public class ModifyStreamLinkInputResponse extends AbstractModel{
    ...
    */
     ...
     * @return Info The input information after modification.
     */
    ...
    public ModifyStreamLinkInputResponse() {
    }
     ...
     */
    public ModifyStreamLinkInputResponse(ModifyStreamLinkInputResponse source) {
        if (source.Info != null) {
