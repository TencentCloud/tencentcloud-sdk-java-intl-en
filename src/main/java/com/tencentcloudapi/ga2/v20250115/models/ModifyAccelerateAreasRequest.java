...
public class ModifyAccelerateAreasRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Acceleration region info.</p><p>Input limit: array length cannot exceed 10.</p> 
     * @return AcceleratorAreas <p>Acceleration region info.</p><p>Input limit: array length cannot exceed 10.</p>
     */
    ...
    /**
     * Set <p>Acceleration region info.</p><p>Input limit: array length cannot exceed 10.</p>
     * @param AcceleratorAreas <p>Acceleration region info.</p><p>Input limit: array length cannot exceed 10.</p>
     */
