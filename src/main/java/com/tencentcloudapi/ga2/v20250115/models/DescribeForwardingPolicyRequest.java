...
public class DescribeForwardingPolicyRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeForwardingPolicyRequest() {
    }
     ...
     */
    public DescribeForwardingPolicyRequest(DescribeForwardingPolicyRequest source) {
