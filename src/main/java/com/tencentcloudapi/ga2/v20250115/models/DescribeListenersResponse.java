...
public class DescribeListenersResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Eligible listener instance. 
    ...
    /**
     * Set Eligible listener instance.
     * @param ListenerSet Eligible listener instance.
     */
    public void setListenerSet(ListenerSet [] ListenerSet) {
    ...
    public DescribeListenersResponse(DescribeListenersResponse source) {
        if (source.ListenerSet != null) {
            this.ListenerSet = new ListenerSet[source.ListenerSet.length];
            for (int i = 0; i < source.ListenerSet.length; i++) {
                this.ListenerSet[i] = new ListenerSet(source.ListenerSet[i]);
            }
        }
