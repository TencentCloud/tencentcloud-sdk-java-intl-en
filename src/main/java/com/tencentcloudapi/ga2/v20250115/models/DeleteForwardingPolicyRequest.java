...
public class DeleteForwardingPolicyRequest extends AbstractModel {
    ...
    */
     ...
     */
    public DeleteForwardingPolicyRequest(DeleteForwardingPolicyRequest source) {
