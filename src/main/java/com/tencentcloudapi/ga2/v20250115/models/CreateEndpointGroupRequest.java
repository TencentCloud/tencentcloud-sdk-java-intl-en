...
public class CreateEndpointGroupRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Node group type.</p><p>Enumeration values:</p><ul><li>VIRTUAL: custom endpoint node group</li><li>DEFAULT: default terminal node group</li></ul> 
    ...
    /**
     * Set <p>Node group type.</p><p>Enumeration values:</p><ul><li>VIRTUAL: custom endpoint node group</li><li>DEFAULT: default terminal node group</li></ul>
     * @param EndpointGroupType <p>Node group type.</p><p>Enumeration values:</p><ul><li>VIRTUAL: custom endpoint node group</li><li>DEFAULT: default terminal node group</li></ul>
     */
    ...
    /**
     * Get <p>Terminal node group configuration.</p> 
    ...
    /**
     * Set <p>Terminal node group configuration.</p>
     * @param EndpointGroupConfiguration <p>Terminal node group configuration.</p>
     */
