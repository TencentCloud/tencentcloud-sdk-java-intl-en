...
public class DescribeGlobalAcceleratorsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Number of returned results.</p><p>Value range: [1, 200]</p><p>Default value: 20</p> 
    ...
    /**
     * Set <p>Number of returned results.</p><p>Value range: [1, 200]</p><p>Default value: 20</p>
     * @param Limit <p>Number of returned results.</p><p>Value range: [1, 200]</p><p>Default value: 20</p>
     */
    ...
    /**
     * Get <p>Filter criteria. <li>global-accelerator-id - String - (Filter condition) Global acceleration instance ID.</li> <li>global-accelerator-state - String - (Filter condition) Global acceleration instance status.</li></p> 
    ...
    /**
     * Set <p>Filter criteria. <li>global-accelerator-id - String - (Filter condition) Global acceleration instance ID.</li> <li>global-accelerator-state - String - (Filter condition) Global acceleration instance status.</li></p>
     * @param Filters <p>Filter criteria. <li>global-accelerator-id - String - (Filter condition) Global acceleration instance ID.</li> <li>global-accelerator-state - String - (Filter condition) Global acceleration instance status.</li></p>
     */
