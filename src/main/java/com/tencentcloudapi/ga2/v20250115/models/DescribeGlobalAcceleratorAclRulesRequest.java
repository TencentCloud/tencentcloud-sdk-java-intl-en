...
public class DescribeGlobalAcceleratorAclRulesRequest extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeGlobalAcceleratorAclRulesRequest(DescribeGlobalAcceleratorAclRulesRequest source) {
