...
public class HideResponseHeaders extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>value</p><p>Currently only support inputting an empty string ""</p> 
     * @return Value <p>value</p><p>Currently only support inputting an empty string ""</p>
     */
    ...
    /**
     * Set <p>value</p><p>Currently only support inputting an empty string ""</p>
     * @param Value <p>value</p><p>Currently only support inputting an empty string ""</p>
     */
     ...
     */
    public HideResponseHeaders(HideResponseHeaders source) {
        if (source.Key != null) {
