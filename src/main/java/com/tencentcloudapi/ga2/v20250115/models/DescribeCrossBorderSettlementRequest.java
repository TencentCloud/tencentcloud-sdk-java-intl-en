...
public class DescribeCrossBorderSettlementRequest extends AbstractModel {
    ...
    */
     ...
     * @param AccelerateRegion Acceleration region.
     */
    ...
    /**
     * Get Region of the terminal node group. 
    ...
    /**
     * Set Region of the terminal node group.
     * @param EndpointGroupRegion Region of the terminal node group.
     */
    ...
    /**
     * Set Bill year and month time.
     * @param SettlementMonth Bill year and month time.
     */
