...
public class CreateEndpointGroupResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Instance ID of the terminal node group.</p> 
     * @return EndpointGroupId <p>Instance ID of the terminal node group.</p>
     */
    ...
    /**
     * Set <p>Instance ID of the terminal node group.</p>
     * @param EndpointGroupId <p>Instance ID of the terminal node group.</p>
     */
     ...
     */
    public CreateEndpointGroupResponse(CreateEndpointGroupResponse source) {
