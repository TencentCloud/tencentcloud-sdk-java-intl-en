...
public class DescribeListenersRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Filter criteria. listener-id - String - (Filter criteria) Listener instance ID. 
     * @return Filters Filter criteria. listener-id - String - (Filter criteria) Listener instance ID.
     */
    ...
    /**
     * Set Filter criteria. listener-id - String - (Filter criteria) Listener instance ID.
     * @param Filters Filter criteria. listener-id - String - (Filter criteria) Listener instance ID.
     */
