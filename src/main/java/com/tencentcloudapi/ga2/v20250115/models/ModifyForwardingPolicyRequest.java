...
public class ModifyForwardingPolicyRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Domain name.</p><p>Input limit: length range is 1-80.</p><p>The format must meet the regular expression: ^(<a href="?:[a-z0-9-]{0,61}[a-z0-9]">a-z0-9</a>?.)+[a-z]{2,}$</p> 
     * @return Host <p>Domain name.</p><p>Input limit: length range is 1-80.</p><p>The format must meet the regular expression: ^(<a href="?:[a-z0-9-]{0,61}[a-z0-9]">a-z0-9</a>?.)+[a-z]{2,}$</p>
     */
    ...
    /**
     * Set <p>Domain name.</p><p>Input limit: length range is 1-80.</p><p>The format must meet the regular expression: ^(<a href="?:[a-z0-9-]{0,61}[a-z0-9]">a-z0-9</a>?.)+[a-z]{2,}$</p>
     * @param Host <p>Domain name.</p><p>Input limit: length range is 1-80.</p><p>The format must meet the regular expression: ^(<a href="?:[a-z0-9-]{0,61}[a-z0-9]">a-z0-9</a>?.)+[a-z]{2,}$</p>
     */
