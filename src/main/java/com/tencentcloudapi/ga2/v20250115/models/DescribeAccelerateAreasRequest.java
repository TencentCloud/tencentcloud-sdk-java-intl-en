...
public class DescribeAccelerateAreasRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Offset. The default is 0.</p> 
    ...
    /**
     * Set <p>Offset. The default is 0.</p>
     * @param Offset <p>Offset. The default is 0.</p>
     */
    ...
    /**
     * Get <p>Number of instances meeting conditions. Default value: 20. Maximum: 200.</p> 
    ...
    /**
     * Set <p>Number of instances meeting conditions. Default value: 20. Maximum: 200.</p>
     * @param Limit <p>Number of instances meeting conditions. Default value: 20. Maximum: 200.</p>
     */
    ...
    /**
     * Get <p>Filter criteria. accelerate-region - String - (Filter criterion) Terminal node group region.</p> 
    ...
    /**
     * Set <p>Filter criteria. accelerate-region - String - (Filter criterion) Terminal node group region.</p>
     * @param Filters <p>Filter criteria. accelerate-region - String - (Filter criterion) Terminal node group region.</p>
     */
