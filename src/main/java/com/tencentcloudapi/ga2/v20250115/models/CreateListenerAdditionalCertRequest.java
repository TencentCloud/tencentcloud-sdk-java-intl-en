...
public class CreateListenerAdditionalCertRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Certificate ID.</p><p>Currently, only server certificates can be added.</p> 
     * @return AdditionalCertificates <p>Certificate ID.</p><p>Currently, only server certificates can be added.</p>
     */
    ...
    /**
     * Set <p>Certificate ID.</p><p>Currently, only server certificates can be added.</p>
     * @param AdditionalCertificates <p>Certificate ID.</p><p>Currently, only server certificates can be added.</p>
     */
