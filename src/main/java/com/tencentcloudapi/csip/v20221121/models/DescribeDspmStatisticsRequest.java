...
public class DescribeDspmStatisticsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Filter by asset type</p><p>Enumeration values:</p><ul><li>cdb: cdb</li><li>mariadb: mariadb</li><li>cynosdb: cynosdb</li></ul><p>Default value: empty by default, meaning no filtering by asset type and return all asset information</p> 
    ...
    /**
     * Set <p>Filter by asset type</p><p>Enumeration values:</p><ul><li>cdb: cdb</li><li>mariadb: mariadb</li><li>cynosdb: cynosdb</li></ul><p>Default value: empty by default, meaning no filtering by asset type and return all asset information</p>
     * @param AssetType <p>Filter by asset type</p><p>Enumeration values:</p><ul><li>cdb: cdb</li><li>mariadb: mariadb</li><li>cynosdb: cynosdb</li></ul><p>Default value: empty by default, meaning no filtering by asset type and return all asset information</p>
     */
