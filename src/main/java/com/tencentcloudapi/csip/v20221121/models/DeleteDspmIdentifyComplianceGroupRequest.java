...
public class DeleteDspmIdentifyComplianceGroupRequest extends AbstractModel {

    /**
    * <p>Identification template ID set</p>
    */
    @SerializedName("Ids")
    @Expose
    private Long [] Ids;
    ...
    */
    ...
    /**
     * Get <p>Identification template ID set</p> 
     * @return Ids <p>Identification template ID set</p>
     */
    public Long [] getIds() {
        return this.Ids;
    }
    ...
    /**
     * Set <p>Identification template ID set</p>
     * @param Ids <p>Identification template ID set</p>
     */
    ...
    public DeleteDspmIdentifyComplianceGroupRequest() {
    }
     ...
     */
    public DeleteDspmIdentifyComplianceGroupRequest(DeleteDspmIdentifyComplianceGroupRequest source) {
        if (source.Ids != null) {
