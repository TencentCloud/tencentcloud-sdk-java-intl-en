...
public class DescribeConfigCheckRulesRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeConfigCheckRulesRequest() {
    }
     ...
     */
    public DescribeConfigCheckRulesRequest(DescribeConfigCheckRulesRequest source) {
