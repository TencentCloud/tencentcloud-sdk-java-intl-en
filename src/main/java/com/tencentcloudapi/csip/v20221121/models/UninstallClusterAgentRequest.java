...
public class UninstallClusterAgentRequest extends AbstractModel {
    ...
    */
    ...
    public UninstallClusterAgentRequest() {
    }
     ...
     */
    public UninstallClusterAgentRequest(UninstallClusterAgentRequest source) {
