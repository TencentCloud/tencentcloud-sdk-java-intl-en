...
public class DescribeBaselineSubTaskListRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Set <p>Baseline main task ID.</p>
     * @param TaskID <p>Baseline main task ID.</p>
     */
    ...
    /**
     * Get <p>Universal Filter Criteria. Supported fields include: TaskID (main task ID, exact), Status (subtask status), CheckAssetType, and InstanceID/ClusterID.</p> 
    ...
    /**
     * Set <p>Universal Filter Criteria. Supported fields include: TaskID (main task ID, exact), Status (subtask status), CheckAssetType, and InstanceID/ClusterID.</p>
     * @param Filters <p>Universal Filter Criteria. Supported fields include: TaskID (main task ID, exact), Status (subtask status), CheckAssetType, and InstanceID/ClusterID.</p>
     */
    ...
    /**
     * Get <p>Starting offset amount for paging query, starting from 0.</p> 
    ...
    /**
     * Set <p>Starting offset amount for paging query, starting from 0.</p>
     * @param Offset <p>Starting offset amount for paging query, starting from 0.</p>
     */
    ...
    /**
     * Get <p>Sorting order. Value: asc (ascending) or desc (descending). Default: desc.</p> 
    ...
    /**
     * Set <p>Sorting order. Value: asc (ascending) or desc (descending). Default: desc.</p>
     * @param Order <p>Sorting order. Value: asc (ascending) or desc (descending). Default: desc.</p>
     */
    ...
    /**
     * Get <p>Sort field name. It is an optional field defined by the specific API.</p> 
    ...
    /**
     * Set <p>Sort field name. It is an optional field defined by the specific API.</p>
     * @param By <p>Sort field name. It is an optional field defined by the specific API.</p>
     */
