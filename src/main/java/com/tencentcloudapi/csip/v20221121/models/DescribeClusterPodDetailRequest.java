...
public class DescribeClusterPodDetailRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeClusterPodDetailRequest() {
    }
     ...
     */
    public DescribeClusterPodDetailRequest(DescribeClusterPodDetailRequest source) {
