...
public class ModifyDspmIdentifyRuleRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Data item enable status</p><p>Enumeration values:</p><ul><li>0: disabled</li><li>1: enabled</li></ul> 
    ...
    /**
     * Set <p>Data item enable status</p><p>Enumeration values:</p><ul><li>0: disabled</li><li>1: enabled</li></ul>
     * @param Status <p>Data item enable status</p><p>Enumeration values:</p><ul><li>0: disabled</li><li>1: enabled</li></ul>
     */
    ...
    public ModifyDspmIdentifyRuleRequest() {
    }
     ...
     */
    public ModifyDspmIdentifyRuleRequest(ModifyDspmIdentifyRuleRequest source) {
        if (source.Id != null) {
