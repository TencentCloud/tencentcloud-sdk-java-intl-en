...
public class DescribeRiskCallRecordResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeRiskCallRecordResponse() {
    }
     ...
     */
    public DescribeRiskCallRecordResponse(DescribeRiskCallRecordResponse source) {
        if (source.Data != null) {
            this.Data = new RiskCallRecord[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new RiskCallRecord(source.Data[i]);
            }
        }
