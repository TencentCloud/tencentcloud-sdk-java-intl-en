...
public class DeleteDspmIdentifyCategoryRequest extends AbstractModel {
    ...
    */
     ...
     * @return Ids <p>Category ID set</p>
     */
    public Long [] getIds() {
        return this.Ids;
    }
    ...
    public DeleteDspmIdentifyCategoryRequest() {
    }
     ...
     */
    public DeleteDspmIdentifyCategoryRequest(DeleteDspmIdentifyCategoryRequest source) {
        if (source.Ids != null) {
