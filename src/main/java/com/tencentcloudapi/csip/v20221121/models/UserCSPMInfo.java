...
public class UserCSPMInfo extends AbstractModel {
    ...
    */
    ...
    /**
     * Set <p>CSPM scan quota</p>
     * @param CSPMNum <p>CSPM scan quota</p>
     */
    ...
    /**
     * Get <p>Consumed CSPM scan quota</p> 
    ...
    /**
     * Set <p>Consumed CSPM scan quota</p>
     * @param UsedCount <p>Consumed CSPM scan quota</p>
     */
    ...
    /**
     * Get <p>Complimentary CSPM scan quota</p> 
    ...
    /**
     * Set <p>Complimentary CSPM scan quota</p>
     * @param GrantedCSPMNum <p>Complimentary CSPM scan quota</p>
     */
    ...
    /**
     * Get <p>Whether it is shared. 1: shared, 2: not shared</p> 
    ...
    /**
     * Set <p>Whether it is shared. 1: shared, 2: not shared</p>
     * @param IsShared <p>Whether it is shared. 1: shared, 2: not shared</p>
     */
    ...
    /**
     * Get <p>Whether to purchase separately. 1: purchase separately, 2: not purchased separately</p> 
    ...
    /**
     * Set <p>Whether to purchase separately. 1: purchase separately, 2: not purchased separately</p>
     * @param IsSelfBuy <p>Whether to purchase separately. 1: purchase separately, 2: not purchased separately</p>
     */
    ...
    /**
     * Set <p>Quota source account</p>
     * @param ShareFromAppID <p>Quota source account</p>
     */
    ...
    /**
     * Get <p>Role: member; admin; delegatedAdmin</p> 
    ...
    /**
     * Set <p>Role: member; admin; delegatedAdmin</p>
     * @param Role <p>Role: member; admin; delegatedAdmin</p>
     */
    ...
    /**
     * Set <p>Department</p>
     * @param Department <p>Department</p>
     */
