...
public class DetectTypeCount extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Detection mode. 0: host detection. 1: network detection</p> 
    ...
    /**
     * Set <p>Detection mode. 0: host detection. 1: network detection</p>
     * @param DetectType <p>Detection mode. 0: host detection. 1: network detection</p>
     */
