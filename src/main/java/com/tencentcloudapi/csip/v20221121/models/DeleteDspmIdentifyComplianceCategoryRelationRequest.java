...
public class DeleteDspmIdentifyComplianceCategoryRelationRequest extends AbstractModel {
    ...
    */
     ...
     */
    public DeleteDspmIdentifyComplianceCategoryRelationRequest(DeleteDspmIdentifyComplianceCategoryRelationRequest source) {
