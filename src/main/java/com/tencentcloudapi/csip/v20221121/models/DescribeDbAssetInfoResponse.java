...
Note: This field may return·null, indicating that no valid values can be obtained.
    ...
    public DescribeDbAssetInfoResponse() {
    }
     ...
     */
    public DescribeDbAssetInfoResponse(DescribeDbAssetInfoResponse source) {
        if (source.Data != null) {
            this.Data = new DbAssetInfo(source.Data);
        }
