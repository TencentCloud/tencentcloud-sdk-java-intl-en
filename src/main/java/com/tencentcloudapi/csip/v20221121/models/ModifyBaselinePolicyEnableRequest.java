...
public class ModifyBaselinePolicyEnableRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Target enable status. 0: disabled, 1: enabled.</p> 
    ...
    /**
     * Set <p>Target enable status. 0: disabled, 1: enabled.</p>
     * @param Enable <p>Target enable status. 0: disabled, 1: enabled.</p>
     */
