...
public class DescribeNFSScanHostRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeNFSScanHostRequest() {
    }
     ...
     */
    public DescribeNFSScanHostRequest(DescribeNFSScanHostRequest source) {
