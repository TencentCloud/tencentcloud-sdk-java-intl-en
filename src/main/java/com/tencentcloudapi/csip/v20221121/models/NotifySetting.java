...
public class NotifySetting extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Notification settings mode</p><p>Enumeration values:</p><ul><li>0: Standard mode</li><li>1: Advanced mode</li></ul> 
     * @return Mode <p>Notification settings mode</p><p>Enumeration values:</p><ul><li>0: Standard mode</li><li>1: Advanced mode</li></ul>
     */
    public Long getMode() {
        return this.Mode;
    }
    ...
    /**
     * Set <p>Notification settings mode</p><p>Enumeration values:</p><ul><li>0: Standard mode</li><li>1: Advanced mode</li></ul>
     * @param Mode <p>Notification settings mode</p><p>Enumeration values:</p><ul><li>0: Standard mode</li><li>1: Advanced mode</li></ul>
     */
    ...
    /**
     * Get <p>Notification status</p><p>Enumeration values:</p><ul><li>0: notification off</li><li>1: notification on</li></ul> 
     * @return Status <p>Notification status</p><p>Enumeration values:</p><ul><li>0: notification off</li><li>1: notification on</li></ul>
     */
    ...
    /**
     * Set <p>Notification status</p><p>Enumeration values:</p><ul><li>0: notification off</li><li>1: notification on</li></ul>
     * @param Status <p>Notification status</p><p>Enumeration values:</p><ul><li>0: notification off</li><li>1: notification on</li></ul>
     */
    ...
    /**
     * Get <p>Asset scope</p><p>Enumeration values:</p><ul><li>1: All hosts</li><li>2: Selected hosts</li><li>3: Select by tag</li></ul> 
     * @return AssetRange <p>Asset scope</p><p>Enumeration values:</p><ul><li>1: All hosts</li><li>2: Selected hosts</li><li>3: Select by tag</li></ul>
     */
    ...
    /**
     * Set <p>Asset scope</p><p>Enumeration values:</p><ul><li>1: All hosts</li><li>2: Selected hosts</li><li>3: Select by tag</li></ul>
     * @param AssetRange <p>Asset scope</p><p>Enumeration values:</p><ul><li>1: All hosts</li><li>2: Selected hosts</li><li>3: Select by tag</li></ul>
     */
    ...
    /**
     * Get <p>Notification module (secondary module)</p> 
     * @return SubModule <p>Notification module (secondary module)</p>
     */
    ...
    /**
     * Set <p>Notification module (secondary module)</p>
     * @param SubModule <p>Notification module (secondary module)</p>
     */
    ...
    /**
     * Get <p>Handling status</p> 
     * @return Item <p>Handling status</p>
     */
    ...
    /**
     * Set <p>Handling status</p>
     * @param Item <p>Handling status</p>
     */
