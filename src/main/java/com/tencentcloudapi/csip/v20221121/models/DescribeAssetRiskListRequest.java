...
public class DescribeAssetRiskListRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeAssetRiskListRequest() {
    }
     ...
     */
    public DescribeAssetRiskListRequest(DescribeAssetRiskListRequest source) {
