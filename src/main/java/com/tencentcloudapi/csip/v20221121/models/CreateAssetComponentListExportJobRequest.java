...
public class CreateAssetComponentListExportJobRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Save file name</p> 
     * @return ExportName <p>Save file name</p>
     */
    ...
    /**
     * Set <p>Save file name</p>
     * @param ExportName <p>Save file name</p>
     */
    public void setExportName(String ExportName) {
        this.ExportName = ExportName;
    }

    public CreateAssetComponentListExportJobRequest() {
    }
     ...
     */
    public CreateAssetComponentListExportJobRequest(CreateAssetComponentListExportJobRequest source) {
