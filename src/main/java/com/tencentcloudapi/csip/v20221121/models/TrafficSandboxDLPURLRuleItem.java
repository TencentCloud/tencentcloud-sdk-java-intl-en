...
public class TrafficSandboxDLPURLRuleItem extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Outbound object list (domain name/URL) 
    ...
    /**
     * Set Outbound object list (domain name/URL)
     * @param URL Outbound object list (domain name/URL)
     */
    ...
    /**
     * Set exclusion object list
     * @param URLExcept exclusion object list
     */
