...
public class EdrContainerGlobalCount extends AbstractModel {
    ...
    */
    ...
    /**
    * <p>Number of clusters with alarms (COUNT(DISTINCT cluster_id), excluding empty cluster_id)</p>
    */
    ...
    /**
     * Get <p>Number of clusters with alarms (COUNT(DISTINCT cluster_id), excluding empty cluster_id)</p> 
     * @return ClustersCount <p>Number of clusters with alarms (COUNT(DISTINCT cluster_id), excluding empty cluster_id)</p>
     */
    ...
    /**
     * Set <p>Number of clusters with alarms (COUNT(DISTINCT cluster_id), excluding empty cluster_id)</p>
     * @param ClustersCount <p>Number of clusters with alarms (COUNT(DISTINCT cluster_id), excluding empty cluster_id)</p>
     */
