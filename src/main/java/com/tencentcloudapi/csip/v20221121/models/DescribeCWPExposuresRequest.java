...
public class DescribeCWPExposuresRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeCWPExposuresRequest() {
    }
     ...
     */
    public DescribeCWPExposuresRequest(DescribeCWPExposuresRequest source) {
