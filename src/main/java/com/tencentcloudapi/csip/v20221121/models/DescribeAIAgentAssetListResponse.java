...
public class DescribeAIAgentAssetListResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private AIAgentAsset [] AssetList;
    ...
    */
    ...
    public DescribeAIAgentAssetListResponse() {
    }
     ...
     */
    public DescribeAIAgentAssetListResponse(DescribeAIAgentAssetListResponse source) {
        if (source.AssetList != null) {
            this.AssetList = new AIAgentAsset[source.AssetList.length];
            for (int i = 0; i < source.AssetList.length; i++) {
                this.AssetList[i] = new AIAgentAsset(source.AssetList[i]);
            }
        }
