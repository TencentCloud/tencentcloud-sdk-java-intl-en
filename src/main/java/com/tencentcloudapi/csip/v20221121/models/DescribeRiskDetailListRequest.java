...
public class DescribeRiskDetailListRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeRiskDetailListRequest() {
    }
     ...
     */
    public DescribeRiskDetailListRequest(DescribeRiskDetailListRequest source) {
