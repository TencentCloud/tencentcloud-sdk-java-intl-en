...
public class TrafficSandboxLLMAuditRuleRef extends AbstractModel {
    ...
    */
     ...
     * @param SystemRuleID LLM audit system rule ID (string)
     */
    ...
    /**
     * Get LLM audit system rule name 
    ...
    /**
     * Set LLM audit system rule name
     * @param SystemRuleName LLM audit system rule name
     */
