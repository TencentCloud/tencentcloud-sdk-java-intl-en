...
public class DescribeKeySandboxCredentialListResponse extends AbstractModel {
    ...
    */
    @SerializedName("Data")
    @Expose
    private KeySandboxCredential [] Data;
    ...
    */
    ...
    public DescribeKeySandboxCredentialListResponse() {
    }
     ...
     */
    public DescribeKeySandboxCredentialListResponse(DescribeKeySandboxCredentialListResponse source) {
        if (source.Data != null) {
            this.Data = new KeySandboxCredential[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new KeySandboxCredential(source.Data[i]);
            }
        }
