...
public class DescribeProcessDaemonHostRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeProcessDaemonHostRequest() {
    }
     ...
     */
    public DescribeProcessDaemonHostRequest(DescribeProcessDaemonHostRequest source) {
