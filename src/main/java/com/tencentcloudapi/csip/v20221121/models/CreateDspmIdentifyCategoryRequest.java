...
public class CreateDspmIdentifyCategoryRequest extends AbstractModel {
    ...
    */
    ...
    public CreateDspmIdentifyCategoryRequest() {
    }
     ...
     */
    public CreateDspmIdentifyCategoryRequest(CreateDspmIdentifyCategoryRequest source) {
        if (source.Name != null) {
