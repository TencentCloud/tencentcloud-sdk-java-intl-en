...
public class DescribeBaselineSyncConfRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeBaselineSyncConfRequest() {
    }
     ...
     */
    public DescribeBaselineSyncConfRequest(DescribeBaselineSyncConfRequest source) {
