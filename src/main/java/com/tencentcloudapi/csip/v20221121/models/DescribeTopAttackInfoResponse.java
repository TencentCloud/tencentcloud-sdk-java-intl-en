...
public class DescribeTopAttackInfoResponse extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeTopAttackInfoResponse(DescribeTopAttackInfoResponse source) {
        if (source.TopAttackInfo != null) {
            this.TopAttackInfo = new TagCount[source.TopAttackInfo.length];
            for (int i = 0; i < source.TopAttackInfo.length; i++) {
                this.TopAttackInfo[i] = new TagCount(source.TopAttackInfo[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "TopAttackInfo.", this.TopAttackInfo);
