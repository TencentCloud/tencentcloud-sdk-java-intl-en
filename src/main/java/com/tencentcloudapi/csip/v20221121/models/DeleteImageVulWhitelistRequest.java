...
public class DeleteImageVulWhitelistRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteImageVulWhitelistRequest() {
    }
     ...
     */
    public DeleteImageVulWhitelistRequest(DeleteImageVulWhitelistRequest source) {
