...
public class ImageRegistryExportJobInfo extends AbstractModel {
    ...
    */
    ...
    /**
     * Set <p>Export task id</p>
     * @param JobID <p>Export task id</p>
     */
    ...
    /**
     * Get <p>Task status.</p><p>Enumeration values: </p><ul><li>SUCCESS: Task successful</li></ul> 
    ...
    /**
     * Set <p>Task status.</p><p>Enumeration values: </p><ul><li>SUCCESS: Task successful</li></ul>
     * @param Status <p>Task status.</p><p>Enumeration values: </p><ul><li>SUCCESS: Task successful</li></ul>
     */
    ...
    /**
     * Get <p>appid of the account to which the task belongs</p> 
    ...
    /**
     * Set <p>appid of the account to which the task belongs</p>
     * @param OwnerAppId <p>appid of the account to which the task belongs</p>
     */
    ...
    /**
     * Set <p>Export type</p>
     * @param ExportType <p>Export type</p>
     */
    ...
    /**
     * Get <p>Export time</p><p>Parameter format: YYYY-MM-DD hh:mm:ss</p> 
    ...
    /**
     * Set <p>Export time</p><p>Parameter format: YYYY-MM-DD hh:mm:ss</p>
     * @param ExportCreateTime <p>Export time</p><p>Parameter format: YYYY-MM-DD hh:mm:ss</p>
     */
