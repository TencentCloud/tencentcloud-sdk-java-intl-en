...
public class DescribeNICAssetsResponse extends AbstractModel {
    ...
    */
     ...
     * @param Data List
     */
    public void setData(NICAsset [] Data) {
        this.Data = Data;
    }
     ...
     */
    public DescribeNICAssetsResponse(DescribeNICAssetsResponse source) {
        if (source.Data != null) {
            this.Data = new NICAsset[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new NICAsset(source.Data[i]);
            }
        }
