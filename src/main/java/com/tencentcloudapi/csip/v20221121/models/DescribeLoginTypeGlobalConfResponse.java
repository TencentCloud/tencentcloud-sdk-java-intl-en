...
public class DescribeLoginTypeGlobalConfResponse extends AbstractModel {
    ...
    */
    ...
    /**
    * <p>Enable scope: 0 - optional host, 1 - all hosts</p>
    */
    ...
    */
    ...
    /**
    * <p>Number of unselected host configurations</p>
    */
    ...
    /**
    * <p>List of configurations for selected quuid</p>
    */
    ...
    /**
    * <p>Deselect the quuid configuration list</p>
    */
    ...
    */
    ...
    /**
    * <p>Number of inactive machines</p>
    */
    ...
    */
    ...
    /**
     * Get <p>Whether anti-uninstall is enabled. 0: No. 1: Yes. 9: Not set, same as 0, not enabled</p> 
    ...
    /**
     * Set <p>Whether anti-uninstall is enabled. 0: No. 1: Yes. 9: Not set, same as 0, not enabled</p>
     * @param Enable <p>Whether anti-uninstall is enabled. 0: No. 1: Yes. 9: Not set, same as 0, not enabled</p>
     */
    ...
    /**
     * Get <p>Enable scope: 0 - optional host, 1 - all hosts</p> 
     * @return Scope <p>Enable scope: 0 - optional host, 1 - all hosts</p>
     */
    ...
    /**
     * Set <p>Enable scope: 0 - optional host, 1 - all hosts</p>
     * @param Scope <p>Enable scope: 0 - optional host, 1 - all hosts</p>
     */
    ...
    /**
     * Get <p>Number of unselected host configurations</p> 
     * @return ExcludeHostCount <p>Number of unselected host configurations</p>
     */
    ...
    /**
     * Set <p>Number of unselected host configurations</p>
     * @param ExcludeHostCount <p>Number of unselected host configurations</p>
     */
    ...
    /**
     * Get <p>List of configurations for selected quuid</p> 
     * @return IncludeQuuid <p>List of configurations for selected quuid</p>
     */
    ...
    /**
     * Set <p>List of configurations for selected quuid</p>
     * @param IncludeQuuid <p>List of configurations for selected quuid</p>
     */
    ...
    /**
     * Get <p>Deselect the quuid configuration list</p> 
     * @return ExcludeQuuid <p>Deselect the quuid configuration list</p>
     */
    ...
    /**
     * Set <p>Deselect the quuid configuration list</p>
     * @param ExcludeQuuid <p>Deselect the quuid configuration list</p>
     */
    ...
    /**
     * Get <p>Enabled machine number</p> 
     * @return EnableCount <p>Enabled machine number</p>
     */
    ...
    /**
     * Set <p>Enabled machine number</p>
     * @param EnableCount <p>Enabled machine number</p>
     */
    ...
    /**
     * Get <p>Number of inactive machines</p> 
     * @return DisableCount <p>Number of inactive machines</p>
     */
    ...
    /**
     * Set <p>Number of inactive machines</p>
     * @param DisableCount <p>Number of inactive machines</p>
     */
