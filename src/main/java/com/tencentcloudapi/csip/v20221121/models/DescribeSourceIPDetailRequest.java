...
public class DescribeSourceIPDetailRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeSourceIPDetailRequest() {
    }
     ...
     */
    public DescribeSourceIPDetailRequest(DescribeSourceIPDetailRequest source) {
        if (source.ID != null) {
