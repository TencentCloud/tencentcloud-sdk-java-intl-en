...
public class DescribeDspmDictionaryListRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Dictionary type (RootCategory: level-1 category, IdentifyRule: sensitive identification data item)</p> 
    ...
    /**
     * Set <p>Dictionary type (RootCategory: level-1 category, IdentifyRule: sensitive identification data item)</p>
     * @param DictType <p>Dictionary type (RootCategory: level-1 category, IdentifyRule: sensitive identification data item)</p>
     */
     ...
     * @param Filters <p>Filter criteria</p>
     */
    ...
    /**
     * Get <p>Operation source: null/dspm=database risk monitoring entry, cos=object storage risk monitoring entry</p> 
    ...
    /**
     * Set <p>Operation source: null/dspm=database risk monitoring entry, cos=object storage risk monitoring entry</p>
     * @param OperationSource <p>Operation source: null/dspm=database risk monitoring entry, cos=object storage risk monitoring entry</p>
     */
