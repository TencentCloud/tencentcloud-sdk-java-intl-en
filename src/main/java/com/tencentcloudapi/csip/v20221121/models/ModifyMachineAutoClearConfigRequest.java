...
public class ModifyMachineAutoClearConfigRequest extends AbstractModel {
    ...
    /**
    * <p>Clean-up rule time. 0 means disabling. Unit: days. Maximum: 30 days</p>
    */
    ...
    */
    ...
    /**
     * Get <p>Clean-up rule time. 0 means disabling. Unit: days. Maximum: 30 days</p> 
     * @return ClearRule <p>Clean-up rule time. 0 means disabling. Unit: days. Maximum: 30 days</p>
     */
    ...
    /**
     * Set <p>Clean-up rule time. 0 means disabling. Unit: days. Maximum: 30 days</p>
     * @param ClearRule <p>Clean-up rule time. 0 means disabling. Unit: days. Maximum: 30 days</p>
     */
