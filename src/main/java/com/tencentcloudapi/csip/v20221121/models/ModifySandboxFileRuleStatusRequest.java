...
public class ModifySandboxFileRuleStatusRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Rule ID list<br>Input parameter limits: non-empty, 1-100 in length</p> 
    ...
    /**
     * Set <p>Rule ID list<br>Input parameter limits: non-empty, 1-100 in length</p>
     * @param IDList <p>Rule ID list<br>Input parameter limits: non-empty, 1-100 in length</p>
     */
    ...
    /**
     * Get <p>Target status<br>Enumeration values: <br>ON: Enablement<br>OFF: Disablement</p> 
    ...
    /**
     * Set <p>Target status<br>Enumeration values: <br>ON: Enablement<br>OFF: Disablement</p>
     * @param Status <p>Target status<br>Enumeration values: <br>ON: Enablement<br>OFF: Disablement</p>
     */
