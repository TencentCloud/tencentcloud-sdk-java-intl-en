...
public class ModifyDspmIdentifyComplianceGroupStatusRequest extends AbstractModel {
    ...
    */
    ...
    /**
    * <p>Enable status</p><p>Enumeration values:</p><ul><li>0: disabled</li><li>1: enabled</li></ul>
    */
    ...
    */
    ...
    /**
     * Get <p>Enable status</p><p>Enumeration values:</p><ul><li>0: disabled</li><li>1: enabled</li></ul> 
     * @return Status <p>Enable status</p><p>Enumeration values:</p><ul><li>0: disabled</li><li>1: enabled</li></ul>
     */
    ...
    /**
     * Set <p>Enable status</p><p>Enumeration values:</p><ul><li>0: disabled</li><li>1: enabled</li></ul>
     * @param Status <p>Enable status</p><p>Enumeration values:</p><ul><li>0: disabled</li><li>1: enabled</li></ul>
     */
