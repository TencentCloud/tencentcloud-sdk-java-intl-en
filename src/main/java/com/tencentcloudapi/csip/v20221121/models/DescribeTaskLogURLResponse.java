...
public class DescribeTaskLogURLResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeTaskLogURLResponse() {
    }
     ...
     */
    public DescribeTaskLogURLResponse(DescribeTaskLogURLResponse source) {
        if (source.Data != null) {
            this.Data = new TaskLogURL[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new TaskLogURL(source.Data[i]);
            }
        }
