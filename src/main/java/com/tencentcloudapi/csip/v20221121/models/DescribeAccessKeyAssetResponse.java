...
public class DescribeAccessKeyAssetResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeAccessKeyAssetResponse() {
    }
     ...
     */
    public DescribeAccessKeyAssetResponse(DescribeAccessKeyAssetResponse source) {
        if (source.Data != null) {
            this.Data = new AccessKeyAsset[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new AccessKeyAsset(source.Data[i]);
            }
        }
