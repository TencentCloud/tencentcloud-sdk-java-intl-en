...
public class StartOrModifyPreventUninstallRequest extends AbstractModel {
    ...
    */
    ...
    public StartOrModifyPreventUninstallRequest() {
    }
     ...
     */
    public StartOrModifyPreventUninstallRequest(StartOrModifyPreventUninstallRequest source) {
        if (source.From != null) {
