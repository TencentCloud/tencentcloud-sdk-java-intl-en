...
Input parameter limits: each item supports domain name wildcards, such as *.example.com, api.*.example.com, example.com/api/*
    ...
    /**
     * Get Excluded URL list
Input parameter limits: same format as the URL. 
     * @return URLExcept Excluded URL list
Input parameter limits: same format as the URL.
     */
    ...
    /**
     * Set Excluded URL list
Input parameter limits: same format as the URL.
     * @param URLExcept Excluded URL list
Input parameter limits: same format as the URL.
     */
    ...
    /**
     * Get Protocol type list
Enumeration values:
http: HTTP protocol
https: HTTPS protocol 
     * @return Protocol Protocol type list
Enumeration values:
http: HTTP protocol
https: HTTPS protocol
     */
    ...
    /**
     * Set Protocol type list
Enumeration values:
http: HTTP protocol
https: HTTPS protocol
     * @param Protocol Protocol type list
Enumeration values:
http: HTTP protocol
https: HTTPS protocol
     */
...
OPTIONS
PATCH 
     * @return Method List of HTTP methods
Enumeration values:
GET
POST
HEAD
...
OPTIONS
PATCH
     * @param Method List of HTTP methods
Enumeration values:
GET
POST
HEAD
