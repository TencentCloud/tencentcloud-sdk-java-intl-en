...
public class CSIPMachineExtraInfo extends AbstractModel {
    ...
    */
     ...
     * @param WanIP <p>Public IP address</p>
     */
    ...
    /**
     * Get <p>Instance ID (unique ID of CVM/BM/ECM)</p> 
    ...
    /**
     * Set <p>Instance ID (unique ID of CVM/BM/ECM)</p>
     * @param InstanceID <p>Instance ID (unique ID of CVM/BM/ECM)</p>
     */
