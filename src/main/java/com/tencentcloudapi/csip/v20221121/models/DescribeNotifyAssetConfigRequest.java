...
public class DescribeNotifyAssetConfigRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Set <p>Module name.</p>
     * @param Modules <p>Module name.</p>
     */
    public void setModules(String [] Modules) {
        this.Modules = Modules;
    }

    public DescribeNotifyAssetConfigRequest() {
    }
     ...
     */
    public DescribeNotifyAssetConfigRequest(DescribeNotifyAssetConfigRequest source) {
