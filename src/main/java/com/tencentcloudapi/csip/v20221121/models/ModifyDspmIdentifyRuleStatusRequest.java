...
public class ModifyDspmIdentifyRuleStatusRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Data item status</p><p>Enumeration values:</p><ul><li>0: off</li><li>1: on</li></ul> 
    ...
    /**
     * Set <p>Data item status</p><p>Enumeration values:</p><ul><li>0: off</li><li>1: on</li></ul>
     * @param Status <p>Data item status</p><p>Enumeration values:</p><ul><li>0: off</li><li>1: on</li></ul>
     */
    ...
    public ModifyDspmIdentifyRuleStatusRequest() {
    }
     ...
     */
    public ModifyDspmIdentifyRuleStatusRequest(ModifyDspmIdentifyRuleStatusRequest source) {
        if (source.Ids != null) {
