...
public class DescribeDspmIdentifyComplianceGroupDetailRequest extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeDspmIdentifyComplianceGroupDetailRequest(DescribeDspmIdentifyComplianceGroupDetailRequest source) {
