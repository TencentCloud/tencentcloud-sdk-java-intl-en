...
public class DescribeBaselinePolicyItemListRequest extends AbstractModel {
    ...
    */
    ...
    /**
    * <p>Baseline parent category ID for filtering detection items under the specified parent category.</p>
    */
    ...
    */
     ...
     * @return PolicyID <p>Baseline policy ID.</p>
     */
     ...
     * @param PolicyID <p>Baseline policy ID.</p>
     */
    ...
    /**
     * Get <p>Baseline parent category ID for filtering detection items under the specified parent category.</p> 
     * @return ParentCategoryID <p>Baseline parent category ID for filtering detection items under the specified parent category.</p>
     */
    ...
    /**
     * Set <p>Baseline parent category ID for filtering detection items under the specified parent category.</p>
     * @param ParentCategoryID <p>Baseline parent category ID for filtering detection items under the specified parent category.</p>
     */
