...
public class DescribeVulScanTaskDetailRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Filter criteria, support the following Name:</p><li>InstanceId - Asset Instance ID, exact match</li><li>InstanceName - Asset instance name, fuzzy matching (exact matching when ExactMatch=1)</li><li>Ip - Asset IP, exact match</li><li>Status - Scan status, exact match</li> 
    ...
    /**
     * Set <p>Filter criteria, support the following Name:</p><li>InstanceId - Asset Instance ID, exact match</li><li>InstanceName - Asset instance name, fuzzy matching (exact matching when ExactMatch=1)</li><li>Ip - Asset IP, exact match</li><li>Status - Scan status, exact match</li>
     * @param Filters <p>Filter criteria, support the following Name:</p><li>InstanceId - Asset Instance ID, exact match</li><li>InstanceName - Asset instance name, fuzzy matching (exact matching when ExactMatch=1)</li><li>Ip - Asset IP, exact match</li><li>Status - Scan status, exact match</li>
     */
    ...
    /**
     * Get <p>Sorting order: asc (ascending)/ desc (descending). Default is desc.</p> 
    ...
    /**
     * Set <p>Sorting order: asc (ascending)/ desc (descending). Default is desc.</p>
     * @param Order <p>Sorting order: asc (ascending)/ desc (descending). Default is desc.</p>
     */
    ...
    /**
     * Get <p>Sorting field, default sorting order is creation time (CreateTime)</p> 
    ...
    /**
     * Set <p>Sorting field, default sorting order is creation time (CreateTime)</p>
     * @param By <p>Sorting field, default sorting order is creation time (CreateTime)</p>
     */
