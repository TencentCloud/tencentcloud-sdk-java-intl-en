...
public class DescribeSCFAliasListRequest extends AbstractModel {
...
Default value: 0
    */
    ...
    /**
     * Get Region of the cloud function
Parameter format: Tencent Cloud standard Region, for example, ap-guangzhou 
...
Parameter format: Tencent Cloud standard Region, for example, ap-guangzhou
    ...
    /**
     * Set Region of the cloud function
Parameter format: Tencent Cloud standard Region, for example, ap-guangzhou
     * @param SCFRegion Region of the cloud function
Parameter format: Tencent Cloud standard Region, for example, ap-guangzhou
     */
...
Default value: 0
    ...
    public DescribeSCFAliasListRequest() {
    }
     ...
     */
    public DescribeSCFAliasListRequest(DescribeSCFAliasListRequest source) {
