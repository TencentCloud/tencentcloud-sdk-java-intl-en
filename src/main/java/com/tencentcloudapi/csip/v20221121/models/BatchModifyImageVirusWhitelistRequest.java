...
public class BatchModifyImageVirusWhitelistRequest extends AbstractModel {
    ...
    */
     ...
     * @return Status <p>Whether to enable</p><p>Enumeration values:</p><ul><li>0: Disable</li><li>1: Enable</li></ul>
     */
     ...
     * @param Status <p>Whether to enable</p><p>Enumeration values:</p><ul><li>0: Disable</li><li>1: Enable</li></ul>
     */
