...
public class CreateVulRisksExportJobRequest extends AbstractModel {
    ...
    */
    ...
    public CreateVulRisksExportJobRequest() {
    }
     ...
     */
    public CreateVulRisksExportJobRequest(CreateVulRisksExportJobRequest source) {
