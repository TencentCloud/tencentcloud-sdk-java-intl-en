...
public class DescribeCWPTaskDurationRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Number of Hosts that Require Performing Tasks 
    ...
    /**
     * Set Number of Hosts that Require Performing Tasks
     * @param UuidCnt Number of Hosts that Require Performing Tasks
     */
    ...
    /**
     * Get Whether to perform a scheduled scan 
    ...
    /**
     * Set Whether to perform a scheduled scan
     * @param TimingScan Whether to perform a scheduled scan
     */
