...
public class DescribeRiskRulesRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeRiskRulesRequest() {
    }
     ...
     */
    public DescribeRiskRulesRequest(DescribeRiskRulesRequest source) {
