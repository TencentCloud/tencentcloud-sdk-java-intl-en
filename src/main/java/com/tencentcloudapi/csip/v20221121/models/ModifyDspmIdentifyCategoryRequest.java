...
public class ModifyDspmIdentifyCategoryRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyDspmIdentifyCategoryRequest() {
    }
     ...
     */
    public ModifyDspmIdentifyCategoryRequest(ModifyDspmIdentifyCategoryRequest source) {
        if (source.Id != null) {
