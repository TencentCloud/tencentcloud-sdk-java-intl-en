...
public class DescribeDynamicAssetsRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeDynamicAssetsRequest() {
    }
     ...
     */
    public DescribeDynamicAssetsRequest(DescribeDynamicAssetsRequest source) {
