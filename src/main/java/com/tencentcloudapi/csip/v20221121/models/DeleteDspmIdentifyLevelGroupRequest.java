...
public class DeleteDspmIdentifyLevelGroupRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteDspmIdentifyLevelGroupRequest() {
    }
     ...
     */
    public DeleteDspmIdentifyLevelGroupRequest(DeleteDspmIdentifyLevelGroupRequest source) {
        if (source.Ids != null) {
