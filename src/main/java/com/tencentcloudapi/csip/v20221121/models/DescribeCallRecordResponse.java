...
public class DescribeCallRecordResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeCallRecordResponse() {
    }
     ...
     */
    public DescribeCallRecordResponse(DescribeCallRecordResponse source) {
        if (source.Data != null) {
