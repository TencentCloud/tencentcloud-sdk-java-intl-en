...
public class ExportEDRRulesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Filter criteria: Name, RuleContent, RuleType, ContentType, Action, Level, DetectMode, DetectType, AttackStage, Status</p> 
    ...
    /**
     * Set <p>Filter criteria: Name, RuleContent, RuleType, ContentType, Action, Level, DetectMode, DetectType, AttackStage, Status</p>
     * @param Filters <p>Filter criteria: Name, RuleContent, RuleType, ContentType, Action, Level, DetectMode, DetectType, AttackStage, Status</p>
     */
    ...
    /**
     * Get <p>Sorting method (case insensitive): ASC for ascending order; DESC for descending order</p> 
    ...
    /**
     * Set <p>Sorting method (case insensitive): ASC for ascending order; DESC for descending order</p>
     * @param Order <p>Sorting method (case insensitive): ASC for ascending order; DESC for descending order</p>
     */
    ...
    /**
     * Get <p>Sort column: ModifyTime</p> 
    ...
    /**
     * Set <p>Sort column: ModifyTime</p>
     * @param By <p>Sort column: ModifyTime</p>
     */
