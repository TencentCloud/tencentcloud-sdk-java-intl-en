...
public class DescribeAccessKeyUserDetailResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeAccessKeyUserDetailResponse() {
    }
     ...
     */
    public DescribeAccessKeyUserDetailResponse(DescribeAccessKeyUserDetailResponse source) {
        if (source.User != null) {
            this.User = new AccessKeyUser(source.User);
        }
