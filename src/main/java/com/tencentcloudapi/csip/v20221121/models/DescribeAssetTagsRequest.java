...
public class DescribeAssetTagsRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeAssetTagsRequest() {
    }
     ...
     */
    public DescribeAssetTagsRequest(DescribeAssetTagsRequest source) {
