...
public class CreateClusterAssetSyncTaskRequest extends AbstractModel {
    ...
    */
    ...
    /**
    * <p>md5 value of the cluster ca certificate, which is the unique identifier of the cluster</p>
    */
    ...
    /**
     * Get <p>md5 value of the cluster ca certificate, which is the unique identifier of the cluster</p> 
     * @return ClusterCaMD5List <p>md5 value of the cluster ca certificate, which is the unique identifier of the cluster</p>
     */
    ...
    /**
     * Set <p>md5 value of the cluster ca certificate, which is the unique identifier of the cluster</p>
     * @param ClusterCaMD5List <p>md5 value of the cluster ca certificate, which is the unique identifier of the cluster</p>
     */
