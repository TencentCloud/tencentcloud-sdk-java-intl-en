...
public class DescribeBaselineSystemCategoryListResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>System parent category list, including subcategories and detection item ID lists under each parent category.</p> 
    ...
    /**
     * Set <p>System parent category list, including subcategories and detection item ID lists under each parent category.</p>
     * @param SystemCategoryList <p>System parent category list, including subcategories and detection item ID lists under each parent category.</p>
     */
