...
public class ModifyProtectionSettingResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get QUUID that failed to be bound because no authorization package for major event protection is bound. 
    ...
    /**
     * Set QUUID that failed to be bound because no authorization package for major event protection is bound.
     * @param FailList QUUID that failed to be bound because no authorization package for major event protection is bound.
     */
    ...
    public ModifyProtectionSettingResponse() {
    }
     ...
     */
    public ModifyProtectionSettingResponse(ModifyProtectionSettingResponse source) {
