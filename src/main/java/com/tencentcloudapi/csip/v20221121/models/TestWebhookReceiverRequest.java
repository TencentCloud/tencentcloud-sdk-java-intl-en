...
public class TestWebhookReceiverRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Robot configuration ID</p> 
    ...
    /**
     * Set <p>Robot configuration ID</p>
     * @param ID <p>Robot configuration ID</p>
     */
    ...
    /**
     * Get <p>Custom test content (plaintext). If not passed, the system default test sample is used<br>Input limit: length 0-2048</p> 
    ...
    /**
     * Set <p>Custom test content (plaintext). If not passed, the system default test sample is used<br>Input limit: length 0-2048</p>
     * @param Data <p>Custom test content (plaintext). If not passed, the system default test sample is used<br>Input limit: length 0-2048</p>
     */
