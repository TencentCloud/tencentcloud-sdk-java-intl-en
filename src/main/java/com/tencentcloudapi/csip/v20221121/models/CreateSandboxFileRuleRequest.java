...
public class CreateSandboxFileRuleRequest extends AbstractModel {
    ...
    */
    ...
    public CreateSandboxFileRuleRequest() {
    }
     ...
     */
    public CreateSandboxFileRuleRequest(CreateSandboxFileRuleRequest source) {
