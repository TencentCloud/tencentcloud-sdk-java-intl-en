...
public class DescribeDspmIdentifyRuleDetailRequest extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeDspmIdentifyRuleDetailRequest(DescribeDspmIdentifyRuleDetailRequest source) {
        if (source.Id != null) {
