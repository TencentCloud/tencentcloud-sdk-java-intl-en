...
public class ImageLayerVul extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Vulnerability record id</p> 
     * @return ID <p>Vulnerability record id</p>
     */
    public Long getID() {
        return this.ID;
    }
    ...
    /**
     * Set <p>Vulnerability record id</p>
     * @param ID <p>Vulnerability record id</p>
     */
    ...
    /**
     * Get <p>First detected time</p><p>Parameter format: YYYY-MM-DD hh:mm:ss</p> 
     * @return FirstFoundTime <p>First detected time</p><p>Parameter format: YYYY-MM-DD hh:mm:ss</p>
     */
    ...
    /**
     * Set <p>First detected time</p><p>Parameter format: YYYY-MM-DD hh:mm:ss</p>
     * @param FirstFoundTime <p>First detected time</p><p>Parameter format: YYYY-MM-DD hh:mm:ss</p>
     */
    ...
    /**
     * Get <p>Vulnerability information</p> 
     * @return VulInfo <p>Vulnerability information</p>
     */
    ...
    /**
     * Set <p>Vulnerability information</p>
     * @param VulInfo <p>Vulnerability information</p>
     */
     ...
     */
    public ImageLayerVul(ImageLayerVul source) {
