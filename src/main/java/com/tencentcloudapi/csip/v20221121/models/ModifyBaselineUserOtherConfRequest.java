...
public class ModifyBaselineUserOtherConfRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Other configuration of the user to be updated; AgentScanTimeout must be within the range of [60, 86400] seconds.</p> 
    ...
    /**
     * Set <p>Other configuration of the user to be updated; AgentScanTimeout must be within the range of [60, 86400] seconds.</p>
     * @param UserConf <p>Other configuration of the user to be updated; AgentScanTimeout must be within the range of [60, 86400] seconds.</p>
     */
