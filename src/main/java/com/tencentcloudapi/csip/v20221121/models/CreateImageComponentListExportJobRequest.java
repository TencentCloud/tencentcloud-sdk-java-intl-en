...
public class CreateImageComponentListExportJobRequest extends AbstractModel {
    ...
    */
    ...
    public CreateImageComponentListExportJobRequest() {
    }
     ...
     */
    public CreateImageComponentListExportJobRequest(CreateImageComponentListExportJobRequest source) {
        if (source.Id != null) {
