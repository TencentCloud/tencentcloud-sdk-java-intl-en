...
public class DeleteBaselineSelfDefinedPolicyListRequest extends AbstractModel {
    ...
    /**
    * <p>List of custom policy IDs pending deletion. It cannot be empty and elements cannot be 0.</p>
    */
    ...
    */
    ...
    /**
     * Get <p>List of custom policy IDs pending deletion. It cannot be empty and elements cannot be 0.</p> 
     * @return PolicyIDList <p>List of custom policy IDs pending deletion. It cannot be empty and elements cannot be 0.</p>
     */
    ...
    /**
     * Set <p>List of custom policy IDs pending deletion. It cannot be empty and elements cannot be 0.</p>
     * @param PolicyIDList <p>List of custom policy IDs pending deletion. It cannot be empty and elements cannot be 0.</p>
     */
