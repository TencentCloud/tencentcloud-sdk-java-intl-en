...
public class DspmColumnPrivilege extends AbstractModel {
    ...
    */
     ...
     * @return Column Database column name
     */
     ...
     */
    public DspmColumnPrivilege(DspmColumnPrivilege source) {
