...
public class CreateExposuresExportJobRequest extends AbstractModel {
    ...
    */
    ...
    public CreateExposuresExportJobRequest() {
    }
     ...
     */
    public CreateExposuresExportJobRequest(CreateExposuresExportJobRequest source) {
