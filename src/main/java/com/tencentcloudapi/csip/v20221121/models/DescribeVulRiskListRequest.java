...
public class DescribeVulRiskListRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeVulRiskListRequest() {
    }
     ...
     */
    public DescribeVulRiskListRequest(DescribeVulRiskListRequest source) {
