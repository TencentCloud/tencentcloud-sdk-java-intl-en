...
public class BaselineSubCategory extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Basic information of the subcategory.</p> 
    ...
    /**
     * Set <p>Basic information of the subcategory.</p>
     * @param Category <p>Basic information of the subcategory.</p>
     */
    public void setCategory(BaselineCategory Category) {
        this.Category = Category;
    }

    public BaselineSubCategory() {
    }
     ...
     */
    public BaselineSubCategory(BaselineSubCategory source) {
