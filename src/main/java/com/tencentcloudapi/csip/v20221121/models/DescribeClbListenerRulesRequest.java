...
public class DescribeClbListenerRulesRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeClbListenerRulesRequest() {
    }
     ...
     */
    public DescribeClbListenerRulesRequest(DescribeClbListenerRulesRequest source) {
