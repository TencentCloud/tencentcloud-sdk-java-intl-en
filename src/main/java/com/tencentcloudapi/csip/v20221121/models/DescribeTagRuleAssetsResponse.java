...
public class DescribeTagRuleAssetsResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private AssetTagPreviewAssetItem [] Assets;
    ...
    */
     ...
     */
    public AssetTagPreviewAssetItem [] getAssets() {
        return this.Assets;
    }
     ...
     */
    public void setAssets(AssetTagPreviewAssetItem [] Assets) {
        this.Assets = Assets;
    }
    ...
    public DescribeTagRuleAssetsResponse() {
    }
     ...
     */
    public DescribeTagRuleAssetsResponse(DescribeTagRuleAssetsResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.Assets != null) {
            this.Assets = new AssetTagPreviewAssetItem[source.Assets.length];
            for (int i = 0; i < source.Assets.length; i++) {
                this.Assets[i] = new AssetTagPreviewAssetItem(source.Assets[i]);
            }
        }
