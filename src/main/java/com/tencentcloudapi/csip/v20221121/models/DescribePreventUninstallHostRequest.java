...
public class DescribePreventUninstallHostRequest extends AbstractModel {
    ...
    */
    ...
    public DescribePreventUninstallHostRequest() {
    }
     ...
     */
    public DescribePreventUninstallHostRequest(DescribePreventUninstallHostRequest source) {
