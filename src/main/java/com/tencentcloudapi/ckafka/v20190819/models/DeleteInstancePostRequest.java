...
public class DeleteInstancePostRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteInstancePostRequest() {
    }
     ...
     */
    public DeleteInstancePostRequest(DeleteInstancePostRequest source) {
