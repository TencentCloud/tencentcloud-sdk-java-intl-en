...
public class DescribeCkafkaZoneResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeCkafkaZoneResponse() {
    }
     ...
     */
    public DescribeCkafkaZoneResponse(DescribeCkafkaZoneResponse source) {
        if (source.Result != null) {
            this.Result = new ZoneResponse(source.Result);
        }
