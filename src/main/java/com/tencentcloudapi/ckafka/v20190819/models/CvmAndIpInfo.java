...
public class CvmAndIpInfo extends AbstractModel {
    ...
    */
     ...
     * @param CkafkaInstanceId The ckafka cluster instance Id.
     */
    ...
    /**
     * Get CVM instance ID (ins-test) or POD IP (10.0.0.30). 
    ...
    /**
     * Set CVM instance ID (ins-test) or POD IP (10.0.0.30).
     * @param InstanceId CVM instance ID (ins-test) or POD IP (10.0.0.30).
     */
