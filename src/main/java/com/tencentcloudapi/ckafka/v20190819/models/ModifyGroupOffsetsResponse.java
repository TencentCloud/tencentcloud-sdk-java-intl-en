...
public class ModifyGroupOffsetsResponse extends AbstractModel{
    ...
    */
    ...
    public ModifyGroupOffsetsResponse() {
    }
     ...
     */
    public ModifyGroupOffsetsResponse(ModifyGroupOffsetsResponse source) {
