...
public class CreatePostPaidInstanceResponse extends AbstractModel{
    ...
    */
    ...
    @Expose
    private CreateInstancePostResp Result;
    ...
    */
    ...
    public CreatePostPaidInstanceResponse() {
    }
     ...
     */
    public CreatePostPaidInstanceResponse(CreatePostPaidInstanceResponse source) {
        if (source.Result != null) {
            this.Result = new CreateInstancePostResp(source.Result);
        }
