...
public class CreateTopicResponse extends AbstractModel{
    ...
    */
    ...
    @Expose
    private CreateTopicResp Result;
    ...
    */
     ...
     */
    public CreateTopicResp getResult() {
        return this.Result;
    }
     ...
     */
    public void setResult(CreateTopicResp Result) {
        this.Result = Result;
    }
    ...
    public CreateTopicResponse(CreateTopicResponse source) {
        if (source.Result != null) {
            this.Result = new CreateTopicResp(source.Result);
        }
