...
public class DescribeTopicDetailResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private TopicDetailResponse Result;
    ...
    */
    ...
    /**
     * Get Returned entity of topic details 
    ...
    /**
     * Set Returned entity of topic details
    ...
    public DescribeTopicDetailResponse(DescribeTopicDetailResponse source) {
        if (source.Result != null) {
            this.Result = new TopicDetailResponse(source.Result);
        }
