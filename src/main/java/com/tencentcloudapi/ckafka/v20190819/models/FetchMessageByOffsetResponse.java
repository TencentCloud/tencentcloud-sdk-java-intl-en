...
public class FetchMessageByOffsetResponse extends AbstractModel{
    ...
    */
    ...
    public FetchMessageByOffsetResponse() {
    }
     ...
     */
    public FetchMessageByOffsetResponse(FetchMessageByOffsetResponse source) {
        if (source.Result != null) {
            this.Result = new ConsumerRecord(source.Result);
        }
