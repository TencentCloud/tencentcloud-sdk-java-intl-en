...
public class InstanceChargeParam extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Validity period, which is only required for the monthly subscription billing mode 
    ...
    /**
     * Set Validity period, which is only required for the monthly subscription billing mode
