...
public class CreateInstancePostRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Instance type. Valid values: `standard` (Standard Edition),  `profession`  (Pro Edition) 
    ...
    /**
     * Set Instance type. Valid values: `standard` (Standard Edition),  `profession`  (Pro Edition)
     * @param SpecificationsType Instance type. Valid values: `standard` (Standard Edition),  `profession`  (Pro Edition)
     */
    ...
    /**
     * Get Instance disk type. Valid values:  `CLOUD_BASIC` (Premium Cloud Storage),  `CLOUD_SSD` (SSD).  If this parameter is left empty, the default value `CLOUD_BASIC` will be used. 
    ...
    /**
     * Set Instance disk type. Valid values:  `CLOUD_BASIC` (Premium Cloud Storage),  `CLOUD_SSD` (SSD).  If this parameter is left empty, the default value `CLOUD_BASIC` will be used.
     * @param DiskType Instance disk type. Valid values:  `CLOUD_BASIC` (Premium Cloud Storage),  `CLOUD_SSD` (SSD).  If this parameter is left empty, the default value `CLOUD_BASIC` will be used.
     */
