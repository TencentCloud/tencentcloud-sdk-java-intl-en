...
public class InquireCkafkaPriceResponse extends AbstractModel{
    ...
    */
    ...
    @Expose
    private InquireCkafkaPriceResp Result;
    ...
    */
    ...
    public InquireCkafkaPriceResponse() {
    }
     ...
     */
    public InquireCkafkaPriceResponse(InquireCkafkaPriceResponse source) {
        if (source.Result != null) {
            this.Result = new InquireCkafkaPriceResp(source.Result);
        }
