...
public class FetchMessageListByTimestampRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Query start time, a timestamp. 
     * @return StartTime Query start time, a timestamp.
     */
    ...
    /**
     * Set Query start time, a timestamp.
     * @param StartTime Query start time, a timestamp.
     */
    ...
    /**
     * Get Maximum number of query results. default: 20. value range: 1-20. 
     * @return SinglePartitionRecordNumber Maximum number of query results. default: 20. value range: 1-20.
     */
    ...
    /**
     * Set Maximum number of query results. default: 20. value range: 1-20.
     * @param SinglePartitionRecordNumber Maximum number of query results. default: 20. value range: 1-20.
     */
