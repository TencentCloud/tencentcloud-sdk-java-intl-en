...
public class ExternalAccessInfoWrapper extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Number of IP allowlist access rules</p> 
    ...
    /**
     * Set <p>Number of IP allowlist access rules</p>
     * @param TotalCount <p>Number of IP allowlist access rules</p>
     */
    ...
    /**
     * Set <p>IP allowlist</p>
     * @param IpWhitelist <p>IP allowlist</p>
     */
