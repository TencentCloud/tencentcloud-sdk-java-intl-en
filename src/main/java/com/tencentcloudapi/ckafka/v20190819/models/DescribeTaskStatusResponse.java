...
public class DescribeTaskStatusResponse extends AbstractModel{
    ...
    */
    ...
    @Expose
    private TaskStatusResponse Result;
    ...
    */
     ...
     */
    public TaskStatusResponse getResult() {
        return this.Result;
    }
     ...
     */
    public void setResult(TaskStatusResponse Result) {
        this.Result = Result;
    }
    ...
    public DescribeTaskStatusResponse(DescribeTaskStatusResponse source) {
        if (source.Result != null) {
            this.Result = new TaskStatusResponse(source.Result);
        }
