...
public class IsolatedInstancePreRequest extends AbstractModel {
    ...
    */
    ...
    public IsolatedInstancePreRequest() {
    }
     ...
     */
    public IsolatedInstancePreRequest(IsolatedInstancePreRequest source) {
