...
public class DescribeAclRuleResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get The set of returned ACL rules 
     * @return Result The set of returned ACL rules
     */
    public AclRuleResp getResult() {
        return this.Result;
    }

    /**
     * Set The set of returned ACL rules
     * @param Result The set of returned ACL rules
     */
    public void setResult(AclRuleResp Result) {
        this.Result = Result;
    }
    ...
    public DescribeAclRuleResponse(DescribeAclRuleResponse source) {
        if (source.Result != null) {
            this.Result = new AclRuleResp(source.Result);
        }
