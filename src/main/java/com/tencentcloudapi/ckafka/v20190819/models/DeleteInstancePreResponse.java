...
public class DeleteInstancePreResponse extends AbstractModel{
    ...
    */
    ...
    @Expose
    private CreateInstancePreResp Result;
    ...
    */
    ...
    public DeleteInstancePreResponse() {
    }
     ...
     */
    public DeleteInstancePreResponse(DeleteInstancePreResponse source) {
        if (source.Result != null) {
            this.Result = new CreateInstancePreResp(source.Result);
        }
