...
public class DescribeInstancesDetailResponse extends AbstractModel{
    ...
    */
    ...
    @Expose
    private InstanceDetailResponse Result;
    ...
    */
    ...
    public DescribeInstancesDetailResponse() {
    }
     ...
     */
    public DescribeInstancesDetailResponse(DescribeInstancesDetailResponse source) {
        if (source.Result != null) {
            this.Result = new InstanceDetailResponse(source.Result);
        }
