...
public class DescribeResourceTagsByResourceIdsSeqResponse extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeResourceTagsByResourceIdsSeqResponse(DescribeResourceTagsByResourceIdsSeqResponse source) {
        ...
        if (source.Tags != null) {
            this.Tags = new TagResource[source.Tags.length];
            for (int i = 0; i < source.Tags.length; i++) {
                this.Tags[i] = new TagResource(source.Tags[i]);
            }
        }
