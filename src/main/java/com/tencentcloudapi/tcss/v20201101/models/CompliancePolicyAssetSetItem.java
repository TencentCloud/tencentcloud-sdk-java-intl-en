...
public class CompliancePolicyAssetSetItem extends AbstractModel{
    ...
    */
    ...
    /**
     * Get List of IDs of assets to be ignored in the specified check item. If it is empty, it indicates all. 
    ...
    /**
     * Set List of IDs of assets to be ignored in the specified check item. If it is empty, it indicates all.
    ...
    public CompliancePolicyAssetSetItem() {
    }
