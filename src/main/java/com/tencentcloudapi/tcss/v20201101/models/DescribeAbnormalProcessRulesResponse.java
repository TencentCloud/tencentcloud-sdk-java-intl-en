...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    */
    ...
    /**
     * Get Exception process strategy extension information list (including rule content and executed action). The new frontend preferentially uses this field.
Note: This field may return null, indicating that no valid values can be obtained. 
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Set Exception process strategy extension information list (including rule content and executed action). The new frontend preferentially uses this field.
Note: This field may return null, indicating that no valid values can be obtained.
     * @param RuleExtSet Exception process strategy extension information list (including rule content and executed action). The new frontend preferentially uses this field.
Note: This field may return null, indicating that no valid values can be obtained.
     */
