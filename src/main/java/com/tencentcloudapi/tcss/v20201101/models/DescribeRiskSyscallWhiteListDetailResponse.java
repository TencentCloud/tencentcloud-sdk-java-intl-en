...
public class DescribeRiskSyscallWhiteListDetailResponse extends AbstractModel {
    ...
    */
     ...
     * @return WhiteListDetailInfo Basic information of the allowlist
     */
     ...
     */
    public void setWhiteListDetailInfo(RiskSyscallWhiteListInfo WhiteListDetailInfo) {
     ...
     */
    public DescribeRiskSyscallWhiteListDetailResponse(DescribeRiskSyscallWhiteListDetailResponse source) {
        if (source.WhiteListDetailInfo != null) {
            this.WhiteListDetailInfo = new RiskSyscallWhiteListInfo(source.WhiteListDetailInfo);
        }
