...
public class DescribeEscapeWhiteListRequest extends AbstractModel{
...
<li>ImageID- string - Required: No - Image ID</li>
    ...
    public DescribeEscapeWhiteListRequest() {
    }
     ...
     */
    public DescribeEscapeWhiteListRequest(DescribeEscapeWhiteListRequest source) {
