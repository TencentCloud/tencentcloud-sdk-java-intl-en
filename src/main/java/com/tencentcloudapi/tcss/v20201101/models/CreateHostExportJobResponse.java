...
public class CreateHostExportJobResponse extends AbstractModel{
    ...
    */
    ...
    public CreateHostExportJobResponse() {
    }
     ...
     */
    public CreateHostExportJobResponse(CreateHostExportJobResponse source) {
