...
public class DescribeRiskSyscallDetailResponse extends AbstractModel{
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    */
     ...
     */
    public RiskSyscallEventDescription getEventDetail() {
     ...
     */
    public void setEventDetail(RiskSyscallEventDescription EventDetail) {
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeRiskSyscallDetailResponse() {
    }
     ...
     */
    public DescribeRiskSyscallDetailResponse(DescribeRiskSyscallDetailResponse source) {
