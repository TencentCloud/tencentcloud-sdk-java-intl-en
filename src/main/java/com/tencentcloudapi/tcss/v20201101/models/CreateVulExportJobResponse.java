...
public class CreateVulExportJobResponse extends AbstractModel{
    ...
    */
    ...
    public CreateVulExportJobResponse() {
    }
     ...
     */
    public CreateVulExportJobResponse(CreateVulExportJobResponse source) {
