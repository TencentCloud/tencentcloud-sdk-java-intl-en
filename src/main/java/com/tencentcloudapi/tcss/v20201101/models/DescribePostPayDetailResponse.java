...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribePostPayDetailResponse(DescribePostPayDetailResponse source) {
        if (source.SoftQuotaDayDetail != null) {
            this.SoftQuotaDayDetail = new SoftQuotaDayInfo[source.SoftQuotaDayDetail.length];
            for (int i = 0; i < source.SoftQuotaDayDetail.length; i++) {
                this.SoftQuotaDayDetail[i] = new SoftQuotaDayInfo(source.SoftQuotaDayDetail[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "SoftQuotaDayDetail.", this.SoftQuotaDayDetail);
