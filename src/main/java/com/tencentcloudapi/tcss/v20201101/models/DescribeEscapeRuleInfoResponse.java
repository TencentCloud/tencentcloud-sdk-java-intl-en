...
public class DescribeEscapeRuleInfoResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setRuleSet(EscapeRule [] RuleSet) {
     ...
     */
    public DescribeEscapeRuleInfoResponse(DescribeEscapeRuleInfoResponse source) {
        if (source.RuleSet != null) {
            this.RuleSet = new EscapeRule[source.RuleSet.length];
            for (int i = 0; i < source.RuleSet.length; i++) {
                this.RuleSet[i] = new EscapeRule(source.RuleSet[i]);
            }
        }
