...
public class CreateWebVulExportJobResponse extends AbstractModel{
    ...
    */
    ...
    public CreateWebVulExportJobResponse() {
    }
     ...
     */
    public CreateWebVulExportJobResponse(CreateWebVulExportJobResponse source) {
