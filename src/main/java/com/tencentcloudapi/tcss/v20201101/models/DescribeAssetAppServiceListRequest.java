...
public class DescribeAssetAppServiceListRequest extends AbstractModel {
...
<li>Keywords- String - Required: No - Optional field for the fuzzy query</li>
    ...
    public DescribeAssetAppServiceListRequest() {
    }
     ...
     */
    public DescribeAssetAppServiceListRequest(DescribeAssetAppServiceListRequest source) {
