...
public class DescribeRaspRuleVulsRequest extends AbstractModel {
    ...
    /**
    * Filter criteria
<li>Level - String - required: no - threat level, CRITICAL: critical, HIGH: high, MIDDLE: medium, LOW: low</li>
<li>CVEID- string - required: no - cve id</li>
<li>Name- string - required: no - vulnerability name</li>
    ...
    */
    ...
    /**
    * Sort field. SubmitTime: Disclosure time
    */
    @SerializedName("By")
    @Expose
    private String By;
...
<li>Name- string - required: no - vulnerability name</li>
    ...
    /**
     * Get Sort field. SubmitTime: Disclosure time 
     * @return By Sort field. SubmitTime: Disclosure time
     */
    public String getBy() {
        return this.By;
    }
    ...
    /**
     * Set Sort field. SubmitTime: Disclosure time
     * @param By Sort field. SubmitTime: Disclosure time
     */
