...
Note: This field may return null, indicating that no valid values can be obtained.
    */
    ...
    @Expose
    private ComplianceAssetInfo [] AssetInfoList;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeComplianceAssetListResponse(DescribeComplianceAssetListResponse source) {
        ...
        if (source.AssetInfoList != null) {
            this.AssetInfoList = new ComplianceAssetInfo[source.AssetInfoList.length];
            for (int i = 0; i < source.AssetInfoList.length; i++) {
                this.AssetInfoList[i] = new ComplianceAssetInfo(source.AssetInfoList[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamArrayObj(map, prefix + "AssetInfoList.", this.AssetInfoList);
