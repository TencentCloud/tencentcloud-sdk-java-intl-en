...
public class DescribeMaliciousConnectionBlackListRequest extends AbstractModel {
    ...
    */
    ...
    /**
    * Filter criteria
<li>RequestType - string - Required: No - Request type. All request types: ALL; Domain name: DOMAIN; IP: IP</li>
<li>BlackDomain- string - required: no - custom black domain name</li>
<li>BlackIP - string - required: no - custom black IP</li>
    */
...
<li>BlackIP - string - required: no - custom black IP</li>
    ...
    public DescribeMaliciousConnectionBlackListRequest() {
    }
     ...
     */
    public DescribeMaliciousConnectionBlackListRequest(DescribeMaliciousConnectionBlackListRequest source) {
