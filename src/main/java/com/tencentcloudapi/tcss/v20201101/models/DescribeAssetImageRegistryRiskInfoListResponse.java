...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeAssetImageRegistryRiskInfoListResponse() {
    }
     ...
     */
    public DescribeAssetImageRegistryRiskInfoListResponse(DescribeAssetImageRegistryRiskInfoListResponse source) {
        if (source.List != null) {
            this.List = new ImageRisk[source.List.length];
            for (int i = 0; i < source.List.length; i++) {
                this.List[i] = new ImageRisk(source.List[i]);
            }
        }
