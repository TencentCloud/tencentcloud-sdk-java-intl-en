...
public class CreateCheckComponentResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Valid values: `InstallSucc` (installed successfully); `InstallFailed` (failed to install). 
    ...
    /**
     * Set Valid values: `InstallSucc` (installed successfully); `InstallFailed` (failed to install).
