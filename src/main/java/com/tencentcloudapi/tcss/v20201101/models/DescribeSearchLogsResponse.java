...
public class DescribeSearchLogsResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Historical search records, the latest ten of which are retained. 
    ...
    /**
     * Set Historical search records, the latest ten of which are retained.
    ...
    public DescribeSearchLogsResponse() {
    }
     ...
     */
    public DescribeSearchLogsResponse(DescribeSearchLogsResponse source) {
        if (source.Data != null) {
