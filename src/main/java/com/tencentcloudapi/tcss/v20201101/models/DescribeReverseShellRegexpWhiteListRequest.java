...
public class DescribeReverseShellRegexpWhiteListRequest extends AbstractModel {
...
RuleName - String - Required: no - Rule name
    ...
    public DescribeReverseShellRegexpWhiteListRequest() {
    }
     ...
     */
    public DescribeReverseShellRegexpWhiteListRequest(DescribeReverseShellRegexpWhiteListRequest source) {
