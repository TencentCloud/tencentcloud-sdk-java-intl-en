...
public class CreateVulImageExportJobResponse extends AbstractModel{
    ...
    */
    ...
    public CreateVulImageExportJobResponse() {
    }
     ...
     */
    public CreateVulImageExportJobResponse(CreateVulImageExportJobResponse source) {
