...
public class DescribeAssetPortListResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setList(PortInfo [] List) {
        this.List = List;
    }
     ...
     */
    public DescribeAssetPortListResponse(DescribeAssetPortListResponse source) {
        if (source.List != null) {
            this.List = new PortInfo[source.List.length];
            for (int i = 0; i < source.List.length; i++) {
                this.List[i] = new PortInfo(source.List[i]);
            }
        }
