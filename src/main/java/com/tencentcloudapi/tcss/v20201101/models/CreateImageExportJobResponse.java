...
public class CreateImageExportJobResponse extends AbstractModel {
    ...
    */
    ...
    public CreateImageExportJobResponse() {
    }
     ...
     */
    public CreateImageExportJobResponse(CreateImageExportJobResponse source) {
