...
public class DescribeAssetClusterListRequest extends AbstractModel{
...
<li>`Status` - String - Optional - Cluster status</li>
    ...
    public DescribeAssetClusterListRequest() {
    }
     ...
     */
    public DescribeAssetClusterListRequest(DescribeAssetClusterListRequest source) {
