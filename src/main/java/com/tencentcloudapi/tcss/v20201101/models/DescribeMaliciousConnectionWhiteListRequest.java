...
public class DescribeMaliciousConnectionWhiteListRequest extends AbstractModel {
    ...
    */
    ...
    /**
    * Filter criteria
<li>RequestType - string - Required: yes - Request type. All request types: ALL; domain name: DOMAIN; IP: IP</li>
<li>WhiteDomain- string - required: no - custom white domain name</li>
<li>WhiteIP - string - Required: No - Custom allowlist IP</li>
    */
...
<li>WhiteIP - string - Required: No - Custom allowlist IP</li>
    ...
    public DescribeMaliciousConnectionWhiteListRequest() {
    }
     ...
     */
    public DescribeMaliciousConnectionWhiteListRequest(DescribeMaliciousConnectionWhiteListRequest source) {
