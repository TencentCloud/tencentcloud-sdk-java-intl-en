...
public class DescribeAssetDBServiceListRequest extends AbstractModel{
...
<li>Keywords- String - Required: No - Optional field for the fuzzy query</li>
    ...
    public DescribeAssetDBServiceListRequest() {
    }
     ...
     */
    public DescribeAssetDBServiceListRequest(DescribeAssetDBServiceListRequest source) {
