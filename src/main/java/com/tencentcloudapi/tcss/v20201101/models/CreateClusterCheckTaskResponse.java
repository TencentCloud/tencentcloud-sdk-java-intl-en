...
public class CreateClusterCheckTaskResponse extends AbstractModel {
    ...
    */
    ...
    /**
    * Return the ID of the created new cluster task.
    */
    ...
    */
    ...
    /**
     * Get Return the ID of the created new cluster task. 
     * @return NewTaskID Return the ID of the created new cluster task.
     */
    ...
    /**
     * Set Return the ID of the created new cluster task.
     * @param NewTaskID Return the ID of the created new cluster task.
     */
