...
public class DeleteNetworkFirewallPolicyDetailResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Result of creating the deletion task. Valid values: `Succ`, `Failed`. 
     * @return Result Result of creating the deletion task. Valid values: `Succ`, `Failed`.
     */
    ...
    /**
     * Set Result of creating the deletion task. Valid values: `Succ`, `Failed`.
    ...
    public DeleteNetworkFirewallPolicyDetailResponse() {
    }
     ...
     */
    public DeleteNetworkFirewallPolicyDetailResponse(DeleteNetworkFirewallPolicyDetailResponse source) {
