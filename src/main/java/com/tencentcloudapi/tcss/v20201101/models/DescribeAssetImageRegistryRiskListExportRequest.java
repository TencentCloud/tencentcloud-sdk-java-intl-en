...
public class DescribeAssetImageRegistryRiskListExportRequest extends AbstractModel {
...
<li>Name - String - Required: No - Vulnerability name</li>
    ...
    public DescribeAssetImageRegistryRiskListExportRequest() {
    }
     ...
     */
    public DescribeAssetImageRegistryRiskListExportRequest(DescribeAssetImageRegistryRiskListExportRequest source) {
