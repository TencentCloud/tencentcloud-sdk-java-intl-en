...
public class DescribeNetworkFirewallPodLabelsListResponse extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
    */
    ...
    @Expose
    private NetworkClusterPodInfo [] PodList;
    ...
    */
    ...
    /**
     * Get Total number of cluster Pods 
    ...
    /**
     * Set Total number of cluster Pods
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeNetworkFirewallPodLabelsListResponse() {
    }
     ...
     */
    public DescribeNetworkFirewallPodLabelsListResponse(DescribeNetworkFirewallPodLabelsListResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.PodList != null) {
            this.PodList = new NetworkClusterPodInfo[source.PodList.length];
            for (int i = 0; i < source.PodList.length; i++) {
                this.PodList[i] = new NetworkClusterPodInfo(source.PodList[i]);
            }
        }
