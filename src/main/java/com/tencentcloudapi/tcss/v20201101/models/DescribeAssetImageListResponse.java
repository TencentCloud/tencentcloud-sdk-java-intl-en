...
public class DescribeAssetImageListResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeAssetImageListResponse() {
    }
     ...
     */
    public DescribeAssetImageListResponse(DescribeAssetImageListResponse source) {
        if (source.List != null) {
            this.List = new ImagesInfo[source.List.length];
            for (int i = 0; i < source.List.length; i++) {
                this.List[i] = new ImagesInfo(source.List[i]);
            }
        }
