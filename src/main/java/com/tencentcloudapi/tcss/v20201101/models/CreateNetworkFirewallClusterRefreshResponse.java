...
public class CreateNetworkFirewallClusterRefreshResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Result of creating the check task. Valid values: `Succ`, `Failed`. 
     * @return Result Result of creating the check task. Valid values: `Succ`, `Failed`.
     */
    ...
    /**
     * Set Result of creating the check task. Valid values: `Succ`, `Failed`.
    ...
    public CreateNetworkFirewallClusterRefreshResponse() {
    }
     ...
     */
    public CreateNetworkFirewallClusterRefreshResponse(CreateNetworkFirewallClusterRefreshResponse source) {
