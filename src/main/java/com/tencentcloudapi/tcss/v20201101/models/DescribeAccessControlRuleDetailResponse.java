...
public class DescribeAccessControlRuleDetailResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Set Runtime policy details
     * @param RuleDetail Runtime policy details
     */
    public void setRuleDetail(AccessControlRuleInfo RuleDetail) {
     ...
     */
    public DescribeAccessControlRuleDetailResponse(DescribeAccessControlRuleDetailResponse source) {
        if (source.RuleDetail != null) {
            this.RuleDetail = new AccessControlRuleInfo(source.RuleDetail);
        }
