...
public class DescribeVulDefenceEventResponse extends AbstractModel {
    ...
    */
     ...
     * @return List List of exploit prevention events
     */
    ...
    public DescribeVulDefenceEventResponse() {
    }
    ...
    public DescribeVulDefenceEventResponse(DescribeVulDefenceEventResponse source) {
        if (source.List != null) {
            this.List = new VulDefenceEvent[source.List.length];
            for (int i = 0; i < source.List.length; i++) {
                this.List[i] = new VulDefenceEvent(source.List[i]);
            }
        }
