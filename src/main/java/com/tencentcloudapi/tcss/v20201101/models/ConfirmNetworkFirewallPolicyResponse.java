...
public class ConfirmNetworkFirewallPolicyResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Result of creating the confirmation task. Valid values: `Succ`, `Failed`. 
     * @return Result Result of creating the confirmation task. Valid values: `Succ`, `Failed`.
     */
    ...
    /**
     * Set Result of creating the confirmation task. Valid values: `Succ`, `Failed`.
    ...
    public ConfirmNetworkFirewallPolicyResponse() {
    }
