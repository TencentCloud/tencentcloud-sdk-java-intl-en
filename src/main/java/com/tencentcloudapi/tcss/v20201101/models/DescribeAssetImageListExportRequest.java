...
public class DescribeAssetImageListExportRequest extends AbstractModel {
...
<li>SecurityRisk- String - Required: No - Security risks. Valid values: `VulCnt`, `VirusCnt`, `RiskCnt`, `IsTrustImage`.</li>
    ...
    public DescribeAssetImageListExportRequest() {
    }
     ...
     */
    public DescribeAssetImageListExportRequest(DescribeAssetImageListExportRequest source) {
