...
public class DescribeComplianceWhitelistItemListResponse extends AbstractModel {
    ...
    * Allowlist
    */
    @SerializedName("WhitelistItemSet")
    @Expose
    private ComplianceWhitelistItem [] WhitelistItemSet;
    ...
    */
    ...
    public void setWhitelistItemSet(ComplianceWhitelistItem [] WhitelistItemSet) {
        this.WhitelistItemSet = WhitelistItemSet;
    }
    ...
    public DescribeComplianceWhitelistItemListResponse() {
    }
    ...
    public DescribeComplianceWhitelistItemListResponse(DescribeComplianceWhitelistItemListResponse source) {
        if (source.WhitelistItemSet != null) {
            this.WhitelistItemSet = new ComplianceWhitelistItem[source.WhitelistItemSet.length];
            for (int i = 0; i < source.WhitelistItemSet.length; i++) {
                this.WhitelistItemSet[i] = new ComplianceWhitelistItem(source.WhitelistItemSet[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "WhitelistItemSet.", this.WhitelistItemSet);
