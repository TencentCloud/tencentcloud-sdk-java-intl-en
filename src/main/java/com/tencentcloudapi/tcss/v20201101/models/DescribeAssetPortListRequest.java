...
public class DescribeAssetPortListRequest extends AbstractModel {
...
<li>ProcessName- string - Required: No - Process name</li>
    ...
    public DescribeAssetPortListRequest() {
    }
     ...
     */
    public DescribeAssetPortListRequest(DescribeAssetPortListRequest source) {
