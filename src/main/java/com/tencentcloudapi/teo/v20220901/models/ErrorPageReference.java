...
public class ErrorPageReference extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Referenced business ID, such as the custom block rule ID. 
    ...
    /**
     * Set Referenced business ID, such as the custom block rule ID.
     * @param BusinessId Referenced business ID, such as the custom block rule ID.
     */
