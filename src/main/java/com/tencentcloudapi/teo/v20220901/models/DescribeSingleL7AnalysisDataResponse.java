...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    */
    ...
    /**
     * Get The list of L7 dimensional data.
Note: This field may return null, indicating that no valid values can be obtained. 
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * Set The list of L7 dimensional data.
Note: This field may return null, indicating that no valid values can be obtained.
     * @param Data The list of L7 dimensional data.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public void setData(SingleDataRecord [] Data) {
        this.Data = Data;
    }
     ...
     */
    public DescribeSingleL7AnalysisDataResponse(DescribeSingleL7AnalysisDataResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.Data != null) {
            this.Data = new SingleDataRecord[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new SingleDataRecord(source.Data[i]);
            }
        }
