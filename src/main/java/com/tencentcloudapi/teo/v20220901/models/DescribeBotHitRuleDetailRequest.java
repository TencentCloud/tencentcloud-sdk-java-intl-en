...
public class DescribeBotHitRuleDetailRequest extends AbstractModel{
...
<li>`mainland`: Chinese mainland.</li>If this field is not specified, the data storage region will be determined based on the user’s location.
    ...
    public DescribeBotHitRuleDetailRequest() {
    }
     ...
     */
    public DescribeBotHitRuleDetailRequest(DescribeBotHitRuleDetailRequest source) {
