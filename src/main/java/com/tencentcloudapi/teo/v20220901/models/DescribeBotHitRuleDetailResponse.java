...
public class DescribeBotHitRuleDetailResponse extends AbstractModel{
...
Note: This field may return null, indicating that no valid values can be obtained. 
     * @return Data The hit rule information.
Note: This field may return null, indicating that no valid values can be obtained.
     */
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeBotHitRuleDetailResponse() {
    }
     ...
     */
    public DescribeBotHitRuleDetailResponse(DescribeBotHitRuleDetailResponse source) {
        if (source.Data != null) {
