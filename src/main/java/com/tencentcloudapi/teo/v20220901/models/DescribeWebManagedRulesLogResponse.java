...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    */
    ...
    /**
     * Get The list of web log data.
Note: This field may return null, indicating that no valid values can be obtained. 
     * @return Data The list of web log data.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public WebLogs [] getData() {
        return this.Data;
    }

    /**
     * Set The list of web log data.
Note: This field may return null, indicating that no valid values can be obtained.
     * @param Data The list of web log data.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public void setData(WebLogs [] Data) {
        this.Data = Data;
    }
    ...
    public DescribeWebManagedRulesLogResponse(DescribeWebManagedRulesLogResponse source) {
        if (source.Data != null) {
            this.Data = new WebLogs[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new WebLogs(source.Data[i]);
            }
        }
