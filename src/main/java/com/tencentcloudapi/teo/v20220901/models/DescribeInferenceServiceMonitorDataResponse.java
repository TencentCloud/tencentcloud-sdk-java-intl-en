...
public class DescribeInferenceServiceMonitorDataResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Total number of entries in the query result.</p> 
    ...
    /**
     * Set <p>Total number of entries in the query result.</p>
     * @param TotalCount <p>Total number of entries in the query result.</p>
     */
    ...
    /**
     * Get <p>Service monitoring data for reasoning.</p> 
    ...
    /**
     * Set <p>Service monitoring data for reasoning.</p>
     * @param InferenceServiceMonitorRecords <p>Service monitoring data for reasoning.</p>
     */
