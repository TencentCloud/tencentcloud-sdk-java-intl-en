...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    */
    ...
    /**
     * Get The blocked client information.
Note: This field may return null, indicating that no valid values can be obtained. 
     * @return Data The blocked client information.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    ...
    /**
     * Set The blocked client information.
Note: This field may return null, indicating that no valid values can be obtained.
     * @param Data The blocked client information.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public void setData(ClientRule [] Data) {
        this.Data = Data;
    }
     ...
     */
    public DescribeClientRuleListResponse(DescribeClientRuleListResponse source) {
        if (source.Data != null) {
            this.Data = new ClientRule[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new ClientRule(source.Data[i]);
            }
        }
