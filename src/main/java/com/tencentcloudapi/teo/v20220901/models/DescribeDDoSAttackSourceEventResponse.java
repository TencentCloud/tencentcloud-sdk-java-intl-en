...
Note: This field may return null, indicating that no valid values can be obtained.
    */
    @SerializedName("Data")
    @Expose
    private DDoSAttackSourceEvent [] Data;
    ...
    */
    ...
    /**
     * Get The list of DDoS attacker data.
Note: This field may return null, indicating that no valid values can be obtained. 
     * @return Data The list of DDoS attacker data.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public DDoSAttackSourceEvent [] getData() {
        return this.Data;
    }

    /**
     * Set The list of DDoS attacker data.
Note: This field may return null, indicating that no valid values can be obtained.
     * @param Data The list of DDoS attacker data.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public void setData(DDoSAttackSourceEvent [] Data) {
        this.Data = Data;
    }
    ...
    public DescribeDDoSAttackSourceEventResponse(DescribeDDoSAttackSourceEventResponse source) {
        if (source.Data != null) {
            this.Data = new DDoSAttackSourceEvent[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new DDoSAttackSourceEvent(source.Data[i]);
            }
        }
