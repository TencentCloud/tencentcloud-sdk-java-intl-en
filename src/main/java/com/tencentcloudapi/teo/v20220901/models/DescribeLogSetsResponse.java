...
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public void setLogSetList(LogSetInfo [] LogSetList) {
    ...
    public DescribeLogSetsResponse(DescribeLogSetsResponse source) {
        if (source.LogSetList != null) {
            this.LogSetList = new LogSetInfo[source.LogSetList.length];
            for (int i = 0; i < source.LogSetList.length; i++) {
                this.LogSetList[i] = new LogSetInfo(source.LogSetList[i]);
            }
        }
