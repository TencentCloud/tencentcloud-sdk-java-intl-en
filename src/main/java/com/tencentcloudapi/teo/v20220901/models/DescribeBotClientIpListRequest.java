...
public class DescribeBotClientIpListRequest extends AbstractModel{
...
<li>`mainland`: Chinese mainland.</li>If this field is not specified, the data storage region will be determined based on the user’s location.
    ...
    public DescribeBotClientIpListRequest() {
    }
     ...
     */
    public DescribeBotClientIpListRequest(DescribeBotClientIpListRequest source) {
