...
public class DeleteFunctionRulesRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteFunctionRulesRequest() {
    }
     ...
     */
    public DeleteFunctionRulesRequest(DeleteFunctionRulesRequest source) {
