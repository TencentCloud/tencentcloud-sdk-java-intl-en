...
<li>`mainland`: Chinese mainland.</li>If this field is not specified, the data storage region will be determined based on the user’s location.
    */
    ...
    /**
     * Get The start time of the attack event. 
    ...
    /**
     * Set The start time of the attack event.
    ...
    /**
     * Get The list of policy IDs to be specified. All policies will be selected if this field is not specified. 
    ...
    /**
     * Set The list of policy IDs to be specified. All policies will be selected if this field is not specified.
