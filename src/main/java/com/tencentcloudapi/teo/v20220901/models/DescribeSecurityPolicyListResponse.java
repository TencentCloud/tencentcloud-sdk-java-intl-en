...
public class DescribeSecurityPolicyListResponse extends AbstractModel{
    ...
    */
     ...
     * @return SecurityEntities List of protected resources
     */
    ...
    public DescribeSecurityPolicyListResponse(DescribeSecurityPolicyListResponse source) {
        if (source.SecurityEntities != null) {
            this.SecurityEntities = new SecurityEntity[source.SecurityEntities.length];
            for (int i = 0; i < source.SecurityEntities.length; i++) {
                this.SecurityEntities[i] = new SecurityEntity(source.SecurityEntities[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "SecurityEntities.", this.SecurityEntities);
