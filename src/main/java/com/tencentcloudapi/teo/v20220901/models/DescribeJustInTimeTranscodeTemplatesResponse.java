...
public class DescribeJustInTimeTranscodeTemplatesResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private JustInTimeTranscodeTemplate [] TemplateSet;
    ...
    */
     ...
     * @return TemplateSet Template details list.
     */
    public JustInTimeTranscodeTemplate [] getTemplateSet() {
        return this.TemplateSet;
    }

    /**
     * Set Template details list.
     * @param TemplateSet Template details list.
     */
    public void setTemplateSet(JustInTimeTranscodeTemplate [] TemplateSet) {
    ...
    public DescribeJustInTimeTranscodeTemplatesResponse(DescribeJustInTimeTranscodeTemplatesResponse source) {
        ...
        if (source.TemplateSet != null) {
            this.TemplateSet = new JustInTimeTranscodeTemplate[source.TemplateSet.length];
            for (int i = 0; i < source.TemplateSet.length; i++) {
                this.TemplateSet[i] = new JustInTimeTranscodeTemplate(source.TemplateSet[i]);
            }
        }
