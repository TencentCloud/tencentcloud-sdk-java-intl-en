...
public class DescribeOriginGroupResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setData(OriginGroup [] Data) {
        this.Data = Data;
    }
    ...
    public DescribeOriginGroupResponse(DescribeOriginGroupResponse source) {
        if (source.Data != null) {
            this.Data = new OriginGroup[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new OriginGroup(source.Data[i]);
            }
        }
