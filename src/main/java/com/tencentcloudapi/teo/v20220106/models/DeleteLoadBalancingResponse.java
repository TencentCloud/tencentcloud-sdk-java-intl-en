...
public class DeleteLoadBalancingResponse extends AbstractModel{
    ...
    */
    ...
    public DeleteLoadBalancingResponse() {
    }
     ...
     */
    public DeleteLoadBalancingResponse(DeleteLoadBalancingResponse source) {
