...
public class DescribeZoneDDoSPolicyRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeZoneDDoSPolicyRequest() {
    }
     ...
     */
    public DescribeZoneDDoSPolicyRequest(DescribeZoneDDoSPolicyRequest source) {
