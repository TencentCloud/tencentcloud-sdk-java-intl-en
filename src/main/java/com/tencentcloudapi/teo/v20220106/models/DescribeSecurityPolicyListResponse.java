...
public class DescribeSecurityPolicyListResponse extends AbstractModel{
    ...
    */
     ...
     */
    public void setEntities(SecurityEntity [] Entities) {
    ...
    public DescribeSecurityPolicyListResponse(DescribeSecurityPolicyListResponse source) {
        if (source.Entities != null) {
            this.Entities = new SecurityEntity[source.Entities.length];
            for (int i = 0; i < source.Entities.length; i++) {
                this.Entities[i] = new SecurityEntity(source.Entities[i]);
            }
        }
