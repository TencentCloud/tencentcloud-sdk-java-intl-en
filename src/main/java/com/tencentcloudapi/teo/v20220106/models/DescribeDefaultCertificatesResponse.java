...
Note: This field may return `null`, indicating that no valid value can be obtained.
    */
    ...
    @Expose
    private DefaultServerCertInfo [] CertInfo;
...
Note: This field may return `null`, indicating that no valid value can be obtained.
     */
    public DefaultServerCertInfo [] getCertInfo() {
...
Note: This field may return `null`, indicating that no valid value can be obtained.
     */
    public void setCertInfo(DefaultServerCertInfo [] CertInfo) {
    ...
    public DescribeDefaultCertificatesResponse(DescribeDefaultCertificatesResponse source) {
        ...
        if (source.CertInfo != null) {
            this.CertInfo = new DefaultServerCertInfo[source.CertInfo.length];
            for (int i = 0; i < source.CertInfo.length; i++) {
                this.CertInfo[i] = new DefaultServerCertInfo(source.CertInfo[i]);
            }
        }
