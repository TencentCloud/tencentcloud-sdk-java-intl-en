...
public class DDosAttackEventData extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public DDosAttackEvent [] getList() {
        return this.List;
    }
...
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public void setList(DDosAttackEvent [] List) {
        this.List = List;
    }
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public DDosAttackEventData(DDosAttackEventData source) {
        if (source.List != null) {
            this.List = new DDosAttackEvent[source.List.length];
            for (int i = 0; i < source.List.length; i++) {
                this.List[i] = new DDosAttackEvent(source.List[i]);
            }
        }
