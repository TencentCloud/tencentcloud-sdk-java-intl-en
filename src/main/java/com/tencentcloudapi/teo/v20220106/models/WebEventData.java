...
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public void setList(WebAttackEvent [] List) {
        this.List = List;
    }
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public WebEventData(WebEventData source) {
        if (source.List != null) {
            this.List = new WebAttackEvent[source.List.length];
            for (int i = 0; i < source.List.length; i++) {
                this.List[i] = new WebAttackEvent(source.List[i]);
            }
        }
