...
public class AddSmsTemplateResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get SMS template addition response packet body 
    ...
    /**
     * Set SMS template addition response packet body
     ...
     */
    public AddSmsTemplateResponse(AddSmsTemplateResponse source) {
        if (source.AddTemplateStatus != null) {
            this.AddTemplateStatus = new AddTemplateStatus(source.AddTemplateStatus);
        }
