...
public class SendStatusStatisticsResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Delivery statistics response packet. 
     * @return SendStatusStatistics Delivery statistics response packet.
     */
    ...
    /**
     * Set Delivery statistics response packet.
    ...
    public SendStatusStatisticsResponse() {
    }
     ...
     */
    public SendStatusStatisticsResponse(SendStatusStatisticsResponse source) {
        if (source.SendStatusStatistics != null) {
            this.SendStatusStatistics = new SendStatusStatistics(source.SendStatusStatistics);
        }
