...
public class ReplaceRoutePolicyAssociationsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Route reception policy binding object list. requires specifying the route reception policy instance ID (RoutePolicyId) and route table instance ID (RouteTableId). 
     * @return RoutePolicyAssociationSet Route reception policy binding object list. requires specifying the route reception policy instance ID (RoutePolicyId) and route table instance ID (RouteTableId).
     */
    ...
    /**
     * Set Route reception policy binding object list. requires specifying the route reception policy instance ID (RoutePolicyId) and route table instance ID (RouteTableId).
     * @param RoutePolicyAssociationSet Route reception policy binding object list. requires specifying the route reception policy instance ID (RoutePolicyId) and route table instance ID (RouteTableId).
     */
