...
public class CreateAssistantCidrResponse extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public CreateAssistantCidrResponse() {
    }
     ...
     */
    public CreateAssistantCidrResponse(CreateAssistantCidrResponse source) {
