...
public class StartTrafficMirrorRequest extends AbstractModel {
    ...
    */
    ...
    public StartTrafficMirrorRequest() {
    }
     ...
     */
    public StartTrafficMirrorRequest(StartTrafficMirrorRequest source) {
