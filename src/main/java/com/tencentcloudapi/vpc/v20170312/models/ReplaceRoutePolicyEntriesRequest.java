...
public class ReplaceRoutePolicyEntriesRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Instance ID of the routing strategy, such as rrp-azd4dt1c. 
     * @return RoutePolicyId Instance ID of the routing strategy, such as rrp-azd4dt1c.
     */
    ...
    /**
     * Set Instance ID of the routing strategy, such as rrp-azd4dt1c.
     * @param RoutePolicyId Instance ID of the routing strategy, such as rrp-azd4dt1c.
     */
    ...
    /**
     * Get Rule list of the routing strategy. requires specifying the policy rule ID (RoutePolicyEntryId). 
     * @return RoutePolicyEntrySet Rule list of the routing strategy. requires specifying the policy rule ID (RoutePolicyEntryId).
     */
    ...
    /**
     * Set Rule list of the routing strategy. requires specifying the policy rule ID (RoutePolicyEntryId).
     * @param RoutePolicyEntrySet Rule list of the routing strategy. requires specifying the policy rule ID (RoutePolicyEntryId).
     */
