...
public class CreateVpnConnectionResponse extends AbstractModel {
    ...
    */
     ...
     */
    public CreateVpnConnectionResponse(CreateVpnConnectionResponse source) {
        if (source.VpnConnection != null) {
            this.VpnConnection = new VpnConnection(source.VpnConnection);
        }
