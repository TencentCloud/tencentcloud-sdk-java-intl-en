...
public class CreateAddressTemplateResponse extends AbstractModel {
    ...
    */
    ...
    public CreateAddressTemplateResponse() {
    }
     ...
     */
    public CreateAddressTemplateResponse(CreateAddressTemplateResponse source) {
        if (source.AddressTemplate != null) {
            this.AddressTemplate = new AddressTemplate(source.AddressTemplate);
        }
