...
public class StopTrafficMirrorRequest extends AbstractModel {
    ...
    */
    ...
    public StopTrafficMirrorRequest() {
    }
     ...
     */
    public StopTrafficMirrorRequest(StopTrafficMirrorRequest source) {
