...
public class DescribeGatewayFlowMonitorDetailResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeGatewayFlowMonitorDetailResponse() {
    }
     ...
     */
    public DescribeGatewayFlowMonitorDetailResponse(DescribeGatewayFlowMonitorDetailResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.GatewayFlowMonitorDetailSet != null) {
            this.GatewayFlowMonitorDetailSet = new GatewayFlowMonitorDetail[source.GatewayFlowMonitorDetailSet.length];
            for (int i = 0; i < source.GatewayFlowMonitorDetailSet.length; i++) {
                this.GatewayFlowMonitorDetailSet[i] = new GatewayFlowMonitorDetail(source.GatewayFlowMonitorDetailSet[i]);
            }
        }
