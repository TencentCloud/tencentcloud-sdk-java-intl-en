...
public class CreateServiceTemplateGroupResponse extends AbstractModel{
    ...
    */
     ...
     */
    public CreateServiceTemplateGroupResponse(CreateServiceTemplateGroupResponse source) {
        if (source.ServiceTemplateGroup != null) {
            this.ServiceTemplateGroup = new ServiceTemplateGroup(source.ServiceTemplateGroup);
        }
