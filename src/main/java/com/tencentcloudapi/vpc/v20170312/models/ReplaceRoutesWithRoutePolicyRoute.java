...
public class ReplaceRoutesWithRoutePolicyRoute extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Route unique policy ID. 
     * @return RouteItemId Route unique policy ID.
     */
    ...
    /**
     * Set Route unique policy ID.
     * @param RouteItemId Route unique policy ID.
     */
    ...
    /**
     * Get Match the route reception policy tag. 
     * @return ForceMatchPolicy Match the route reception policy tag.
     */
    ...
    /**
     * Set Match the route reception policy tag.
     * @param ForceMatchPolicy Match the route reception policy tag.
     */
