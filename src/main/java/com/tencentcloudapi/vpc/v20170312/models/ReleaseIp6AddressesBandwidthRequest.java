...
public class ReleaseIp6AddressesBandwidthRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get IPv6 addresses. Both Ip6Addresses and Ip6AddressIds are required, but they cannot be specified at the same time. 
    ...
    /**
     * Set IPv6 addresses. Both Ip6Addresses and Ip6AddressIds are required, but they cannot be specified at the same time.
     * @param Ip6Addresses IPv6 addresses. Both Ip6Addresses and Ip6AddressIds are required, but they cannot be specified at the same time.
     */
    ...
    /**
     * Get Unique IDs corresponding to the IPv6 addresses. Format: eip-xxxxxxxx. Both Ip6Addresses and Ip6AddressIds are required, but they cannot be specified at the same time. 
    ...
    /**
     * Set Unique IDs corresponding to the IPv6 addresses. Format: eip-xxxxxxxx. Both Ip6Addresses and Ip6AddressIds are required, but they cannot be specified at the same time.
     * @param Ip6AddressIds Unique IDs corresponding to the IPv6 addresses. Format: eip-xxxxxxxx. Both Ip6Addresses and Ip6AddressIds are required, but they cannot be specified at the same time.
     */
