...
public class DisableSnapshotPoliciesRequest extends AbstractModel{
    ...
    */
    ...
    public DisableSnapshotPoliciesRequest() {
    }
     ...
     */
    public DisableSnapshotPoliciesRequest(DisableSnapshotPoliciesRequest source) {
