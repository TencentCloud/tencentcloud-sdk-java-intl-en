...
public class DescribeNetworkAclsResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeNetworkAclsResponse() {
    }
     ...
     */
    public DescribeNetworkAclsResponse(DescribeNetworkAclsResponse source) {
        if (source.NetworkAclSet != null) {
            this.NetworkAclSet = new NetworkAcl[source.NetworkAclSet.length];
            for (int i = 0; i < source.NetworkAclSet.length; i++) {
                this.NetworkAclSet[i] = new NetworkAcl(source.NetworkAclSet[i]);
            }
        }
