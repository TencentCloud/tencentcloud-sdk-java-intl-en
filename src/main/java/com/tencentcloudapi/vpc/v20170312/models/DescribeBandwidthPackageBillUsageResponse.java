...
public class DescribeBandwidthPackageBillUsageResponse extends AbstractModel {
    ...
    */
     ...
     */
    public DescribeBandwidthPackageBillUsageResponse(DescribeBandwidthPackageBillUsageResponse source) {
        if (source.BandwidthPackageBillBandwidthSet != null) {
            this.BandwidthPackageBillBandwidthSet = new BandwidthPackageBillBandwidth[source.BandwidthPackageBillBandwidthSet.length];
            for (int i = 0; i < source.BandwidthPackageBillBandwidthSet.length; i++) {
                this.BandwidthPackageBillBandwidthSet[i] = new BandwidthPackageBillBandwidth(source.BandwidthPackageBillBandwidthSet[i]);
            }
        }
