...
public class DescribeInstanceJumboRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Instance ID list of CVM. limits up to 10 instances for each query. 
    ...
    /**
     * Set Instance ID list of CVM. limits up to 10 instances for each query.
     * @param InstanceIds Instance ID list of CVM. limits up to 10 instances for each query.
     */
