...
public class CreateNetworkAclResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Network ACL instance 
     * @return NetworkAcl Network ACL instance
     */
    ...
    public CreateNetworkAclResponse() {
    }
     ...
     */
    public CreateNetworkAclResponse(CreateNetworkAclResponse source) {
        if (source.NetworkAcl != null) {
            this.NetworkAcl = new NetworkAcl(source.NetworkAcl);
        }
