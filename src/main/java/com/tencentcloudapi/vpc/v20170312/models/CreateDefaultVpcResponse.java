...
public class CreateDefaultVpcResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Set Default VPC and subnet IDs
    ...
    public CreateDefaultVpcResponse() {
    }
     ...
     */
    public CreateDefaultVpcResponse(CreateDefaultVpcResponse source) {
        if (source.Vpc != null) {
            this.Vpc = new DefaultVpcSubnet(source.Vpc);
        }
