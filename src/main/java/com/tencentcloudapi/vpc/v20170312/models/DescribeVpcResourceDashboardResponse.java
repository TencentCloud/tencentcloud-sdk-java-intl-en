...
public class DescribeVpcResourceDashboardResponse extends AbstractModel{
    ...
    */
     ...
     */
    public DescribeVpcResourceDashboardResponse(DescribeVpcResourceDashboardResponse source) {
        if (source.ResourceDashboardSet != null) {
            this.ResourceDashboardSet = new ResourceDashboard[source.ResourceDashboardSet.length];
            for (int i = 0; i < source.ResourceDashboardSet.length; i++) {
                this.ResourceDashboardSet[i] = new ResourceDashboard(source.ResourceDashboardSet[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "ResourceDashboardSet.", this.ResourceDashboardSet);
