...
public class CreateAndAttachNetworkInterfaceResponse extends AbstractModel {
    ...
    */
     ...
     * @return NetworkInterface The ENI instance.
     */
    ...
    public CreateAndAttachNetworkInterfaceResponse() {
    }
     ...
     */
    public CreateAndAttachNetworkInterfaceResponse(CreateAndAttachNetworkInterfaceResponse source) {
        if (source.NetworkInterface != null) {
            this.NetworkInterface = new NetworkInterface(source.NetworkInterface);
        }
