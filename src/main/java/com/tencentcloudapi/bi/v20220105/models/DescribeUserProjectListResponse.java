...
public class DescribeUserProjectListResponse extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public DescribeUserProjectListResponse() {
    }
     ...
     */
    public DescribeUserProjectListResponse(DescribeUserProjectListResponse source) {
        if (source.ErrorInfo != null) {
            this.ErrorInfo = new ErrorInfo(source.ErrorInfo);
        }
        if (source.Data != null) {
            this.Data = new CorpUserListData(source.Data);
        }
