...
public class ModifyTagTableResponse extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public ModifyTagTableVO getData() {
        return this.Data;
    }
...
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public void setData(ModifyTagTableVO Data) {
        this.Data = Data;
    }
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public ModifyTagTableResponse(ModifyTagTableResponse source) {
        if (source.ErrorInfo != null) {
            this.ErrorInfo = new ErrorInfo(source.ErrorInfo);
        }
        if (source.Data != null) {
            this.Data = new ModifyTagTableVO(source.Data);
        }
