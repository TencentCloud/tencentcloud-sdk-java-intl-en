...
public class CreateTagTableResponse extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public CreateTagTableVO getData() {
        return this.Data;
    }
...
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public void setData(CreateTagTableVO Data) {
        this.Data = Data;
    }
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     */
    public CreateTagTableResponse(CreateTagTableResponse source) {
        if (source.ErrorInfo != null) {
            this.ErrorInfo = new ErrorInfo(source.ErrorInfo);
        }
        if (source.Data != null) {
            this.Data = new CreateTagTableVO(source.Data);
        }
