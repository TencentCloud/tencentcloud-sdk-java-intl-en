...
public class ModifyResourceUserRequest extends AbstractModel {
    ...
    */
    ...
    public ModifyResourceUserRequest() {
    }
     ...
     */
    public ModifyResourceUserRequest(ModifyResourceUserRequest source) {
