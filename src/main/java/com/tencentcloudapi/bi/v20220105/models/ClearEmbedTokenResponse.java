...
public class ClearEmbedTokenResponse extends AbstractModel {
...
Note: This field may return null, indicating that no valid values can be obtained. 
     * @return Extra Additional message.
Note: This field may return null, indicating that no valid values can be obtained.
     */
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    public ClearEmbedTokenResponse() {
    }
     ...
     */
    public ClearEmbedTokenResponse(ClearEmbedTokenResponse source) {
