...
public class CreateIAPUserOIDCConfigRequest extends AbstractModel {
    ...
    */
    ...
    public CreateIAPUserOIDCConfigRequest() {
    }
     ...
     */
    public CreateIAPUserOIDCConfigRequest(CreateIAPUserOIDCConfigRequest source) {
