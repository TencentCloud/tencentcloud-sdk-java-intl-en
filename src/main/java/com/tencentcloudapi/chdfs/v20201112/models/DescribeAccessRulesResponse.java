...
public class DescribeAccessRulesResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeAccessRulesResponse() {
    }
     ...
     */
    public DescribeAccessRulesResponse(DescribeAccessRulesResponse source) {
