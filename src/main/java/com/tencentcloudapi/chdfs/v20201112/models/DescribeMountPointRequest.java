...
public class DescribeMountPointRequest extends AbstractModel{
    ...
    */
    ...
    public DescribeMountPointRequest() {
    }
     ...
     */
    public DescribeMountPointRequest(DescribeMountPointRequest source) {
