...
public class DeleteRecordGroupRequest extends AbstractModel{
    ...
    */
    ...
    public DeleteRecordGroupRequest() {
    }
     ...
     */
    public DeleteRecordGroupRequest(DeleteRecordGroupRequest source) {
