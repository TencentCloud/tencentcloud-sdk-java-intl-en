...
public class CreateDomainResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private DomainCreateInfo DomainInfo;
    ...
    */
     ...
     * @return DomainInfo Domain information
     */
    public DomainCreateInfo getDomainInfo() {
     ...
     */
    public void setDomainInfo(DomainCreateInfo DomainInfo) {
