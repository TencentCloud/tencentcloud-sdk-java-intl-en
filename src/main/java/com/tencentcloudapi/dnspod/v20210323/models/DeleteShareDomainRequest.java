...
public class DeleteShareDomainRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Account of the domain to be shared 
     * @return Account Account of the domain to be shared
     */
    ...
    /**
     * Set Account of the domain to be shared
    ...
    public DeleteShareDomainRequest() {
    }
     ...
     */
    public DeleteShareDomainRequest(DeleteShareDomainRequest source) {
