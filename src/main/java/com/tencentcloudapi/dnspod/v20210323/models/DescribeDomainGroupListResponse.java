...
public class DescribeDomainGroupListResponse extends AbstractModel {
    ...
    */
     ...
     */
    public void setGroupList(GroupInfo [] GroupList) {
     ...
     */
    public DescribeDomainGroupListResponse(DescribeDomainGroupListResponse source) {
        if (source.GroupList != null) {
            this.GroupList = new GroupInfo[source.GroupList.length];
            for (int i = 0; i < source.GroupList.length; i++) {
                this.GroupList[i] = new GroupInfo(source.GroupList[i]);
            }
        }
