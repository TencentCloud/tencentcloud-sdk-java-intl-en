...
public class DescribeDomainAliasListRequest extends AbstractModel {
    ...
    */
    ...
    public DescribeDomainAliasListRequest() {
    }
     ...
     */
    public DescribeDomainAliasListRequest(DescribeDomainAliasListRequest source) {
