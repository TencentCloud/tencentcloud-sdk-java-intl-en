...
public class DeleteDomainBatchRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteDomainBatchRequest() {
    }
     ...
     */
    public DeleteDomainBatchRequest(DeleteDomainBatchRequest source) {
