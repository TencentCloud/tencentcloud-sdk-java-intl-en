...
public class ModifyDomainUnlockRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Domain unlock code, which will be returned when the domain is locked. 
     * @return LockCode Domain unlock code, which will be returned when the domain is locked.
     */
    ...
    /**
     * Set Domain unlock code, which will be returned when the domain is locked.
    ...
    public ModifyDomainUnlockRequest() {
    }
     ...
     */
    public ModifyDomainUnlockRequest(ModifyDomainUnlockRequest source) {
