...
public class DescribeRecordResponse extends AbstractModel{
    ...
    */
     ...
     */
    public DescribeRecordResponse(DescribeRecordResponse source) {
        if (source.RecordInfo != null) {
            this.RecordInfo = new RecordInfo(source.RecordInfo);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamObj(map, prefix + "RecordInfo.", this.RecordInfo);
