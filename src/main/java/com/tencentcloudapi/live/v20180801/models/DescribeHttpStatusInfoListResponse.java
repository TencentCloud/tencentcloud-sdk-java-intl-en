...
public class DescribeHttpStatusInfoListResponse extends AbstractModel{
    ...
    */
     ...
     */
    public DescribeHttpStatusInfoListResponse(DescribeHttpStatusInfoListResponse source) {
        if (source.DataInfoList != null) {
            this.DataInfoList = new HttpStatusData[source.DataInfoList.length];
            for (int i = 0; i < source.DataInfoList.length; i++) {
                this.DataInfoList[i] = new HttpStatusData(source.DataInfoList[i]);
            }
        }
