...
public class DescribeLiveCallbackTemplatesResponse extends AbstractModel {
    ...
    */
     ...
     * @return Templates Template information list.
     */
     ...
     */
    public void setTemplates(CallBackTemplateInfo [] Templates) {
     ...
     */
    public DescribeLiveCallbackTemplatesResponse(DescribeLiveCallbackTemplatesResponse source) {
        if (source.Templates != null) {
            this.Templates = new CallBackTemplateInfo[source.Templates.length];
            for (int i = 0; i < source.Templates.length; i++) {
                this.Templates[i] = new CallBackTemplateInfo(source.Templates[i]);
            }
        }
