...
public class CreateLiveRecordRuleRequest extends AbstractModel {
...
Note: If the parameter is a non-empty string, the rule will be only applicable to the particular stream.
    ...
    public CreateLiveRecordRuleRequest() {
    }
     ...
     */
    public CreateLiveRecordRuleRequest(CreateLiveRecordRuleRequest source) {
