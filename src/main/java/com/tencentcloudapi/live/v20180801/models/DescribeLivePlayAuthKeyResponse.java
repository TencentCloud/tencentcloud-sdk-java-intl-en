...
public class DescribeLivePlayAuthKeyResponse extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Playback authentication key information. 
    ...
    /**
     * Set Playback authentication key information.
     ...
     */
    public DescribeLivePlayAuthKeyResponse(DescribeLivePlayAuthKeyResponse source) {
        if (source.PlayAuthKeyInfo != null) {
            this.PlayAuthKeyInfo = new PlayAuthKeyInfo(source.PlayAuthKeyInfo);
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamObj(map, prefix + "PlayAuthKeyInfo.", this.PlayAuthKeyInfo);
