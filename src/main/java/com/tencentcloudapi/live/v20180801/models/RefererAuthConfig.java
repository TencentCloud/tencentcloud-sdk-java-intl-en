...
public class RefererAuthConfig extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Whether to enable referer. Valid values: `0` (no), `1` (yes) 
     * @return Enable Whether to enable referer. Valid values: `0` (no), `1` (yes)
     */
    ...
    /**
     * Set Whether to enable referer. Valid values: `0` (no), `1` (yes)
