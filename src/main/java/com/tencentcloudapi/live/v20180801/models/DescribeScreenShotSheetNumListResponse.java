...
public class DescribeScreenShotSheetNumListResponse extends AbstractModel {
    ...
    */
    ...
    @Expose
    private TimeValue [] DataInfoList;
    ...
    */
    ...
    public DescribeScreenShotSheetNumListResponse() {
    }
     ...
     */
    public DescribeScreenShotSheetNumListResponse(DescribeScreenShotSheetNumListResponse source) {
        if (source.DataInfoList != null) {
            this.DataInfoList = new TimeValue[source.DataInfoList.length];
            for (int i = 0; i < source.DataInfoList.length; i++) {
                this.DataInfoList[i] = new TimeValue(source.DataInfoList[i]);
            }
        }
