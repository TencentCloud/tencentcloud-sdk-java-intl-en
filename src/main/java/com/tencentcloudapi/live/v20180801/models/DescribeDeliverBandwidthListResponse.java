...
public class DescribeDeliverBandwidthListResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Billable bandwidth of live stream relaying. 
    ...
    /**
     * Set Billable bandwidth of live stream relaying.
     * @param DataInfoList Billable bandwidth of live stream relaying.
     */
    public void setDataInfoList(BandwidthInfo [] DataInfoList) {
     ...
     */
    public DescribeDeliverBandwidthListResponse(DescribeDeliverBandwidthListResponse source) {
        if (source.DataInfoList != null) {
            this.DataInfoList = new BandwidthInfo[source.DataInfoList.length];
            for (int i = 0; i < source.DataInfoList.length; i++) {
                this.DataInfoList[i] = new BandwidthInfo(source.DataInfoList[i]);
            }
        }
