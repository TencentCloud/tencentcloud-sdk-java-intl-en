...
public class DescribeLiveWatermarkResponse extends AbstractModel {
    ...
    */
    ...
    public DescribeLiveWatermarkResponse() {
    }
     ...
     */
    public DescribeLiveWatermarkResponse(DescribeLiveWatermarkResponse source) {
        if (source.Watermark != null) {
            this.Watermark = new WatermarkInfo(source.Watermark);
        }
