...
public class DescribeLiveStreamPushInfoListResponse extends AbstractModel{
    ...
    */
    ...
    public DescribeLiveStreamPushInfoListResponse() {
    }
     ...
     */
    public DescribeLiveStreamPushInfoListResponse(DescribeLiveStreamPushInfoListResponse source) {
        if (source.DataInfoList != null) {
            this.DataInfoList = new PushDataInfo[source.DataInfoList.length];
            for (int i = 0; i < source.DataInfoList.length; i++) {
                this.DataInfoList[i] = new PushDataInfo(source.DataInfoList[i]);
            }
        }
