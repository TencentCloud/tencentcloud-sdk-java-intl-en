...
public class ForbidLiveDomainRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get LVB domain name to be disabled. 
    ...
    /**
     * Set LVB domain name to be disabled.
    ...
    public ForbidLiveDomainRequest() {
    }
     ...
     */
    public ForbidLiveDomainRequest(ForbidLiveDomainRequest source) {
