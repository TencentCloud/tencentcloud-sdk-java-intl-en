...
public class GetCountryCodesResponse extends AbstractModel{
    ...
    */
     ...
     */
    public GetCountryCodesResponse(GetCountryCodesResponse source) {
        if (source.Data != null) {
            this.Data = new CountryCodeItem[source.Data.length];
            for (int i = 0; i < source.Data.length; i++) {
                this.Data[i] = new CountryCodeItem(source.Data[i]);
            }
        }
