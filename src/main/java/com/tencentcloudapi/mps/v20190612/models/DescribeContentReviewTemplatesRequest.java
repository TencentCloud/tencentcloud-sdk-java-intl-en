...
public class DescribeContentReviewTemplatesRequest extends AbstractModel{
    ...
    */
    ...
    /**
     * Get Unique ID filter of content audit templates. Array length limit: 50. 
     * @return Definitions Unique ID filter of content audit templates. Array length limit: 50.
     */
    ...
    /**
     * Set Unique ID filter of content audit templates. Array length limit: 50.
