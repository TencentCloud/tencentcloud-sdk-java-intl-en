...
public class TextToSpeechResponse extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>base64 code of the synthetic audio in default wav format</p> 
     * @return AudioData <p>base64 code of the synthetic audio in default wav format</p>
     */
    ...
    /**
     * Set <p>base64 code of the synthetic audio in default wav format</p>
     * @param AudioData <p>base64 code of the synthetic audio in default wav format</p>
     */
    ...
    /**
     * Get <p>Extended information, json string  duration: Audio duration of the result, in seconds</p> 
     * @return ExtInfo <p>Extended information, json string  duration: Audio duration of the result, in seconds</p>
     */
    ...
    /**
     * Set <p>Extended information, json string  duration: Audio duration of the result, in seconds</p>
     * @param ExtInfo <p>Extended information, json string  duration: Audio duration of the result, in seconds</p>
     */
