...
public class DeleteAsrHotwordsRequest extends AbstractModel {
    ...
    */
    ...
    /**
     * Get ID of the hotword lexicon to be deleted. 
     * @return HotwordsId ID of the hotword lexicon to be deleted.
     */
    ...
    /**
     * Set ID of the hotword lexicon to be deleted.
     * @param HotwordsId ID of the hotword lexicon to be deleted.
     */
