...
public class AiAnalysisTaskDelLogoInput extends AbstractModel {
    ...
    */
    ...
    /**
     * Get Intelligent removal template ID. 
     * @return Definition Intelligent removal template ID.
     */
    ...
    /**
     * Set Intelligent removal template ID.
     * @param Definition Intelligent removal template ID.
     */
