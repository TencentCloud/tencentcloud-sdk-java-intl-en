...
public class AiAnalysisTaskDelLogoInput extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>ID of the intelligent video erasing template.</p> 
     * @return Definition <p>ID of the intelligent video erasing template.</p>
     */
    ...
    /**
     * Set <p>ID of the intelligent video erasing template.</p>
     * @param Definition <p>ID of the intelligent video erasing template.</p>
     */
