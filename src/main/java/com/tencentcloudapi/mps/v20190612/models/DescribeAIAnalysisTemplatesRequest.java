...
* Custom
    ...
    */
    ...
    /**
     * Get Filter condition for the unique identifier of the video content analysis template. The array can contain up to 100 unique identifiers. 
     * @return Definitions Filter condition for the unique identifier of the video content analysis template. The array can contain up to 100 unique identifiers.
     */
    ...
    /**
     * Set Filter condition for the unique identifier of the video content analysis template. The array can contain up to 100 unique identifiers.
     * @param Definitions Filter condition for the unique identifier of the video content analysis template. The array can contain up to 100 unique identifiers.
     */
...
* Custom
    ...
    /**
     * Get Filter condition for video analysis template identifiers, with a length limit of 64 characters. 
    ...
    /**
     * Set Filter condition for video analysis template identifiers, with a length limit of 64 characters.
     * @param Name Filter condition for video analysis template identifiers, with a length limit of 64 characters.
     */
