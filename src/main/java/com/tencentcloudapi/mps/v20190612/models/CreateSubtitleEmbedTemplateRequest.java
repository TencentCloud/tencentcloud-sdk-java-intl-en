...
public class CreateSubtitleEmbedTemplateRequest extends AbstractModel {
    ...
    */
    ...
    public CreateSubtitleEmbedTemplateRequest() {
    }
     ...
     */
    public CreateSubtitleEmbedTemplateRequest(CreateSubtitleEmbedTemplateRequest source) {
        if (source.Name != null) {
