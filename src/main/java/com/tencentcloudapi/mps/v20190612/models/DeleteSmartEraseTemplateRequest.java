...
public class DeleteSmartEraseTemplateRequest extends AbstractModel {
    ...
    */
    ...
    public DeleteSmartEraseTemplateRequest() {
    }
     ...
     */
    public DeleteSmartEraseTemplateRequest(DeleteSmartEraseTemplateRequest source) {
