...
public class OverrideAIDubbingParameter extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>Subtitle configuration message.</p> 
    ...
    /**
     * Set <p>Subtitle configuration message.</p>
     * @param SubtitleConfig <p>Subtitle configuration message.</p>
     */
    ...
    /**
     * Get <p>Output configuration information.</p> 
    ...
    /**
     * Set <p>Output configuration information.</p>
     * @param OutputConfig <p>Output configuration information.</p>
     */
    public void setOutputConfig(DubbingOutputConfig OutputConfig) {
        this.OutputConfig = OutputConfig;
    }

    public OverrideAIDubbingParameter() {
    }
     ...
     */
    public OverrideAIDubbingParameter(OverrideAIDubbingParameter source) {
