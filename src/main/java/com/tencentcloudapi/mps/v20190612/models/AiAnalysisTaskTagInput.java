...
public class AiAnalysisTaskTagInput extends AbstractModel {
    ...
    */
    ...
    /**
     * Get <p>ID of the intelligent video tagging template.</p> 
     * @return Definition <p>ID of the intelligent video tagging template.</p>
     */
    ...
    /**
     * Set <p>ID of the intelligent video tagging template.</p>
     * @param Definition <p>ID of the intelligent video tagging template.</p>
     */
