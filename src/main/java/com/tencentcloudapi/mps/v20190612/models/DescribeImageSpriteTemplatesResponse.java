...
public class DescribeImageSpriteTemplatesResponse extends AbstractModel{
    ...
    */
    ...
    @Expose
    private ImageSpriteTemplate [] ImageSpriteTemplateSet;
    ...
    */
    ...
    /**
     * Get List of image sprite generating template details. 
    ...
    /**
     * Set List of image sprite generating template details.
    ...
    public DescribeImageSpriteTemplatesResponse() {
    }
     ...
     */
    public DescribeImageSpriteTemplatesResponse(DescribeImageSpriteTemplatesResponse source) {
        if (source.TotalCount != null) {
            this.TotalCount = new Long(source.TotalCount);
        }
        if (source.ImageSpriteTemplateSet != null) {
            this.ImageSpriteTemplateSet = new ImageSpriteTemplate[source.ImageSpriteTemplateSet.length];
            for (int i = 0; i < source.ImageSpriteTemplateSet.length; i++) {
                this.ImageSpriteTemplateSet[i] = new ImageSpriteTemplate(source.ImageSpriteTemplateSet[i]);
            }
        }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        ...
        this.setParamArrayObj(map, prefix + "ImageSpriteTemplateSet.", this.ImageSpriteTemplateSet);
